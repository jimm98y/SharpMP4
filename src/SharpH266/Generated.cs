    ...
    */
    public class VideoParameterSetRbsp : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            this.vps_ols_ptl_idx = new uint[TotalNumOlss];
            for (i = 0; i < TotalNumOlss; i++)
            {
            ...
            if (vps_each_layer_is_an_ols_flag == 0)
            {
                ...
                this.vps_dpb_max_tid = new uint[VpsNumDpbParams];
                this.dpb_parameters = new DpbParameters[VpsNumDpbParams];
                for (i = 0; i < VpsNumDpbParams; i++)
                {
    ...
    */
    public class SeqParameterSetRbsp : IItuSerializable
    {
      ...
      sps_pic_height_max_in_luma_samples > CtbSizeY)
            ...
            this.sps_num_ref_pic_lists = new uint[(sps_rpl1_same_as_rpl0_flag ? 1 : 2)];
            this.ref_pic_list_struct = new RefPicListStruct[(sps_rpl1_same_as_rpl0_flag ? 1 : 2)][];
            for (i = 0; i < (sps_rpl1_same_as_rpl0_flag ? 1 : 2); i++)
            {
            ...
            if (sps_ptl_dpb_hrd_params_present_flag != 0)
            {
                ...
                if (sps_timing_hrd_params_present_flag != 0)
                {
                    ...
                    firstSubLayer = sps_sublayer_cpb_params_present_flag ? 0 : ;
                    this.sps_max_sublayers_minus1 = new SpsMaxSublayersMinus1();
                    size += stream.ReadClass<SpsMaxSublayersMinus1>(size, context, this.sps_max_sublayers_minus1);
      ...
      sps_pic_height_max_in_luma_samples > CtbSizeY)
            ...
            if (sps_ptl_dpb_hrd_params_present_flag != 0)
            {
                ...
                if (sps_timing_hrd_params_present_flag != 0)
                {
                    ...
                    firstSubLayer = sps_sublayer_cpb_params_present_flag ? 0 : ;
                    size += stream.WriteClass<SpsMaxSublayersMinus1>(context, this.sps_max_sublayers_minus1);
    ...
    public class PicParameterSetRbsp : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (pps_subpic_id_mapping_present_flag != 0)
            {
                ...
                for (i = 0; i <= pps_num_subpics_minus1; i++)
                {
                    size += stream.ReadUnsignedIntVariable(size, pps_subpic_id, out this.pps_subpic_id[i]);
                }
            }
    ...
    pps_rpl_info_in_ph_flag != 0)
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            if (pps_subpic_id_mapping_present_flag != 0)
            {
                ...
                for (i = 0; i <= pps_num_subpics_minus1; i++)
                {
                    size += stream.WriteUnsignedIntVariable(pps_subpic_id[i], this.pps_subpic_id[i]);
                }
            }
    ...
    public class AdaptationParameterSetRbsp : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            else if (aps_params_type == LMCS_APS)
            {
                ...
                size += stream.ReadClass<LmcsData>(size, context, this.lmcs_data);
            }
            else if (aps_params_type == SCALING_APS)
            {
            ...
            size += stream.ReadUnsignedInt(size, 1, out this.aps_extension_flag);
            ...
            if (aps_extension_flag != 0)
            {
                ...
                while (stream.ReadMoreRbspData(this))
                {
                    ...
                    size += stream.ReadUnsignedInt(size, 1, whileIndex, this.aps_extension_data_flag);
                }
            }
            this.rbsp_trailing_bits = new RbspTrailingBits();
            size += stream.ReadClass<RbspTrailingBits>(size, context, this.rbsp_trailing_bits);
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            {
                size += stream.WriteClass<LmcsData>(context, this.lmcs_data);
            }
            else if (aps_params_type == SCALING_APS)
            {
                size += stream.WriteClass<ScalingListData>(context, this.scaling_list_data);
            }
            size += stream.WriteUnsignedInt(1, this.aps_extension_flag);
            ...
            if (aps_extension_flag != 0)
            {
                ...
                while (stream.WriteMoreRbspData(this))
                {
                    ...
                    size += stream.WriteUnsignedInt(1, whileIndex, this.aps_extension_data_flag);
                }
            }
            size += stream.WriteClass<RbspTrailingBits>(context, this.rbsp_trailing_bits);
    ...
    */
    public class PictureHeaderStructure : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            this.ph_extra_bit = new byte[NumExtraPhBits];
            for (i = 0; i < NumExtraPhBits; i++)
            {
            ...
            if (sps_alf_enabled_flag != 0 && pps_alf_info_in_ph_flag != 0)
            {
            ...
            if (sps_explicit_scaling_list_enabled_flag != 0)
            {
            ...
            if (sps_virtual_boundaries_enabled_flag != 0 && sps_virtual_boundaries_present_flag == 0)
            {
            ...
            if (ph_intra_slice_allowed_flag != 0)
            {
                ...
                if (pps_cu_qp_delta_enabled_flag != 0)
                {
            ...
            if (ph_inter_slice_allowed_flag != 0)
            {
                ...
                if (sps_temporal_mvp_enabled_flag != 0)
                {
                    ...
                    if (ph_temporal_mvp_enabled_flag != 0 && pps_rpl_info_in_ph_flag != 0)
                    {
      ...
      num_ref_entries[1][RplsIdx[1]] > 1))
                ...
                if (sps_mmvd_fullpel_only_enabled_flag != 0)
                {
    ...
    pps_wp_info_in_ph_flag != 0)
            ...
            if (pps_picture_header_extension_present_flag != 0)
            {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (alf_luma_filter_signal_flag != 0)
            {
                ...
                if (alf_luma_num_filters_signalled_minus1 > 0)
                {
                    ...
                    this.alf_luma_coeff_delta_idx = new uint[NumAlfFilters];
                    for (filtIdx = 0; filtIdx < NumAlfFilters; filtIdx++)
                    {
                        size += stream.ReadUnsignedIntVariable(size, alf_luma_coeff_delta_idx, out this.alf_luma_coeff_delta_idx[filtIdx]);
                    }
                }
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            if (alf_luma_filter_signal_flag != 0)
            {
                ...
                if (alf_luma_num_filters_signalled_minus1 > 0)
                {
                    ...
                    for (filtIdx = 0; filtIdx < NumAlfFilters; filtIdx++)
                    {
                        size += stream.WriteUnsignedIntVariable(alf_luma_coeff_delta_idx[filtIdx], this.alf_luma_coeff_delta_idx[filtIdx]);
                    }
                }
    ...
    */
    public class LmcsData : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            this.lmcs_delta_abs_cw = new uint[LmcsMaxBinIdx];
            this.lmcs_delta_sign_cw_flag = new byte[LmcsMaxBinIdx];
            for (i = lmcs_min_bin_idx; i <= LmcsMaxBinIdx; i++)
            {
                size += stream.ReadUnsignedIntVariable(size, lmcs_delta_abs_cw, out this.lmcs_delta_abs_cw[i]);
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            for (i = lmcs_min_bin_idx; i <= LmcsMaxBinIdx; i++)
            {
                size += stream.WriteUnsignedIntVariable(lmcs_delta_abs_cw[i], this.lmcs_delta_abs_cw[i]);
  ...
  if( aps_chroma_present_flag  ||  id % 3  ==  2  ||  id  ==  27 ) {  
    ...
    */
    public class ScalingListData : IItuSerializable
    {
        ...
        private uint[] scaling_list_pred_id_delta;
        public uint[] ScalingListPredIdDelta { get { return scaling_list_pred_id_delta; } set { scaling_list_pred_id_delta = value; } }
        private int[][] scaling_list_dc_coef;
        public int[][] ScalingListDcCoef { get { return scaling_list_dc_coef; } set { scaling_list_dc_coef = value; } }
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            this.scaling_list_pred_id_delta = new uint[28];
            this.scaling_list_dc_coef = new int[28];
            this.scaling_list_delta_coef = new int[28][];
            for (id = 0; id < 28; id++)
            {
                matrixSize = id < 2 ? 2 : (id < 8 ? 4 : 8);

                if (aps_chroma_present_flag != 0 || id % 3 == 2 || id == 27)
                {
                    size += stream.ReadUnsignedInt(size, 1, out this.scaling_list_copy_mode_flag[id]);

                    if (scaling_list_copy_mode_flag[id] == 0)
                    {
                        size += stream.ReadUnsignedInt(size, 1, out this.scaling_list_pred_mode_flag[id]);
                    }

                    if ((scaling_list_copy_mode_flag[id] != 0 || scaling_list_pred_mode_flag[id] != 0) &&
     id != 0 && id != 2 && id != 8)
                    {
                        size += stream.ReadUnsignedIntGolomb(size, out this.scaling_list_pred_id_delta[id]);
                    }
                    ...
                    if (scaling_list_copy_mode_flag[id] == 0)
                    {
                        ...
                        if (id > 13)
                        {
                            size += stream.ReadSignedIntGolomb(size, out this.scaling_list_dc_coef[id - 14][id]);
                            nextCoef += scaling_list_dc_coef[id - 14];
                        }

                        this.scaling_list_delta_coef[id] = new int[matrixSize * matrixSize];
                        for (i = 0; i < matrixSize * matrixSize; i++)
                        {
                            x = DiagScanOrder[3][3][i][0];
                            y = DiagScanOrder[3][3][i][1];
                            ...
                            if (!(id > 25 && x >= 4 && y >= 4))
                            {
                                size += stream.ReadSignedIntGolomb(size, out this.scaling_list_delta_coef[id][i]);
                                nextCoef += scaling_list_delta_coef[id][i];
                            }
                            ScalingList[id][i] = nextCoef;
                        }
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            for (id = 0; id < 28; id++)
            {
                ...
                if (aps_chroma_present_flag != 0 || id % 3 == 2 || id == 27)
                {
                    size += stream.WriteUnsignedInt(1, this.scaling_list_copy_mode_flag[id]);

                    if (scaling_list_copy_mode_flag[id] == 0)
                    {
                        size += stream.WriteUnsignedInt(1, this.scaling_list_pred_mode_flag[id]);
                    }

                    if ((scaling_list_copy_mode_flag[id] != 0 || scaling_list_pred_mode_flag[id] != 0) &&
     id != 0 && id != 2 && id != 8)
                    {
                        size += stream.WriteUnsignedIntGolomb(this.scaling_list_pred_id_delta[id]);
                    }
                    ...
                    if (scaling_list_copy_mode_flag[id] == 0)
                    {
                        ...
                        if (id > 13)
                        {
                            size += stream.WriteSignedIntGolomb(this.scaling_list_dc_coef[id - 14][id]);
                            nextCoef += scaling_list_dc_coef[id - 14];
                        }
                        ...
                        for (i = 0; i < matrixSize * matrixSize; i++)
                        {
                            ...
                            if (!(id > 25 && x >= 4 && y >= 4))
                            {
                                size += stream.WriteSignedIntGolomb(this.scaling_list_delta_coef[id][i]);
                                nextCoef += scaling_list_delta_coef[id][i];
                            }
                            ScalingList[id][i] = nextCoef;
                        }
    ...
    */
    public class ProfileTierLevel : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            this.ptl_sublayer_level_present_flag = new byte[0];
            for (i = MaxNumSubLayersMinus1 - 1; i >= 0; i--)
            {
            ...
            this.sublayer_level_idc = new uint[0];
            for (i = MaxNumSubLayersMinus1 - 1; i >= 0; i--)
            {
    ...
    public class OlsTimingHrdParameters : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            for (i = firstSubLayer; i <= MaxSubLayersVal; i++)
            {
                ...
                else if ((general_nal_hrd_params_present_flag != 0 ||
    general_vcl_hrd_params_present_flag != 0) && hrd_cpb_cnt_minus1 == 0)
                {
                    size += stream.ReadUnsignedInt(size, 1, out this.low_delay_hrd_flag[i]);
                }

                if (general_nal_hrd_params_present_flag != 0)
                {
                ...
                if (general_vcl_hrd_params_present_flag != 0)
                {
                    this.sublayer_hrd_parameters[i] = new SublayerHrdParameters(i);
                    size += stream.ReadClass<SublayerHrdParameters>(size, context, this.sublayer_hrd_parameters[i]);
                }
    ...
    */
    public class SublayerHrdParameters : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            this.bit_rate_value_minus1 = new uint[hrd_cpb_cnt_minus1 + 1];
            this.cpb_size_value_minus1 = new uint[hrd_cpb_cnt_minus1 + 1];
            this.cpb_size_du_value_minus1 = new uint[hrd_cpb_cnt_minus1 + 1];
            this.bit_rate_du_value_minus1 = new uint[hrd_cpb_cnt_minus1 + 1];
            this.cbr_flag = new byte[hrd_cpb_cnt_minus1 + 1];
            for (j = 0; j <= hrd_cpb_cnt_minus1; j++)
            {
    ...
    */
    public class PredWeightTable : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (pps_weighted_bipred_flag != 0 && pps_wp_info_in_ph_flag != 0 &&
   num_ref_entries[1][RplsIdx[1]] > 0)
            {
    ...
    public class RefPicLists : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            for (i = 0; i < 2; i++)
            {
                ...
                if (sps_num_ref_pic_lists[i] > 0 &&
     (i == 0 || (i == 1 && pps_rpl1_idx_present_flag != 0)))
                {
      ...
      (i == 0 || (i == 1 && pps_rpl1_idx_present_flag != 0)))
                    {
                        size += stream.ReadUnsignedIntVariable(size, rpl_idx, out this.rpl_idx[i]);
                    }
                }
                else
                {
                ...
                this.poc_lsb_lt[i] = new uint[NumLtrpEntries[i][RplsIdx[i]]];
                this.delta_poc_msb_cycle_present_flag[i] = new byte[NumLtrpEntries[i][RplsIdx[i]]];
                this.delta_poc_msb_cycle_lt[i] = new uint[NumLtrpEntries[i][RplsIdx[i]]];
                for (j = 0; j < NumLtrpEntries[i][RplsIdx[i]]; j++)
                {

                    if (ltrp_in_header_flag[i][RplsIdx[i]] != 0)
                    {
                        size += stream.ReadUnsignedIntVariable(size, poc_lsb_lt, out this.poc_lsb_lt[i][j]);
                    }
     ...
     (i == 0 || (i == 1 && pps_rpl1_idx_present_flag != 0)))
      ...
      (i == 0 || (i == 1 && pps_rpl1_idx_present_flag != 0)))
                    {
                        size += stream.WriteUnsignedIntVariable(rpl_idx[i], this.rpl_idx[i]);
                    }
                }
                else
                {
                ...
                for (j = 0; j < NumLtrpEntries[i][RplsIdx[i]]; j++)
                {
                    ...
                    if (ltrp_in_header_flag[i][RplsIdx[i]] != 0)
                    {
                        size += stream.WriteUnsignedIntVariable(poc_lsb_lt[i][j], this.poc_lsb_lt[i][j]);
                    }
    ...
    */
    public class RefPicListStruct : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (sps_long_term_ref_pics_flag != 0 && rplsIdx < sps_num_ref_pic_lists[listIdx] &&
   num_ref_entries[listIdx][rplsIdx] > 0)
            {
                size += stream.ReadUnsignedInt(size, 1, out this.ltrp_in_header_flag[listIdx][rplsIdx]);
            }

            this.inter_layer_ref_pic_flag = new byte[num_ref_entries[listIdx][rplsIdx]];
            this.st_ref_pic_flag = new byte[num_ref_entries[listIdx][rplsIdx]];
            this.abs_delta_poc_st = new uint[num_ref_entries[listIdx][rplsIdx]];
            this.strp_entry_sign_flag = new byte[num_ref_entries[listIdx][rplsIdx]];
            this.rpls_poc_lsb_lt = new uint[num_ref_entries[listIdx][rplsIdx]];
            this.ilrp_idx = new uint[num_ref_entries[listIdx][rplsIdx]];
            for (i = 0, j = 0; i < num_ref_entries[listIdx][rplsIdx]; i++)
            {
                ...
                if (inter_layer_ref_pic_flag[listIdx][rplsIdx][i] == 0)
                {
                    ...
                    {
                        size += stream.ReadUnsignedIntVariable(size, rpls_poc_lsb_lt, out this.rpls_poc_lsb_lt[listIdx][rplsIdx][j++][i]);
                    }
                }
                else
                {
   ...
   num_ref_entries[listIdx][rplsIdx] > 0)
            ...
            for (i = 0, j = 0; i < num_ref_entries[listIdx][rplsIdx]; i++)
            {
                ...
                if (inter_layer_ref_pic_flag[listIdx][rplsIdx][i] == 0)
                {
                    ...
                    {
                        size += stream.WriteUnsignedIntVariable(rpls_poc_lsb_lt[i], this.rpls_poc_lsb_lt[listIdx][rplsIdx][j++][i]);
                    }
                }
                else
                {
  ...
  ccv_reserved_zero_2bits u(2)
    ...
    */
    public class ContentColourVolume : IItuSerializable
    {
        ...
        public Descriptor Descriptor { get { return Descriptor; } set { Descriptor = value; } }
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            size += stream.ReadClass<Descriptor>(size, context, this.Descriptor);
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            uint c = 0;
            size += stream.WriteClass<Descriptor>(context, this.Descriptor);
                    ...
                    if (ar_object_cancel_flag[i] == 0)
                    {
                        ...
                        if (ar_bounding_box_update_flag[i] != 0)
                        {
                            ...
                            if (ar_bounding_box_cancel_flag[i] == 0)
                            {
                                ...
                                if (ar_object_confidence_info_present_flag != 0)
                                {
                                    size += stream.ReadUnsignedIntVariable(size, ar_object_confidence, out this.ar_object_confidence[ar_object_idx[i]]);
                                }
                            }
                        }
                    }
                    ...
                    if (ar_object_cancel_flag[i] == 0)
                    {
                        ...
                        if (ar_bounding_box_update_flag[i] != 0)
                        {
                            ...
                            if (ar_bounding_box_cancel_flag[i] == 0)
                            {
                                ...
                                if (ar_object_confidence_info_present_flag != 0)
                                {
                                    size += stream.WriteUnsignedIntVariable(ar_object_confidence[i], this.ar_object_confidence[ar_object_idx[i]]);
                                }
                            }
                        }
                    }
    ...
    */
    public class ScalabilityDimensionInfo : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (sdi_multiview_info_flag | | sdi_auxiliary_info_flag != 0)
            {
                ...
                for (i = 0; i <= sdi_max_layers_minus1; i++)
                {
                    ...
                    if (sdi_multiview_info_flag != 0)
                    {
                        size += stream.ReadUnsignedIntVariable(size, sdi_view_id_val, out this.sdi_view_id_val[i]);
                    }
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            if (sdi_multiview_info_flag | | sdi_auxiliary_info_flag != 0)
            {
                ...
                for (i = 0; i <= sdi_max_layers_minus1; i++)
                {
                    ...
                    if (sdi_multiview_info_flag != 0)
                    {
                        size += stream.WriteUnsignedIntVariable(sdi_view_id_val[i], this.sdi_view_id_val[i]);
                    }
    ...
    public class MultiviewAcquisitionInfo : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (intrinsic_param_flag != 0)
            {
                ...
                this.sign_focal_length_x = new byte[intrinsic_params_equal_flag ? 0 : num_views_minus1 + 1];
                this.exponent_focal_length_x = new uint[intrinsic_params_equal_flag ? 0 : num_views_minus1 + 1];
                this.mantissa_focal_length_x = new uint[intrinsic_params_equal_flag ? 0 : num_views_minus1 + 1];
                this.sign_focal_length_y = new byte[intrinsic_params_equal_flag ? 0 : num_views_minus1 + 1];
                this.exponent_focal_length_y = new uint[intrinsic_params_equal_flag ? 0 : num_views_minus1 + 1];
                this.mantissa_focal_length_y = new uint[intrinsic_params_equal_flag ? 0 : num_views_minus1 + 1];
                this.sign_principal_point_x = new byte[intrinsic_params_equal_flag ? 0 : num_views_minus1 + 1];
                this.exponent_principal_point_x = new uint[intrinsic_params_equal_flag ? 0 : num_views_minus1 + 1];
                this.mantissa_principal_point_x = new uint[intrinsic_params_equal_flag ? 0 : num_views_minus1 + 1];
                this.sign_principal_point_y = new byte[intrinsic_params_equal_flag ? 0 : num_views_minus1 + 1];
                this.exponent_principal_point_y = new uint[intrinsic_params_equal_flag ? 0 : num_views_minus1 + 1];
                this.mantissa_principal_point_y = new uint[intrinsic_params_equal_flag ? 0 : num_views_minus1 + 1];
                this.sign_skew_factor = new byte[intrinsic_params_equal_flag ? 0 : num_views_minus1 + 1];
                this.exponent_skew_factor = new uint[intrinsic_params_equal_flag ? 0 : num_views_minus1 + 1];
                this.mantissa_skew_factor = new uint[intrinsic_params_equal_flag ? 0 : num_views_minus1 + 1];
                for (i = 0; i <= intrinsic_params_equal_flag ? 0 : num_views_minus1; i++)
                {
    ...
    public class ColourTransformInfo : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (colour_transform_cancel_flag == 0)
            {
                ...
                if (colour_transform _cross_component_flag != 0 )
				{
                    size += stream.ReadUnsignedInt(size, 1, out this.colour_transform_cross_comp_inferred_flag);
                }

                this.colour_transf_lut = new uint[colourTransformSize];
                for (i = 0; i < colourTransformSize; i++)
                {
                    size += stream.ReadUnsignedIntVariable(size, colour_transf_lut, out this.colour_transf_lut[0][i]);
                }
            ...
            colour_transform_cross_comp_inferred_flag == 0)
                {
                    ...
                    if (colour_transform_lut2_present_flag != 0)
                    {
                        ...
                        for (i = 0; i < colourTransformSize; i++)
                        {
                            size += stream.ReadUnsignedIntVariable(size, colour_transf_lut, out this.colour_transf_lut[2][i]);
                        }
                    }
                }
                else
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            if (colour_transform_cancel_flag == 0)
            {
                ...
                for (i = 0; i < colourTransformSize; i++)
                {
                    size += stream.WriteUnsignedIntVariable(colour_transf_lut[i], this.colour_transf_lut[0][i]);
                }
            ...
            colour_transform_cross_comp_inferred_flag == 0)
                {
                    ...
                    if (colour_transform_lut2_present_flag != 0)
                    {
                        ...
                        for (i = 0; i < colourTransformSize; i++)
                        {
                            size += stream.WriteUnsignedIntVariable(colour_transf_lut[i], this.colour_transf_lut[2][i]);
                        }
                    }
                }
                else
    ...
    */
    public class ShutterIntervalInfo : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (fixed_shutter_interval_within_clvs_flag != 0)
            {
...
nn_post_filter_characteristics(payloadSize) {
 ...
 nnpfc_property_present_flag u(1)
  ...
  nnpfc_num_metadata_extension_bits ue(v)
    ...
    */
    public class NnPostFilterCharacteristics : IItuSerializable
    {
        private uint payloadSize;
        public uint PayloadSize { get { return payloadSize; } set { payloadSize = value; } }
        private uint nnpfc_purpose;
        public uint NnpfcPurpose { get { return nnpfc_purpose; } set { nnpfc_purpose = value; } }
        private uint nnpfc_id;
        public uint NnpfcId { get { return nnpfc_id; } set { nnpfc_id = value; } }
        private byte nnpfc_base_flag;
        public byte NnpfcBaseFlag { get { return nnpfc_base_flag; } set { nnpfc_base_flag = value; } }
        private uint nnpfc_mode_idc;
        public uint NnpfcModeIdc { get { return nnpfc_mode_idc; } set { nnpfc_mode_idc = value; } }
        private Dictionary<int, byte> nnpfc_alignment_zero_bit_a = new Dictionary<int, byte>();
        public Dictionary<int, byte> NnpfcAlignmentZeroBita { get { return nnpfc_alignment_zero_bit_a; } set { nnpfc_alignment_zero_bit_a = value; } }
        private byte[] nnpfc_tag_uri;
        public byte[] NnpfcTagUri { get { return nnpfc_tag_uri; } set { nnpfc_tag_uri = value; } }
        private byte[] nnpfc_uri;
        public byte[] NnpfcUri { get { return nnpfc_uri; } set { nnpfc_uri = value; } }
        private byte nnpfc_property_present_flag;
        public byte NnpfcPropertyPresentFlag { get { return nnpfc_property_present_flag; } set { nnpfc_property_present_flag = value; } }
        private uint nnpfc_num_input_pics_minus1;
        public uint NnpfcNumInputPicsMinus1 { get { return nnpfc_num_input_pics_minus1; } set { nnpfc_num_input_pics_minus1 = value; } }
        private byte[] nnpfc_input_pic_filtering_flag;
        public byte[] NnpfcInputPicFilteringFlag { get { return nnpfc_input_pic_filtering_flag; } set { nnpfc_input_pic_filtering_flag = value; } }
        private byte nnpfc_absent_input_pic_zero_flag;
        public byte NnpfcAbsentInputPicZeroFlag { get { return nnpfc_absent_input_pic_zero_flag; } set { nnpfc_absent_input_pic_zero_flag = value; } }
        private byte nnpfc_out_sub_c_flag;
        public byte NnpfcOutSubcFlag { get { return nnpfc_out_sub_c_flag; } set { nnpfc_out_sub_c_flag = value; } }
        private uint nnpfc_out_colour_format_idc;
        public uint NnpfcOutColourFormatIdc { get { return nnpfc_out_colour_format_idc; } set { nnpfc_out_colour_format_idc = value; } }
        private uint nnpfc_pic_width_num_minus1;
        public uint NnpfcPicWidthNumMinus1 { get { return nnpfc_pic_width_num_minus1; } set { nnpfc_pic_width_num_minus1 = value; } }
        private uint nnpfc_pic_width_denom_minus1;
        public uint NnpfcPicWidthDenomMinus1 { get { return nnpfc_pic_width_denom_minus1; } set { nnpfc_pic_width_denom_minus1 = value; } }
        private uint nnpfc_pic_height_num_minus1;
        public uint NnpfcPicHeightNumMinus1 { get { return nnpfc_pic_height_num_minus1; } set { nnpfc_pic_height_num_minus1 = value; } }
        private uint nnpfc_pic_height_denom_minus1;
        public uint NnpfcPicHeightDenomMinus1 { get { return nnpfc_pic_height_denom_minus1; } set { nnpfc_pic_height_denom_minus1 = value; } }
        private uint[] nnpfc_interpolated_pics;
        public uint[] NnpfcInterpolatedPics { get { return nnpfc_interpolated_pics; } set { nnpfc_interpolated_pics = value; } }
        private byte nnpfc_component_last_flag;
        public byte NnpfcComponentLastFlag { get { return nnpfc_component_last_flag; } set { nnpfc_component_last_flag = value; } }
        private uint nnpfc_inp_format_idc;
        public uint NnpfcInpFormatIdc { get { return nnpfc_inp_format_idc; } set { nnpfc_inp_format_idc = value; } }
        private uint nnpfc_auxiliary_inp_idc;
        public uint NnpfcAuxiliaryInpIdc { get { return nnpfc_auxiliary_inp_idc; } set { nnpfc_auxiliary_inp_idc = value; } }
        private uint nnpfc_inp_order_idc;
        public uint NnpfcInpOrderIdc { get { return nnpfc_inp_order_idc; } set { nnpfc_inp_order_idc = value; } }
        private uint nnpfc_inp_tensor_luma_bitdepth_minus8;
        public uint NnpfcInpTensorLumaBitdepthMinus8 { get { return nnpfc_inp_tensor_luma_bitdepth_minus8; } set { nnpfc_inp_tensor_luma_bitdepth_minus8 = value; } }
        private uint nnpfc_inp_tensor_chroma_bitdepth_minus8;
        public uint NnpfcInpTensorChromaBitdepthMinus8 { get { return nnpfc_inp_tensor_chroma_bitdepth_minus8; } set { nnpfc_inp_tensor_chroma_bitdepth_minus8 = value; } }
        private uint nnpfc_out_format_idc;
        public uint NnpfcOutFormatIdc { get { return nnpfc_out_format_idc; } set { nnpfc_out_format_idc = value; } }
        private uint nnpfc_out_order_idc;
        public uint NnpfcOutOrderIdc { get { return nnpfc_out_order_idc; } set { nnpfc_out_order_idc = value; } }
        private uint nnpfc_out_tensor_luma_bitdepth_minus8;
        public uint NnpfcOutTensorLumaBitdepthMinus8 { get { return nnpfc_out_tensor_luma_bitdepth_minus8; } set { nnpfc_out_tensor_luma_bitdepth_minus8 = value; } }
        private uint nnpfc_out_tensor_chroma_bitdepth_minus8;
        public uint NnpfcOutTensorChromaBitdepthMinus8 { get { return nnpfc_out_tensor_chroma_bitdepth_minus8; } set { nnpfc_out_tensor_chroma_bitdepth_minus8 = value; } }
        private byte nnpfc_separate_colour_description_present_flag;
        public byte NnpfcSeparateColourDescriptionPresentFlag { get { return nnpfc_separate_colour_description_present_flag; } set { nnpfc_separate_colour_description_present_flag = value; } }
        private uint nnpfc_colour_primaries;
        public uint NnpfcColourPrimaries { get { return nnpfc_colour_primaries; } set { nnpfc_colour_primaries = value; } }
        private uint nnpfc_transfer_characteristics;
        public uint NnpfcTransferCharacteristics { get { return nnpfc_transfer_characteristics; } set { nnpfc_transfer_characteristics = value; } }
        private uint nnpfc_matrix_coeffs;
        public uint NnpfcMatrixCoeffs { get { return nnpfc_matrix_coeffs; } set { nnpfc_matrix_coeffs = value; } }
        private byte nnpfc_full_range_flag;
        public byte NnpfcFullRangeFlag { get { return nnpfc_full_range_flag; } set { nnpfc_full_range_flag = value; } }
        private byte nnpfc_chroma_loc_info_present_flag;
        public byte NnpfcChromaLocInfoPresentFlag { get { return nnpfc_chroma_loc_info_present_flag; } set { nnpfc_chroma_loc_info_present_flag = value; } }
        private uint nnpfc_chroma_sample_loc_type_frame;
        public uint NnpfcChromaSampleLocTypeFrame { get { return nnpfc_chroma_sample_loc_type_frame; } set { nnpfc_chroma_sample_loc_type_frame = value; } }
        private uint nnpfc_overlap;
        public uint NnpfcOverlap { get { return nnpfc_overlap; } set { nnpfc_overlap = value; } }
        private byte nnpfc_constant_patch_size_flag;
        public byte NnpfcConstantPatchSizeFlag { get { return nnpfc_constant_patch_size_flag; } set { nnpfc_constant_patch_size_flag = value; } }
        private uint nnpfc_patch_width_minus1;
        public uint NnpfcPatchWidthMinus1 { get { return nnpfc_patch_width_minus1; } set { nnpfc_patch_width_minus1 = value; } }
        private uint nnpfc_patch_height_minus1;
        public uint NnpfcPatchHeightMinus1 { get { return nnpfc_patch_height_minus1; } set { nnpfc_patch_height_minus1 = value; } }
        private uint nnpfc_extended_patch_width_cd_delta_minus1;
        public uint NnpfcExtendedPatchWidthCdDeltaMinus1 { get { return nnpfc_extended_patch_width_cd_delta_minus1; } set { nnpfc_extended_patch_width_cd_delta_minus1 = value; } }
        private uint nnpfc_extended_patch_height_cd_delta_minus1;
        public uint NnpfcExtendedPatchHeightCdDeltaMinus1 { get { return nnpfc_extended_patch_height_cd_delta_minus1; } set { nnpfc_extended_patch_height_cd_delta_minus1 = value; } }
        private uint nnpfc_padding_type;
        public uint NnpfcPaddingType { get { return nnpfc_padding_type; } set { nnpfc_padding_type = value; } }
        private uint nnpfc_luma_padding_val;
        public uint NnpfcLumaPaddingVal { get { return nnpfc_luma_padding_val; } set { nnpfc_luma_padding_val = value; } }
        private uint nnpfc_cb_padding_val;
        public uint NnpfcCbPaddingVal { get { return nnpfc_cb_padding_val; } set { nnpfc_cb_padding_val = value; } }
        private uint nnpfc_cr_padding_val;
        public uint NnpfcCrPaddingVal { get { return nnpfc_cr_padding_val; } set { nnpfc_cr_padding_val = value; } }
        private byte nnpfc_complexity_info_present_flag;
        public byte NnpfcComplexityInfoPresentFlag { get { return nnpfc_complexity_info_present_flag; } set { nnpfc_complexity_info_present_flag = value; } }
        private uint nnpfc_parameter_type_idc;
        public uint NnpfcParameterTypeIdc { get { return nnpfc_parameter_type_idc; } set { nnpfc_parameter_type_idc = value; } }
        private uint nnpfc_log2_parameter_bit_length_minus3;
        public uint NnpfcLog2ParameterBitLengthMinus3 { get { return nnpfc_log2_parameter_bit_length_minus3; } set { nnpfc_log2_parameter_bit_length_minus3 = value; } }
        private uint nnpfc_num_parameters_idc;
        public uint NnpfcNumParametersIdc { get { return nnpfc_num_parameters_idc; } set { nnpfc_num_parameters_idc = value; } }
        private uint nnpfc_num_kmac_operations_idc;
        public uint NnpfcNumKmacOperationsIdc { get { return nnpfc_num_kmac_operations_idc; } set { nnpfc_num_kmac_operations_idc = value; } }
        private uint nnpfc_total_kilobyte_size;
        public uint NnpfcTotalKilobyteSize { get { return nnpfc_total_kilobyte_size; } set { nnpfc_total_kilobyte_size = value; } }
        private uint nnpfc_num_metadata_extension_bits;
        public uint NnpfcNumMetadataExtensionBits { get { return nnpfc_num_metadata_extension_bits; } set { nnpfc_num_metadata_extension_bits = value; } }
        private uint nnpfc_reserved_metadata_extension;
        public uint NnpfcReservedMetadataExtension { get { return nnpfc_reserved_metadata_extension; } set { nnpfc_reserved_metadata_extension = value; } }
        private Dictionary<int, byte> nnpfc_alignment_zero_bit_b = new Dictionary<int, byte>();
        public Dictionary<int, byte> NnpfcAlignmentZeroBitb { get { return nnpfc_alignment_zero_bit_b; } set { nnpfc_alignment_zero_bit_b = value; } }
        private byte[] nnpfc_payload_byte;
        public byte[] NnpfcPayloadByte { get { return nnpfc_payload_byte; } set { nnpfc_payload_byte = value; } }

        public int HasMoreRbspData { get; set; }
        public int[] ReadNextBits { get; set; }

        public NnPostFilterCharacteristics(uint payloadSize)
        {
            this.payloadSize = payloadSize;
        }
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            int whileIndex = -1;
            uint i = 0;
            size += stream.ReadUnsignedInt(size, 16, out this.nnpfc_purpose);
            size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_id);
            size += stream.ReadUnsignedInt(size, 1, out this.nnpfc_base_flag);
            size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_mode_idc);
            ...
            if (nnpfc_mode_idc == 1)
            {
                ...
                while (!stream.ByteAligned())
                {
                    ...
                    size += stream.ReadUnsignedInt(size, 1, whileIndex, this.nnpfc_alignment_zero_bit_a);
                }
                size += stream.ReadUtf8String(size, out this.nnpfc_tag_uri);
                size += stream.ReadUtf8String(size, out this.nnpfc_uri);
            }
            size += stream.ReadUnsignedInt(size, 1, out this.nnpfc_property_present_flag);

            if (nnpfc_property_present_flag != 0)
            {
                /*  input and output formatting  */

                size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_num_input_pics_minus1);

                if (nnpfc_num_input_pics_minus1 > 0)
                {

                    this.nnpfc_input_pic_filtering_flag = new byte[nnpfc_num_input_pics_minus1 + 1];
                    for (i = 0; i <= nnpfc_num_input_pics_minus1; i++)
                    {
                        size += stream.ReadUnsignedInt(size, 1, out this.nnpfc_input_pic_filtering_flag[i]);
                    }
                    size += stream.ReadUnsignedInt(size, 1, out this.nnpfc_absent_input_pic_zero_flag);
                }

                if (ChromaUpsamplingFlag != 0)
                {
                    size += stream.ReadUnsignedInt(size, 1, out this.nnpfc_out_sub_c_flag);
                }

                if (ColourizationFlag != 0)
                {
                    size += stream.ReadUnsignedInt(size, 2, out this.nnpfc_out_colour_format_idc);
                }

                if (ResolutionResamplingFlag != 0)
                {
                    size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_pic_width_num_minus1);
                    size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_pic_width_denom_minus1);
                    size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_pic_height_num_minus1);
                    size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_pic_height_denom_minus1);
                }

                if (PictureRateUpsamplingFlag != 0)
                {

                    this.nnpfc_interpolated_pics = new uint[nnpfc_num_input_pics_minus1 + 1];
                    for (i = 0; i < nnpfc_num_input_pics_minus1; i++)
                    {
                        size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_interpolated_pics[i]);
                    }
                }
                size += stream.ReadUnsignedInt(size, 1, out this.nnpfc_component_last_flag);
                size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_inp_format_idc);
                size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_auxiliary_inp_idc);
                size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_inp_order_idc);
                ...
                if (nnpfc_inp_format_idc == 1)
                {
                    ...
                    if (nnpfc_inp_order_idc != 1)
                    {
                        size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_inp_tensor_luma_bitdepth_minus8);
                    }

                    if (nnpfc_inp_order_idc > 0)
                    {
                        size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_inp_tensor_chroma_bitdepth_minus8);
                    }
                }
                size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_out_format_idc);
                size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_out_order_idc);
                ...
                if (nnpfc_out_format_idc == 1)
                {
                    ...
                    if (nnpfc_out_order_idc != 1)
                    {
                        size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_out_tensor_luma_bitdepth_minus8);
                    }

                    if (nnpfc_out_order_idc != 0)
                    {
                        size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_out_tensor_chroma_bitdepth_minus8);
                    }
                }
                size += stream.ReadUnsignedInt(size, 1, out this.nnpfc_separate_colour_description_present_flag);

                if (nnpfc_separate_colour_description_present_flag != 0)
                {
                    size += stream.ReadUnsignedInt(size, 8, out this.nnpfc_colour_primaries);
                    size += stream.ReadUnsignedInt(size, 8, out this.nnpfc_transfer_characteristics);

                    if (nnpfc_out_format_idc == 1)
                    {
                        size += stream.ReadUnsignedInt(size, 8, out this.nnpfc_matrix_coeffs);
                        size += stream.ReadUnsignedInt(size, 1, out this.nnpfc_full_range_flag);
                    }
                }

                if (nnpfc_out_order_idc > 0)
                {
                    size += stream.ReadUnsignedInt(size, 1, out this.nnpfc_chroma_loc_info_present_flag);
                }

                if (nnpfc_chroma_loc_info_present_flag != 0)
                {
                    size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_chroma_sample_loc_type_frame);
                }
                size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_overlap);
                size += stream.ReadUnsignedInt(size, 1, out this.nnpfc_constant_patch_size_flag);

                if (nnpfc_constant_patch_size_flag != 0)
                {
                    size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_patch_width_minus1);
                    size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_patch_height_minus1);
                }
                else
                {
                    size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_extended_patch_width_cd_delta_minus1);
                    size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_extended_patch_height_cd_delta_minus1);
                }
                size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_padding_type);
                ...
                if (nnpfc_padding_type == 4)
                {
                    ...
                    if (nnpfc_inp_order_idc != 1)
                    {
                        size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_luma_padding_val);
                    }

                    if (nnpfc_inp_order_idc != 0)
                    {
                        size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_cb_padding_val);
                        size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_cr_padding_val);
                    }
                }
                size += stream.ReadUnsignedInt(size, 1, out this.nnpfc_complexity_info_present_flag);

                if (nnpfc_complexity_info_present_flag != 0)
                {
                    size += stream.ReadUnsignedInt(size, 2, out this.nnpfc_parameter_type_idc);

                    if (nnpfc_parameter_type_idc != 2)
                    {
                        size += stream.ReadUnsignedInt(size, 2, out this.nnpfc_log2_parameter_bit_length_minus3);
                    }
                    size += stream.ReadUnsignedInt(size, 6, out this.nnpfc_num_parameters_idc);
                    size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_num_kmac_operations_idc);
                    size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_total_kilobyte_size);
                }
                size += stream.ReadUnsignedIntGolomb(size, out this.nnpfc_num_metadata_extension_bits);

                if (nnpfc_num_metadata_extension_bits > 0)
                {
                    size += stream.ReadUnsignedIntVariable(size, nnpfc_reserved_metadata_extension, out this.nnpfc_reserved_metadata_extension);
                }
            }
            /*  ISO/IEC 15938-17 bitstream  */
            ...
            if (nnpfc_mode_idc == 0)
            {
                ...
                while (!stream.ByteAligned())
                {
                    ...
                    size += stream.ReadUnsignedInt(size, 1, whileIndex, this.nnpfc_alignment_zero_bit_b);
                }

                for (i = 0; more_data_in_payload(); i++)
                {
                    size += stream.ReadBits(size, 8, out this.nnpfc_payload_byte[i]);
                }
            }
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            int whileIndex = -1;
            uint i = 0;
            size += stream.WriteUnsignedInt(16, this.nnpfc_purpose);
            size += stream.WriteUnsignedIntGolomb(this.nnpfc_id);
            size += stream.WriteUnsignedInt(1, this.nnpfc_base_flag);
            size += stream.WriteUnsignedIntGolomb(this.nnpfc_mode_idc);
            ...
            if (nnpfc_mode_idc == 1)
            {
                ...
                while (!stream.ByteAligned())
                {
                    ...
                    size += stream.WriteUnsignedInt(1, whileIndex, this.nnpfc_alignment_zero_bit_a);
                }
                size += stream.WriteUtf8String(this.nnpfc_tag_uri);
                size += stream.WriteUtf8String(this.nnpfc_uri);
            }
            size += stream.WriteUnsignedInt(1, this.nnpfc_property_present_flag);

            if (nnpfc_property_present_flag != 0)
            {
                /*  input and output formatting  */

                size += stream.WriteUnsignedIntGolomb(this.nnpfc_num_input_pics_minus1);
                ...
                if (nnpfc_num_input_pics_minus1 > 0)
                {
                    ...
                    for (i = 0; i <= nnpfc_num_input_pics_minus1; i++)
                    {
                        size += stream.WriteUnsignedInt(1, this.nnpfc_input_pic_filtering_flag[i]);
                    }
                    size += stream.WriteUnsignedInt(1, this.nnpfc_absent_input_pic_zero_flag);
                }

                if (ChromaUpsamplingFlag != 0)
                {
                    size += stream.WriteUnsignedInt(1, this.nnpfc_out_sub_c_flag);
                }

                if (ColourizationFlag != 0)
                {
                    size += stream.WriteUnsignedInt(2, this.nnpfc_out_colour_format_idc);
                }

                if (ResolutionResamplingFlag != 0)
                {
                    size += stream.WriteUnsignedIntGolomb(this.nnpfc_pic_width_num_minus1);
                    size += stream.WriteUnsignedIntGolomb(this.nnpfc_pic_width_denom_minus1);
                    size += stream.WriteUnsignedIntGolomb(this.nnpfc_pic_height_num_minus1);
                    size += stream.WriteUnsignedIntGolomb(this.nnpfc_pic_height_denom_minus1);
                }
                ...
                if (PictureRateUpsamplingFlag != 0)
                {
                    ...
                    for (i = 0; i < nnpfc_num_input_pics_minus1; i++)
                    {
                        size += stream.WriteUnsignedIntGolomb(this.nnpfc_interpolated_pics[i]);
                    }
                }
                size += stream.WriteUnsignedInt(1, this.nnpfc_component_last_flag);
                size += stream.WriteUnsignedIntGolomb(this.nnpfc_inp_format_idc);
                size += stream.WriteUnsignedIntGolomb(this.nnpfc_auxiliary_inp_idc);
                size += stream.WriteUnsignedIntGolomb(this.nnpfc_inp_order_idc);
                ...
                if (nnpfc_inp_format_idc == 1)
                {
                    ...
                    if (nnpfc_inp_order_idc != 1)
                    {
                        size += stream.WriteUnsignedIntGolomb(this.nnpfc_inp_tensor_luma_bitdepth_minus8);
                    }

                    if (nnpfc_inp_order_idc > 0)
                    {
                        size += stream.WriteUnsignedIntGolomb(this.nnpfc_inp_tensor_chroma_bitdepth_minus8);
                    }
                }
                size += stream.WriteUnsignedIntGolomb(this.nnpfc_out_format_idc);
                size += stream.WriteUnsignedIntGolomb(this.nnpfc_out_order_idc);
                ...
                if (nnpfc_out_format_idc == 1)
                {
                    ...
                    if (nnpfc_out_order_idc != 1)
                    {
                        size += stream.WriteUnsignedIntGolomb(this.nnpfc_out_tensor_luma_bitdepth_minus8);
                    }

                    if (nnpfc_out_order_idc != 0)
                    {
                        size += stream.WriteUnsignedIntGolomb(this.nnpfc_out_tensor_chroma_bitdepth_minus8);
                    }
                }
                size += stream.WriteUnsignedInt(1, this.nnpfc_separate_colour_description_present_flag);

                if (nnpfc_separate_colour_description_present_flag != 0)
                {
                    size += stream.WriteUnsignedInt(8, this.nnpfc_colour_primaries);
                    size += stream.WriteUnsignedInt(8, this.nnpfc_transfer_characteristics);

                    if (nnpfc_out_format_idc == 1)
                    {
                        size += stream.WriteUnsignedInt(8, this.nnpfc_matrix_coeffs);
                        size += stream.WriteUnsignedInt(1, this.nnpfc_full_range_flag);
                    }
                }

                if (nnpfc_out_order_idc > 0)
                {
                    size += stream.WriteUnsignedInt(1, this.nnpfc_chroma_loc_info_present_flag);
                }

                if (nnpfc_chroma_loc_info_present_flag != 0)
                {
                    size += stream.WriteUnsignedIntGolomb(this.nnpfc_chroma_sample_loc_type_frame);
                }
                size += stream.WriteUnsignedIntGolomb(this.nnpfc_overlap);
                size += stream.WriteUnsignedInt(1, this.nnpfc_constant_patch_size_flag);

                if (nnpfc_constant_patch_size_flag != 0)
                {
                    size += stream.WriteUnsignedIntGolomb(this.nnpfc_patch_width_minus1);
                    size += stream.WriteUnsignedIntGolomb(this.nnpfc_patch_height_minus1);
                }
                else
                {
                    size += stream.WriteUnsignedIntGolomb(this.nnpfc_extended_patch_width_cd_delta_minus1);
                    size += stream.WriteUnsignedIntGolomb(this.nnpfc_extended_patch_height_cd_delta_minus1);
                }
                size += stream.WriteUnsignedIntGolomb(this.nnpfc_padding_type);
                ...
                if (nnpfc_padding_type == 4)
                {
                    ...
                    if (nnpfc_inp_order_idc != 1)
                    {
                        size += stream.WriteUnsignedIntGolomb(this.nnpfc_luma_padding_val);
                    }

                    if (nnpfc_inp_order_idc != 0)
                    {
                        size += stream.WriteUnsignedIntGolomb(this.nnpfc_cb_padding_val);
                        size += stream.WriteUnsignedIntGolomb(this.nnpfc_cr_padding_val);
                    }
                }
                size += stream.WriteUnsignedInt(1, this.nnpfc_complexity_info_present_flag);

                if (nnpfc_complexity_info_present_flag != 0)
                {
                    size += stream.WriteUnsignedInt(2, this.nnpfc_parameter_type_idc);

                    if (nnpfc_parameter_type_idc != 2)
                    {
                        size += stream.WriteUnsignedInt(2, this.nnpfc_log2_parameter_bit_length_minus3);
                    }
                    size += stream.WriteUnsignedInt(6, this.nnpfc_num_parameters_idc);
                    size += stream.WriteUnsignedIntGolomb(this.nnpfc_num_kmac_operations_idc);
                    size += stream.WriteUnsignedIntGolomb(this.nnpfc_total_kilobyte_size);
                }
                size += stream.WriteUnsignedIntGolomb(this.nnpfc_num_metadata_extension_bits);

                if (nnpfc_num_metadata_extension_bits > 0)
                {
                    size += stream.WriteUnsignedIntVariable(nnpfc_reserved_metadata_extension, this.nnpfc_reserved_metadata_extension);
                }
            }
            /*  ISO/IEC 15938-17 bitstream  */
            ...
            if (nnpfc_mode_idc == 0)
            {
                ...
                while (!stream.ByteAligned())
                {
                    ...
                    size += stream.WriteUnsignedInt(1, whileIndex, this.nnpfc_alignment_zero_bit_b);
                }

                for (i = 0; more_data_in_payload(); i++)
                {
                    size += stream.WriteBits(8, this.nnpfc_payload_byte[i]);
                }
            }
...
nn_post_filter_activation(payloadSize) {
    ...
    */
    public class NnPostFilterActivation : IItuSerializable
    {
        private uint payloadSize;
        public uint PayloadSize { get { return payloadSize; } set { payloadSize = value; } }
        private uint nnpfa_target_id;
        public uint NnpfaTargetId { get { return nnpfa_target_id; } set { nnpfa_target_id = value; } }
        private byte nnpfa_cancel_flag;
        public byte NnpfaCancelFlag { get { return nnpfa_cancel_flag; } set { nnpfa_cancel_flag = value; } }
        private byte nnpfa_persistence_flag;
        public byte NnpfaPersistenceFlag { get { return nnpfa_persistence_flag; } set { nnpfa_persistence_flag = value; } }
        private byte nnpfa_target_base_flag;
        public byte NnpfaTargetBaseFlag { get { return nnpfa_target_base_flag; } set { nnpfa_target_base_flag = value; } }
        private byte nnpfa_no_prev_clvs_flag;
        public byte NnpfaNoPrevClvsFlag { get { return nnpfa_no_prev_clvs_flag; } set { nnpfa_no_prev_clvs_flag = value; } }
        private byte nnpfa_no_foll_clvs_flag;
        public byte NnpfaNoFollClvsFlag { get { return nnpfa_no_foll_clvs_flag; } set { nnpfa_no_foll_clvs_flag = value; } }
        private uint nnpfa_num_output_entries;
        public uint NnpfaNumOutputEntries { get { return nnpfa_num_output_entries; } set { nnpfa_num_output_entries = value; } }
        private byte[] nnpfa_output_flag;
        public byte[] NnpfaOutputFlag { get { return nnpfa_output_flag; } set { nnpfa_output_flag = value; } }

        public int HasMoreRbspData { get; set; }
        public int[] ReadNextBits { get; set; }

        public NnPostFilterActivation(uint payloadSize)
        {
            this.payloadSize = payloadSize;
        }
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            uint i = 0;
            size += stream.ReadUnsignedIntGolomb(size, out this.nnpfa_target_id);
            size += stream.ReadUnsignedInt(size, 1, out this.nnpfa_cancel_flag);

            if (nnpfa_cancel_flag == 0)
            {
                size += stream.ReadUnsignedInt(size, 1, out this.nnpfa_persistence_flag);
                size += stream.ReadUnsignedInt(size, 1, out this.nnpfa_target_base_flag);
                size += stream.ReadUnsignedInt(size, 1, out this.nnpfa_no_prev_clvs_flag);

                if (nnpfa_persistence_flag != 0)
                {
                    size += stream.ReadUnsignedInt(size, 1, out this.nnpfa_no_foll_clvs_flag);
                }
                size += stream.ReadUnsignedIntGolomb(size, out this.nnpfa_num_output_entries);

                this.nnpfa_output_flag = new byte[nnpfa_num_output_entries];
                for (i = 0; i < nnpfa_num_output_entries; i++)
                {
                    size += stream.ReadUnsignedInt(size, 1, out this.nnpfa_output_flag[i]);
                }
            }
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            uint i = 0;
            size += stream.WriteUnsignedIntGolomb(this.nnpfa_target_id);
            size += stream.WriteUnsignedInt(1, this.nnpfa_cancel_flag);

            if (nnpfa_cancel_flag == 0)
            {
                size += stream.WriteUnsignedInt(1, this.nnpfa_persistence_flag);
                size += stream.WriteUnsignedInt(1, this.nnpfa_target_base_flag);
                size += stream.WriteUnsignedInt(1, this.nnpfa_no_prev_clvs_flag);

                if (nnpfa_persistence_flag != 0)
                {
                    size += stream.WriteUnsignedInt(1, this.nnpfa_no_foll_clvs_flag);
                }
                size += stream.WriteUnsignedIntGolomb(this.nnpfa_num_output_entries);

                for (i = 0; i < nnpfa_num_output_entries; i++)
                {
                    size += stream.WriteUnsignedInt(1, this.nnpfa_output_flag[i]);
                }
            }
    ...
    public class BufferingPeriod : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (bp_cpb_removal_delay_deltas_present_flag != 0)
            {
                ...
                for (i = 0; i <= bp_num_cpb_removal_delay_deltas_minus1; i++)
                {
                    size += stream.ReadUnsignedIntVariable(size, bp_cpb_removal_delay_delta_val, out this.bp_cpb_removal_delay_delta_val[i]);
                }
            }
   ...
   0 : bp_max_sublayers_minus1); i <= bp_max_sublayers_minus1; i++)
            {
                ...
                if (bp_nal_hrd_params_present_flag != 0)
                {
                    ...
                    for (j = 0; j < bp_cpb_cnt_minus1 + 1; j++)
                    {
                        size += stream.ReadUnsignedIntVariable(size, bp_nal_initial_cpb_removal_delay, out this.bp_nal_initial_cpb_removal_delay[i][j]);
                        size += stream.ReadUnsignedIntVariable(size, bp_nal_initial_cpb_removal_offset, out this.bp_nal_initial_cpb_removal_offset[i][j]);

                        if (bp_du_hrd_params_present_flag != 0)
                        {
                            size += stream.ReadUnsignedIntVariable(size, bp_nal_initial_alt_cpb_removal_delay, out this.bp_nal_initial_alt_cpb_removal_delay[i][j]);
                            size += stream.ReadUnsignedIntVariable(size, bp_nal_initial_alt_cpb_removal_offset, out this.bp_nal_initial_alt_cpb_removal_offset[i][j]);
                        }
                    }
                }
                ...
                if (bp_vcl_hrd_params_present_flag != 0)
                {
                    ...
                    for (j = 0; j < bp_cpb_cnt_minus1 + 1; j++)
                    {
                        size += stream.ReadUnsignedIntVariable(size, bp_vcl_initial_cpb_removal_delay, out this.bp_vcl_initial_cpb_removal_delay[i][j]);
                        size += stream.ReadUnsignedIntVariable(size, bp_vcl_initial_cpb_removal_offset, out this.bp_vcl_initial_cpb_removal_offset[i][j]);

                        if (bp_du_hrd_params_present_flag != 0)
                        {
                            size += stream.ReadUnsignedIntVariable(size, bp_vcl_initial_alt_cpb_removal_delay, out this.bp_vcl_initial_alt_cpb_removal_delay[i][j]);
                            size += stream.ReadUnsignedIntVariable(size, bp_vcl_initial_alt_cpb_removal_offset, out this.bp_vcl_initial_alt_cpb_removal_offset[i][j]);
                        }
                    }
                }
            }
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            if (bp_cpb_removal_delay_deltas_present_flag != 0)
            {
                ...
                for (i = 0; i <= bp_num_cpb_removal_delay_deltas_minus1; i++)
                {
                    size += stream.WriteUnsignedIntVariable(bp_cpb_removal_delay_delta_val[i], this.bp_cpb_removal_delay_delta_val[i]);
                }
            }
   ...
   0 : bp_max_sublayers_minus1); i <= bp_max_sublayers_minus1; i++)
            {
                ...
                if (bp_nal_hrd_params_present_flag != 0)
                {
                    ...
                    for (j = 0; j < bp_cpb_cnt_minus1 + 1; j++)
                    {
                        size += stream.WriteUnsignedIntVariable(bp_nal_initial_cpb_removal_delay[i][j], this.bp_nal_initial_cpb_removal_delay[i][j]);
                        size += stream.WriteUnsignedIntVariable(bp_nal_initial_cpb_removal_offset[i][j], this.bp_nal_initial_cpb_removal_offset[i][j]);

                        if (bp_du_hrd_params_present_flag != 0)
                        {
                            size += stream.WriteUnsignedIntVariable(bp_nal_initial_alt_cpb_removal_delay[i][j], this.bp_nal_initial_alt_cpb_removal_delay[i][j]);
                            size += stream.WriteUnsignedIntVariable(bp_nal_initial_alt_cpb_removal_offset[i][j], this.bp_nal_initial_alt_cpb_removal_offset[i][j]);
                        }
                    }
                }
                ...
                if (bp_vcl_hrd_params_present_flag != 0)
                {
                    ...
                    for (j = 0; j < bp_cpb_cnt_minus1 + 1; j++)
                    {
                        size += stream.WriteUnsignedIntVariable(bp_vcl_initial_cpb_removal_delay[i][j], this.bp_vcl_initial_cpb_removal_delay[i][j]);
                        size += stream.WriteUnsignedIntVariable(bp_vcl_initial_cpb_removal_offset[i][j], this.bp_vcl_initial_cpb_removal_offset[i][j]);

                        if (bp_du_hrd_params_present_flag != 0)
                        {
                            size += stream.WriteUnsignedIntVariable(bp_vcl_initial_alt_cpb_removal_delay[i][j], this.bp_vcl_initial_alt_cpb_removal_delay[i][j]);
                            size += stream.WriteUnsignedIntVariable(bp_vcl_initial_alt_cpb_removal_offset[i][j], this.bp_vcl_initial_alt_cpb_removal_offset[i][j]);
                        }
                    }
                }
            }
    ...
    */
    public class PicTiming : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            uint i = 0;
            uint j = 0;
            size += stream.ReadUnsignedIntVariable(size, pt_cpb_removal_delay_minus1, out this.pt_cpb_removal_delay_minus1[bp_max_sublayers_minus1]);

            this.pt_sublayer_delays_present_flag = new byte[bp_max_sublayers_minus1 + 1];
            this.pt_cpb_removal_delay_delta_enabled_flag = new byte[bp_max_sublayers_minus1 + 1];
            this.pt_cpb_removal_delay_delta_idx = new uint[bp_max_sublayers_minus1 + 1];
            for (i = TemporalId; i < bp_max_sublayers_minus1; i++)
            {
                ...
                if (pt_sublayer_delays_present_flag[i] != 0)
                {
                    ...
                    if (pt_cpb_removal_delay_delta_enabled_flag[i] != 0)
                    {
                        ...
                        if (bp_num_cpb_removal_delay_deltas_minus1 > 0)
                        {
                            size += stream.ReadUnsignedIntVariable(size, pt_cpb_removal_delay_delta_idx, out this.pt_cpb_removal_delay_delta_idx[i]);
                        }
                    }
                    else
                    {
                        size += stream.ReadUnsignedIntVariable(size, pt_cpb_removal_delay_minus1, out this.pt_cpb_removal_delay_minus1[i]);
                    }
                }
            }
            ...
            if (bp_alt_cpb_params_present_flag != 0)
            {
                ...
                if (pt_cpb_alt_timing_info_present_flag != 0)
                {
                    ...
                    if (bp_nal_hrd_params_present_flag != 0)
                    {
                        ...
                        this.pt_nal_cpb_alt_initial_removal_delay_delta = new uint[bp_max_sublayers_minus1 + 1][];
                        this.pt_nal_cpb_alt_initial_removal_offset_delta = new uint[bp_max_sublayers_minus1 + 1][];
                        this.pt_nal_cpb_delay_offset = new uint[bp_max_sublayers_minus1 + 1];
                        this.pt_nal_dpb_delay_offset = new uint[bp_max_sublayers_minus1 + 1];
                        for (i = (bp_sublayer_initial_cpb_removal_delay_present_flag ? 0 :
      bp_max_sublayers_minus1); i <= bp_max_sublayers_minus1; i++)
                        {

                            this.pt_nal_cpb_alt_initial_removal_delay_delta[i] = new uint[bp_cpb_cnt_minus1 + 1 + 1];
                            this.pt_nal_cpb_alt_initial_removal_offset_delta[i] = new uint[bp_cpb_cnt_minus1 + 1 + 1];
                            for (j = 0; j < bp_cpb_cnt_minus1 + 1; j++)
                            {
                                size += stream.ReadUnsignedIntVariable(size, pt_nal_cpb_alt_initial_removal_delay_delta, out this.pt_nal_cpb_alt_initial_removal_delay_delta[i][j]);
                                size += stream.ReadUnsignedIntVariable(size, pt_nal_cpb_alt_initial_removal_offset_delta, out this.pt_nal_cpb_alt_initial_removal_offset_delta[i][j]);
                            }
                            size += stream.ReadUnsignedIntVariable(size, pt_nal_cpb_delay_offset, out this.pt_nal_cpb_delay_offset[i]);
                            size += stream.ReadUnsignedIntVariable(size, pt_nal_dpb_delay_offset, out this.pt_nal_dpb_delay_offset[i]);
                        }
                    }
                    ...
                    if (bp_vcl_hrd_params_present_flag != 0)
                    {
                        ...
                        this.pt_vcl_cpb_alt_initial_removal_delay_delta = new uint[bp_max_sublayers_minus1 + 1][];
                        this.pt_vcl_cpb_alt_initial_removal_offset_delta = new uint[bp_max_sublayers_minus1 + 1][];
                        this.pt_vcl_cpb_delay_offset = new uint[bp_max_sublayers_minus1 + 1];
                        this.pt_vcl_dpb_delay_offset = new uint[bp_max_sublayers_minus1 + 1];
                        for (i = (bp_sublayer_initial_cpb_removal_delay_present_flag ? 0 :
      bp_max_sublayers_minus1); i <= bp_max_sublayers_minus1; i++)
                        {

                            this.pt_vcl_cpb_alt_initial_removal_delay_delta[i] = new uint[bp_cpb_cnt_minus1 + 1 + 1];
                            this.pt_vcl_cpb_alt_initial_removal_offset_delta[i] = new uint[bp_cpb_cnt_minus1 + 1 + 1];
                            for (j = 0; j < bp_cpb_cnt_minus1 + 1; j++)
                            {
                                size += stream.ReadUnsignedIntVariable(size, pt_vcl_cpb_alt_initial_removal_delay_delta, out this.pt_vcl_cpb_alt_initial_removal_delay_delta[i][j]);
                                size += stream.ReadUnsignedIntVariable(size, pt_vcl_cpb_alt_initial_removal_offset_delta, out this.pt_vcl_cpb_alt_initial_removal_offset_delta[i][j]);
                            }
                            size += stream.ReadUnsignedIntVariable(size, pt_vcl_cpb_delay_offset, out this.pt_vcl_cpb_delay_offset[i]);
                            size += stream.ReadUnsignedIntVariable(size, pt_vcl_dpb_delay_offset, out this.pt_vcl_dpb_delay_offset[i]);
                        }
                    }
                }
            }
   ...
   bp_du_cpb_params_in_pic_timing_sei_flag != 0)
            {
                ...
                if (pt_num_decoding_units_minus1 > 0)
                {
                    ...
                    if (pt_du_common_cpb_removal_delay_flag != 0)
                    {
                        ...
                        this.pt_du_common_cpb_removal_delay_increment_minus1 = new uint[bp_max_sublayers_minus1 + 1];
                        for (i = TemporalId; i <= bp_max_sublayers_minus1; i++)
                        {

                            if (pt_sublayer_delays_present_flag[i] != 0)
                            {
                                size += stream.ReadUnsignedIntVariable(size, pt_du_common_cpb_removal_delay_increment_minus1, out this.pt_du_common_cpb_removal_delay_increment_minus1[i]);
                            }
                        }
                    }
      ...
      i < pt_num_decoding_units_minus1)
                        {
                            ...
                            this.pt_du_cpb_removal_delay_increment_minus1[i] = new uint[bp_max_sublayers_minus1 + 1];
                            for (j = TemporalId; j <= bp_max_sublayers_minus1; j++)
                            {

                                if (pt_sublayer_delays_present_flag[j] != 0)
                                {
                                    size += stream.ReadUnsignedIntVariable(size, pt_du_cpb_removal_delay_increment_minus1, out this.pt_du_cpb_removal_delay_increment_minus1[i][j]);
                                }
                            }
                        }
                    }
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            uint i = 0;
            uint j = 0;
            size += stream.WriteUnsignedIntVariable(pt_cpb_removal_delay_minus1, this.pt_cpb_removal_delay_minus1[bp_max_sublayers_minus1]);
            ...
            for (i = TemporalId; i < bp_max_sublayers_minus1; i++)
            {
                ...
                if (pt_sublayer_delays_present_flag[i] != 0)
                {
                    ...
                    if (pt_cpb_removal_delay_delta_enabled_flag[i] != 0)
                    {
                        ...
                        if (bp_num_cpb_removal_delay_deltas_minus1 > 0)
                        {
                            size += stream.WriteUnsignedIntVariable(pt_cpb_removal_delay_delta_idx[i], this.pt_cpb_removal_delay_delta_idx[i]);
                        }
                    }
                    else
                    {
                        size += stream.WriteUnsignedIntVariable(pt_cpb_removal_delay_minus1[i], this.pt_cpb_removal_delay_minus1[i]);
                    }
                }
            }
      ...
      bp_max_sublayers_minus1); i <= bp_max_sublayers_minus1; i++)
                        {
                            ...
                            for (j = 0; j < bp_cpb_cnt_minus1 + 1; j++)
                            {
                                size += stream.WriteUnsignedIntVariable(pt_nal_cpb_alt_initial_removal_delay_delta[i][j], this.pt_nal_cpb_alt_initial_removal_delay_delta[i][j]);
                                size += stream.WriteUnsignedIntVariable(pt_nal_cpb_alt_initial_removal_offset_delta[i][j], this.pt_nal_cpb_alt_initial_removal_offset_delta[i][j]);
                            }
                            size += stream.WriteUnsignedIntVariable(pt_nal_cpb_delay_offset[i], this.pt_nal_cpb_delay_offset[i]);
                            size += stream.WriteUnsignedIntVariable(pt_nal_dpb_delay_offset[i], this.pt_nal_dpb_delay_offset[i]);
                        }
                    }
      ...
      bp_max_sublayers_minus1); i <= bp_max_sublayers_minus1; i++)
                        {
                            ...
                            for (j = 0; j < bp_cpb_cnt_minus1 + 1; j++)
                            {
                                size += stream.WriteUnsignedIntVariable(pt_vcl_cpb_alt_initial_removal_delay_delta[i][j], this.pt_vcl_cpb_alt_initial_removal_delay_delta[i][j]);
                                size += stream.WriteUnsignedIntVariable(pt_vcl_cpb_alt_initial_removal_offset_delta[i][j], this.pt_vcl_cpb_alt_initial_removal_offset_delta[i][j]);
                            }
                            size += stream.WriteUnsignedIntVariable(pt_vcl_cpb_delay_offset[i], this.pt_vcl_cpb_delay_offset[i]);
                            size += stream.WriteUnsignedIntVariable(pt_vcl_dpb_delay_offset[i], this.pt_vcl_dpb_delay_offset[i]);
                        }
                    }
                }
            }
                ...
                if (pt_num_decoding_units_minus1 > 0)
                {
                    ...
                    if (pt_du_common_cpb_removal_delay_flag != 0)
                    {
                        ...
                        for (i = TemporalId; i <= bp_max_sublayers_minus1; i++)
                        {
                            ...
                            if (pt_sublayer_delays_present_flag[i] != 0)
                            {
                                size += stream.WriteUnsignedIntVariable(pt_du_common_cpb_removal_delay_increment_minus1[i], this.pt_du_common_cpb_removal_delay_increment_minus1[i]);
                            }
                        }
                    }
      ...
      i < pt_num_decoding_units_minus1)
                        {
                            ...
                            for (j = TemporalId; j <= bp_max_sublayers_minus1; j++)
                            {
                                ...
                                if (pt_sublayer_delays_present_flag[j] != 0)
                                {
                                    size += stream.WriteUnsignedIntVariable(pt_du_cpb_removal_delay_increment_minus1[i][j], this.pt_du_cpb_removal_delay_increment_minus1[i][j]);
                                }
                            }
                        }
                    }
    ...
    */
    public class DecodingUnitInfo : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (bp_du_cpb_params_in_pic_timing_sei_flag == 0)
            {

                this.dui_sublayer_delays_present_flag = new byte[bp_max_sublayers_minus1 + 1];
                this.dui_du_cpb_removal_delay_increment = new uint[bp_max_sublayers_minus1 + 1];
                for (i = TemporalId; i <= bp_max_sublayers_minus1; i++)
                {
            ...
            if (bp_du_dpb_params_in_pic_timing_sei_flag == 0)
            {
    ...
    public class ScalableNesting : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (sn_subpic_flag != 0)
            {
                ...
                for (i = 0; i <= sn_num_subpics_minus1; i++)
                {
                    size += stream.ReadUnsignedIntVariable(size, sn_subpic_id, out this.sn_subpic_id[i]);
                }
            }
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            if (sn_subpic_flag != 0)
            {
                ...
                for (i = 0; i <= sn_num_subpics_minus1; i++)
                {
                    size += stream.WriteUnsignedIntVariable(sn_subpic_id[i], this.sn_subpic_id[i]);
                }
            }
