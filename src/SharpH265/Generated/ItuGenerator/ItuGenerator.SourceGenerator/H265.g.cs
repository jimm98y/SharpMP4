    ...
    public class NalUnit : IItuSerializable
    {
		...
		public NalUnitHeader NalUnitHeader { get { return nal_unit_header; } set { nal_unit_header = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			size +=  stream.ReadClass<NalUnitHeader>(size, context, this.nal_unit_header, "nal_unit_header"); //NumBytesInRbsp = 0 
/* for( i = 2; i < NumBytesInNalUnit; i++ )   */
    ...
    public class SpsRangeExtension : IItuSerializable
    {
		...
		public byte CabacBypassAlignmentEnabledFlag { get { return cabac_bypass_alignment_enabled_flag; } set { cabac_bypass_alignment_enabled_flag = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			size += stream.ReadUnsignedInt(size, 1, out this.transform_skip_context_enabled_flag, "transform_skip_context_enabled_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.implicit_rdpcm_enabled_flag, "implicit_rdpcm_enabled_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.explicit_rdpcm_enabled_flag, "explicit_rdpcm_enabled_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.extended_precision_processing_flag, "extended_precision_processing_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.intra_smoothing_disabled_flag, "intra_smoothing_disabled_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.high_precision_offsets_enabled_flag, "high_precision_offsets_enabled_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.persistent_rice_adaptation_enabled_flag, "persistent_rice_adaptation_enabled_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.cabac_bypass_alignment_enabled_flag, "cabac_bypass_alignment_enabled_flag"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			size += stream.WriteUnsignedInt(1, this.transform_skip_context_enabled_flag, "transform_skip_context_enabled_flag"); 
			size += stream.WriteUnsignedInt(1, this.implicit_rdpcm_enabled_flag, "implicit_rdpcm_enabled_flag"); 
			size += stream.WriteUnsignedInt(1, this.explicit_rdpcm_enabled_flag, "explicit_rdpcm_enabled_flag"); 
			size += stream.WriteUnsignedInt(1, this.extended_precision_processing_flag, "extended_precision_processing_flag"); 
			size += stream.WriteUnsignedInt(1, this.intra_smoothing_disabled_flag, "intra_smoothing_disabled_flag"); 
			size += stream.WriteUnsignedInt(1, this.high_precision_offsets_enabled_flag, "high_precision_offsets_enabled_flag"); 
			size += stream.WriteUnsignedInt(1, this.persistent_rice_adaptation_enabled_flag, "persistent_rice_adaptation_enabled_flag"); 
			size += stream.WriteUnsignedInt(1, this.cabac_bypass_alignment_enabled_flag, "cabac_bypass_alignment_enabled_flag"); 
 ...
 intra_boundary_filtering_disabled_flag u(1) 
    ...
    */
    public class SpsSccExtension : IItuSerializable
    {
		...
		private ulong palette_max_size;
		public ulong PaletteMaxSize { get { return palette_max_size; } set { palette_max_size = value; } }
		private ulong delta_palette_max_predictor_size;
		public ulong DeltaPaletteMaxPredictorSize { get { return delta_palette_max_predictor_size; } set { delta_palette_max_predictor_size = value; } }
		...
		private ulong sps_num_palette_predictor_initializers_minus1;
		public ulong SpsNumPalettePredictorInitializersMinus1 { get { return sps_num_palette_predictor_initializers_minus1; } set { sps_num_palette_predictor_initializers_minus1 = value; } }
		private ulong[][] sps_palette_predictor_initializer;
		public ulong[][] SpsPalettePredictorInitializer { get { return sps_palette_predictor_initializer; } set { sps_palette_predictor_initializer = value; } }
		...
		public byte IntraBoundaryFilteringDisabledFlag { get { return intra_boundary_filtering_disabled_flag; } set { intra_boundary_filtering_disabled_flag = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			uint comp = 0;
			uint i = 0;
			size += stream.ReadUnsignedInt(size, 1, out this.sps_curr_pic_ref_enabled_flag, "sps_curr_pic_ref_enabled_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.palette_mode_enabled_flag, "palette_mode_enabled_flag"); 

			if ( palette_mode_enabled_flag != 0 )
			{
				size += stream.ReadUnsignedIntGolomb(size, out this.palette_max_size, "palette_max_size"); 
				size += stream.ReadUnsignedIntGolomb(size, out this.delta_palette_max_predictor_size, "delta_palette_max_predictor_size"); 
				size += stream.ReadUnsignedInt(size, 1, out this.sps_palette_predictor_initializers_present_flag, "sps_palette_predictor_initializers_present_flag"); 
				...
				if ( sps_palette_predictor_initializers_present_flag != 0 )
				{
					...
					for ( comp = 0; comp < numComps; comp++ )
					{
						...
						for ( i = 0; i <= sps_num_palette_predictor_initializers_minus1; i++ )
						{
							size += stream.ReadUnsignedIntVariable(size, (ituContext.SeqParameterSetRbsp.BitDepthChromaMinus8 + 8), out this.sps_palette_predictor_initializer[ comp ][ i ], "sps_palette_predictor_initializer"); 
						}
					}
				}
			}
			size += stream.ReadUnsignedInt(size, 2, out this.motion_vector_resolution_control_idc, "motion_vector_resolution_control_idc"); 
			size += stream.ReadUnsignedInt(size, 1, out this.intra_boundary_filtering_disabled_flag, "intra_boundary_filtering_disabled_flag"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			uint comp = 0;
			uint i = 0;
			size += stream.WriteUnsignedInt(1, this.sps_curr_pic_ref_enabled_flag, "sps_curr_pic_ref_enabled_flag"); 
			size += stream.WriteUnsignedInt(1, this.palette_mode_enabled_flag, "palette_mode_enabled_flag"); 

			if ( palette_mode_enabled_flag != 0 )
			{
				size += stream.WriteUnsignedIntGolomb( this.palette_max_size, "palette_max_size"); 
				size += stream.WriteUnsignedIntGolomb( this.delta_palette_max_predictor_size, "delta_palette_max_predictor_size"); 
				size += stream.WriteUnsignedInt(1, this.sps_palette_predictor_initializers_present_flag, "sps_palette_predictor_initializers_present_flag"); 
				...
				if ( sps_palette_predictor_initializers_present_flag != 0 )
				{
					...
					for ( comp = 0; comp < numComps; comp++ )
					{
						...
						for ( i = 0; i <= sps_num_palette_predictor_initializers_minus1; i++ )
						{
							size += stream.WriteUnsignedIntVariable((ituContext.SeqParameterSetRbsp.BitDepthChromaMinus8 + 8), this.sps_palette_predictor_initializer[ comp ][ i ], "sps_palette_predictor_initializer"); 
						}
					}
				}
			}
			size += stream.WriteUnsignedInt(2, this.motion_vector_resolution_control_idc, "motion_vector_resolution_control_idc"); 
			size += stream.WriteUnsignedInt(1, this.intra_boundary_filtering_disabled_flag, "intra_boundary_filtering_disabled_flag"); 
...
pic_parameter_set_rbsp() { 
 ...
 rbsp_trailing_bits()  
    ...
    */
    ...
    {
		private ulong pps_pic_parameter_set_id;
		public ulong PpsPicParameterSetId { get { return pps_pic_parameter_set_id; } set { pps_pic_parameter_set_id = value; } }
		private ulong pps_seq_parameter_set_id;
		public ulong PpsSeqParameterSetId { get { return pps_seq_parameter_set_id; } set { pps_seq_parameter_set_id = value; } }
		...
		private long init_qp_minus26;
		public long InitQpMinus26 { get { return init_qp_minus26; } set { init_qp_minus26 = value; } }
		...
		private ulong diff_cu_qp_delta_depth;
		public ulong DiffCuQpDeltaDepth { get { return diff_cu_qp_delta_depth; } set { diff_cu_qp_delta_depth = value; } }
		...
		private ulong num_tile_columns_minus1;
		public ulong NumTileColumnsMinus1 { get { return num_tile_columns_minus1; } set { num_tile_columns_minus1 = value; } }
		private ulong num_tile_rows_minus1;
		public ulong NumTileRowsMinus1 { get { return num_tile_rows_minus1; } set { num_tile_rows_minus1 = value; } }
		...
		private ulong[] column_width_minus1;
		public ulong[] ColumnWidthMinus1 { get { return column_width_minus1; } set { column_width_minus1 = value; } }
		private ulong[] row_height_minus1;
		public ulong[] RowHeightMinus1 { get { return row_height_minus1; } set { row_height_minus1 = value; } }
		...
		private long pps_beta_offset_div2;
		public long PpsBetaOffsetDiv2 { get { return pps_beta_offset_div2; } set { pps_beta_offset_div2 = value; } }
		private long pps_tc_offset_div2;
		public long PpsTcOffsetDiv2 { get { return pps_tc_offset_div2; } set { pps_tc_offset_div2 = value; } }
		...
		private ulong log2_parallel_merge_level_minus2;
		public ulong Log2ParallelMergeLevelMinus2 { get { return log2_parallel_merge_level_minus2; } set { log2_parallel_merge_level_minus2 = value; } }
		...
		public RbspTrailingBits RbspTrailingBits { get { return rbsp_trailing_bits; } set { rbsp_trailing_bits = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			size += stream.ReadUnsignedInt(size, 1, out this.sign_data_hiding_enabled_flag, "sign_data_hiding_enabled_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.cabac_init_present_flag, "cabac_init_present_flag"); 
			...
			size += stream.ReadSignedIntGolomb(size, out this.init_qp_minus26, "init_qp_minus26"); 
			size += stream.ReadUnsignedInt(size, 1, out this.constrained_intra_pred_flag, "constrained_intra_pred_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.transform_skip_enabled_flag, "transform_skip_enabled_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.cu_qp_delta_enabled_flag, "cu_qp_delta_enabled_flag"); 

			if ( cu_qp_delta_enabled_flag != 0 )
			{
				size += stream.ReadUnsignedIntGolomb(size, out this.diff_cu_qp_delta_depth, "diff_cu_qp_delta_depth"); 
			}
			size += stream.ReadSignedIntGolomb(size, out this.pps_cb_qp_offset, "pps_cb_qp_offset"); 
			size += stream.ReadSignedIntGolomb(size, out this.pps_cr_qp_offset, "pps_cr_qp_offset"); 
			size += stream.ReadUnsignedInt(size, 1, out this.pps_slice_chroma_qp_offsets_present_flag, "pps_slice_chroma_qp_offsets_present_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.weighted_pred_flag, "weighted_pred_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.weighted_bipred_flag, "weighted_bipred_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.transquant_bypass_enabled_flag, "transquant_bypass_enabled_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.tiles_enabled_flag, "tiles_enabled_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.entropy_coding_sync_enabled_flag, "entropy_coding_sync_enabled_flag"); 

			if ( tiles_enabled_flag != 0 )
			{
				size += stream.ReadUnsignedIntGolomb(size, out this.num_tile_columns_minus1, "num_tile_columns_minus1"); 
				size += stream.ReadUnsignedIntGolomb(size, out this.num_tile_rows_minus1, "num_tile_rows_minus1"); 
				size += stream.ReadUnsignedInt(size, 1, out this.uniform_spacing_flag, "uniform_spacing_flag"); 
				...
				if ( uniform_spacing_flag== 0 )
				{
					...
					for ( i = 0; i < num_tile_rows_minus1; i++ )
					{
						size += stream.ReadUnsignedIntGolomb(size, out this.row_height_minus1[ i ], "row_height_minus1"); 
					}
				}
				size += stream.ReadUnsignedInt(size, 1, out this.loop_filter_across_tiles_enabled_flag, "loop_filter_across_tiles_enabled_flag"); 
			}
			size += stream.ReadUnsignedInt(size, 1, out this.pps_loop_filter_across_slices_enabled_flag, "pps_loop_filter_across_slices_enabled_flag"); 
			...
			{
				size += stream.ReadUnsignedInt(size, 1, out this.deblocking_filter_override_enabled_flag, "deblocking_filter_override_enabled_flag"); 
				size += stream.ReadUnsignedInt(size, 1, out this.pps_deblocking_filter_disabled_flag, "pps_deblocking_filter_disabled_flag"); 

				if ( pps_deblocking_filter_disabled_flag== 0 )
				{
					size += stream.ReadSignedIntGolomb(size, out this.pps_beta_offset_div2, "pps_beta_offset_div2"); 
					size += stream.ReadSignedIntGolomb(size, out this.pps_tc_offset_div2, "pps_tc_offset_div2"); 
				}
			}
			size += stream.ReadUnsignedInt(size, 1, out this.pps_scaling_list_data_present_flag, "pps_scaling_list_data_present_flag"); 
			...
			size += stream.ReadUnsignedInt(size, 1, out this.lists_modification_present_flag, "lists_modification_present_flag"); 
			size += stream.ReadUnsignedIntGolomb(size, out this.log2_parallel_merge_level_minus2, "log2_parallel_merge_level_minus2"); 
			size += stream.ReadUnsignedInt(size, 1, out this.slice_segment_header_extension_present_flag, "slice_segment_header_extension_present_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.pps_extension_present_flag, "pps_extension_present_flag"); 

			if ( pps_extension_present_flag != 0 )
			{
				size += stream.ReadUnsignedInt(size, 1, out this.pps_range_extension_flag, "pps_range_extension_flag"); 
				size += stream.ReadUnsignedInt(size, 1, out this.pps_multilayer_extension_flag, "pps_multilayer_extension_flag"); 
				size += stream.ReadUnsignedInt(size, 1, out this.pps_3d_extension_flag, "pps_3d_extension_flag"); 
				size += stream.ReadUnsignedInt(size, 1, out this.pps_scc_extension_flag, "pps_scc_extension_flag"); 
				size += stream.ReadUnsignedInt(size, 4, out this.pps_extension_4bits, "pps_extension_4bits"); 
			}

			if ( pps_range_extension_flag != 0 )
			{
				this.pps_range_extension =  new PpsRangeExtension() ;
				size +=  stream.ReadClass<PpsRangeExtension>(size, context, this.pps_range_extension, "pps_range_extension"); 
			}

			if ( pps_multilayer_extension_flag != 0 )
			{
				this.pps_multilayer_extension =  new PpsMultilayerExtension() ;
				size +=  stream.ReadClass<PpsMultilayerExtension>(size, context, this.pps_multilayer_extension, "pps_multilayer_extension"); // specified in Annex F 
			}

			if ( pps_3d_extension_flag != 0 )
			{
				this.pps_3d_extension =  new Pps3dExtension() ;
				size +=  stream.ReadClass<Pps3dExtension>(size, context, this.pps_3d_extension, "pps_3d_extension"); // specified in Annex I 
			}

			if ( pps_scc_extension_flag != 0 )
			{
				this.pps_scc_extension =  new PpsSccExtension() ;
				size +=  stream.ReadClass<PpsSccExtension>(size, context, this.pps_scc_extension, "pps_scc_extension"); 
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			size += stream.WriteUnsignedInt(1, this.sign_data_hiding_enabled_flag, "sign_data_hiding_enabled_flag"); 
			size += stream.WriteUnsignedInt(1, this.cabac_init_present_flag, "cabac_init_present_flag"); 
			...
			size += stream.WriteSignedIntGolomb( this.init_qp_minus26, "init_qp_minus26"); 
			size += stream.WriteUnsignedInt(1, this.constrained_intra_pred_flag, "constrained_intra_pred_flag"); 
			size += stream.WriteUnsignedInt(1, this.transform_skip_enabled_flag, "transform_skip_enabled_flag"); 
			size += stream.WriteUnsignedInt(1, this.cu_qp_delta_enabled_flag, "cu_qp_delta_enabled_flag"); 

			if ( cu_qp_delta_enabled_flag != 0 )
			{
				size += stream.WriteUnsignedIntGolomb( this.diff_cu_qp_delta_depth, "diff_cu_qp_delta_depth"); 
			}
			size += stream.WriteSignedIntGolomb( this.pps_cb_qp_offset, "pps_cb_qp_offset"); 
			size += stream.WriteSignedIntGolomb( this.pps_cr_qp_offset, "pps_cr_qp_offset"); 
			size += stream.WriteUnsignedInt(1, this.pps_slice_chroma_qp_offsets_present_flag, "pps_slice_chroma_qp_offsets_present_flag"); 
			size += stream.WriteUnsignedInt(1, this.weighted_pred_flag, "weighted_pred_flag"); 
			size += stream.WriteUnsignedInt(1, this.weighted_bipred_flag, "weighted_bipred_flag"); 
			size += stream.WriteUnsignedInt(1, this.transquant_bypass_enabled_flag, "transquant_bypass_enabled_flag"); 
			size += stream.WriteUnsignedInt(1, this.tiles_enabled_flag, "tiles_enabled_flag"); 
			size += stream.WriteUnsignedInt(1, this.entropy_coding_sync_enabled_flag, "entropy_coding_sync_enabled_flag"); 

			if ( tiles_enabled_flag != 0 )
			{
				size += stream.WriteUnsignedIntGolomb( this.num_tile_columns_minus1, "num_tile_columns_minus1"); 
				size += stream.WriteUnsignedIntGolomb( this.num_tile_rows_minus1, "num_tile_rows_minus1"); 
				size += stream.WriteUnsignedInt(1, this.uniform_spacing_flag, "uniform_spacing_flag"); 
				...
				if ( uniform_spacing_flag== 0 )
				{
					...
					for ( i = 0; i < num_tile_columns_minus1; i++ )
					{
						size += stream.WriteUnsignedIntGolomb( this.column_width_minus1[ i ], "column_width_minus1"); 
					}

					for ( i = 0; i < num_tile_rows_minus1; i++ )
					{
						size += stream.WriteUnsignedIntGolomb( this.row_height_minus1[ i ], "row_height_minus1"); 
					}
				}
				size += stream.WriteUnsignedInt(1, this.loop_filter_across_tiles_enabled_flag, "loop_filter_across_tiles_enabled_flag"); 
			}
			size += stream.WriteUnsignedInt(1, this.pps_loop_filter_across_slices_enabled_flag, "pps_loop_filter_across_slices_enabled_flag"); 
			size += stream.WriteUnsignedInt(1, this.deblocking_filter_control_present_flag, "deblocking_filter_control_present_flag"); 

			if ( deblocking_filter_control_present_flag != 0 )
			{
				size += stream.WriteUnsignedInt(1, this.deblocking_filter_override_enabled_flag, "deblocking_filter_override_enabled_flag"); 
				size += stream.WriteUnsignedInt(1, this.pps_deblocking_filter_disabled_flag, "pps_deblocking_filter_disabled_flag"); 

				if ( pps_deblocking_filter_disabled_flag== 0 )
				{
					size += stream.WriteSignedIntGolomb( this.pps_beta_offset_div2, "pps_beta_offset_div2"); 
					size += stream.WriteSignedIntGolomb( this.pps_tc_offset_div2, "pps_tc_offset_div2"); 
				}
			}
			size += stream.WriteUnsignedInt(1, this.pps_scaling_list_data_present_flag, "pps_scaling_list_data_present_flag"); 

			if ( pps_scaling_list_data_present_flag != 0 )
			{
				size += stream.WriteClass<ScalingListData>(context, this.scaling_list_data, "scaling_list_data"); 
			}
			size += stream.WriteUnsignedInt(1, this.lists_modification_present_flag, "lists_modification_present_flag"); 
			size += stream.WriteUnsignedIntGolomb( this.log2_parallel_merge_level_minus2, "log2_parallel_merge_level_minus2"); 
			size += stream.WriteUnsignedInt(1, this.slice_segment_header_extension_present_flag, "slice_segment_header_extension_present_flag"); 
			size += stream.WriteUnsignedInt(1, this.pps_extension_present_flag, "pps_extension_present_flag"); 

			if ( pps_extension_present_flag != 0 )
			{
				size += stream.WriteUnsignedInt(1, this.pps_range_extension_flag, "pps_range_extension_flag"); 
				size += stream.WriteUnsignedInt(1, this.pps_multilayer_extension_flag, "pps_multilayer_extension_flag"); 
				size += stream.WriteUnsignedInt(1, this.pps_3d_extension_flag, "pps_3d_extension_flag"); 
				size += stream.WriteUnsignedInt(1, this.pps_scc_extension_flag, "pps_scc_extension_flag"); 
				size += stream.WriteUnsignedInt(4, this.pps_extension_4bits, "pps_extension_4bits"); 
			}

			if ( pps_range_extension_flag != 0 )
			{
				size += stream.WriteClass<PpsRangeExtension>(context, this.pps_range_extension, "pps_range_extension"); 
			}

			if ( pps_multilayer_extension_flag != 0 )
			{
				size += stream.WriteClass<PpsMultilayerExtension>(context, this.pps_multilayer_extension, "pps_multilayer_extension"); // specified in Annex F 
			}

			if ( pps_3d_extension_flag != 0 )
			{
				size += stream.WriteClass<Pps3dExtension>(context, this.pps_3d_extension, "pps_3d_extension"); // specified in Annex I 
			}

			if ( pps_scc_extension_flag != 0 )
			{
				size += stream.WriteClass<PpsSccExtension>(context, this.pps_scc_extension, "pps_scc_extension"); 
			}
...
pps_range_extension() { 
 ...
 log2_sao_offset_scale_chroma ue(v) 
    ...
    */
    ...
    {
		private ulong log2_max_transform_skip_block_size_minus2;
		public ulong Log2MaxTransformSkipBlockSizeMinus2 { get { return log2_max_transform_skip_block_size_minus2; } set { log2_max_transform_skip_block_size_minus2 = value; } }
		...
		private ulong diff_cu_chroma_qp_offset_depth;
		public ulong DiffCuChromaQpOffsetDepth { get { return diff_cu_chroma_qp_offset_depth; } set { diff_cu_chroma_qp_offset_depth = value; } }
		private ulong chroma_qp_offset_list_len_minus1;
		public ulong ChromaQpOffsetListLenMinus1 { get { return chroma_qp_offset_list_len_minus1; } set { chroma_qp_offset_list_len_minus1 = value; } }
		private long[] cb_qp_offset_list;
		public long[] CbQpOffsetList { get { return cb_qp_offset_list; } set { cb_qp_offset_list = value; } }
		private long[] cr_qp_offset_list;
		public long[] CrQpOffsetList { get { return cr_qp_offset_list; } set { cr_qp_offset_list = value; } }
		private ulong log2_sao_offset_scale_luma;
		public ulong Log2SaoOffsetScaleLuma { get { return log2_sao_offset_scale_luma; } set { log2_sao_offset_scale_luma = value; } }
		private ulong log2_sao_offset_scale_chroma;
		public ulong Log2SaoOffsetScaleChroma { get { return log2_sao_offset_scale_chroma; } set { log2_sao_offset_scale_chroma = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			size += stream.ReadUnsignedInt(size, 1, out this.cross_component_prediction_enabled_flag, "cross_component_prediction_enabled_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.chroma_qp_offset_list_enabled_flag, "chroma_qp_offset_list_enabled_flag"); 
			...
			if ( chroma_qp_offset_list_enabled_flag != 0 )
			{
				...
				for ( i = 0; i <= chroma_qp_offset_list_len_minus1; i++ )
				{
					size += stream.ReadSignedIntGolomb(size, out this.cb_qp_offset_list[ i ], "cb_qp_offset_list"); 
					size += stream.ReadSignedIntGolomb(size, out this.cr_qp_offset_list[ i ], "cr_qp_offset_list"); 
				}
			}
			size += stream.ReadUnsignedIntGolomb(size, out this.log2_sao_offset_scale_luma, "log2_sao_offset_scale_luma"); 
			size += stream.ReadUnsignedIntGolomb(size, out this.log2_sao_offset_scale_chroma, "log2_sao_offset_scale_chroma"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			size += stream.WriteUnsignedInt(1, this.cross_component_prediction_enabled_flag, "cross_component_prediction_enabled_flag"); 
			size += stream.WriteUnsignedInt(1, this.chroma_qp_offset_list_enabled_flag, "chroma_qp_offset_list_enabled_flag"); 

			if ( chroma_qp_offset_list_enabled_flag != 0 )
			{
				size += stream.WriteUnsignedIntGolomb( this.diff_cu_chroma_qp_offset_depth, "diff_cu_chroma_qp_offset_depth"); 
				size += stream.WriteUnsignedIntGolomb( this.chroma_qp_offset_list_len_minus1, "chroma_qp_offset_list_len_minus1"); 

				for ( i = 0; i <= chroma_qp_offset_list_len_minus1; i++ )
				{
					size += stream.WriteSignedIntGolomb( this.cb_qp_offset_list[ i ], "cb_qp_offset_list"); 
					size += stream.WriteSignedIntGolomb( this.cr_qp_offset_list[ i ], "cr_qp_offset_list"); 
				}
			}
			size += stream.WriteUnsignedIntGolomb( this.log2_sao_offset_scale_luma, "log2_sao_offset_scale_luma"); 
			size += stream.WriteUnsignedIntGolomb( this.log2_sao_offset_scale_chroma, "log2_sao_offset_scale_chroma"); 
  ...
  if( pps_num_palette_predictor_initializers > 0 ) {  
    ...
    */
    public class PpsSccExtension : IItuSerializable
    {
		...
		private long pps_act_y_qp_offset_plus5;
		public long PpsActyQpOffsetPlus5 { get { return pps_act_y_qp_offset_plus5; } set { pps_act_y_qp_offset_plus5 = value; } }
		private long pps_act_cb_qp_offset_plus5;
		public long PpsActCbQpOffsetPlus5 { get { return pps_act_cb_qp_offset_plus5; } set { pps_act_cb_qp_offset_plus5 = value; } }
		private long pps_act_cr_qp_offset_plus3;
		public long PpsActCrQpOffsetPlus3 { get { return pps_act_cr_qp_offset_plus3; } set { pps_act_cr_qp_offset_plus3 = value; } }
		...
		private ulong pps_num_palette_predictor_initializers;
		public ulong PpsNumPalettePredictorInitializers { get { return pps_num_palette_predictor_initializers; } set { pps_num_palette_predictor_initializers = value; } }
		...
		private ulong luma_bit_depth_entry_minus8;
		public ulong LumaBitDepthEntryMinus8 { get { return luma_bit_depth_entry_minus8; } set { luma_bit_depth_entry_minus8 = value; } }
		private ulong chroma_bit_depth_entry_minus8;
		public ulong ChromaBitDepthEntryMinus8 { get { return chroma_bit_depth_entry_minus8; } set { chroma_bit_depth_entry_minus8 = value; } }
		private ulong[][] pps_palette_predictor_initializer;
		public ulong[][] PpsPalettePredictorInitializer { get { return pps_palette_predictor_initializer; } set { pps_palette_predictor_initializer = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			uint comp = 0;
			uint i = 0;
			size += stream.ReadUnsignedInt(size, 1, out this.pps_curr_pic_ref_enabled_flag, "pps_curr_pic_ref_enabled_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.residual_adaptive_colour_transform_enabled_flag, "residual_adaptive_colour_transform_enabled_flag"); 

			if ( residual_adaptive_colour_transform_enabled_flag != 0 )
			{
				size += stream.ReadUnsignedInt(size, 1, out this.pps_slice_act_qp_offsets_present_flag, "pps_slice_act_qp_offsets_present_flag"); 
				size += stream.ReadSignedIntGolomb(size, out this.pps_act_y_qp_offset_plus5, "pps_act_y_qp_offset_plus5"); 
				size += stream.ReadSignedIntGolomb(size, out this.pps_act_cb_qp_offset_plus5, "pps_act_cb_qp_offset_plus5"); 
				size += stream.ReadSignedIntGolomb(size, out this.pps_act_cr_qp_offset_plus3, "pps_act_cr_qp_offset_plus3"); 
			}
			size += stream.ReadUnsignedInt(size, 1, out this.pps_palette_predictor_initializers_present_flag, "pps_palette_predictor_initializers_present_flag"); 

			if ( pps_palette_predictor_initializers_present_flag != 0 )
			{
				size += stream.ReadUnsignedIntGolomb(size, out this.pps_num_palette_predictor_initializers, "pps_num_palette_predictor_initializers"); 

				if ( pps_num_palette_predictor_initializers > 0 )
				{
					size += stream.ReadUnsignedInt(size, 1, out this.monochrome_palette_flag, "monochrome_palette_flag"); 
					size += stream.ReadUnsignedIntGolomb(size, out this.luma_bit_depth_entry_minus8, "luma_bit_depth_entry_minus8"); 

					if ( monochrome_palette_flag== 0 )
					{
						size += stream.ReadUnsignedIntGolomb(size, out this.chroma_bit_depth_entry_minus8, "chroma_bit_depth_entry_minus8"); 
					}
					numComps= monochrome_palette_flag != 0 ?  1 : 3;
					...
					for ( comp = 0; comp < numComps; comp++ )
					{
						...
						for ( i = 0; i < pps_num_palette_predictor_initializers; i++ )
						{
							size += stream.ReadUnsignedIntVariable(size, comp == 0 ? (ituContext.PicParameterSetRbsp.PpsSccExtension.LumaBitDepthEntryMinus8 + 8) : (ituContext.PicParameterSetRbsp.PpsSccExtension.ChromaBitDepthEntryMinus8 + 8), out this.pps_palette_predictor_initializer[ comp ][ i ], "pps_palette_predictor_initializer"); 
						}
					}
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			uint comp = 0;
			uint i = 0;
			size += stream.WriteUnsignedInt(1, this.pps_curr_pic_ref_enabled_flag, "pps_curr_pic_ref_enabled_flag"); 
			size += stream.WriteUnsignedInt(1, this.residual_adaptive_colour_transform_enabled_flag, "residual_adaptive_colour_transform_enabled_flag"); 

			if ( residual_adaptive_colour_transform_enabled_flag != 0 )
			{
				size += stream.WriteUnsignedInt(1, this.pps_slice_act_qp_offsets_present_flag, "pps_slice_act_qp_offsets_present_flag"); 
				size += stream.WriteSignedIntGolomb( this.pps_act_y_qp_offset_plus5, "pps_act_y_qp_offset_plus5"); 
				size += stream.WriteSignedIntGolomb( this.pps_act_cb_qp_offset_plus5, "pps_act_cb_qp_offset_plus5"); 
				size += stream.WriteSignedIntGolomb( this.pps_act_cr_qp_offset_plus3, "pps_act_cr_qp_offset_plus3"); 
			}
			size += stream.WriteUnsignedInt(1, this.pps_palette_predictor_initializers_present_flag, "pps_palette_predictor_initializers_present_flag"); 

			if ( pps_palette_predictor_initializers_present_flag != 0 )
			{
				size += stream.WriteUnsignedIntGolomb( this.pps_num_palette_predictor_initializers, "pps_num_palette_predictor_initializers"); 

				if ( pps_num_palette_predictor_initializers > 0 )
				{
					size += stream.WriteUnsignedInt(1, this.monochrome_palette_flag, "monochrome_palette_flag"); 
					size += stream.WriteUnsignedIntGolomb( this.luma_bit_depth_entry_minus8, "luma_bit_depth_entry_minus8"); 

					if ( monochrome_palette_flag== 0 )
					{
						size += stream.WriteUnsignedIntGolomb( this.chroma_bit_depth_entry_minus8, "chroma_bit_depth_entry_minus8"); 
					}
					numComps= monochrome_palette_flag != 0 ?  1 : 3;
					...
					for ( comp = 0; comp < numComps; comp++ )
					{
						...
						for ( i = 0; i < pps_num_palette_predictor_initializers; i++ )
						{
							size += stream.WriteUnsignedIntVariable(comp == 0 ? (ituContext.PicParameterSetRbsp.PpsSccExtension.LumaBitDepthEntryMinus8 + 8) : (ituContext.PicParameterSetRbsp.PpsSccExtension.ChromaBitDepthEntryMinus8 + 8), this.pps_palette_predictor_initializer[ comp ][ i ], "pps_palette_predictor_initializer"); 
						}
					}
				}
			}
    ...
    public class ByteAlignment : IItuSerializable
    {
		...
		public Dictionary<int, uint> AlignmentBitEqualToZero { get { return alignment_bit_equal_to_zero; } set { alignment_bit_equal_to_zero = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			int whileIndex = -1;
			size += stream.ReadFixed(size, 1, out this.alignment_bit_equal_to_one, "alignment_bit_equal_to_one"); // equal to 1 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			int whileIndex = -1;
			size += stream.WriteFixed(1, this.alignment_bit_equal_to_one, "alignment_bit_equal_to_one"); // equal to 1 
  ...
  if( sub_layer_level_present_flag[ i ] )  
    ...
    */
    public class ProfileTierLevel : IItuSerializable
    {
		...
		private ulong maxNumSubLayersMinus1;
		public ulong MaxNumSubLayersMinus1 { get { return maxNumSubLayersMinus1; } set { maxNumSubLayersMinus1 = value; } }
		...
		public uint[] SubLayerLevelIdc { get { return sub_layer_level_idc; } set { sub_layer_level_idc = value; } }
         ...
         public ProfileTierLevel(uint profilePresentFlag, ulong maxNumSubLayersMinus1)
         { 
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			{
				size += stream.ReadUnsignedInt(size, 2, out this.general_profile_space, "general_profile_space"); 
				...
				for ( j = 0; j < 32; j++ )
				{
					size += stream.ReadUnsignedInt(size, 1, out this.general_profile_compatibility_flag[ j ], "general_profile_compatibility_flag"); 
				}
				size += stream.ReadUnsignedInt(size, 1, out this.general_progressive_source_flag, "general_progressive_source_flag"); 
				size += stream.ReadUnsignedInt(size, 1, out this.general_interlaced_source_flag, "general_interlaced_source_flag"); 
...
/*  The number of bits in this syntax structure is not affected by this condition  */
					...
					size += stream.ReadUnsignedInt(size, 1, out this.general_max_12bit_constraint_flag, "general_max_12bit_constraint_flag"); 
					size += stream.ReadUnsignedInt(size, 1, out this.general_max_10bit_constraint_flag, "general_max_10bit_constraint_flag"); 
					size += stream.ReadUnsignedInt(size, 1, out this.general_max_8bit_constraint_flag, "general_max_8bit_constraint_flag"); 
					size += stream.ReadUnsignedInt(size, 1, out this.general_max_422chroma_constraint_flag, "general_max_422chroma_constraint_flag"); 
					size += stream.ReadUnsignedInt(size, 1, out this.general_max_420chroma_constraint_flag, "general_max_420chroma_constraint_flag"); 
					size += stream.ReadUnsignedInt(size, 1, out this.general_max_monochrome_constraint_flag, "general_max_monochrome_constraint_flag"); 
					size += stream.ReadUnsignedInt(size, 1, out this.general_intra_constraint_flag, "general_intra_constraint_flag"); 
    ...
    general_profile_idc == 10  ||  general_profile_compatibility_flag[ 10 ] != 0 )
					...
					{
						size += stream.ReadUnsignedInt(size, 34, out this.general_reserved_zero_34bits, "general_reserved_zero_34bits"); 
					}
				}
				else if ( general_profile_idc == 2  ||  general_profile_compatibility_flag[ 2 ] != 0 )
				{
					size += stream.ReadUnsignedInt(size, 7, out this.general_reserved_zero_7bits, "general_reserved_zero_7bits"); 
					size += stream.ReadUnsignedInt(size, 1, out this.general_one_picture_only_constraint_flag, "general_one_picture_only_constraint_flag"); 
					size += stream.ReadUnsignedInt(size, 35, out this.general_reserved_zero_35bits, "general_reserved_zero_35bits"); 
				}
				else 
				{
    ...
    general_profile_compatibility_flag[ 5 ] != 0  ||  general_profile_compatibility_flag[ 9 ] != 0 )
				...
				{
					size += stream.ReadUnsignedInt(size, 1, out this.general_reserved_zero_bit, "general_reserved_zero_bit"); 
				}
			}
			...
			{
				size += stream.ReadUnsignedInt(size, 1, out this.sub_layer_profile_present_flag[ i ], "sub_layer_profile_present_flag"); 
				size += stream.ReadUnsignedInt(size, 1, out this.sub_layer_level_present_flag[ i ], "sub_layer_level_present_flag"); 
			}
			...
			if ( maxNumSubLayersMinus1 > 0 )
			{
				...
				{
					size += stream.ReadUnsignedInt(size, 2, out this.reserved_zero_2bits[ i ], "reserved_zero_2bits"); 
				}
			}
			...
			for ( i = 0; i < (int)maxNumSubLayersMinus1; i++ )
			{
				...
				{
					size += stream.ReadUnsignedInt(size, 2, out this.sub_layer_profile_space[ i ], "sub_layer_profile_space"); 
					...
					for ( j = 0; j < 32; j++ )
					{
						size += stream.ReadUnsignedInt(size, 1, out this.sub_layer_profile_compatibility_flag[ i ][ j ], "sub_layer_profile_compatibility_flag"); 
					}
					size += stream.ReadUnsignedInt(size, 1, out this.sub_layer_progressive_source_flag[ i ], "sub_layer_progressive_source_flag"); 
					size += stream.ReadUnsignedInt(size, 1, out this.sub_layer_interlaced_source_flag[ i ], "sub_layer_interlaced_source_flag"); 
...
/*  The number of bits in this syntax structure is not affected by this condition  */
						...
						size += stream.ReadUnsignedInt(size, 1, out this.sub_layer_max_12bit_constraint_flag[ i ], "sub_layer_max_12bit_constraint_flag"); 
						size += stream.ReadUnsignedInt(size, 1, out this.sub_layer_max_10bit_constraint_flag[ i ], "sub_layer_max_10bit_constraint_flag"); 
						size += stream.ReadUnsignedInt(size, 1, out this.sub_layer_max_8bit_constraint_flag[ i ], "sub_layer_max_8bit_constraint_flag"); 
						size += stream.ReadUnsignedInt(size, 1, out this.sub_layer_max_422chroma_constraint_flag[ i ], "sub_layer_max_422chroma_constraint_flag"); 
						size += stream.ReadUnsignedInt(size, 1, out this.sub_layer_max_420chroma_constraint_flag[ i ], "sub_layer_max_420chroma_constraint_flag"); 
						size += stream.ReadUnsignedInt(size, 1, out this.sub_layer_max_monochrome_constraint_flag[ i ], "sub_layer_max_monochrome_constraint_flag"); 
						size += stream.ReadUnsignedInt(size, 1, out this.sub_layer_intra_constraint_flag[ i ], "sub_layer_intra_constraint_flag"); 
						size += stream.ReadUnsignedInt(size, 1, out this.sub_layer_one_picture_only_constraint_flag[ i ], "sub_layer_one_picture_only_constraint_flag"); 
						size += stream.ReadUnsignedInt(size, 1, out this.sub_layer_lower_bit_rate_constraint_flag[ i ], "sub_layer_lower_bit_rate_constraint_flag"); 

						if ( sub_layer_profile_idc[ i ] == 5 || 
     sub_layer_profile_compatibility_flag[ i ][ 5 ] != 0 )
						{
							size += stream.ReadUnsignedInt(size, 1, out this.sub_layer_max_14bit_constraint_flag[ i ], "sub_layer_max_14bit_constraint_flag"); 
							size += stream.ReadUnsignedInt(size, 33, out this.sub_layer_reserved_zero_33bits[ i ], "sub_layer_reserved_zero_33bits"); 
						}
						else 
						{
							size += stream.ReadUnsignedInt(size, 34, out this.sub_layer_reserved_zero_34bits[ i ], "sub_layer_reserved_zero_34bits"); 
						}
					}
					else if ( sub_layer_profile_idc[ i ] == 2  || 
       sub_layer_profile_compatibility_flag[ i ][ 2 ] != 0 )
					{
						size += stream.ReadUnsignedInt(size, 7, out this.sub_layer_reserved_zero_7bits[ i ], "sub_layer_reserved_zero_7bits"); 
						size += stream.ReadUnsignedInt(size, 1, out this.sub_layer_one_picture_only_constraint_flag[ i ], "sub_layer_one_picture_only_constraint_flag"); 
						size += stream.ReadUnsignedInt(size, 35, out this.sub_layer_reserved_zero_35bits[ i ], "sub_layer_reserved_zero_35bits"); 
					}
					else 
					{
     ...
     sub_layer_profile_compatibility_flag[ i ][ 9 ] != 0 )
					...
					{
						size += stream.ReadUnsignedInt(size, 1, out this.sub_layer_reserved_zero_bit[ i ], "sub_layer_reserved_zero_bit"); 
					}
				}

				if ( sub_layer_level_present_flag[ i ] != 0 )
				{
					size += stream.ReadUnsignedInt(size, 8, out this.sub_layer_level_idc[ i ], "sub_layer_level_idc"); 
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( profilePresentFlag != 0 )
			{
				size += stream.WriteUnsignedInt(2, this.general_profile_space, "general_profile_space"); 
				size += stream.WriteUnsignedInt(1, this.general_tier_flag, "general_tier_flag"); 
				size += stream.WriteUnsignedInt(5, this.general_profile_idc, "general_profile_idc"); 

				for ( j = 0; j < 32; j++ )
				{
					size += stream.WriteUnsignedInt(1, this.general_profile_compatibility_flag[ j ], "general_profile_compatibility_flag"); 
				}
				size += stream.WriteUnsignedInt(1, this.general_progressive_source_flag, "general_progressive_source_flag"); 
				size += stream.WriteUnsignedInt(1, this.general_interlaced_source_flag, "general_interlaced_source_flag"); 
...
/*  The number of bits in this syntax structure is not affected by this condition  */
					...
					size += stream.WriteUnsignedInt(1, this.general_max_12bit_constraint_flag, "general_max_12bit_constraint_flag"); 
					size += stream.WriteUnsignedInt(1, this.general_max_10bit_constraint_flag, "general_max_10bit_constraint_flag"); 
					size += stream.WriteUnsignedInt(1, this.general_max_8bit_constraint_flag, "general_max_8bit_constraint_flag"); 
					size += stream.WriteUnsignedInt(1, this.general_max_422chroma_constraint_flag, "general_max_422chroma_constraint_flag"); 
					size += stream.WriteUnsignedInt(1, this.general_max_420chroma_constraint_flag, "general_max_420chroma_constraint_flag"); 
					size += stream.WriteUnsignedInt(1, this.general_max_monochrome_constraint_flag, "general_max_monochrome_constraint_flag"); 
					size += stream.WriteUnsignedInt(1, this.general_intra_constraint_flag, "general_intra_constraint_flag"); 
    ...
    general_profile_idc == 10  ||  general_profile_compatibility_flag[ 10 ] != 0 )
					...
					{
						size += stream.WriteUnsignedInt(34, this.general_reserved_zero_34bits, "general_reserved_zero_34bits"); 
					}
				}
				else if ( general_profile_idc == 2  ||  general_profile_compatibility_flag[ 2 ] != 0 )
				{
					size += stream.WriteUnsignedInt(7, this.general_reserved_zero_7bits, "general_reserved_zero_7bits"); 
					size += stream.WriteUnsignedInt(1, this.general_one_picture_only_constraint_flag, "general_one_picture_only_constraint_flag"); 
					size += stream.WriteUnsignedInt(35, this.general_reserved_zero_35bits, "general_reserved_zero_35bits"); 
				}
				else 
				{
    ...
    general_profile_compatibility_flag[ 5 ] != 0  ||  general_profile_compatibility_flag[ 9 ] != 0 )
				...
				{
					size += stream.WriteUnsignedInt(1, this.general_reserved_zero_bit, "general_reserved_zero_bit"); 
				}
			}
			size += stream.WriteUnsignedInt(8, this.general_level_idc, "general_level_idc"); 

			for ( i = 0; i < (int)maxNumSubLayersMinus1; i++ )
			{
				size += stream.WriteUnsignedInt(1, this.sub_layer_profile_present_flag[ i ], "sub_layer_profile_present_flag"); 
				size += stream.WriteUnsignedInt(1, this.sub_layer_level_present_flag[ i ], "sub_layer_level_present_flag"); 
			}
			...
			if ( maxNumSubLayersMinus1 > 0 )
			{
				...
				for ( i = (int)maxNumSubLayersMinus1; i < 8; i++ )
				{
					size += stream.WriteUnsignedInt(2, this.reserved_zero_2bits[ i ], "reserved_zero_2bits"); 
				}
			}
			...
			for ( i = 0; i < (int)maxNumSubLayersMinus1; i++ )
			{
				...
				if ( sub_layer_profile_present_flag[ i ] != 0 )
				{
					size += stream.WriteUnsignedInt(2, this.sub_layer_profile_space[ i ], "sub_layer_profile_space"); 
					size += stream.WriteUnsignedInt(1, this.sub_layer_tier_flag[ i ], "sub_layer_tier_flag"); 
					size += stream.WriteUnsignedInt(5, this.sub_layer_profile_idc[ i ], "sub_layer_profile_idc"); 

					for ( j = 0; j < 32; j++ )
					{
						size += stream.WriteUnsignedInt(1, this.sub_layer_profile_compatibility_flag[ i ][ j ], "sub_layer_profile_compatibility_flag"); 
					}
					size += stream.WriteUnsignedInt(1, this.sub_layer_progressive_source_flag[ i ], "sub_layer_progressive_source_flag"); 
					size += stream.WriteUnsignedInt(1, this.sub_layer_interlaced_source_flag[ i ], "sub_layer_interlaced_source_flag"); 
...
/*  The number of bits in this syntax structure is not affected by this condition  */
						...
						size += stream.WriteUnsignedInt(1, this.sub_layer_max_12bit_constraint_flag[ i ], "sub_layer_max_12bit_constraint_flag"); 
						size += stream.WriteUnsignedInt(1, this.sub_layer_max_10bit_constraint_flag[ i ], "sub_layer_max_10bit_constraint_flag"); 
						size += stream.WriteUnsignedInt(1, this.sub_layer_max_8bit_constraint_flag[ i ], "sub_layer_max_8bit_constraint_flag"); 
						size += stream.WriteUnsignedInt(1, this.sub_layer_max_422chroma_constraint_flag[ i ], "sub_layer_max_422chroma_constraint_flag"); 
						size += stream.WriteUnsignedInt(1, this.sub_layer_max_420chroma_constraint_flag[ i ], "sub_layer_max_420chroma_constraint_flag"); 
						size += stream.WriteUnsignedInt(1, this.sub_layer_max_monochrome_constraint_flag[ i ], "sub_layer_max_monochrome_constraint_flag"); 
						size += stream.WriteUnsignedInt(1, this.sub_layer_intra_constraint_flag[ i ], "sub_layer_intra_constraint_flag"); 
						size += stream.WriteUnsignedInt(1, this.sub_layer_one_picture_only_constraint_flag[ i ], "sub_layer_one_picture_only_constraint_flag"); 
						size += stream.WriteUnsignedInt(1, this.sub_layer_lower_bit_rate_constraint_flag[ i ], "sub_layer_lower_bit_rate_constraint_flag"); 

						if ( sub_layer_profile_idc[ i ] == 5 || 
     sub_layer_profile_compatibility_flag[ i ][ 5 ] != 0 )
						{
							size += stream.WriteUnsignedInt(1, this.sub_layer_max_14bit_constraint_flag[ i ], "sub_layer_max_14bit_constraint_flag"); 
							size += stream.WriteUnsignedInt(33, this.sub_layer_reserved_zero_33bits[ i ], "sub_layer_reserved_zero_33bits"); 
						}
						else 
						{
							size += stream.WriteUnsignedInt(34, this.sub_layer_reserved_zero_34bits[ i ], "sub_layer_reserved_zero_34bits"); 
						}
					}
					else if ( sub_layer_profile_idc[ i ] == 2  || 
       sub_layer_profile_compatibility_flag[ i ][ 2 ] != 0 )
					{
						size += stream.WriteUnsignedInt(7, this.sub_layer_reserved_zero_7bits[ i ], "sub_layer_reserved_zero_7bits"); 
						size += stream.WriteUnsignedInt(1, this.sub_layer_one_picture_only_constraint_flag[ i ], "sub_layer_one_picture_only_constraint_flag"); 
						size += stream.WriteUnsignedInt(35, this.sub_layer_reserved_zero_35bits[ i ], "sub_layer_reserved_zero_35bits"); 
					}
					else 
					{
     ...
     sub_layer_profile_compatibility_flag[ i ][ 9 ] != 0 )
					...
					{
						size += stream.WriteUnsignedInt(1, this.sub_layer_reserved_zero_bit[ i ], "sub_layer_reserved_zero_bit"); 
					}
				}

				if ( sub_layer_level_present_flag[ i ] != 0 )
				{
					size += stream.WriteUnsignedInt(8, this.sub_layer_level_idc[ i ], "sub_layer_level_idc"); 
				}
			}
  ...
  for( matrixId = 0; matrixId < 6; matrixId  +=  ( sizeId == 3 ) ? 3 : 1 ) {  
    ...
    */
    public class ScalingListData : IItuSerializable
    {
		...
		private ulong[][] scaling_list_pred_matrix_id_delta;
		public ulong[][] ScalingListPredMatrixIdDelta { get { return scaling_list_pred_matrix_id_delta; } set { scaling_list_pred_matrix_id_delta = value; } }
		private long[][] scaling_list_dc_coef_minus8;
		public long[][] ScalingListDcCoefMinus8 { get { return scaling_list_dc_coef_minus8; } set { scaling_list_dc_coef_minus8 = value; } }
		...
		public long[][][] ScalingListDeltaCoef { get { return scaling_list_delta_coef; } set { scaling_list_delta_coef = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			for ( sizeId = 0; sizeId < 4; sizeId++ )
			{
				...
				for ( matrixId = 0; matrixId < 6; matrixId  +=  ( sizeId == 3 ) ? 3 : 1 )
				{
					size += stream.ReadUnsignedInt(size, 1, out this.scaling_list_pred_mode_flag[ sizeId ][ matrixId ], "scaling_list_pred_mode_flag"); 

					if ( scaling_list_pred_mode_flag[ sizeId ][ matrixId ]== 0 )
					{
						size += stream.ReadUnsignedIntGolomb(size, out this.scaling_list_pred_matrix_id_delta[ sizeId ][ matrixId ], "scaling_list_pred_matrix_id_delta"); 
					}
					else 
					{
						nextCoef= 8;
						...
						if ( sizeId > 1 )
						{
							size += stream.ReadSignedIntGolomb(size, out this.scaling_list_dc_coef_minus8[ sizeId - 2 ][ matrixId ], "scaling_list_dc_coef_minus8"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			for ( sizeId = 0; sizeId < 4; sizeId++ )
			{
				...
				for ( matrixId = 0; matrixId < 6; matrixId  +=  ( sizeId == 3 ) ? 3 : 1 )
				{
					size += stream.WriteUnsignedInt(1, this.scaling_list_pred_mode_flag[ sizeId ][ matrixId ], "scaling_list_pred_mode_flag"); 

					if ( scaling_list_pred_mode_flag[ sizeId ][ matrixId ]== 0 )
					{
						size += stream.WriteUnsignedIntGolomb( this.scaling_list_pred_matrix_id_delta[ sizeId ][ matrixId ], "scaling_list_pred_matrix_id_delta"); 
					}
					else 
					{
						nextCoef= 8;
						...
						if ( sizeId > 1 )
						{
							size += stream.WriteSignedIntGolomb( this.scaling_list_dc_coef_minus8[ sizeId - 2 ][ matrixId ], "scaling_list_dc_coef_minus8"); 
							nextCoef= (uint)scaling_list_dc_coef_minus8[ sizeId - 2 ][ matrixId ] + 8;
						}
 ...
 if( inter_ref_pic_set_prediction_flag ) {  
  ...
  for( i = 0; i < num_positive_pics; i++ ) {  
    ...
    */
    ...
    {
		private ulong stRpsIdx;
		public ulong StRpsIdx { get { return stRpsIdx; } set { stRpsIdx = value; } }
		...
		private ulong delta_idx_minus1;
		public ulong DeltaIdxMinus1 { get { return delta_idx_minus1; } set { delta_idx_minus1 = value; } }
		private byte delta_rps_sign;
		public byte DeltaRpsSign { get { return delta_rps_sign; } set { delta_rps_sign = value; } }
		private ulong abs_delta_rps_minus1;
		public ulong AbsDeltaRpsMinus1 { get { return abs_delta_rps_minus1; } set { abs_delta_rps_minus1 = value; } }
		...
		private ulong num_negative_pics;
		public ulong NumNegativePics { get { return num_negative_pics; } set { num_negative_pics = value; } }
		private ulong num_positive_pics;
		public ulong NumPositivePics { get { return num_positive_pics; } set { num_positive_pics = value; } }
		private ulong[] delta_poc_s0_minus1;
		public ulong[] DeltaPocS0Minus1 { get { return delta_poc_s0_minus1; } set { delta_poc_s0_minus1 = value; } }
		...
		private ulong[] delta_poc_s1_minus1;
		public ulong[] DeltaPocS1Minus1 { get { return delta_poc_s1_minus1; } set { delta_poc_s1_minus1 = value; } }
		...
		public byte[] UsedByCurrPicS1Flag { get { return used_by_curr_pic_s1_flag; } set { used_by_curr_pic_s1_flag = value; } }
         ...
         public StRefPicSet(ulong stRpsIdx)
         { 
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			if ( stRpsIdx != 0 )
			{
				size += stream.ReadUnsignedInt(size, 1, out this.inter_ref_pic_set_prediction_flag, "inter_ref_pic_set_prediction_flag"); 
			}
			...
			if ( inter_ref_pic_set_prediction_flag != 0 )
			{
				...
				for ( j = 0; j <= ituContext.NumDeltaPocs[ ituContext.RefRpsIdx ]; j++ )
				{
					...
					{
						size += stream.ReadUnsignedInt(size, 1, out this.use_delta_flag[ j ], "use_delta_flag"); 
					}
				}
			}
			else 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( stRpsIdx != 0 )
			{
				size += stream.WriteUnsignedInt(1, this.inter_ref_pic_set_prediction_flag, "inter_ref_pic_set_prediction_flag"); 
			}
			...
			if ( inter_ref_pic_set_prediction_flag != 0 )
			{
				...
				for ( j = 0; j <= ituContext.NumDeltaPocs[ ituContext.RefRpsIdx ]; j++ )
				{
					...
					if ( used_by_curr_pic_flag[ j ]== 0 )
					{
						size += stream.WriteUnsignedInt(1, this.use_delta_flag[ j ], "use_delta_flag"); 
					}
				}
			}
			else 
			{
				size += stream.WriteUnsignedIntGolomb( this.num_negative_pics, "num_negative_pics"); 
				size += stream.WriteUnsignedIntGolomb( this.num_positive_pics, "num_positive_pics"); 
  ...
  while( !byte_aligned() )  
    ...
    */
    public class SeiPayload : IItuSerializable
    {
		...
		private ulong reserved_payload_extension_data;
		...
		public Dictionary<int, uint> PayloadBitEqualToZero { get { return payload_bit_equal_to_zero; } set { payload_bit_equal_to_zero = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			if ( ituContext.NalHeader.NalUnitHeader.NalUnitType == H265NALTypes.PREFIX_SEI_NUT )
			{
				...
				else if ( payloadType == 15 )
				{
					...
					size +=  stream.ReadClass<PictureSnapshot>(size, context, this.picture_snapshot, "picture_snapshot"); 
				}
				else if ( payloadType == 16 )
				{
				...
				else if ( payloadType == 128 )
				{
					...
					size +=  stream.ReadClass<StructureOfPicturesInfo>(size, context, this.structure_of_pictures_info, "structure_of_pictures_info"); 
				}
				else if ( payloadType == 129 )
				{
					this.active_parameter_sets =  new ActiveParameterSets( payloadSize ) ;
					size +=  stream.ReadClass<ActiveParameterSets>(size, context, this.active_parameter_sets, "active_parameter_sets"); 
				}
				else if ( payloadType == 130 )
				{
				...
				else if ( payloadType == 131 )
				{
					...
					size +=  stream.ReadClass<TemporalSubLayerZeroIdx>(size, context, this.temporal_sub_layer_zero_idx, "temporal_sub_layer_zero_idx"); 
				}
				else if ( payloadType == 133 )
				{
					this.scalable_nesting =  new ScalableNesting( payloadSize ) ;
					size +=  stream.ReadClass<ScalableNesting>(size, context, this.scalable_nesting, "scalable_nesting"); 
				}
				else if ( payloadType == 134 )
				{
					this.region_refresh_info =  new RegionRefreshInfo( payloadSize ) ;
					size +=  stream.ReadClass<RegionRefreshInfo>(size, context, this.region_refresh_info, "region_refresh_info"); 
				}
				else if ( payloadType == 135 )
				{
					this.no_display =  new NoDisplay( payloadSize ) ;
					size +=  stream.ReadClass<NoDisplay>(size, context, this.no_display, "no_display"); 
				}
				else if ( payloadType == 136 )
				{
					this.time_code =  new TimeCode( payloadSize ) ;
					size +=  stream.ReadClass<TimeCode>(size, context, this.time_code, "time_code"); 
				}
				else if ( payloadType == 137 )
				{
				...
				else if ( payloadType == 138 )
				{
					...
					size +=  stream.ReadClass<SegmentedRectFramePackingArrangement>(size, context, this.segmented_rect_frame_packing_arrangement, "segmented_rect_frame_packing_arrangement"); 
				}
				else if ( payloadType == 139 )
				{
					this.temporal_motion_constrained_tile_sets =  new TemporalMotionConstrainedTileSets( payloadSize ) ;
					size +=  stream.ReadClass<TemporalMotionConstrainedTileSets>(size, context, this.temporal_motion_constrained_tile_sets, "temporal_motion_constrained_tile_sets"); 
				}
				else if ( payloadType == 140 )
				{
					this.chroma_resampling_filter_hint =  new ChromaResamplingFilterHint( payloadSize ) ;
					size +=  stream.ReadClass<ChromaResamplingFilterHint>(size, context, this.chroma_resampling_filter_hint, "chroma_resampling_filter_hint"); 
				}
				else if ( payloadType == 141 )
				{
					this.knee_function_info =  new KneeFunctionInfo( payloadSize ) ;
					size +=  stream.ReadClass<KneeFunctionInfo>(size, context, this.knee_function_info, "knee_function_info"); 
				}
				else if ( payloadType == 142 )
				{
				...
				else if ( payloadType == 143 )
				{
					...
					size +=  stream.ReadClass<DeinterlacedFieldIdentification>(size, context, this.deinterlaced_field_identification, "deinterlaced_field_identification"); 
				}
				else if ( payloadType == 144 )
				{
				...
				else if ( payloadType == 145 )
				{
					...
					size +=  stream.ReadClass<DependentRapIndication>(size, context, this.dependent_rap_indication, "dependent_rap_indication"); 
				}
				else if ( payloadType == 146 )
				{
					this.coded_region_completion =  new CodedRegionCompletion( payloadSize ) ;
					size +=  stream.ReadClass<CodedRegionCompletion>(size, context, this.coded_region_completion, "coded_region_completion"); 
				}
				else if ( payloadType == 147 )
				{
				...
				else if ( payloadType == 157 )
				{
					...
					size +=  stream.ReadClass<RegionalNesting>(size, context, this.regional_nesting, "regional_nesting"); 
				}
				else if ( payloadType == 158 )
				{
					this.mcts_extraction_info_sets =  new MctsExtractionInfoSets( payloadSize ) ;
					size +=  stream.ReadClass<MctsExtractionInfoSets>(size, context, this.mcts_extraction_info_sets, "mcts_extraction_info_sets"); 
				}
				else if ( payloadType == 159 )
				{
					this.mcts_extraction_info_nesting =  new MctsExtractionInfoNesting( payloadSize ) ;
					size +=  stream.ReadClass<MctsExtractionInfoNesting>(size, context, this.mcts_extraction_info_nesting, "mcts_extraction_info_nesting"); 
				}
				else if ( payloadType == 160 )
				{
					this.layers_not_present =  new LayersNotPresent( payloadSize ) ;
					size +=  stream.ReadClass<LayersNotPresent>(size, context, this.layers_not_present, "layers_not_present"); // specified in Annex F 
				}
				else if ( payloadType == 161 )
				{
					this.inter_layer_constrained_tile_sets =  new InterLayerConstrainedTileSets( payloadSize ) ;
					size +=  stream.ReadClass<InterLayerConstrainedTileSets>(size, context, this.inter_layer_constrained_tile_sets, "inter_layer_constrained_tile_sets"); // specified in Annex F 
				}
				else if ( payloadType == 162 )
				{
					this.bsp_nesting =  new BspNesting( payloadSize ) ;
					size +=  stream.ReadClass<BspNesting>(size, context, this.bsp_nesting, "bsp_nesting"); // specified in Annex F 
				}
				else if ( payloadType == 163 )
				{
					this.bsp_initial_arrival_time =  new BspInitialArrivalTime( payloadSize ) ;
					size +=  stream.ReadClass<BspInitialArrivalTime>(size, context, this.bsp_initial_arrival_time, "bsp_initial_arrival_time"); // specified in Annex F 
				}
				else if ( payloadType == 164 )
				{
					this.sub_bitstream_property =  new SubBitstreamProperty( payloadSize ) ;
					size +=  stream.ReadClass<SubBitstreamProperty>(size, context, this.sub_bitstream_property, "sub_bitstream_property"); // specified in Annex F 
				}
				else if ( payloadType == 165 )
				{
					this.alpha_channel_info =  new AlphaChannelInfo( payloadSize ) ;
					size +=  stream.ReadClass<AlphaChannelInfo>(size, context, this.alpha_channel_info, "alpha_channel_info"); // specified in Annex F 
				}
				else if ( payloadType == 166 )
				{
					this.overlay_info =  new OverlayInfo( payloadSize ) ;
					size +=  stream.ReadClass<OverlayInfo>(size, context, this.overlay_info, "overlay_info"); // specified in Annex F 
				}
				else if ( payloadType == 167 )
				{
					this.temporal_mv_prediction_constraints =  new TemporalMvPredictionConstraints( payloadSize ) ;
					size +=  stream.ReadClass<TemporalMvPredictionConstraints>(size, context, this.temporal_mv_prediction_constraints, "temporal_mv_prediction_constraints"); // specified in Annex F 
				}
				else if ( payloadType == 168 )
				{
					this.frame_field_info =  new FrameFieldInfo( payloadSize ) ;
					size +=  stream.ReadClass<FrameFieldInfo>(size, context, this.frame_field_info, "frame_field_info"); // specified in Annex F 
				}
				else if ( payloadType == 176 )
				{
					this.three_dimensional_reference_displays_info =  new ThreeDimensionalReferenceDisplaysInfo( payloadSize ) ;
					size +=  stream.ReadClass<ThreeDimensionalReferenceDisplaysInfo>(size, context, this.three_dimensional_reference_displays_info, "three_dimensional_reference_displays_info"); // specified in Annex G 
				}
				else if ( payloadType == 177 )
				{
					this.depth_representation_info =  new DepthRepresentationInfo( payloadSize ) ;
					size +=  stream.ReadClass<DepthRepresentationInfo>(size, context, this.depth_representation_info, "depth_representation_info"); // specified in Annex G 
				}
				else if ( payloadType == 178 )
				{
					this.multiview_scene_info =  new MultiviewSceneInfo( payloadSize ) ;
					size +=  stream.ReadClass<MultiviewSceneInfo>(size, context, this.multiview_scene_info, "multiview_scene_info"); // specified in Annex G 
				}
				else if ( payloadType == 179 )
				{
					this.multiview_acquisition_info =  new MultiviewAcquisitionInfo( payloadSize ) ;
					size +=  stream.ReadClass<MultiviewAcquisitionInfo>(size, context, this.multiview_acquisition_info, "multiview_acquisition_info"); // specified in Annex G 
				}
				else if ( payloadType == 180 )
				{
					this.multiview_view_position =  new MultiviewViewPosition( payloadSize ) ;
					size +=  stream.ReadClass<MultiviewViewPosition>(size, context, this.multiview_view_position, "multiview_view_position"); // specified in Annex G 
				}
				else if ( payloadType == 181 )
				{
			...
			else 
			{
				...
				else if ( payloadType == 132 )
				{
					...
					size +=  stream.ReadClass<DecodedPictureHash>(size, context, this.decoded_picture_hash, "decoded_picture_hash"); 
				}
				else if ( payloadType == 146 )
				{
					this.coded_region_completion =  new CodedRegionCompletion( payloadSize ) ;
			...
			if ( (!(stream.ByteAligned() && 8 * payloadSize == stream.GetBitsPositionSinceLastMark())) )
			{
				...
				{
					size += stream.ReadUnsignedIntVariable(size, 0 /* TODO */, out this.reserved_payload_extension_data, "reserved_payload_extension_data"); 
				}
				size += stream.ReadFixed(size, 1, out this.payload_bit_equal_to_one, "payload_bit_equal_to_one"); // equal to 1 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( ituContext.NalHeader.NalUnitHeader.NalUnitType == H265NALTypes.PREFIX_SEI_NUT )
			{
				...
				{
					size += stream.WriteClass<PictureSnapshot>(context, this.picture_snapshot, "picture_snapshot"); 
				}
				else if ( payloadType == 16 )
				{
				...
				{
					size += stream.WriteClass<StructureOfPicturesInfo>(context, this.structure_of_pictures_info, "structure_of_pictures_info"); 
				}
				else if ( payloadType == 129 )
				{
					size += stream.WriteClass<ActiveParameterSets>(context, this.active_parameter_sets, "active_parameter_sets"); 
				}
				else if ( payloadType == 130 )
				{
				...
				{
					size += stream.WriteClass<TemporalSubLayerZeroIdx>(context, this.temporal_sub_layer_zero_idx, "temporal_sub_layer_zero_idx"); 
				}
				else if ( payloadType == 133 )
				{
					size += stream.WriteClass<ScalableNesting>(context, this.scalable_nesting, "scalable_nesting"); 
				}
				else if ( payloadType == 134 )
				{
					size += stream.WriteClass<RegionRefreshInfo>(context, this.region_refresh_info, "region_refresh_info"); 
				}
				else if ( payloadType == 135 )
				{
					size += stream.WriteClass<NoDisplay>(context, this.no_display, "no_display"); 
				}
				else if ( payloadType == 136 )
				{
					size += stream.WriteClass<TimeCode>(context, this.time_code, "time_code"); 
				}
				else if ( payloadType == 137 )
				{
				...
				{
					size += stream.WriteClass<SegmentedRectFramePackingArrangement>(context, this.segmented_rect_frame_packing_arrangement, "segmented_rect_frame_packing_arrangement"); 
				}
				else if ( payloadType == 139 )
				{
					size += stream.WriteClass<TemporalMotionConstrainedTileSets>(context, this.temporal_motion_constrained_tile_sets, "temporal_motion_constrained_tile_sets"); 
				}
				else if ( payloadType == 140 )
				{
					size += stream.WriteClass<ChromaResamplingFilterHint>(context, this.chroma_resampling_filter_hint, "chroma_resampling_filter_hint"); 
				}
				else if ( payloadType == 141 )
				{
					size += stream.WriteClass<KneeFunctionInfo>(context, this.knee_function_info, "knee_function_info"); 
				}
				else if ( payloadType == 142 )
				{
				...
				{
					size += stream.WriteClass<DeinterlacedFieldIdentification>(context, this.deinterlaced_field_identification, "deinterlaced_field_identification"); 
				}
				else if ( payloadType == 144 )
				{
				...
				{
					size += stream.WriteClass<DependentRapIndication>(context, this.dependent_rap_indication, "dependent_rap_indication"); 
				}
				else if ( payloadType == 146 )
				{
					size += stream.WriteClass<CodedRegionCompletion>(context, this.coded_region_completion, "coded_region_completion"); 
				}
				else if ( payloadType == 147 )
				{
				...
				{
					size += stream.WriteClass<RegionalNesting>(context, this.regional_nesting, "regional_nesting"); 
				}
				else if ( payloadType == 158 )
				{
					size += stream.WriteClass<MctsExtractionInfoSets>(context, this.mcts_extraction_info_sets, "mcts_extraction_info_sets"); 
				}
				else if ( payloadType == 159 )
				{
					size += stream.WriteClass<MctsExtractionInfoNesting>(context, this.mcts_extraction_info_nesting, "mcts_extraction_info_nesting"); 
				}
				else if ( payloadType == 160 )
				{
					size += stream.WriteClass<LayersNotPresent>(context, this.layers_not_present, "layers_not_present"); // specified in Annex F 
				}
				else if ( payloadType == 161 )
				{
					size += stream.WriteClass<InterLayerConstrainedTileSets>(context, this.inter_layer_constrained_tile_sets, "inter_layer_constrained_tile_sets"); // specified in Annex F 
				}
				else if ( payloadType == 162 )
				{
					size += stream.WriteClass<BspNesting>(context, this.bsp_nesting, "bsp_nesting"); // specified in Annex F 
				}
				else if ( payloadType == 163 )
				{
					size += stream.WriteClass<BspInitialArrivalTime>(context, this.bsp_initial_arrival_time, "bsp_initial_arrival_time"); // specified in Annex F 
				}
				else if ( payloadType == 164 )
				{
					size += stream.WriteClass<SubBitstreamProperty>(context, this.sub_bitstream_property, "sub_bitstream_property"); // specified in Annex F 
				}
				else if ( payloadType == 165 )
				{
					size += stream.WriteClass<AlphaChannelInfo>(context, this.alpha_channel_info, "alpha_channel_info"); // specified in Annex F 
				}
				else if ( payloadType == 166 )
				{
					size += stream.WriteClass<OverlayInfo>(context, this.overlay_info, "overlay_info"); // specified in Annex F 
				}
				else if ( payloadType == 167 )
				{
					size += stream.WriteClass<TemporalMvPredictionConstraints>(context, this.temporal_mv_prediction_constraints, "temporal_mv_prediction_constraints"); // specified in Annex F 
				}
				else if ( payloadType == 168 )
				{
					size += stream.WriteClass<FrameFieldInfo>(context, this.frame_field_info, "frame_field_info"); // specified in Annex F 
				}
				else if ( payloadType == 176 )
				{
					size += stream.WriteClass<ThreeDimensionalReferenceDisplaysInfo>(context, this.three_dimensional_reference_displays_info, "three_dimensional_reference_displays_info"); // specified in Annex G 
				}
				else if ( payloadType == 177 )
				{
					size += stream.WriteClass<DepthRepresentationInfo>(context, this.depth_representation_info, "depth_representation_info"); // specified in Annex G 
				}
				else if ( payloadType == 178 )
				{
					size += stream.WriteClass<MultiviewSceneInfo>(context, this.multiview_scene_info, "multiview_scene_info"); // specified in Annex G 
				}
				else if ( payloadType == 179 )
				{
					size += stream.WriteClass<MultiviewAcquisitionInfo>(context, this.multiview_acquisition_info, "multiview_acquisition_info"); // specified in Annex G 
				}
				else if ( payloadType == 180 )
				{
					size += stream.WriteClass<MultiviewViewPosition>(context, this.multiview_view_position, "multiview_view_position"); // specified in Annex G 
				}
				else if ( payloadType == 181 )
				{
			...
			else 
			{
				...
				{
					size += stream.WriteClass<DecodedPictureHash>(context, this.decoded_picture_hash, "decoded_picture_hash"); 
				}
				else if ( payloadType == 146 )
				{
					size += stream.WriteClass<CodedRegionCompletion>(context, this.coded_region_completion, "coded_region_completion"); 
			...
			if ( (!(stream.ByteAligned() && 8 * payloadSize == stream.GetBitsPositionSinceLastMark())) )
			{
				...
				if ( stream.WriteMoreRbspData(this, payloadSize) )
				{
					size += stream.WriteUnsignedIntVariable(0 /* TODO */, this.reserved_payload_extension_data, "reserved_payload_extension_data"); 
				}
				size += stream.WriteFixed(1, this.payload_bit_equal_to_one, "payload_bit_equal_to_one"); // equal to 1 
  ...
  use_alt_cpb_params_flag u(1) 
    ...
    */
    public class BufferingPeriod : IItuSerializable
    {
		private uint payloadSize;
		public uint PayloadSize { get { return payloadSize; } set { payloadSize = value; } }
		private ulong bp_seq_parameter_set_id;
		public ulong BpSeqParameterSetId { get { return bp_seq_parameter_set_id; } set { bp_seq_parameter_set_id = value; } }
		...
		private ulong cpb_delay_offset;
		public ulong CpbDelayOffset { get { return cpb_delay_offset; } set { cpb_delay_offset = value; } }
		private ulong dpb_delay_offset;
		public ulong DpbDelayOffset { get { return dpb_delay_offset; } set { dpb_delay_offset = value; } }
		private byte concatenation_flag;
		public byte ConcatenationFlag { get { return concatenation_flag; } set { concatenation_flag = value; } }
		private ulong au_cpb_removal_delay_delta_minus1;
		public ulong AuCpbRemovalDelayDeltaMinus1 { get { return au_cpb_removal_delay_delta_minus1; } set { au_cpb_removal_delay_delta_minus1 = value; } }
		private ulong[] nal_initial_cpb_removal_delay;
		public ulong[] NalInitialCpbRemovalDelay { get { return nal_initial_cpb_removal_delay; } set { nal_initial_cpb_removal_delay = value; } }
		private ulong[] nal_initial_cpb_removal_offset;
		public ulong[] NalInitialCpbRemovalOffset { get { return nal_initial_cpb_removal_offset; } set { nal_initial_cpb_removal_offset = value; } }
		private ulong[] nal_initial_alt_cpb_removal_delay;
		public ulong[] NalInitialAltCpbRemovalDelay { get { return nal_initial_alt_cpb_removal_delay; } set { nal_initial_alt_cpb_removal_delay = value; } }
		private ulong[] nal_initial_alt_cpb_removal_offset;
		public ulong[] NalInitialAltCpbRemovalOffset { get { return nal_initial_alt_cpb_removal_offset; } set { nal_initial_alt_cpb_removal_offset = value; } }
		private ulong[] vcl_initial_cpb_removal_delay;
		public ulong[] VclInitialCpbRemovalDelay { get { return vcl_initial_cpb_removal_delay; } set { vcl_initial_cpb_removal_delay = value; } }
		private ulong[] vcl_initial_cpb_removal_offset;
		public ulong[] VclInitialCpbRemovalOffset { get { return vcl_initial_cpb_removal_offset; } set { vcl_initial_cpb_removal_offset = value; } }
		private ulong[] vcl_initial_alt_cpb_removal_delay;
		public ulong[] VclInitialAltCpbRemovalDelay { get { return vcl_initial_alt_cpb_removal_delay; } set { vcl_initial_alt_cpb_removal_delay = value; } }
		private ulong[] vcl_initial_alt_cpb_removal_offset;
		public ulong[] VclInitialAltCpbRemovalOffset { get { return vcl_initial_alt_cpb_removal_offset; } set { vcl_initial_alt_cpb_removal_offset = value; } }
		...
		public byte UseAltCpbParamsFlag { get { return use_alt_cpb_params_flag; } set { use_alt_cpb_params_flag = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			{
				size += stream.ReadUnsignedIntVariable(size, ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.AuCpbRemovalDelayLengthMinus1 + 1, out this.cpb_delay_offset, "cpb_delay_offset"); 
				size += stream.ReadUnsignedIntVariable(size, ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.DpbOutputDelayLengthMinus1 + 1, out this.dpb_delay_offset, "dpb_delay_offset"); 
			}
			size += stream.ReadUnsignedInt(size, 1, out this.concatenation_flag, "concatenation_flag"); 
			size += stream.ReadUnsignedIntVariable(size, ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.AuCpbRemovalDelayLengthMinus1 + 1, out this.au_cpb_removal_delay_delta_minus1, "au_cpb_removal_delay_delta_minus1"); 
			...
			if ( ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.NalHrdParametersPresentFlag != 0 )
			{
				...
				{
					size += stream.ReadUnsignedIntVariable(size, (ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), out this.nal_initial_cpb_removal_delay[ i ], "nal_initial_cpb_removal_delay"); 
					size += stream.ReadUnsignedIntVariable(size, (ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), out this.nal_initial_cpb_removal_offset[ i ], "nal_initial_cpb_removal_offset"); 
					...
					{
						size += stream.ReadUnsignedIntVariable(size, (ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), out this.nal_initial_alt_cpb_removal_delay[ i ], "nal_initial_alt_cpb_removal_delay"); 
						size += stream.ReadUnsignedIntVariable(size, (ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), out this.nal_initial_alt_cpb_removal_offset[ i ], "nal_initial_alt_cpb_removal_offset"); 
					}
				}
			}
			...
			if ( ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.VclHrdParametersPresentFlag != 0 )
			{
				...
				for ( i = 0; i < ituContext.CpbCnt; i++ )
				{
					size += stream.ReadUnsignedIntVariable(size, (ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), out this.vcl_initial_cpb_removal_delay[ i ], "vcl_initial_cpb_removal_delay"); 
					size += stream.ReadUnsignedIntVariable(size, (ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), out this.vcl_initial_cpb_removal_offset[ i ], "vcl_initial_cpb_removal_offset"); 

					if ( ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.SubPicHrdParamsPresentFlag != 0  ||  irap_cpb_params_present_flag != 0 )
					{
						size += stream.ReadUnsignedIntVariable(size, (ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), out this.vcl_initial_alt_cpb_removal_delay[ i ], "vcl_initial_alt_cpb_removal_delay"); 
						size += stream.ReadUnsignedIntVariable(size, (ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), out this.vcl_initial_alt_cpb_removal_offset[ i ], "vcl_initial_alt_cpb_removal_offset"); 
					}
				}
			}
			...
			if ( stream.ReadMoreRbspData(this, payloadSize) )
			{
				size += stream.ReadUnsignedInt(size, 1, out this.use_alt_cpb_params_flag, "use_alt_cpb_params_flag"); 
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( irap_cpb_params_present_flag != 0 )
			{
				size += stream.WriteUnsignedIntVariable(ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.AuCpbRemovalDelayLengthMinus1 + 1, this.cpb_delay_offset, "cpb_delay_offset"); 
				size += stream.WriteUnsignedIntVariable(ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.DpbOutputDelayLengthMinus1 + 1, this.dpb_delay_offset, "dpb_delay_offset"); 
			}
			size += stream.WriteUnsignedInt(1, this.concatenation_flag, "concatenation_flag"); 
			size += stream.WriteUnsignedIntVariable(ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.AuCpbRemovalDelayLengthMinus1 + 1, this.au_cpb_removal_delay_delta_minus1, "au_cpb_removal_delay_delta_minus1"); 
			...
			if ( ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.NalHrdParametersPresentFlag != 0 )
			{
				...
				for ( i = 0; i < ituContext.CpbCnt; i++ )
				{
					size += stream.WriteUnsignedIntVariable((ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), this.nal_initial_cpb_removal_delay[ i ], "nal_initial_cpb_removal_delay"); 
					size += stream.WriteUnsignedIntVariable((ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), this.nal_initial_cpb_removal_offset[ i ], "nal_initial_cpb_removal_offset"); 

					if ( ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.SubPicHrdParamsPresentFlag != 0  ||  irap_cpb_params_present_flag != 0 )
					{
						size += stream.WriteUnsignedIntVariable((ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), this.nal_initial_alt_cpb_removal_delay[ i ], "nal_initial_alt_cpb_removal_delay"); 
						size += stream.WriteUnsignedIntVariable((ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), this.nal_initial_alt_cpb_removal_offset[ i ], "nal_initial_alt_cpb_removal_offset"); 
					}
				}
			}
			...
			if ( ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.VclHrdParametersPresentFlag != 0 )
			{
				...
				for ( i = 0; i < ituContext.CpbCnt; i++ )
				{
					size += stream.WriteUnsignedIntVariable((ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), this.vcl_initial_cpb_removal_delay[ i ], "vcl_initial_cpb_removal_delay"); 
					size += stream.WriteUnsignedIntVariable((ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), this.vcl_initial_cpb_removal_offset[ i ], "vcl_initial_cpb_removal_offset"); 

					if ( ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.SubPicHrdParamsPresentFlag != 0  ||  irap_cpb_params_present_flag != 0 )
					{
						size += stream.WriteUnsignedIntVariable((ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), this.vcl_initial_alt_cpb_removal_delay[ i ], "vcl_initial_alt_cpb_removal_delay"); 
						size += stream.WriteUnsignedIntVariable((ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), this.vcl_initial_alt_cpb_removal_offset[ i ], "vcl_initial_alt_cpb_removal_offset"); 
					}
				}
			}
			...
			if ( stream.WriteMoreRbspData(this, payloadSize) )
			{
				size += stream.WriteUnsignedInt(1, this.use_alt_cpb_params_flag, "use_alt_cpb_params_flag"); 
			}
  ...
  if( sub_pic_hrd_params_present_flag  && 
    ...
    */
    public class PicTiming : IItuSerializable
    {
		...
		private ulong au_cpb_removal_delay_minus1;
		public ulong AuCpbRemovalDelayMinus1 { get { return au_cpb_removal_delay_minus1; } set { au_cpb_removal_delay_minus1 = value; } }
		private ulong pic_dpb_output_delay;
		public ulong PicDpbOutputDelay { get { return pic_dpb_output_delay; } set { pic_dpb_output_delay = value; } }
		private ulong pic_dpb_output_du_delay;
		public ulong PicDpbOutputDuDelay { get { return pic_dpb_output_du_delay; } set { pic_dpb_output_du_delay = value; } }
		private ulong num_decoding_units_minus1;
		public ulong NumDecodingUnitsMinus1 { get { return num_decoding_units_minus1; } set { num_decoding_units_minus1 = value; } }
		...
		private ulong du_common_cpb_removal_delay_increment_minus1;
		public ulong DuCommonCpbRemovalDelayIncrementMinus1 { get { return du_common_cpb_removal_delay_increment_minus1; } set { du_common_cpb_removal_delay_increment_minus1 = value; } }
		private ulong[] num_nalus_in_du_minus1;
		public ulong[] NumNalusInDuMinus1 { get { return num_nalus_in_du_minus1; } set { num_nalus_in_du_minus1 = value; } }
		private ulong[] du_cpb_removal_delay_increment_minus1;
		public ulong[] DuCpbRemovalDelayIncrementMinus1 { get { return du_cpb_removal_delay_increment_minus1; } set { du_cpb_removal_delay_increment_minus1 = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			{
				size += stream.ReadUnsignedIntVariable(size, (ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.AuCpbRemovalDelayLengthMinus1 + 1), out this.au_cpb_removal_delay_minus1, "au_cpb_removal_delay_minus1"); 
				size += stream.ReadUnsignedIntVariable(size, ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.DpbOutputDelayLengthMinus1 + 1, out this.pic_dpb_output_delay, "pic_dpb_output_delay"); 

				if ( ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.SubPicHrdParamsPresentFlag != 0 )
				{
					size += stream.ReadUnsignedIntVariable(size, ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.DpbOutputDelayDuLengthMinus1 + 1, out this.pic_dpb_output_du_delay, "pic_dpb_output_du_delay"); 
				}
    ...
    ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.SubPicCpbParamsInPicTimingSeiFlag != 0 )
				{
					...
					{
						size += stream.ReadUnsignedIntVariable(size, ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.DuCpbRemovalDelayIncrementLengthMinus1 + 1, out this.du_common_cpb_removal_delay_increment_minus1, "du_common_cpb_removal_delay_increment_minus1"); 
					}
					...
					for ( i = 0; i <= num_decoding_units_minus1; i++ )
					{
						size += stream.ReadUnsignedIntGolomb(size, out this.num_nalus_in_du_minus1[ i ], "num_nalus_in_du_minus1"); 

						if ( du_common_cpb_removal_delay_flag== 0  &&  i < num_decoding_units_minus1 )
						{
							size += stream.ReadUnsignedIntVariable(size, (ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.DuCpbRemovalDelayIncrementLengthMinus1 + 1), out this.du_cpb_removal_delay_increment_minus1[ i ], "du_cpb_removal_delay_increment_minus1"); 
						}
					}
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( (ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.NalHrdParametersPresentFlag == 1 || ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.VclHrdParametersPresentFlag == 1 ? 1 : 0) != 0 )
			{
				size += stream.WriteUnsignedIntVariable((ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.AuCpbRemovalDelayLengthMinus1 + 1), this.au_cpb_removal_delay_minus1, "au_cpb_removal_delay_minus1"); 
				size += stream.WriteUnsignedIntVariable(ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.DpbOutputDelayLengthMinus1 + 1, this.pic_dpb_output_delay, "pic_dpb_output_delay"); 

				if ( ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.SubPicHrdParamsPresentFlag != 0 )
				{
					size += stream.WriteUnsignedIntVariable(ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.DpbOutputDelayDuLengthMinus1 + 1, this.pic_dpb_output_du_delay, "pic_dpb_output_du_delay"); 
				}
    ...
    ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.SubPicCpbParamsInPicTimingSeiFlag != 0 )
				{
					...
					if ( du_common_cpb_removal_delay_flag != 0 )
					{
						size += stream.WriteUnsignedIntVariable(ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.DuCpbRemovalDelayIncrementLengthMinus1 + 1, this.du_common_cpb_removal_delay_increment_minus1, "du_common_cpb_removal_delay_increment_minus1"); 
					}

					for ( i = 0; i <= num_decoding_units_minus1; i++ )
					{
						size += stream.WriteUnsignedIntGolomb( this.num_nalus_in_du_minus1[ i ], "num_nalus_in_du_minus1"); 

						if ( du_common_cpb_removal_delay_flag== 0  &&  i < num_decoding_units_minus1 )
						{
							size += stream.WriteUnsignedIntVariable((ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.DuCpbRemovalDelayIncrementLengthMinus1 + 1), this.du_cpb_removal_delay_increment_minus1[ i ], "du_cpb_removal_delay_increment_minus1"); 
						}
					}
				}
			}
		...
		public byte PanScanRectPersistenceFlag { get { return pan_scan_rect_persistence_flag; } set { pan_scan_rect_persistence_flag = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			if ( pan_scan_rect_cancel_flag== 0 )
			{
				...
				size += stream.ReadUnsignedInt(size, 1, out this.pan_scan_rect_persistence_flag, "pan_scan_rect_persistence_flag"); 
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( pan_scan_rect_cancel_flag== 0 )
			{
				...
				size += stream.WriteUnsignedInt(1, this.pan_scan_rect_persistence_flag, "pan_scan_rect_persistence_flag"); 
			}
 ...
 broken_link_flag u(1) 
    ...
    */
    public class RecoveryPoint : IItuSerializable
    {
		private uint payloadSize;
		public uint PayloadSize { get { return payloadSize; } set { payloadSize = value; } }
		private long recovery_poc_cnt;
		public long RecoveryPocCnt { get { return recovery_poc_cnt; } set { recovery_poc_cnt = value; } }
    ...
    public class SceneInfo : IItuSerializable
    {
		...
		public ulong SecondSceneId { get { return second_scene_id; } set { second_scene_id = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			{
				size += stream.ReadUnsignedInt(size, 1, out this.prev_scene_id_valid_flag, "prev_scene_id_valid_flag"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( scene_info_present_flag != 0 )
			{
				size += stream.WriteUnsignedInt(1, this.prev_scene_id_valid_flag, "prev_scene_id_valid_flag"); 
  ...
  pic_order_cnt_delta ue(v) 
    ...
    */
    public class ProgressiveRefinementSegmentStart : IItuSerializable
    {
		...
		private ulong pic_order_cnt_delta;
		public ulong PicOrderCntDelta { get { return pic_order_cnt_delta; } set { pic_order_cnt_delta = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			size += stream.ReadUnsignedIntGolomb(size, out this.pic_order_cnt_delta, "pic_order_cnt_delta"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			size += stream.WriteUnsignedIntGolomb( this.pic_order_cnt_delta, "pic_order_cnt_delta"); 
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			if ( film_grain_characteristics_cancel_flag== 0 )
			{
				...
				if ( separate_colour_description_present_flag != 0 )
				{
					...
					size += stream.ReadUnsignedInt(size, 8, out this.film_grain_matrix_coeffs, "film_grain_matrix_coeffs"); 
				}
				...
				size += stream.ReadUnsignedInt(size, 1, out this.film_grain_characteristics_persistence_flag, "film_grain_characteristics_persistence_flag"); 
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( film_grain_characteristics_cancel_flag== 0 )
			{
				...
				if ( separate_colour_description_present_flag != 0 )
				{
					...
					size += stream.WriteUnsignedInt(8, this.film_grain_matrix_coeffs, "film_grain_matrix_coeffs"); 
				}
				...
				size += stream.WriteUnsignedInt(1, this.film_grain_characteristics_persistence_flag, "film_grain_characteristics_persistence_flag"); 
			}
  ...
  for( cy = 0; cy < filter_hint_size_y; cy++ )  
    ...
    */
    public class PostFilterHint : IItuSerializable
    {
		...
		private long[][][] filter_hint_value;
		public long[][][] FilterHintValue { get { return filter_hint_value; } set { filter_hint_value = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			for ( cIdx = 0; cIdx < ( ituContext.SeqParameterSetRbsp.ChromaFormatIdc == 0 ? 1 : 3 ); cIdx++ )
			{
				...
				for ( cy = 0; cy < filter_hint_size_y; cy++ )
				{
					...
					for ( cx = 0; cx < filter_hint_size_x; cx++ )
					{
						size += stream.ReadSignedIntGolomb(size, out this.filter_hint_value[ cIdx ][ cy ][ cx ], "filter_hint_value"); 
					}
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			for ( cIdx = 0; cIdx < ( ituContext.SeqParameterSetRbsp.ChromaFormatIdc == 0 ? 1 : 3 ); cIdx++ )
			{
				...
				for ( cy = 0; cy < filter_hint_size_y; cy++ )
				{
					...
					for ( cx = 0; cx < filter_hint_size_x; cx++ )
					{
						size += stream.WriteSignedIntGolomb( this.filter_hint_value[ cIdx ][ cy ][ cx ], "filter_hint_value"); 
					}
				}
			}
    ...
    public class ToneMappingInfo : IItuSerializable
    {
		...
		public uint ExtendedWhiteLevelCodeValue { get { return extended_white_level_code_value; } set { extended_white_level_code_value = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			{
				size += stream.ReadUnsignedInt(size, 1, out this.tone_map_persistence_flag, "tone_map_persistence_flag"); 
				...
				else if ( tone_map_model_id == 2 )
				{
					...
					{
						size += stream.ReadUnsignedIntVariable(size, ( ( coded_data_bit_depth + 7 )  >>  3 )  <<  3, out this.start_of_coded_interval[ i ], "start_of_coded_interval"); 
					}
				}
				else if ( tone_map_model_id == 3 )
				{
					...
					for ( i = 0; i < num_pivots; i++ )
					{
						size += stream.ReadUnsignedIntVariable(size, ( ( coded_data_bit_depth + 7 )  >>  3 )  <<  3, out this.coded_pivot_value[ i ], "coded_pivot_value"); 
						size += stream.ReadUnsignedIntVariable(size, ( ( target_bit_depth + 7 )  >>  3 )  <<  3, out this.target_pivot_value[ i ], "target_pivot_value"); 
					}
				}
				else if ( tone_map_model_id == 4 )
				{
					...
					size += stream.ReadUnsignedInt(size, 8, out this.exposure_idx_idc, "exposure_idx_idc"); 

					if ( exposure_idx_idc == H265Constants.EXTENDED_ISO )
					{
						size += stream.ReadUnsignedInt(size, 32, out this.exposure_idx_value, "exposure_idx_value"); 
					}
					...
					size += stream.ReadUnsignedInt(size, 16, out this.nominal_black_level_code_value, "nominal_black_level_code_value"); 
					size += stream.ReadUnsignedInt(size, 16, out this.nominal_white_level_code_value, "nominal_white_level_code_value"); 
					size += stream.ReadUnsignedInt(size, 16, out this.extended_white_level_code_value, "extended_white_level_code_value"); 
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( tone_map_cancel_flag== 0 )
			{
				size += stream.WriteUnsignedInt(1, this.tone_map_persistence_flag, "tone_map_persistence_flag"); 
				...
				else if ( tone_map_model_id == 2 )
				{
					...
					for ( i = 0; i < ( 1  << (int)  target_bit_depth ); i++ )
					{
						size += stream.WriteUnsignedIntVariable(( ( coded_data_bit_depth + 7 )  >>  3 )  <<  3, this.start_of_coded_interval[ i ], "start_of_coded_interval"); 
					}
				}
				else if ( tone_map_model_id == 3 )
				{
					...
					for ( i = 0; i < num_pivots; i++ )
					{
						size += stream.WriteUnsignedIntVariable(( ( coded_data_bit_depth + 7 )  >>  3 )  <<  3, this.coded_pivot_value[ i ], "coded_pivot_value"); 
						size += stream.WriteUnsignedIntVariable(( ( target_bit_depth + 7 )  >>  3 )  <<  3, this.target_pivot_value[ i ], "target_pivot_value"); 
					}
				}
				else if ( tone_map_model_id == 4 )
				{
					...
					size += stream.WriteUnsignedInt(8, this.exposure_idx_idc, "exposure_idx_idc"); 

					if ( exposure_idx_idc == H265Constants.EXTENDED_ISO )
					{
						size += stream.WriteUnsignedInt(32, this.exposure_idx_value, "exposure_idx_value"); 
					}
					...
					size += stream.WriteUnsignedInt(16, this.nominal_black_level_code_value, "nominal_black_level_code_value"); 
					size += stream.WriteUnsignedInt(16, this.nominal_white_level_code_value, "nominal_white_level_code_value"); 
					size += stream.WriteUnsignedInt(16, this.extended_white_level_code_value, "extended_white_level_code_value"); 
				}
			}
		...
		public byte UpsampledAspectRatioFlag { get { return upsampled_aspect_ratio_flag; } set { upsampled_aspect_ratio_flag = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			if ( frame_packing_arrangement_cancel_flag== 0 )
			{
				...
				size += stream.ReadUnsignedInt(size, 1, out this.frame_packing_arrangement_persistence_flag, "frame_packing_arrangement_persistence_flag"); 
			}
			size += stream.ReadUnsignedInt(size, 1, out this.upsampled_aspect_ratio_flag, "upsampled_aspect_ratio_flag"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( frame_packing_arrangement_cancel_flag== 0 )
			{
				...
				size += stream.WriteUnsignedInt(1, this.frame_packing_arrangement_persistence_flag, "frame_packing_arrangement_persistence_flag"); 
			}
			size += stream.WriteUnsignedInt(1, this.upsampled_aspect_ratio_flag, "upsampled_aspect_ratio_flag"); 
		...
		public byte DisplayOrientationPersistenceFlag { get { return display_orientation_persistence_flag; } set { display_orientation_persistence_flag = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			if ( display_orientation_cancel_flag== 0 )
			{
				...
				size += stream.ReadUnsignedInt(size, 1, out this.display_orientation_persistence_flag, "display_orientation_persistence_flag"); 
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( display_orientation_cancel_flag== 0 )
			{
				...
				size += stream.WriteUnsignedInt(1, this.display_orientation_persistence_flag, "display_orientation_persistence_flag"); 
			}
  ...
  if( i > 0 )  
    ...
    */
    public class StructureOfPicturesInfo : IItuSerializable
    {
		private uint payloadSize;
		public uint PayloadSize { get { return payloadSize; } set { payloadSize = value; } }
		private ulong sop_seq_parameter_set_id;
		public ulong SopSeqParameterSetId { get { return sop_seq_parameter_set_id; } set { sop_seq_parameter_set_id = value; } }
		private ulong num_entries_in_sop_minus1;
		public ulong NumEntriesInSopMinus1 { get { return num_entries_in_sop_minus1; } set { num_entries_in_sop_minus1 = value; } }
		...
		private ulong[] sop_short_term_rps_idx;
		public ulong[] SopShortTermRpsIdx { get { return sop_short_term_rps_idx; } set { sop_short_term_rps_idx = value; } }
		private long[] sop_poc_delta;
		public long[] SopPocDelta { get { return sop_poc_delta; } set { sop_poc_delta = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			for ( i = 0; i <= num_entries_in_sop_minus1; i++ )
			{
				size += stream.ReadUnsignedInt(size, 6, out this.sop_vcl_nut[ i ], "sop_vcl_nut"); 
				size += stream.ReadUnsignedInt(size, 3, out this.sop_temporal_id[ i ], "sop_temporal_id"); 

				if ( sop_vcl_nut[i] != H265NALTypes.IDR_W_RADL  &&  sop_vcl_nut[i] != H265NALTypes.IDR_N_LP )
				{
					size += stream.ReadUnsignedIntGolomb(size, out this.sop_short_term_rps_idx[ i ], "sop_short_term_rps_idx"); 
				}

				if ( i > 0 )
				{
					size += stream.ReadSignedIntGolomb(size, out this.sop_poc_delta[ i ], "sop_poc_delta"); 
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			size += stream.WriteUnsignedIntGolomb( this.sop_seq_parameter_set_id, "sop_seq_parameter_set_id"); 
			size += stream.WriteUnsignedIntGolomb( this.num_entries_in_sop_minus1, "num_entries_in_sop_minus1"); 

			for ( i = 0; i <= num_entries_in_sop_minus1; i++ )
			{
				size += stream.WriteUnsignedInt(6, this.sop_vcl_nut[ i ], "sop_vcl_nut"); 
				size += stream.WriteUnsignedInt(3, this.sop_temporal_id[ i ], "sop_temporal_id"); 

				if ( sop_vcl_nut[i] != H265NALTypes.IDR_W_RADL  &&  sop_vcl_nut[i] != H265NALTypes.IDR_N_LP )
				{
					size += stream.WriteUnsignedIntGolomb( this.sop_short_term_rps_idx[ i ], "sop_short_term_rps_idx"); 
				}

				if ( i > 0 )
				{
					size += stream.WriteSignedIntGolomb( this.sop_poc_delta[ i ], "sop_poc_delta"); 
				}
			}
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			for ( cIdx = 0; cIdx < ( ituContext.SeqParameterSetRbsp.ChromaFormatIdc == 0 ? 1 : 3 ); cIdx++ )
			{
				...
				if ( hash_type == 0 )
				{
					...
					for ( i = 0; i < 16; i++)
					{
						size += stream.ReadBits(size, 8, out this.picture_md5[ cIdx ][ i ], "picture_md5"); 
					}
				}
				else if ( hash_type == 1 )
				{
					size += stream.ReadUnsignedInt(size, 16, out this.picture_crc[ cIdx ], "picture_crc"); 
				}
				else if ( hash_type == 2 )
				{
					size += stream.ReadUnsignedInt(size, 32, out this.picture_checksum[ cIdx ], "picture_checksum"); 
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			for ( cIdx = 0; cIdx < ( ituContext.SeqParameterSetRbsp.ChromaFormatIdc == 0 ? 1 : 3 ); cIdx++ )
			{
				...
				if ( hash_type == 0 )
				{
					...
					for ( i = 0; i < 16; i++)
					{
						size += stream.WriteBits(8, this.picture_md5[ cIdx ][ i ], "picture_md5"); 
					}
				}
				else if ( hash_type == 1 )
				{
					size += stream.WriteUnsignedInt(16, this.picture_crc[ cIdx ], "picture_crc"); 
				}
				else if ( hash_type == 2 )
				{
					size += stream.WriteUnsignedInt(32, this.picture_checksum[ cIdx ], "picture_checksum"); 
				}
			}
  ...
  layer_sps_idx[ i ] ue(v) 
    ...
    */
    public class ActiveParameterSets : IItuSerializable
    {
		...
		private ulong num_sps_ids_minus1;
		public ulong NumSpsIdsMinus1 { get { return num_sps_ids_minus1; } set { num_sps_ids_minus1 = value; } }
		private ulong[] active_seq_parameter_set_id;
		public ulong[] ActiveSeqParameterSetId { get { return active_seq_parameter_set_id; } set { active_seq_parameter_set_id = value; } }
		private ulong[] layer_sps_idx;
		public ulong[] LayerSpsIdx { get { return layer_sps_idx; } set { layer_sps_idx = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			size += stream.ReadUnsignedInt(size, 4, out this.active_video_parameter_set_id, "active_video_parameter_set_id"); 
			size += stream.ReadUnsignedInt(size, 1, out this.self_contained_cvs_flag, "self_contained_cvs_flag"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			size += stream.WriteUnsignedInt(4, this.active_video_parameter_set_id, "active_video_parameter_set_id"); 
			size += stream.WriteUnsignedInt(1, this.self_contained_cvs_flag, "self_contained_cvs_flag"); 
			size += stream.WriteUnsignedInt(1, this.no_parameter_set_update_flag, "no_parameter_set_update_flag"); 
			size += stream.WriteUnsignedIntGolomb( this.num_sps_ids_minus1, "num_sps_ids_minus1"); 
  ...
  pic_spt_dpb_output_du_delay u(v) 
    ...
    */
    public class DecodingUnitInfo : IItuSerializable
    {
		private uint payloadSize;
		public uint PayloadSize { get { return payloadSize; } set { payloadSize = value; } }
		private ulong decoding_unit_idx;
		public ulong DecodingUnitIdx { get { return decoding_unit_idx; } set { decoding_unit_idx = value; } }
		private ulong du_spt_cpb_removal_delay_increment;
		public ulong DuSptCpbRemovalDelayIncrement { get { return du_spt_cpb_removal_delay_increment; } set { du_spt_cpb_removal_delay_increment = value; } }
		...
		private ulong pic_spt_dpb_output_du_delay;
		public ulong PicSptDpbOutputDuDelay { get { return pic_spt_dpb_output_du_delay; } set { pic_spt_dpb_output_du_delay = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			{
				size += stream.ReadUnsignedIntVariable(size, ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.DuCpbRemovalDelayIncrementLengthMinus1 + 1, out this.du_spt_cpb_removal_delay_increment, "du_spt_cpb_removal_delay_increment"); 
			}
			size += stream.ReadUnsignedInt(size, 1, out this.dpb_output_du_delay_present_flag, "dpb_output_du_delay_present_flag"); 

			if ( dpb_output_du_delay_present_flag != 0 )
			{
				size += stream.ReadUnsignedIntVariable(size, ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.DpbOutputDelayDuLengthMinus1 + 1, out this.pic_spt_dpb_output_du_delay, "pic_spt_dpb_output_du_delay"); 
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.SubPicCpbParamsInPicTimingSeiFlag== 0 )
			{
				size += stream.WriteUnsignedIntVariable(ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.DuCpbRemovalDelayIncrementLengthMinus1 + 1, this.du_spt_cpb_removal_delay_increment, "du_spt_cpb_removal_delay_increment"); 
			}
			size += stream.WriteUnsignedInt(1, this.dpb_output_du_delay_present_flag, "dpb_output_du_delay_present_flag"); 

			if ( dpb_output_du_delay_present_flag != 0 )
			{
				size += stream.WriteUnsignedIntVariable(ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.DpbOutputDelayDuLengthMinus1 + 1, this.pic_spt_dpb_output_du_delay, "pic_spt_dpb_output_du_delay"); 
			}
    ...
    public class TemporalSubLayerZeroIdx : IItuSerializable
    {
		...
		public uint IrapPicId { get { return irap_pic_id; } set { irap_pic_id = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			size += stream.ReadUnsignedInt(size, 8, out this.irap_pic_id, "irap_pic_id"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			size += stream.WriteUnsignedInt(8, this.irap_pic_id, "irap_pic_id"); 
 ...
 while( more_rbsp_data() )  
    ...
    */
    public class ScalableNesting : IItuSerializable
    {
		...
		private ulong nesting_num_ops_minus1;
		public ulong NestingNumOpsMinus1 { get { return nesting_num_ops_minus1; } set { nesting_num_ops_minus1 = value; } }
		...
		private ulong[] nesting_op_idx;
		public ulong[] NestingOpIdx { get { return nesting_op_idx; } set { nesting_op_idx = value; } }
		...
		private ulong nesting_num_layers_minus1;
		...
		public Dictionary<int, SeiMessage> SeiMessage { get { return sei_message; } set { sei_message = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			int whileIndex = -1;
			size += stream.ReadUnsignedInt(size, 1, out this.bitstream_subset_flag, "bitstream_subset_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.nesting_op_flag, "nesting_op_flag"); 
			...
			{
				size += stream.ReadUnsignedInt(size, 1, out this.all_layers_flag, "all_layers_flag"); 
				...
				if ( all_layers_flag== 0 )
				{
					...
					for ( i = 0; i <= nesting_num_layers_minus1; i++ )
					{
						size += stream.ReadUnsignedInt(size, 6, out this.nesting_layer_id[ i ], "nesting_layer_id"); 
					}
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			int whileIndex = -1;
			size += stream.WriteUnsignedInt(1, this.bitstream_subset_flag, "bitstream_subset_flag"); 
			size += stream.WriteUnsignedInt(1, this.nesting_op_flag, "nesting_op_flag"); 

			if ( nesting_op_flag != 0 )
			{
				size += stream.WriteUnsignedInt(1, this.default_op_flag, "default_op_flag"); 
				size += stream.WriteUnsignedIntGolomb( this.nesting_num_ops_minus1, "nesting_num_ops_minus1"); 
			...
			{
				size += stream.WriteUnsignedInt(1, this.all_layers_flag, "all_layers_flag"); 

				if ( all_layers_flag== 0 )
				{
					size += stream.WriteUnsignedInt(3, this.nesting_no_op_max_temporal_id_plus1, "nesting_no_op_max_temporal_id_plus1"); 
					size += stream.WriteUnsignedIntGolomb( this.nesting_num_layers_minus1, "nesting_num_layers_minus1"); 

					for ( i = 0; i <= nesting_num_layers_minus1; i++ )
					{
						size += stream.WriteUnsignedInt(6, this.nesting_layer_id[ i ], "nesting_layer_id"); 
					}
				}
			}
		...
		public int[] TimeOffsetValue { get { return time_offset_value; } set { time_offset_value = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			for ( i = 0; i < num_clock_ts; i++ )
			{
				...
				{
					size += stream.ReadUnsignedInt(size, 1, out this.units_field_based_flag[ i ], "units_field_based_flag"); 
					...
					size += stream.ReadUnsignedInt(size, 9, out this.n_frames[ i ], "n_frames"); 

					if ( full_timestamp_flag[ i ] != 0 )
					{
						size += stream.ReadUnsignedInt(size, 6, out this.seconds_value[ i ], "seconds_value"); 
/*  0..59  */

						size += stream.ReadUnsignedInt(size, 6, out this.minutes_value[ i ], "minutes_value"); 
/*  0..59  */

						size += stream.ReadUnsignedInt(size, 5, out this.hours_value[ i ], "hours_value"); 
/*  0..23  */
...
/*  0..23  */
					...
					size += stream.ReadUnsignedInt(size, 5, out this.time_offset_length[ i ], "time_offset_length"); 

					if ( time_offset_length[ i ] > 0 )
					{
						size += stream.ReadSignedIntVariable(size, time_offset_length[i], out this.time_offset_value[ i ], "time_offset_value"); 
					}
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			size += stream.WriteUnsignedInt(2, this.num_clock_ts, "num_clock_ts"); 
			...
			for ( i = 0; i < num_clock_ts; i++ )
			{
				...
				if ( clock_timestamp_flag[ i ] != 0 )
				{
					size += stream.WriteUnsignedInt(1, this.units_field_based_flag[ i ], "units_field_based_flag"); 
					...
					size += stream.WriteUnsignedInt(9, this.n_frames[ i ], "n_frames"); 

					if ( full_timestamp_flag[ i ] != 0 )
					{
						size += stream.WriteUnsignedInt(6, this.seconds_value[ i ], "seconds_value"); 
/*  0..59  */

						size += stream.WriteUnsignedInt(6, this.minutes_value[ i ], "minutes_value"); 
/*  0..59  */

						size += stream.WriteUnsignedInt(5, this.hours_value[ i ], "hours_value"); 
/*  0..23  */
...
/*  0..23  */
					...
					size += stream.WriteUnsignedInt(5, this.time_offset_length[ i ], "time_offset_length"); 

					if ( time_offset_length[ i ] > 0 )
					{
						size += stream.WriteSignedIntVariable(time_offset_length[i], this.time_offset_value[ i ], "time_offset_value"); 
					}
				}
			}
    ...
    public class SegmentedRectFramePackingArrangement : IItuSerializable
    {
		...
		public byte SegmentedRectFramePackingArrangementPersistenceFlag { get { return segmented_rect_frame_packing_arrangement_persistence_flag; } set { segmented_rect_frame_packing_arrangement_persistence_flag = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			{
				size += stream.ReadUnsignedInt(size, 2, out this.segmented_rect_content_interpretation_type, "segmented_rect_content_interpretation_type"); 
				size += stream.ReadUnsignedInt(size, 1, out this.segmented_rect_frame_packing_arrangement_persistence_flag, "segmented_rect_frame_packing_arrangement_persistence_flag"); 
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( segmented_rect_frame_packing_arrangement_cancel_flag== 0 )
			{
				size += stream.WriteUnsignedInt(2, this.segmented_rect_content_interpretation_type, "segmented_rect_content_interpretation_type"); 
				size += stream.WriteUnsignedInt(1, this.segmented_rect_frame_packing_arrangement_persistence_flag, "segmented_rect_frame_packing_arrangement_persistence_flag"); 
			}
  ...
  max_mcs_tier_level_idc_present_flag u(1) 
    ...
    */
    public class TemporalMotionConstrainedTileSets : IItuSerializable
    {
		...
		private ulong num_sets_in_message_minus1;
		public ulong NumSetsInMessageMinus1 { get { return num_sets_in_message_minus1; } set { num_sets_in_message_minus1 = value; } }
		private ulong[] mcts_id;
		public ulong[] MctsId { get { return mcts_id; } set { mcts_id = value; } }
		...
		private ulong[] num_tile_rects_in_set_minus1;
		public ulong[] NumTileRectsInSetMinus1 { get { return num_tile_rects_in_set_minus1; } set { num_tile_rects_in_set_minus1 = value; } }
		private ulong[][] top_left_tile_idx;
		public ulong[][] TopLeftTileIdx { get { return top_left_tile_idx; } set { top_left_tile_idx = value; } }
		private ulong[][] bottom_right_tile_idx;
		public ulong[][] BottomRightTileIdx { get { return bottom_right_tile_idx; } set { bottom_right_tile_idx = value; } }
		...
		public uint MctsMaxLevelIdc { get { return mcts_max_level_idc; } set { mcts_max_level_idc = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			uint j = 0;
			size += stream.ReadUnsignedInt(size, 1, out this.mc_all_tiles_exact_sample_value_match_flag, "mc_all_tiles_exact_sample_value_match_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.each_tile_one_tile_set_flag, "each_tile_one_tile_set_flag"); 
			...
			if ( each_tile_one_tile_set_flag== 0 )
			{
				...
				for ( i = 0; i <= num_sets_in_message_minus1; i++ )
				{
					size += stream.ReadUnsignedIntGolomb(size, out this.mcts_id[ i ], "mcts_id"); 

					if ( limited_tile_set_display_flag != 0 )
					{
						size += stream.ReadUnsignedInt(size, 1, out this.display_tile_set_flag[ i ], "display_tile_set_flag"); 
					}
					size += stream.ReadUnsignedIntGolomb(size, out this.num_tile_rects_in_set_minus1[ i ], "num_tile_rects_in_set_minus1"); 

					this.top_left_tile_idx[ i ] = new ulong[ num_tile_rects_in_set_minus1[ i ] + 1];
					this.bottom_right_tile_idx[ i ] = new ulong[ num_tile_rects_in_set_minus1[ i ] + 1];
					for ( j = 0; j <= num_tile_rects_in_set_minus1[ i ]; j++ )
					{
						size += stream.ReadUnsignedIntGolomb(size, out this.top_left_tile_idx[ i ][ j ], "top_left_tile_idx"); 
						size += stream.ReadUnsignedIntGolomb(size, out this.bottom_right_tile_idx[ i ][ j ], "bottom_right_tile_idx"); 
					}

					if ( mc_all_tiles_exact_sample_value_match_flag== 0 )
					{
						size += stream.ReadUnsignedInt(size, 1, out this.mc_exact_sample_value_match_flag[ i ], "mc_exact_sample_value_match_flag"); 
					}
					size += stream.ReadUnsignedInt(size, 1, out this.mcts_tier_level_idc_present_flag[ i ], "mcts_tier_level_idc_present_flag"); 

					if ( mcts_tier_level_idc_present_flag[ i ] != 0 )
					{
						size += stream.ReadUnsignedInt(size, 1, out this.mcts_tier_flag[ i ], "mcts_tier_flag"); 
						size += stream.ReadUnsignedInt(size, 8, out this.mcts_level_idc[ i ], "mcts_level_idc"); 
					}
				}
			}
			else 
			{
				size += stream.ReadUnsignedInt(size, 1, out this.max_mcs_tier_level_idc_present_flag, "max_mcs_tier_level_idc_present_flag"); 

				if (max_mcs_tier_level_idc_present_flag != 0 )
				{
					size += stream.ReadUnsignedInt(size, 1, out this.mcts_max_tier_flag, "mcts_max_tier_flag"); 
					size += stream.ReadUnsignedInt(size, 8, out this.mcts_max_level_idc, "mcts_max_level_idc"); 
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			uint j = 0;
			size += stream.WriteUnsignedInt(1, this.mc_all_tiles_exact_sample_value_match_flag, "mc_all_tiles_exact_sample_value_match_flag"); 
			size += stream.WriteUnsignedInt(1, this.each_tile_one_tile_set_flag, "each_tile_one_tile_set_flag"); 

			if ( each_tile_one_tile_set_flag== 0 )
			{
				size += stream.WriteUnsignedInt(1, this.limited_tile_set_display_flag, "limited_tile_set_display_flag"); 
				size += stream.WriteUnsignedIntGolomb( this.num_sets_in_message_minus1, "num_sets_in_message_minus1"); 

				for ( i = 0; i <= num_sets_in_message_minus1; i++ )
				{
					size += stream.WriteUnsignedIntGolomb( this.mcts_id[ i ], "mcts_id"); 

					if ( limited_tile_set_display_flag != 0 )
					{
						size += stream.WriteUnsignedInt(1, this.display_tile_set_flag[ i ], "display_tile_set_flag"); 
					}
					size += stream.WriteUnsignedIntGolomb( this.num_tile_rects_in_set_minus1[ i ], "num_tile_rects_in_set_minus1"); 

					for ( j = 0; j <= num_tile_rects_in_set_minus1[ i ]; j++ )
					{
						size += stream.WriteUnsignedIntGolomb( this.top_left_tile_idx[ i ][ j ], "top_left_tile_idx"); 
						size += stream.WriteUnsignedIntGolomb( this.bottom_right_tile_idx[ i ][ j ], "bottom_right_tile_idx"); 
					}

					if ( mc_all_tiles_exact_sample_value_match_flag== 0 )
					{
						size += stream.WriteUnsignedInt(1, this.mc_exact_sample_value_match_flag[ i ], "mc_exact_sample_value_match_flag"); 
					}
					size += stream.WriteUnsignedInt(1, this.mcts_tier_level_idc_present_flag[ i ], "mcts_tier_level_idc_present_flag"); 

					if ( mcts_tier_level_idc_present_flag[ i ] != 0 )
					{
						size += stream.WriteUnsignedInt(1, this.mcts_tier_flag[ i ], "mcts_tier_flag"); 
						size += stream.WriteUnsignedInt(8, this.mcts_level_idc[ i ], "mcts_level_idc"); 
					}
				}
			}
			else 
			{
				size += stream.WriteUnsignedInt(1, this.max_mcs_tier_level_idc_present_flag, "max_mcs_tier_level_idc_present_flag"); 

				if (max_mcs_tier_level_idc_present_flag != 0 )
				{
					size += stream.WriteUnsignedInt(1, this.mcts_max_tier_flag, "mcts_max_tier_flag"); 
					size += stream.WriteUnsignedInt(8, this.mcts_max_level_idc, "mcts_max_level_idc"); 
				}
			}
  ...
  if( hor_chroma_filter_idc == 1 ) {  
    ...
    */
    public class ChromaResamplingFilterHint : IItuSerializable
    {
		...
		private ulong target_format_idc;
		public ulong TargetFormatIdc { get { return target_format_idc; } set { target_format_idc = value; } }
		private ulong num_vertical_filters;
		public ulong NumVerticalFilters { get { return num_vertical_filters; } set { num_vertical_filters = value; } }
		private ulong[] ver_tap_length_minus1;
		public ulong[] VerTapLengthMinus1 { get { return ver_tap_length_minus1; } set { ver_tap_length_minus1 = value; } }
		private long[][] ver_filter_coeff;
		public long[][] VerFilterCoeff { get { return ver_filter_coeff; } set { ver_filter_coeff = value; } }
		private ulong num_horizontal_filters;
		public ulong NumHorizontalFilters { get { return num_horizontal_filters; } set { num_horizontal_filters = value; } }
		private ulong[] hor_tap_length_minus1;
		public ulong[] HorTapLengthMinus1 { get { return hor_tap_length_minus1; } set { hor_tap_length_minus1 = value; } }
		private long[][] hor_filter_coeff;
		public long[][] HorFilterCoeff { get { return hor_filter_coeff; } set { hor_filter_coeff = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			uint j = 0;
			size += stream.ReadUnsignedInt(size, 8, out this.ver_chroma_filter_idc, "ver_chroma_filter_idc"); 
			size += stream.ReadUnsignedInt(size, 8, out this.hor_chroma_filter_idc, "hor_chroma_filter_idc"); 
			size += stream.ReadUnsignedInt(size, 1, out this.ver_filtering_field_processing_flag, "ver_filtering_field_processing_flag"); 

			if ( ver_chroma_filter_idc == 1  ||  hor_chroma_filter_idc == 1 )
			{
				size += stream.ReadUnsignedIntGolomb(size, out this.target_format_idc, "target_format_idc"); 
				...
				if ( ver_chroma_filter_idc == 1 )
				{
					...
					for ( i = 0; i < num_vertical_filters; i++ )
					{
						size += stream.ReadUnsignedIntGolomb(size, out this.ver_tap_length_minus1[ i ], "ver_tap_length_minus1"); 

						this.ver_filter_coeff[ i ] = new long[ ver_tap_length_minus1[ i ] + 1];
						for ( j = 0; j <= ver_tap_length_minus1[ i ]; j++ )
						{
							size += stream.ReadSignedIntGolomb(size, out this.ver_filter_coeff[ i ][ j ], "ver_filter_coeff"); 
						}
					}
				}
				...
				if ( hor_chroma_filter_idc == 1 )
				{
					...
					for ( i = 0; i < num_horizontal_filters; i++ )
					{
						size += stream.ReadUnsignedIntGolomb(size, out this.hor_tap_length_minus1[ i ], "hor_tap_length_minus1"); 

						this.hor_filter_coeff[ i ] = new long[ hor_tap_length_minus1[ i ] + 1];
						for ( j = 0; j <= hor_tap_length_minus1[ i ]; j++ )
						{
							size += stream.ReadSignedIntGolomb(size, out this.hor_filter_coeff[ i ][ j ], "hor_filter_coeff"); 
						}
					}
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			uint j = 0;
			size += stream.WriteUnsignedInt(8, this.ver_chroma_filter_idc, "ver_chroma_filter_idc"); 
			size += stream.WriteUnsignedInt(8, this.hor_chroma_filter_idc, "hor_chroma_filter_idc"); 
			size += stream.WriteUnsignedInt(1, this.ver_filtering_field_processing_flag, "ver_filtering_field_processing_flag"); 

			if ( ver_chroma_filter_idc == 1  ||  hor_chroma_filter_idc == 1 )
			{
				size += stream.WriteUnsignedIntGolomb( this.target_format_idc, "target_format_idc"); 

				if ( ver_chroma_filter_idc == 1 )
				{
					size += stream.WriteUnsignedIntGolomb( this.num_vertical_filters, "num_vertical_filters"); 

					for ( i = 0; i < num_vertical_filters; i++ )
					{
						size += stream.WriteUnsignedIntGolomb( this.ver_tap_length_minus1[ i ], "ver_tap_length_minus1"); 

						for ( j = 0; j <= ver_tap_length_minus1[ i ]; j++ )
						{
							size += stream.WriteSignedIntGolomb( this.ver_filter_coeff[ i ][ j ], "ver_filter_coeff"); 
						}
					}
				}
				...
				if ( hor_chroma_filter_idc == 1 )
				{
					size += stream.WriteUnsignedIntGolomb( this.num_horizontal_filters, "num_horizontal_filters"); 

					for ( i = 0; i < num_horizontal_filters; i++ )
					{
						size += stream.WriteUnsignedIntGolomb( this.hor_tap_length_minus1[ i ], "hor_tap_length_minus1"); 

						for ( j = 0; j <= hor_tap_length_minus1[ i ]; j++ )
						{
							size += stream.WriteSignedIntGolomb( this.hor_filter_coeff[ i ][ j ], "hor_filter_coeff"); 
						}
					}
				}
			}
  ...
  for( i = 0; i <= num_knee_points_minus1; i++ ) {  
    ...
    */
    public class KneeFunctionInfo : IItuSerializable
    {
		private uint payloadSize;
		public uint PayloadSize { get { return payloadSize; } set { payloadSize = value; } }
		private ulong knee_function_id;
		public ulong KneeFunctionId { get { return knee_function_id; } set { knee_function_id = value; } }
		...
		private ulong num_knee_points_minus1;
		public ulong NumKneePointsMinus1 { get { return num_knee_points_minus1; } set { num_knee_points_minus1 = value; } }
		...
		public uint[] OutputKneePoint { get { return output_knee_point; } set { output_knee_point = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			size += stream.ReadUnsignedIntGolomb(size, out this.knee_function_id, "knee_function_id"); 
			size += stream.ReadUnsignedInt(size, 1, out this.knee_function_cancel_flag, "knee_function_cancel_flag"); 

			if ( knee_function_cancel_flag== 0 )
			{
				size += stream.ReadUnsignedInt(size, 1, out this.knee_function_persistence_flag, "knee_function_persistence_flag"); 
				size += stream.ReadUnsignedInt(size, 32, out this.input_d_range, "input_d_range"); 
				size += stream.ReadUnsignedInt(size, 32, out this.input_disp_luminance, "input_disp_luminance"); 
				size += stream.ReadUnsignedInt(size, 32, out this.output_d_range, "output_d_range"); 
				...
				for ( i = 0; i <= num_knee_points_minus1; i++ )
				{
					size += stream.ReadUnsignedInt(size, 10, out this.input_knee_point[ i ], "input_knee_point"); 
					size += stream.ReadUnsignedInt(size, 10, out this.output_knee_point[ i ], "output_knee_point"); 
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			size += stream.WriteUnsignedIntGolomb( this.knee_function_id, "knee_function_id"); 
			size += stream.WriteUnsignedInt(1, this.knee_function_cancel_flag, "knee_function_cancel_flag"); 

			if ( knee_function_cancel_flag== 0 )
			{
				size += stream.WriteUnsignedInt(1, this.knee_function_persistence_flag, "knee_function_persistence_flag"); 
				size += stream.WriteUnsignedInt(32, this.input_d_range, "input_d_range"); 
				size += stream.WriteUnsignedInt(32, this.input_disp_luminance, "input_disp_luminance"); 
				size += stream.WriteUnsignedInt(32, this.output_d_range, "output_d_range"); 
				size += stream.WriteUnsignedInt(32, this.output_disp_luminance, "output_disp_luminance"); 
				size += stream.WriteUnsignedIntGolomb( this.num_knee_points_minus1, "num_knee_points_minus1"); 

				for ( i = 0; i <= num_knee_points_minus1; i++ )
				{
					size += stream.WriteUnsignedInt(10, this.input_knee_point[ i ], "input_knee_point"); 
					size += stream.WriteUnsignedInt(10, this.output_knee_point[ i ], "output_knee_point"); 
				}
			}
    ...
    public class ColourRemappingInfo : IItuSerializable
    {
		...
		public ulong[][] PostLutTargetValue { get { return post_lut_target_value; } set { post_lut_target_value = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			{
				size += stream.ReadUnsignedInt(size, 1, out this.colour_remap_persistence_flag, "colour_remap_persistence_flag"); 
				...
				for ( c = 0; c < 3; c++ )
				{
					...
					if ( pre_lut_num_val_minus1[ c ] > 0 )
					{
						...
						for ( i = 0; i <= pre_lut_num_val_minus1[ c ]; i++ )
						{
							size += stream.ReadUnsignedIntVariable(size, (( ( colour_remap_input_bit_depth + 7 )  >>  3 )  <<  3), out this.pre_lut_coded_value[ c ][ i ], "pre_lut_coded_value"); 
							size += stream.ReadUnsignedIntVariable(size, (( ( colour_remap_output_bit_depth + 7 )  >>  3 )  <<  3), out this.pre_lut_target_value[ c ][ i ], "pre_lut_target_value"); 
						}
					}
				}
				...
				for ( c = 0; c < 3; c++ )
				{
					...
					if ( post_lut_num_val_minus1[ c ] > 0 )
					{
						...
						for ( i = 0; i <= post_lut_num_val_minus1[ c ]; i++ )
						{
							size += stream.ReadUnsignedIntVariable(size, (( ( colour_remap_input_bit_depth + 7 )  >>  3 )  <<  3), out this.post_lut_coded_value[ c ][ i ], "post_lut_coded_value"); 
							size += stream.ReadUnsignedIntVariable(size, (( ( colour_remap_output_bit_depth + 7 )  >>  3 )  <<  3), out this.post_lut_target_value[ c ][ i ], "post_lut_target_value"); 
						}
					}
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( colour_remap_cancel_flag== 0 )
			{
				size += stream.WriteUnsignedInt(1, this.colour_remap_persistence_flag, "colour_remap_persistence_flag"); 
				...
				for ( c = 0; c < 3; c++ )
				{
					...
					if ( pre_lut_num_val_minus1[ c ] > 0 )
					{
						...
						for ( i = 0; i <= pre_lut_num_val_minus1[ c ]; i++ )
						{
							size += stream.WriteUnsignedIntVariable((( ( colour_remap_input_bit_depth + 7 )  >>  3 )  <<  3), this.pre_lut_coded_value[ c ][ i ], "pre_lut_coded_value"); 
							size += stream.WriteUnsignedIntVariable((( ( colour_remap_output_bit_depth + 7 )  >>  3 )  <<  3), this.pre_lut_target_value[ c ][ i ], "pre_lut_target_value"); 
						}
					}
				}
				...
				for ( c = 0; c < 3; c++ )
				{
					...
					if ( post_lut_num_val_minus1[ c ] > 0 )
					{
						...
						for ( i = 0; i <= post_lut_num_val_minus1[ c ]; i++ )
						{
							size += stream.WriteUnsignedIntVariable((( ( colour_remap_input_bit_depth + 7 )  >>  3 )  <<  3), this.post_lut_coded_value[ c ][ i ], "post_lut_coded_value"); 
							size += stream.WriteUnsignedIntVariable((( ( colour_remap_output_bit_depth + 7 )  >>  3 )  <<  3), this.post_lut_target_value[ c ][ i ], "post_lut_target_value"); 
						}
					}
				}
			}
...
deinterlaced_picture_source_parity_flag  u(1) 
    ...
    */
    public class DeinterlacedFieldIdentification : IItuSerializable
    {
		private uint payloadSize;
		public uint PayloadSize { get { return payloadSize; } set { payloadSize = value; } }
		...
		public byte DeinterlacedPictureSourceParityFlag { get { return deinterlaced_picture_source_parity_flag; } set { deinterlaced_picture_source_parity_flag = value; } }
         ...
         public DeinterlacedFieldIdentification(uint payloadSize)
         { 
			this.payloadSize = payloadSize;
         }
...
independent_slice_segment_flag u(1) 
    ...
    */
    public class CodedRegionCompletion : IItuSerializable
    {
		private uint payloadSize;
		public uint PayloadSize { get { return payloadSize; } set { payloadSize = value; } }
		private ulong next_segment_address;
		public ulong NextSegmentAddress { get { return next_segment_address; } set { next_segment_address = value; } }
		...
		public byte IndependentSliceSegmentFlag { get { return independent_slice_segment_flag; } set { independent_slice_segment_flag = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			if ( next_segment_address > 0 )
			{
				size += stream.ReadUnsignedInt(size, 1, out this.independent_slice_segment_flag, "independent_slice_segment_flag"); 
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( next_segment_address > 0 )
			{
				size += stream.WriteUnsignedInt(1, this.independent_slice_segment_flag, "independent_slice_segment_flag"); 
			}
		...
		public uint ErpRightGuardBandWidth { get { return erp_right_guard_band_width; } set { erp_right_guard_band_width = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			if ( erp_cancel_flag== 0 )
			{
				...
				size += stream.ReadUnsignedInt(size, 1, out this.erp_guard_band_flag, "erp_guard_band_flag"); 
				size += stream.ReadUnsignedInt(size, 2, out this.erp_reserved_zero_2bits, "erp_reserved_zero_2bits"); 

				if ( erp_guard_band_flag == 1 )
				{
					size += stream.ReadUnsignedInt(size, 3, out this.erp_guard_band_type, "erp_guard_band_type"); 
					size += stream.ReadUnsignedInt(size, 8, out this.erp_left_guard_band_width, "erp_left_guard_band_width"); 
					size += stream.ReadUnsignedInt(size, 8, out this.erp_right_guard_band_width, "erp_right_guard_band_width"); 
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( erp_cancel_flag== 0 )
			{
				...
				size += stream.WriteUnsignedInt(1, this.erp_guard_band_flag, "erp_guard_band_flag"); 
				size += stream.WriteUnsignedInt(2, this.erp_reserved_zero_2bits, "erp_reserved_zero_2bits"); 

				if ( erp_guard_band_flag == 1 )
				{
					size += stream.WriteUnsignedInt(3, this.erp_guard_band_type, "erp_guard_band_type"); 
					size += stream.WriteUnsignedInt(8, this.erp_left_guard_band_width, "erp_left_guard_band_width"); 
					size += stream.WriteUnsignedInt(8, this.erp_right_guard_band_width, "erp_right_guard_band_width"); 
				}
			}
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			if ( rwp_cancel_flag== 0 )
			{
				...
				for ( i = 0; i < num_packed_regions; i++ )
				{
					...
					size += stream.ReadUnsignedInt(size, 3, out this.rwp_transform_type[ i ], "rwp_transform_type"); 
					size += stream.ReadUnsignedInt(size, 1, out this.rwp_guard_band_flag[ i ], "rwp_guard_band_flag"); 
					...
					{
						size += stream.ReadUnsignedInt(size, 8, out this.rwp_left_guard_band_width[ i ], "rwp_left_guard_band_width"); 
						size += stream.ReadUnsignedInt(size, 8, out this.rwp_right_guard_band_width[ i ], "rwp_right_guard_band_width"); 
						size += stream.ReadUnsignedInt(size, 8, out this.rwp_top_guard_band_height[ i ], "rwp_top_guard_band_height"); 
						...
						for ( j = 0; j < 4; j++ )
						{
							size += stream.ReadUnsignedInt(size, 3, out this.rwp_guard_band_type[ i ][ j ], "rwp_guard_band_type"); 
						}
						size += stream.ReadUnsignedInt(size, 3, out this.rwp_guard_band_reserved_zero_3bits[ i ], "rwp_guard_band_reserved_zero_3bits"); 
					}
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( rwp_cancel_flag== 0 )
			{
				...
				for ( i = 0; i < num_packed_regions; i++ )
				{
					...
					size += stream.WriteUnsignedInt(3, this.rwp_transform_type[ i ], "rwp_transform_type"); 
					size += stream.WriteUnsignedInt(1, this.rwp_guard_band_flag[ i ], "rwp_guard_band_flag"); 
					...
					if ( rwp_guard_band_flag[ i ] != 0 )
					{
						size += stream.WriteUnsignedInt(8, this.rwp_left_guard_band_width[ i ], "rwp_left_guard_band_width"); 
						size += stream.WriteUnsignedInt(8, this.rwp_right_guard_band_width[ i ], "rwp_right_guard_band_width"); 
						size += stream.WriteUnsignedInt(8, this.rwp_top_guard_band_height[ i ], "rwp_top_guard_band_height"); 
						size += stream.WriteUnsignedInt(8, this.rwp_bottom_guard_band_height[ i ], "rwp_bottom_guard_band_height"); 
						size += stream.WriteUnsignedInt(1, this.rwp_guard_band_not_used_for_pred_flag[ i ], "rwp_guard_band_not_used_for_pred_flag"); 

						for ( j = 0; j < 4; j++ )
						{
							size += stream.WriteUnsignedInt(3, this.rwp_guard_band_type[ i ][ j ], "rwp_guard_band_type"); 
						}
						size += stream.WriteUnsignedInt(3, this.rwp_guard_band_reserved_zero_3bits[ i ], "rwp_guard_band_reserved_zero_3bits"); 
					}
				}
			}
    ...
    public class RegionalNesting : IItuSerializable
    {
		...
		public SeiMessage[] SeiMessage { get { return sei_message; } set { sei_message = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			for ( i = 0; i < regional_nesting_num_rect_regions; i++ )
			{
				size += stream.ReadUnsignedInt(size, 8, out this.regional_nesting_rect_region_id[ i ], "regional_nesting_rect_region_id"); 
				size += stream.ReadUnsignedInt(size, 16, out this.regional_nesting_rect_left_offset[ i ], "regional_nesting_rect_left_offset"); 
				size += stream.ReadUnsignedInt(size, 16, out this.regional_nesting_rect_right_offset[ i ], "regional_nesting_rect_right_offset"); 
				size += stream.ReadUnsignedInt(size, 16, out this.regional_nesting_rect_top_offset[ i ], "regional_nesting_rect_top_offset"); 
				size += stream.ReadUnsignedInt(size, 16, out this.regional_nesting_rect_bottom_offset[ i ], "regional_nesting_rect_bottom_offset"); 
			}
			...
			for ( i = 0; i <= num_sei_messages_in_regional_nesting_minus1; i++ )
			{
				size += stream.ReadUnsignedInt(size, 8, out this.num_regions_for_sei_message[ i ], "num_regions_for_sei_message"); 

				this.regional_nesting_sei_region_idx[ i ] = new uint[ num_regions_for_sei_message[ i ]];
				for (j = 0; j < num_regions_for_sei_message[ i ]; j++ )
				{
					size += stream.ReadUnsignedInt(size, 8, out this.regional_nesting_sei_region_idx[ i ][ j ], "regional_nesting_sei_region_idx"); 
				}
				this.sei_message[ i ] =  new SeiMessage() ;
				size +=  stream.ReadClass<SeiMessage>(size, context, this.sei_message[ i ], "sei_message"); 
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			uint j = 0;
			size += stream.WriteUnsignedInt(16, this.regional_nesting_id, "regional_nesting_id"); 
			size += stream.WriteUnsignedInt(8, this.regional_nesting_num_rect_regions, "regional_nesting_num_rect_regions"); 

			for ( i = 0; i < regional_nesting_num_rect_regions; i++ )
			{
				size += stream.WriteUnsignedInt(8, this.regional_nesting_rect_region_id[ i ], "regional_nesting_rect_region_id"); 
				size += stream.WriteUnsignedInt(16, this.regional_nesting_rect_left_offset[ i ], "regional_nesting_rect_left_offset"); 
				size += stream.WriteUnsignedInt(16, this.regional_nesting_rect_right_offset[ i ], "regional_nesting_rect_right_offset"); 
				size += stream.WriteUnsignedInt(16, this.regional_nesting_rect_top_offset[ i ], "regional_nesting_rect_top_offset"); 
				size += stream.WriteUnsignedInt(16, this.regional_nesting_rect_bottom_offset[ i ], "regional_nesting_rect_bottom_offset"); 
			}
			size += stream.WriteUnsignedInt(8, this.num_sei_messages_in_regional_nesting_minus1, "num_sei_messages_in_regional_nesting_minus1"); 

			for ( i = 0; i <= num_sei_messages_in_regional_nesting_minus1; i++ )
			{
				size += stream.WriteUnsignedInt(8, this.num_regions_for_sei_message[ i ], "num_regions_for_sei_message"); 

				for (j = 0; j < num_regions_for_sei_message[ i ]; j++ )
				{
					size += stream.WriteUnsignedInt(8, this.regional_nesting_sei_region_idx[ i ][ j ], "regional_nesting_sei_region_idx"); 
				}
				size += stream.WriteClass<SeiMessage>(context, this.sei_message[ i ], "sei_message"); 
			}
  ...
  for( j = 0; j <= num_pps_in_info_set_minus1[ i ]; j++ )  
    ...
    */
    public class MctsExtractionInfoSets : IItuSerializable
    {
		private uint payloadSize;
		public uint PayloadSize { get { return payloadSize; } set { payloadSize = value; } }
		private ulong num_info_sets_minus1;
		public ulong NumInfoSetsMinus1 { get { return num_info_sets_minus1; } set { num_info_sets_minus1 = value; } }
		private ulong[] num_mcts_sets_minus1;
		public ulong[] NumMctsSetsMinus1 { get { return num_mcts_sets_minus1; } set { num_mcts_sets_minus1 = value; } }
		private ulong[][] num_mcts_in_set_minus1;
		public ulong[][] NumMctsInSetMinus1 { get { return num_mcts_in_set_minus1; } set { num_mcts_in_set_minus1 = value; } }
		private ulong[][][] idx_of_mcts_in_set;
		public ulong[][][] IdxOfMctsInSet { get { return idx_of_mcts_in_set; } set { idx_of_mcts_in_set = value; } }
		...
		private ulong[] num_slice_segments_minus1;
		public ulong[] NumSliceSegmentsMinus1 { get { return num_slice_segments_minus1; } set { num_slice_segments_minus1 = value; } }
		private ulong[][] output_slice_segment_address;
		public ulong[][] OutputSliceSegmentAddress { get { return output_slice_segment_address; } set { output_slice_segment_address = value; } }
		private ulong[] num_vps_in_info_set_minus1;
		public ulong[] NumVpsInInfoSetMinus1 { get { return num_vps_in_info_set_minus1; } set { num_vps_in_info_set_minus1 = value; } }
		private ulong[][] vps_rbsp_data_length;
		public ulong[][] VpsRbspDataLength { get { return vps_rbsp_data_length; } set { vps_rbsp_data_length = value; } }
		private ulong[] num_sps_in_info_set_minus1;
		public ulong[] NumSpsInInfoSetMinus1 { get { return num_sps_in_info_set_minus1; } set { num_sps_in_info_set_minus1 = value; } }
		private ulong[][] sps_rbsp_data_length;
		public ulong[][] SpsRbspDataLength { get { return sps_rbsp_data_length; } set { sps_rbsp_data_length = value; } }
		private ulong[] num_pps_in_info_set_minus1;
		public ulong[] NumPpsInInfoSetMinus1 { get { return num_pps_in_info_set_minus1; } set { num_pps_in_info_set_minus1 = value; } }
		...
		public uint[][][] PpsRbspDataByte { get { return pps_rbsp_data_byte; } set { pps_rbsp_data_byte = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			for ( i = 0; i <= num_info_sets_minus1; i++ )
			{
				size += stream.ReadUnsignedIntGolomb(size, out this.num_mcts_sets_minus1[ i ], "num_mcts_sets_minus1"); 

				this.num_mcts_in_set_minus1[ i ] = new ulong[ num_mcts_sets_minus1[ i ] + 1];
				this.idx_of_mcts_in_set[ i ] = new ulong[ num_mcts_sets_minus1[ i ] + 1][];
				for ( j = 0; j <= num_mcts_sets_minus1[ i ]; j++ )
				{
					size += stream.ReadUnsignedIntGolomb(size, out this.num_mcts_in_set_minus1[ i ][ j ], "num_mcts_in_set_minus1"); 

					this.idx_of_mcts_in_set[ i ][ j ] = new ulong[ num_mcts_in_set_minus1[ i ][ j ] + 1];
					for ( k = 0; k <= num_mcts_in_set_minus1[ i ][ j ]; k++ )
					{
						size += stream.ReadUnsignedIntGolomb(size, out this.idx_of_mcts_in_set[ i ][ j ][ k ], "idx_of_mcts_in_set"); 
					}
				}
				size += stream.ReadUnsignedInt(size, 1, out this.slice_reordering_enabled_flag[ i ], "slice_reordering_enabled_flag"); 

				if ( slice_reordering_enabled_flag[ i ] != 0 )
				{
					size += stream.ReadUnsignedIntGolomb(size, out this.num_slice_segments_minus1[ i ], "num_slice_segments_minus1"); 

					this.output_slice_segment_address[ i ] = new ulong[ num_slice_segments_minus1[ i ] + 1];
					for ( j = 0; j <= num_slice_segments_minus1[ i ]; j++ )
					{
						size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling( MathEx.Log2( ituContext.PicSizeInCtbsY ) ), out this.output_slice_segment_address[ i ][ j ], "output_slice_segment_address"); 
					}
				}
				size += stream.ReadUnsignedIntGolomb(size, out this.num_vps_in_info_set_minus1[ i ], "num_vps_in_info_set_minus1"); 

				this.vps_rbsp_data_length[ i ] = new ulong[ num_vps_in_info_set_minus1[ i ] + 1];
				for ( j = 0; j <= num_vps_in_info_set_minus1[ i ]; j++ )
				{
					size += stream.ReadUnsignedIntGolomb(size, out this.vps_rbsp_data_length[ i ][ j ], "vps_rbsp_data_length"); 
				}
				size += stream.ReadUnsignedIntGolomb(size, out this.num_sps_in_info_set_minus1[ i ], "num_sps_in_info_set_minus1"); 

				this.sps_rbsp_data_length[ i ] = new ulong[ num_sps_in_info_set_minus1[ i ] + 1];
				for ( j = 0; j <= num_sps_in_info_set_minus1[ i ]; j++ )
				{
					size += stream.ReadUnsignedIntGolomb(size, out this.sps_rbsp_data_length[ i ][ j ], "sps_rbsp_data_length"); 
				}
				size += stream.ReadUnsignedIntGolomb(size, out this.num_pps_in_info_set_minus1[ i ], "num_pps_in_info_set_minus1"); 

				this.pps_nuh_temporal_id_plus1[ i ] = new uint[ num_pps_in_info_set_minus1[ i ] + 1];
				this.pps_rbsp_data_length[ i ] = new ulong[ num_pps_in_info_set_minus1[ i ] + 1];
				for ( j = 0; j <= num_pps_in_info_set_minus1[ i ]; j++ )
				{
					size += stream.ReadUnsignedInt(size, 3, out this.pps_nuh_temporal_id_plus1[ i ][ j ], "pps_nuh_temporal_id_plus1"); 
					size += stream.ReadUnsignedIntGolomb(size, out this.pps_rbsp_data_length[ i ][ j ], "pps_rbsp_data_length"); 
				}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			uint k = 0;
			int whileIndex = -1;
			size += stream.WriteUnsignedIntGolomb( this.num_info_sets_minus1, "num_info_sets_minus1"); 

			for ( i = 0; i <= num_info_sets_minus1; i++ )
			{
				size += stream.WriteUnsignedIntGolomb( this.num_mcts_sets_minus1[ i ], "num_mcts_sets_minus1"); 

				for ( j = 0; j <= num_mcts_sets_minus1[ i ]; j++ )
				{
					size += stream.WriteUnsignedIntGolomb( this.num_mcts_in_set_minus1[ i ][ j ], "num_mcts_in_set_minus1"); 

					for ( k = 0; k <= num_mcts_in_set_minus1[ i ][ j ]; k++ )
					{
						size += stream.WriteUnsignedIntGolomb( this.idx_of_mcts_in_set[ i ][ j ][ k ], "idx_of_mcts_in_set"); 
					}
				}
				size += stream.WriteUnsignedInt(1, this.slice_reordering_enabled_flag[ i ], "slice_reordering_enabled_flag"); 

				if ( slice_reordering_enabled_flag[ i ] != 0 )
				{
					size += stream.WriteUnsignedIntGolomb( this.num_slice_segments_minus1[ i ], "num_slice_segments_minus1"); 

					for ( j = 0; j <= num_slice_segments_minus1[ i ]; j++ )
					{
						size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling( MathEx.Log2( ituContext.PicSizeInCtbsY ) ), this.output_slice_segment_address[ i ][ j ], "output_slice_segment_address"); 
					}
				}
				size += stream.WriteUnsignedIntGolomb( this.num_vps_in_info_set_minus1[ i ], "num_vps_in_info_set_minus1"); 

				for ( j = 0; j <= num_vps_in_info_set_minus1[ i ]; j++ )
				{
					size += stream.WriteUnsignedIntGolomb( this.vps_rbsp_data_length[ i ][ j ], "vps_rbsp_data_length"); 
				}
				size += stream.WriteUnsignedIntGolomb( this.num_sps_in_info_set_minus1[ i ], "num_sps_in_info_set_minus1"); 

				for ( j = 0; j <= num_sps_in_info_set_minus1[ i ]; j++ )
				{
					size += stream.WriteUnsignedIntGolomb( this.sps_rbsp_data_length[ i ][ j ], "sps_rbsp_data_length"); 
				}
				size += stream.WriteUnsignedIntGolomb( this.num_pps_in_info_set_minus1[ i ], "num_pps_in_info_set_minus1"); 

				for ( j = 0; j <= num_pps_in_info_set_minus1[ i ]; j++ )
				{
					size += stream.WriteUnsignedInt(3, this.pps_nuh_temporal_id_plus1[ i ][ j ], "pps_nuh_temporal_id_plus1"); 
					size += stream.WriteUnsignedIntGolomb( this.pps_rbsp_data_length[ i ][ j ], "pps_rbsp_data_length"); 
				}
				...
				for ( j = 0; j <= num_vps_in_info_set_minus1[ i ]; j++ )
				{
					...
					for ( k = 0; k <= vps_rbsp_data_length[ i ][ j ]; k++ )
					{
						size += stream.WriteUnsignedInt(8, this.vps_rbsp_data_byte[ i ][ j ][ k ], "vps_rbsp_data_byte"); 
					}
				}
				...
				for ( j = 0; j <= num_sps_in_info_set_minus1[ i ]; j++ )
				{
					...
					for ( k = 0; k <= sps_rbsp_data_length[ i ][ j ]; k++ )
					{
						size += stream.WriteUnsignedInt(8, this.sps_rbsp_data_byte[ i ][ j ][ k ], "sps_rbsp_data_byte"); 
					}
				}
				...
				for ( j = 0; j <= num_pps_in_info_set_minus1[ i ]; j++ )
				{
					...
					for ( k = 0; k <= pps_rbsp_data_length[ i ][ j ]; k++ )
					{
						size += stream.WriteUnsignedInt(8, this.pps_rbsp_data_byte[ i ][ j ][ k ], "pps_rbsp_data_byte"); 
					}
				}
			}
...
sei_message()  
    ...
    */
    public class MctsExtractionInfoNesting : IItuSerializable
    {
		...
		private ulong num_associated_mcts_minus1;
		public ulong NumAssociatedMctsMinus1 { get { return num_associated_mcts_minus1; } set { num_associated_mcts_minus1 = value; } }
		private ulong[] idx_of_associated_mcts;
		...
		public SeiMessage[] SeiMessage { get { return sei_message; } set { sei_message = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			int whileIndex = -1;
			size += stream.ReadUnsignedInt(size, 1, out this.all_mcts_flag, "all_mcts_flag"); 
			...
			if ( all_mcts_flag== 0 )
			{
				...
				for ( i = 0; i <= num_associated_mcts_minus1; i++ )
				{
					size += stream.ReadUnsignedIntGolomb(size, out this.idx_of_associated_mcts[ i ], "idx_of_associated_mcts"); 
				}
			}
			size += stream.ReadUnsignedIntGolomb(size, out this.num_sei_messages_in_mcts_extraction_nesting_minus1, "num_sei_messages_in_mcts_extraction_nesting_minus1"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			int whileIndex = -1;
			size += stream.WriteUnsignedInt(1, this.all_mcts_flag, "all_mcts_flag"); 

			if ( all_mcts_flag== 0 )
			{
				size += stream.WriteUnsignedIntGolomb( this.num_associated_mcts_minus1, "num_associated_mcts_minus1"); 

				for ( i = 0; i <= num_associated_mcts_minus1; i++ )
				{
					size += stream.WriteUnsignedIntGolomb( this.idx_of_associated_mcts[ i ], "idx_of_associated_mcts"); 
				}
			}
			size += stream.WriteUnsignedIntGolomb( this.num_sei_messages_in_mcts_extraction_nesting_minus1, "num_sei_messages_in_mcts_extraction_nesting_minus1"); 
  ...
  log2_max_mv_length_vertical ue(v) 
    ...
    */
    public class VuiParameters : IItuSerializable
    {
		...
		private ulong def_disp_win_left_offset;
		public ulong DefDispWinLeftOffset { get { return def_disp_win_left_offset; } set { def_disp_win_left_offset = value; } }
		private ulong def_disp_win_right_offset;
		public ulong DefDispWinRightOffset { get { return def_disp_win_right_offset; } set { def_disp_win_right_offset = value; } }
		private ulong def_disp_win_top_offset;
		public ulong DefDispWinTopOffset { get { return def_disp_win_top_offset; } set { def_disp_win_top_offset = value; } }
		private ulong def_disp_win_bottom_offset;
		public ulong DefDispWinBottomOffset { get { return def_disp_win_bottom_offset; } set { def_disp_win_bottom_offset = value; } }
		...
		private ulong vui_num_ticks_poc_diff_one_minus1;
		public ulong VuiNumTicksPocDiffOneMinus1 { get { return vui_num_ticks_poc_diff_one_minus1; } set { vui_num_ticks_poc_diff_one_minus1 = value; } }
		...
		private ulong min_spatial_segmentation_idc;
		public ulong MinSpatialSegmentationIdc { get { return min_spatial_segmentation_idc; } set { min_spatial_segmentation_idc = value; } }
		...
		private ulong max_bits_per_min_cu_denom;
		public ulong MaxBitsPerMinCuDenom { get { return max_bits_per_min_cu_denom; } set { max_bits_per_min_cu_denom = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			if ( video_signal_type_present_flag != 0 )
			{
				...
				if ( colour_description_present_flag != 0 )
				{
					...
					size += stream.ReadUnsignedInt(size, 8, out this.matrix_coeffs, "matrix_coeffs"); 
				}
			}
			...
			size += stream.ReadUnsignedInt(size, 1, out this.neutral_chroma_indication_flag, "neutral_chroma_indication_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.field_seq_flag, "field_seq_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.frame_field_info_present_flag, "frame_field_info_present_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.default_display_window_flag, "default_display_window_flag"); 

			if ( default_display_window_flag != 0 )
			{
				size += stream.ReadUnsignedIntGolomb(size, out this.def_disp_win_left_offset, "def_disp_win_left_offset"); 
				size += stream.ReadUnsignedIntGolomb(size, out this.def_disp_win_right_offset, "def_disp_win_right_offset"); 
				size += stream.ReadUnsignedIntGolomb(size, out this.def_disp_win_top_offset, "def_disp_win_top_offset"); 
				size += stream.ReadUnsignedIntGolomb(size, out this.def_disp_win_bottom_offset, "def_disp_win_bottom_offset"); 
			}
			size += stream.ReadUnsignedInt(size, 1, out this.vui_timing_info_present_flag, "vui_timing_info_present_flag"); 

			if ( vui_timing_info_present_flag != 0 )
			{
				size += stream.ReadUnsignedInt(size, 32, out this.vui_num_units_in_tick, "vui_num_units_in_tick"); 
				size += stream.ReadUnsignedInt(size, 32, out this.vui_time_scale, "vui_time_scale"); 
				size += stream.ReadUnsignedInt(size, 1, out this.vui_poc_proportional_to_timing_flag, "vui_poc_proportional_to_timing_flag"); 

				if ( vui_poc_proportional_to_timing_flag != 0 )
				{
					size += stream.ReadUnsignedIntGolomb(size, out this.vui_num_ticks_poc_diff_one_minus1, "vui_num_ticks_poc_diff_one_minus1"); 
				}
				size += stream.ReadUnsignedInt(size, 1, out this.vui_hrd_parameters_present_flag, "vui_hrd_parameters_present_flag"); 
			...
			{
				size += stream.ReadUnsignedInt(size, 1, out this.tiles_fixed_structure_flag, "tiles_fixed_structure_flag"); 
				...
				size += stream.ReadUnsignedInt(size, 1, out this.restricted_ref_pic_lists_flag, "restricted_ref_pic_lists_flag"); 
				size += stream.ReadUnsignedIntGolomb(size, out this.min_spatial_segmentation_idc, "min_spatial_segmentation_idc"); 
				size += stream.ReadUnsignedIntGolomb(size, out this.max_bytes_per_pic_denom, "max_bytes_per_pic_denom"); 
				size += stream.ReadUnsignedIntGolomb(size, out this.max_bits_per_min_cu_denom, "max_bits_per_min_cu_denom"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( video_signal_type_present_flag != 0 )
			{
				...
				if ( colour_description_present_flag != 0 )
				{
					...
					size += stream.WriteUnsignedInt(8, this.matrix_coeffs, "matrix_coeffs"); 
				}
			}
			...
			size += stream.WriteUnsignedInt(1, this.neutral_chroma_indication_flag, "neutral_chroma_indication_flag"); 
			size += stream.WriteUnsignedInt(1, this.field_seq_flag, "field_seq_flag"); 
			size += stream.WriteUnsignedInt(1, this.frame_field_info_present_flag, "frame_field_info_present_flag"); 
			size += stream.WriteUnsignedInt(1, this.default_display_window_flag, "default_display_window_flag"); 

			if ( default_display_window_flag != 0 )
			{
				size += stream.WriteUnsignedIntGolomb( this.def_disp_win_left_offset, "def_disp_win_left_offset"); 
				size += stream.WriteUnsignedIntGolomb( this.def_disp_win_right_offset, "def_disp_win_right_offset"); 
				size += stream.WriteUnsignedIntGolomb( this.def_disp_win_top_offset, "def_disp_win_top_offset"); 
				size += stream.WriteUnsignedIntGolomb( this.def_disp_win_bottom_offset, "def_disp_win_bottom_offset"); 
			}
			size += stream.WriteUnsignedInt(1, this.vui_timing_info_present_flag, "vui_timing_info_present_flag"); 

			if ( vui_timing_info_present_flag != 0 )
			{
				size += stream.WriteUnsignedInt(32, this.vui_num_units_in_tick, "vui_num_units_in_tick"); 
				size += stream.WriteUnsignedInt(32, this.vui_time_scale, "vui_time_scale"); 
				size += stream.WriteUnsignedInt(1, this.vui_poc_proportional_to_timing_flag, "vui_poc_proportional_to_timing_flag"); 

				if ( vui_poc_proportional_to_timing_flag != 0 )
				{
					size += stream.WriteUnsignedIntGolomb( this.vui_num_ticks_poc_diff_one_minus1, "vui_num_ticks_poc_diff_one_minus1"); 
				}
				size += stream.WriteUnsignedInt(1, this.vui_hrd_parameters_present_flag, "vui_hrd_parameters_present_flag"); 
			...
			if ( bitstream_restriction_flag != 0 )
			{
				size += stream.WriteUnsignedInt(1, this.tiles_fixed_structure_flag, "tiles_fixed_structure_flag"); 
				size += stream.WriteUnsignedInt(1, this.motion_vectors_over_pic_boundaries_flag, "motion_vectors_over_pic_boundaries_flag"); 
				size += stream.WriteUnsignedInt(1, this.restricted_ref_pic_lists_flag, "restricted_ref_pic_lists_flag"); 
				size += stream.WriteUnsignedIntGolomb( this.min_spatial_segmentation_idc, "min_spatial_segmentation_idc"); 
				size += stream.WriteUnsignedIntGolomb( this.max_bytes_per_pic_denom, "max_bytes_per_pic_denom"); 
				size += stream.WriteUnsignedIntGolomb( this.max_bits_per_min_cu_denom, "max_bits_per_min_cu_denom"); 
    ...
    */
    public class HrdParameters : IItuSerializable
    {
		...
		public SubLayerHrdParameters[] SubLayerHrdParameters { get { return sub_layer_hrd_parameters; } set { sub_layer_hrd_parameters = value; } }
         ...
         public HrdParameters(uint commonInfPresentFlag, ulong maxNumSubLayersMinus1)
         { 
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			if ( commonInfPresentFlag != 0 )
			{
				...
				{
					size += stream.ReadUnsignedInt(size, 1, out this.sub_pic_hrd_params_present_flag, "sub_pic_hrd_params_present_flag"); 

					if ( sub_pic_hrd_params_present_flag != 0 )
					{
						size += stream.ReadUnsignedInt(size, 8, out this.tick_divisor_minus2, "tick_divisor_minus2"); 
						size += stream.ReadUnsignedInt(size, 5, out this.du_cpb_removal_delay_increment_length_minus1, "du_cpb_removal_delay_increment_length_minus1"); 
						size += stream.ReadUnsignedInt(size, 1, out this.sub_pic_cpb_params_in_pic_timing_sei_flag, "sub_pic_cpb_params_in_pic_timing_sei_flag"); 
						size += stream.ReadUnsignedInt(size, 5, out this.dpb_output_delay_du_length_minus1, "dpb_output_delay_du_length_minus1"); 
					}
					...
					if ( sub_pic_hrd_params_present_flag != 0 )
					{
						size += stream.ReadUnsignedInt(size, 4, out this.cpb_size_du_scale, "cpb_size_du_scale"); 
					}
					...
					size += stream.ReadUnsignedInt(size, 5, out this.au_cpb_removal_delay_length_minus1, "au_cpb_removal_delay_length_minus1"); 
			...
			for ( i = 0; i <= maxNumSubLayersMinus1; i++ )
			{
				...
				{
					size += stream.ReadUnsignedInt(size, 1, out this.fixed_pic_rate_within_cvs_flag[ i ], "fixed_pic_rate_within_cvs_flag"); 
				}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( commonInfPresentFlag != 0 )
			{
				...
				if ( nal_hrd_parameters_present_flag != 0  ||  vcl_hrd_parameters_present_flag != 0 )
				{
					size += stream.WriteUnsignedInt(1, this.sub_pic_hrd_params_present_flag, "sub_pic_hrd_params_present_flag"); 

					if ( sub_pic_hrd_params_present_flag != 0 )
					{
						size += stream.WriteUnsignedInt(8, this.tick_divisor_minus2, "tick_divisor_minus2"); 
						size += stream.WriteUnsignedInt(5, this.du_cpb_removal_delay_increment_length_minus1, "du_cpb_removal_delay_increment_length_minus1"); 
						size += stream.WriteUnsignedInt(1, this.sub_pic_cpb_params_in_pic_timing_sei_flag, "sub_pic_cpb_params_in_pic_timing_sei_flag"); 
						size += stream.WriteUnsignedInt(5, this.dpb_output_delay_du_length_minus1, "dpb_output_delay_du_length_minus1"); 
					}
					...
					if ( sub_pic_hrd_params_present_flag != 0 )
					{
						size += stream.WriteUnsignedInt(4, this.cpb_size_du_scale, "cpb_size_du_scale"); 
					}
					size += stream.WriteUnsignedInt(5, this.initial_cpb_removal_delay_length_minus1, "initial_cpb_removal_delay_length_minus1"); 
					size += stream.WriteUnsignedInt(5, this.au_cpb_removal_delay_length_minus1, "au_cpb_removal_delay_length_minus1"); 
			...
			for ( i = 0; i <= maxNumSubLayersMinus1; i++ )
			{
				...
				if ( fixed_pic_rate_general_flag[ i ]== 0 )
				{
					size += stream.WriteUnsignedInt(1, this.fixed_pic_rate_within_cvs_flag[ i ], "fixed_pic_rate_within_cvs_flag"); 
				}
		...
		public byte[] CbrFlag { get { return cbr_flag; } set { cbr_flag = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			for ( i = 0; i < ituContext.CpbCnt; i++ )
			{
				...
				size += stream.ReadUnsignedInt(size, 1, out this.cbr_flag[ i ], "cbr_flag"); 
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			for ( i = 0; i < ituContext.CpbCnt; i++ )
			{
				...
				size += stream.WriteUnsignedInt(1, this.cbr_flag[ i ], "cbr_flag"); 
			}
...
vps_extension() {  
 ...
 for( i = (uint)(vps_base_layer_internal_flag != 0 ? 2 : 1); 
 ...
 if( rep_format_idx_present_flag )   
  for( i = (uint)(vps_base_layer_internal_flag != 0 ? 1 : 0); i <= MaxLayersMinus1; i++ )  
 ...
 if( direct_dependency_all_layers_flag )  
  ...
  for( i = (uint)(vps_base_layer_internal_flag != 0 ? 1 : 2); i <= MaxLayersMinus1; i++ )  
   for( j = (uint)(vps_base_layer_internal_flag != 0 ? 0 : 1); j < i; j++ )  
  ...
  vps_vui()  
    ...
    */
    public class VpsExtension : IItuSerializable
    {
		...
		private ulong[][] dimension_id;
		public ulong[][] DimensionId { get { return dimension_id; } set { dimension_id = value; } }
		private uint view_id_len;
		public uint ViewIdLen { get { return view_id_len; } set { view_id_len = value; } }
		private ulong[] view_id_val;
		public ulong[] ViewIdVal { get { return view_id_val; } set { view_id_val = value; } }
		...
		private ulong num_add_layer_sets;
		public ulong NumAddLayerSets { get { return num_add_layer_sets; } set { num_add_layer_sets = value; } }
		private ulong[][] highest_layer_idx_plus1;
		public ulong[][] HighestLayerIdxPlus1 { get { return highest_layer_idx_plus1; } set { highest_layer_idx_plus1 = value; } }
		...
		private ulong vps_num_profile_tier_level_minus1;
		public ulong VpsNumProfileTierLevelMinus1 { get { return vps_num_profile_tier_level_minus1; } set { vps_num_profile_tier_level_minus1 = value; } }
		...
		private ulong num_add_olss;
		public ulong NumAddOlss { get { return num_add_olss; } set { num_add_olss = value; } }
		...
		private ulong numOutputLayerSets;
		public ulong NumOutputLayerSets { get { return numOutputLayerSets; } set { numOutputLayerSets = value; } }
		private ulong[] layer_set_idx_for_ols_minus1;
		public ulong[] LayerSetIdxForOlsMinus1 { get { return layer_set_idx_for_ols_minus1; } set { layer_set_idx_for_ols_minus1 = value; } }
		private byte[][] output_layer_flag;
		public byte[][] OutputLayerFlag { get { return output_layer_flag; } set { output_layer_flag = value; } }
		private ulong[][] profile_tier_level_idx;
		public ulong[][] ProfileTierLevelIdx { get { return profile_tier_level_idx; } set { profile_tier_level_idx = value; } }
		...
		private ulong vps_num_rep_formats_minus1;
		public ulong VpsNumRepFormatsMinus1 { get { return vps_num_rep_formats_minus1; } set { vps_num_rep_formats_minus1 = value; } }
		...
		private ulong[] vps_rep_format_idx;
		public ulong[] VpsRepFormatIdx { get { return vps_rep_format_idx; } set { vps_rep_format_idx = value; } }
		...
		private ulong direct_dep_type_len_minus2;
		public ulong DirectDepTypeLenMinus2 { get { return direct_dep_type_len_minus2; } set { direct_dep_type_len_minus2 = value; } }
		...
		private ulong direct_dependency_all_layers_type;
		public ulong DirectDependencyAllLayersType { get { return direct_dependency_all_layers_type; } set { direct_dependency_all_layers_type = value; } }
		private ulong[][] direct_dependency_type;
		public ulong[][] DirectDependencyType { get { return direct_dependency_type; } set { direct_dependency_type = value; } }
		private ulong vps_non_vui_extension_length;
		public ulong VpsNonVuiExtensionLength { get { return vps_non_vui_extension_length; } set { vps_non_vui_extension_length = value; } }
		...
		public VpsVui VpsVui { get { return vps_vui; } set { vps_vui = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			for ( i = 0, NumScalabilityTypes = 0; i < 16; i++ )
			{
				size += stream.ReadUnsignedInt(size, 1, out this.scalability_mask_flag[ i ], "scalability_mask_flag"); 
				NumScalabilityTypes+= scalability_mask_flag[ i ];
			}
			...
			for ( j = 0; j < ( NumScalabilityTypes - splitting_flag ); j++ )
			{
				size += stream.ReadUnsignedInt(size, 3, out this.dimension_id_len_minus1[ j ], "dimension_id_len_minus1"); 
			}
			...
			this.direct_dependency_flag[0] = new byte[ituContext.VideoParameterSetRbsp.VpsMaxLayersMinus1 + 1];
			for ( i = 1; i <= Math.Min( 62, ituContext.VideoParameterSetRbsp.VpsMaxLayersMinus1); i++ )
			{

				this.direct_dependency_flag[ i ] = new byte[ituContext.VideoParameterSetRbsp.VpsMaxLayersMinus1 + 1];
				for ( j = 0; j < i; j++ )
				{
 ...
 ituContext.OnNumAddLayerSets(); 
			...
			for ( i = 0; i < num_add_layer_sets; i++ )
			{
				...
				{
					size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling( MathEx.Log2( ituContext.NumLayersInTreePartition[ j ] + 1 ) ), out this.highest_layer_idx_plus1[ i ][ j ], "highest_layer_idx_plus1"); 
			...
			if ( max_tid_ref_present_flag != 0 )
			{
				...
				for ( i = 0; i < Math.Min( 62, ituContext.VideoParameterSetRbsp.VpsMaxLayersMinus1); i++ )
				{
					...
					for ( j = i + 1; j <= Math.Min( 62, ituContext.VideoParameterSetRbsp.VpsMaxLayersMinus1); j++ )
					{
						...
						{
							size += stream.ReadUnsignedInt(size, 3, out this.max_tid_il_ref_pics_plus1[ i ][ j ], "max_tid_il_ref_pics_plus1"); 
						}
					}
				}
			}
          ...
          i <= vps_num_profile_tier_level_minus1; i++ )
			...
			for ( i = 1; i < NumOutputLayerSets; i++ )
			{
				...
				{
					size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling( MathEx.Log2( (ituContext.VideoParameterSetRbsp.VpsNumLayerSetsMinus1 + 1 + ituContext.VideoParameterSetRbsp.VpsExtension.NumAddLayerSets) - 1 ) ) , out this.layer_set_idx_for_ols_minus1[ i ], "layer_set_idx_for_ols_minus1"); 
...
/*  if( i > vps_num_layer_sets_minus1  ||  defaultOutputLayerIdc == 2 )  */
				...
				this.output_layer_flag[ i ] = new byte[ ituContext.NumLayersInIdList[ ituContext.OlsIdxToLsIdx[ i ] ]];
				for ( j = 0; j < ituContext.NumLayersInIdList[ ituContext.OlsIdxToLsIdx[ i ] ]; j++ )
				{
					size += stream.ReadUnsignedInt(size, 1, out this.output_layer_flag[ i ][ j ], "output_layer_flag"); 
					ituContext.OnOutputLayerFlag(i, j);
				}

				this.profile_tier_level_idx[ i ] = new ulong[ ituContext.NumLayersInIdList[ ituContext.OlsIdxToLsIdx[ i ] ]];
				for ( j = 0; j < ituContext.NumLayersInIdList[ ituContext.OlsIdxToLsIdx[ i ] ]; j++ )
				{
   ...
   &&  ituContext.NumDirectRefLayers[ ituContext.OlsHighestOutputLayerId[ i ] ] > 0 )
			...
			for ( i = 0; i <= vps_num_rep_formats_minus1; i++ )
			{
				...
				size +=  stream.ReadClass<RepFormat>(size, context, this.rep_format[ i ], "rep_format"); 
			}

			if ( vps_num_rep_formats_minus1 > 0 )
			{
				size += stream.ReadUnsignedInt(size, 1, out this.rep_format_idx_present_flag, "rep_format_idx_present_flag"); 
			}
			...
			size +=  stream.ReadClass<DpbSize>(size, context, this.dpb_size, "dpb_size"); 
			size += stream.ReadUnsignedIntGolomb(size, out this.direct_dep_type_len_minus2, "direct_dep_type_len_minus2"); 
			size += stream.ReadUnsignedInt(size, 1, out this.direct_dependency_all_layers_flag, "direct_dependency_all_layers_flag"); 
			...
			size += stream.ReadUnsignedInt(size, 1, out this.vps_vui_present_flag, "vps_vui_present_flag"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			size += stream.WriteUnsignedInt(1, this.splitting_flag, "splitting_flag"); 

			for ( i = 0, NumScalabilityTypes = 0; i < 16; i++ )
			{
				size += stream.WriteUnsignedInt(1, this.scalability_mask_flag[ i ], "scalability_mask_flag"); 
				NumScalabilityTypes+= scalability_mask_flag[ i ];
			}

			for ( j = 0; j < ( NumScalabilityTypes - splitting_flag ); j++ )
			{
				size += stream.WriteUnsignedInt(3, this.dimension_id_len_minus1[ j ], "dimension_id_len_minus1"); 
			}
 ...
 ituContext.OnNumAddLayerSets(); 
			...
			for ( i = 0; i < num_add_layer_sets; i++ )
			{
				...
				for ( j = 1; j < ituContext.NumIndependentLayers; j++ )
				{
					size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling( MathEx.Log2( ituContext.NumLayersInTreePartition[ j ] + 1 ) ), this.highest_layer_idx_plus1[ i ][ j ], "highest_layer_idx_plus1"); 
					ituContext.OnHighestLayerIdxPlus1(i);
				}
			}
			...
			if ( max_tid_ref_present_flag != 0 )
			{
				...
				for ( i = 0; i < Math.Min( 62, ituContext.VideoParameterSetRbsp.VpsMaxLayersMinus1); i++ )
				{
					...
					for ( j = i + 1; j <= Math.Min( 62, ituContext.VideoParameterSetRbsp.VpsMaxLayersMinus1); j++ )
					{
						...
						if ( direct_dependency_flag[ j ][ i ] != 0 )
						{
							size += stream.WriteUnsignedInt(3, this.max_tid_il_ref_pics_plus1[ i ][ j ], "max_tid_il_ref_pics_plus1"); 
						}
					}
				}
			}
          ...
          i <= vps_num_profile_tier_level_minus1; i++ )
			...
			for ( i = 1; i < NumOutputLayerSets; i++ )
			{
				...
				if ( (ituContext.VideoParameterSetRbsp.VpsNumLayerSetsMinus1 + 1 + ituContext.VideoParameterSetRbsp.VpsExtension.NumAddLayerSets) > 2  &&  i >= (ituContext.VideoParameterSetRbsp.VpsNumLayerSetsMinus1 + 1 + ituContext.VideoParameterSetRbsp.VpsExtension.NumAddLayerSets) )
				{
					size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling( MathEx.Log2( (ituContext.VideoParameterSetRbsp.VpsNumLayerSetsMinus1 + 1 + ituContext.VideoParameterSetRbsp.VpsExtension.NumAddLayerSets) - 1 ) ) , this.layer_set_idx_for_ols_minus1[ i ], "layer_set_idx_for_ols_minus1"); 
					ituContext.OnLayerSetIdxForOlsMinus1(i, NumOutputLayerSets);
				}
				else
				{
...
/*  if( i > vps_num_layer_sets_minus1  ||  defaultOutputLayerIdc == 2 )  */
   ...
   &&  ituContext.NumDirectRefLayers[ ituContext.OlsHighestOutputLayerId[ i ] ] > 0 )
			...
			size += stream.WriteUnsignedIntGolomb( this.vps_num_rep_formats_minus1, "vps_num_rep_formats_minus1"); 

			for ( i = 0; i <= vps_num_rep_formats_minus1; i++ )
			{
				size += stream.WriteClass<RepFormat>(context, this.rep_format[ i ], "rep_format"); 
			}

			if ( vps_num_rep_formats_minus1 > 0 )
			{
				size += stream.WriteUnsignedInt(1, this.rep_format_idx_present_flag, "rep_format_idx_present_flag"); 
			}
			...
			size += stream.WriteClass<DpbSize>(context, this.dpb_size, "dpb_size"); 
			size += stream.WriteUnsignedIntGolomb( this.direct_dep_type_len_minus2, "direct_dep_type_len_minus2"); 
			size += stream.WriteUnsignedInt(1, this.direct_dependency_all_layers_flag, "direct_dependency_all_layers_flag"); 
			...
			size += stream.WriteUnsignedIntGolomb( this.vps_non_vui_extension_length, "vps_non_vui_extension_length"); 

			for ( i = 1; i <= vps_non_vui_extension_length; i++ )
			{
				size += stream.WriteUnsignedInt(8, this.vps_non_vui_extension_data_byte[ i ], "vps_non_vui_extension_data_byte"); 
			}
			size += stream.WriteUnsignedInt(1, this.vps_vui_present_flag, "vps_vui_present_flag"); 
  ...
  conf_win_vps_bottom_offset ue(v) 
    ...
    */
    public class RepFormat : IItuSerializable
    {
		...
		private ulong conf_win_vps_left_offset;
		public ulong ConfWinVpsLeftOffset { get { return conf_win_vps_left_offset; } set { conf_win_vps_left_offset = value; } }
		private ulong conf_win_vps_right_offset;
		public ulong ConfWinVpsRightOffset { get { return conf_win_vps_right_offset; } set { conf_win_vps_right_offset = value; } }
		private ulong conf_win_vps_top_offset;
		public ulong ConfWinVpsTopOffset { get { return conf_win_vps_top_offset; } set { conf_win_vps_top_offset = value; } }
		private ulong conf_win_vps_bottom_offset;
		public ulong ConfWinVpsBottomOffset { get { return conf_win_vps_bottom_offset; } set { conf_win_vps_bottom_offset = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			size += stream.ReadUnsignedInt(size, 16, out this.pic_height_vps_in_luma_samples, "pic_height_vps_in_luma_samples"); 
			size += stream.ReadUnsignedInt(size, 1, out this.chroma_and_bit_depth_vps_present_flag, "chroma_and_bit_depth_vps_present_flag"); 

			if ( chroma_and_bit_depth_vps_present_flag != 0 )
			{
				size += stream.ReadUnsignedInt(size, 2, out this.chroma_format_vps_idc, "chroma_format_vps_idc"); 

				if ( chroma_format_vps_idc == 3 )
				{
					size += stream.ReadUnsignedInt(size, 1, out this.separate_colour_plane_vps_flag, "separate_colour_plane_vps_flag"); 
				}
				size += stream.ReadUnsignedInt(size, 4, out this.bit_depth_vps_luma_minus8, "bit_depth_vps_luma_minus8"); 
				size += stream.ReadUnsignedInt(size, 4, out this.bit_depth_vps_chroma_minus8, "bit_depth_vps_chroma_minus8"); 
			}
			size += stream.ReadUnsignedInt(size, 1, out this.conformance_window_vps_flag, "conformance_window_vps_flag"); 

			if ( conformance_window_vps_flag != 0 )
			{
				size += stream.ReadUnsignedIntGolomb(size, out this.conf_win_vps_left_offset, "conf_win_vps_left_offset"); 
				size += stream.ReadUnsignedIntGolomb(size, out this.conf_win_vps_right_offset, "conf_win_vps_right_offset"); 
				size += stream.ReadUnsignedIntGolomb(size, out this.conf_win_vps_top_offset, "conf_win_vps_top_offset"); 
				size += stream.ReadUnsignedIntGolomb(size, out this.conf_win_vps_bottom_offset, "conf_win_vps_bottom_offset"); 
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			size += stream.WriteUnsignedInt(16, this.pic_height_vps_in_luma_samples, "pic_height_vps_in_luma_samples"); 
			size += stream.WriteUnsignedInt(1, this.chroma_and_bit_depth_vps_present_flag, "chroma_and_bit_depth_vps_present_flag"); 

			if ( chroma_and_bit_depth_vps_present_flag != 0 )
			{
				size += stream.WriteUnsignedInt(2, this.chroma_format_vps_idc, "chroma_format_vps_idc"); 

				if ( chroma_format_vps_idc == 3 )
				{
					size += stream.WriteUnsignedInt(1, this.separate_colour_plane_vps_flag, "separate_colour_plane_vps_flag"); 
				}
				size += stream.WriteUnsignedInt(4, this.bit_depth_vps_luma_minus8, "bit_depth_vps_luma_minus8"); 
				size += stream.WriteUnsignedInt(4, this.bit_depth_vps_chroma_minus8, "bit_depth_vps_chroma_minus8"); 
			}
			size += stream.WriteUnsignedInt(1, this.conformance_window_vps_flag, "conformance_window_vps_flag"); 

			if ( conformance_window_vps_flag != 0 )
			{
				size += stream.WriteUnsignedIntGolomb( this.conf_win_vps_left_offset, "conf_win_vps_left_offset"); 
				size += stream.WriteUnsignedIntGolomb( this.conf_win_vps_right_offset, "conf_win_vps_right_offset"); 
				size += stream.WriteUnsignedIntGolomb( this.conf_win_vps_top_offset, "conf_win_vps_top_offset"); 
				size += stream.WriteUnsignedIntGolomb( this.conf_win_vps_bottom_offset, "conf_win_vps_bottom_offset"); 
			}
  ...
  for( j = 0; j <= MaxSubLayersInLayerSetMinus1[ currLsIdx ]; j++ ) {  
    ...
    */
    public class DpbSize : IItuSerializable
    {
		...
		private ulong[][][] max_vps_dec_pic_buffering_minus1;
		public ulong[][][] MaxVpsDecPicBufferingMinus1 { get { return max_vps_dec_pic_buffering_minus1; } set { max_vps_dec_pic_buffering_minus1 = value; } }
		private ulong[][] max_vps_num_reorder_pics;
		public ulong[][] MaxVpsNumReorderPics { get { return max_vps_num_reorder_pics; } set { max_vps_num_reorder_pics = value; } }
		private ulong[][] max_vps_latency_increase_plus1;
		public ulong[][] MaxVpsLatencyIncreasePlus1 { get { return max_vps_latency_increase_plus1; } set { max_vps_latency_increase_plus1 = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			{
				currLsIdx= ituContext.OlsIdxToLsIdx[ i ];
				...
				for ( j = 0; j <= ituContext.MaxSubLayersInLayerSetMinus1[ currLsIdx ]; j++ )
				{
					...
					{
						size += stream.ReadUnsignedInt(size, 1, out this.sub_layer_dpb_info_present_flag[ i ][ j ], "sub_layer_dpb_info_present_flag"); 
					}
      ...
      ( ituContext.LayerSetLayerIdList[ currLsIdx ][ k ] != 0 ) ) )
						...
						size += stream.ReadUnsignedIntGolomb(size, out this.max_vps_num_reorder_pics[ i ][ j ], "max_vps_num_reorder_pics"); 
						size += stream.ReadUnsignedIntGolomb(size, out this.max_vps_latency_increase_plus1[ i ][ j ], "max_vps_latency_increase_plus1"); 
					}
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			for ( i = 1; i < ituContext.VideoParameterSetRbsp.VpsExtension.NumOutputLayerSets; i++ )
			{
				...
				for ( j = 0; j <= ituContext.MaxSubLayersInLayerSetMinus1[ currLsIdx ]; j++ )
				{
					...
					if ( j > 0  &&  sub_layer_flag_info_present_flag[ i ] != 0 )
					{
						size += stream.WriteUnsignedInt(1, this.sub_layer_dpb_info_present_flag[ i ][ j ], "sub_layer_dpb_info_present_flag"); 
					}
      ...
      ( ituContext.LayerSetLayerIdList[ currLsIdx ][ k ] != 0 ) ) )
						...
						size += stream.WriteUnsignedIntGolomb( this.max_vps_num_reorder_pics[ i ][ j ], "max_vps_num_reorder_pics"); 
						size += stream.WriteUnsignedIntGolomb( this.max_vps_latency_increase_plus1[ i ][ j ], "max_vps_latency_increase_plus1"); 
					}
				}
			}
...
vps_vui() {  
 ...
 if( bit_rate_present_vps_flag  ||  pic_rate_present_vps_flag )  
  for( i = (uint)(vps_base_layer_internal_flag != 0 ? 0 : 1); i < NumLayerSets; i++ )  
 ...
 if( video_signal_info_idx_present_flag  &&  vps_num_video_signal_info_minus1 > 0 )  
  for( i = (uint)(vps_base_layer_internal_flag != 0 ? 0 : 1); i <= MaxLayersMinus1; i++ )  
  ...
  if( NumDirectRefLayers[ layer_id_in_nuh[ i ] ] == 0 )  
    ...
    */
    public class VpsVui : IItuSerializable
    {
		...
		private ulong[][] min_spatial_segment_offset_plus1;
		public ulong[][] MinSpatialSegmentOffsetPlus1 { get { return min_spatial_segment_offset_plus1; } set { min_spatial_segment_offset_plus1 = value; } }
		...
		private ulong[][] min_horizontal_ctu_offset_plus1;
		public ulong[][] MinHorizontalCtuOffsetPlus1 { get { return min_horizontal_ctu_offset_plus1; } set { min_horizontal_ctu_offset_plus1 = value; } }
		...
		public byte[] BaseLayerParameterSetCompatibilityFlag { get { return base_layer_parameter_set_compatibility_flag; } set { base_layer_parameter_set_compatibility_flag = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			{
				size += stream.ReadUnsignedInt(size, 1, out this.cross_layer_irap_aligned_flag, "cross_layer_irap_aligned_flag"); 
			}

			if ( cross_layer_irap_aligned_flag != 0 )
			{
				size += stream.ReadUnsignedInt(size, 1, out this.all_layers_idr_aligned_flag, "all_layers_idr_aligned_flag"); 
			}
			size += stream.ReadUnsignedInt(size, 1, out this.bit_rate_present_vps_flag, "bit_rate_present_vps_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.pic_rate_present_vps_flag, "pic_rate_present_vps_flag"); 
			...
			if ( bit_rate_present_vps_flag != 0  ||  pic_rate_present_vps_flag != 0 )
			{
				...
				for ( i = (uint)(ituContext.VideoParameterSetRbsp.VpsBaseLayerInternalFlag != 0 ? 0 : 1); i < (ituContext.VideoParameterSetRbsp.VpsNumLayerSetsMinus1 + 1 + ituContext.VideoParameterSetRbsp.VpsExtension.NumAddLayerSets); i++ )
				{
					...
					for ( j = 0; j <= ituContext.MaxSubLayersInLayerSetMinus1[ i ]; j++ )
					{
						...
						{
							size += stream.ReadUnsignedInt(size, 1, out this.bit_rate_present_flag[ i ][ j ], "bit_rate_present_flag"); 
						}

						if ( pic_rate_present_vps_flag != 0 )
						{
							size += stream.ReadUnsignedInt(size, 1, out this.pic_rate_present_flag[ i ][ j ], "pic_rate_present_flag"); 
						}

						if ( bit_rate_present_flag[ i ][ j ] != 0 )
						{
							size += stream.ReadUnsignedInt(size, 16, out this.avg_bit_rate[ i ][ j ], "avg_bit_rate"); 
							size += stream.ReadUnsignedInt(size, 16, out this.max_bit_rate[ i ][ j ], "max_bit_rate"); 
						}

						if ( pic_rate_present_flag[ i ][ j ] != 0 )
						{
							size += stream.ReadUnsignedInt(size, 2, out this.constant_pic_rate_idc[ i ][ j ], "constant_pic_rate_idc"); 
							size += stream.ReadUnsignedInt(size, 16, out this.avg_pic_rate[ i ][ j ], "avg_pic_rate"); 
						}
					}
				}
			}
			size += stream.ReadUnsignedInt(size, 1, out this.video_signal_info_idx_present_flag, "video_signal_info_idx_present_flag"); 
			...
			for ( i = 0; i <= vps_num_video_signal_info_minus1; i++ )
			{
				...
				size +=  stream.ReadClass<VideoSignalInfo>(size, context, this.video_signal_info[ i ], "video_signal_info"); 
			}
			...
			size += stream.ReadUnsignedInt(size, 1, out this.tiles_not_in_use_flag, "tiles_not_in_use_flag"); 
			...
			if ( tiles_not_in_use_flag== 0 )
			{
				...
				for ( i = (uint)(ituContext.VideoParameterSetRbsp.VpsBaseLayerInternalFlag != 0 ? 0 : 1); i <= Math.Min( 62, ituContext.VideoParameterSetRbsp.VpsMaxLayersMinus1); i++ )
				{
					...
					{
						size += stream.ReadUnsignedInt(size, 1, out this.loop_filter_not_across_tiles_flag[ i ], "loop_filter_not_across_tiles_flag"); 
					}
				}
				...
				for ( i = (uint)(ituContext.VideoParameterSetRbsp.VpsBaseLayerInternalFlag != 0 ? 1 : 2); i <= Math.Min( 62, ituContext.VideoParameterSetRbsp.VpsMaxLayersMinus1); i++ )
				{
					...
					for ( j = 0; j < ituContext.NumDirectRefLayers[ ituContext.VideoParameterSetRbsp.VpsExtension.LayerIdInNuh[ i ] ]; j++ )
					{
						...
						{
							size += stream.ReadUnsignedInt(size, 1, out this.tile_boundaries_aligned_flag[ i ][ j ], "tile_boundaries_aligned_flag"); 
						}
					}
				}
			}
			size += stream.ReadUnsignedInt(size, 1, out this.wpp_not_in_use_flag, "wpp_not_in_use_flag"); 
			...
			size += stream.ReadUnsignedInt(size, 1, out this.single_layer_for_non_irap_flag, "single_layer_for_non_irap_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.higher_layer_irap_skip_flag, "higher_layer_irap_skip_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.ilp_restricted_ref_layers_flag, "ilp_restricted_ref_layers_flag"); 
        ...
        ituContext.IdDirectRefLayer[ ituContext.VideoParameterSetRbsp.VpsExtension.LayerIdInNuh[ i ] ][ j ] > 0 )
						{
							...
							if ( min_spatial_segment_offset_plus1[ i ][ j ] > 0 )
							{
								size += stream.ReadUnsignedInt(size, 1, out this.ctu_based_offset_enabled_flag[ i ][ j ], "ctu_based_offset_enabled_flag"); 

								if ( ctu_based_offset_enabled_flag[ i ][ j ] != 0 )
								{
									size += stream.ReadUnsignedIntGolomb(size, out this.min_horizontal_ctu_offset_plus1[ i ][ j ], "min_horizontal_ctu_offset_plus1"); 
								}
							}
						}
					}
			...
			size += stream.ReadUnsignedInt(size, 1, out this.vps_vui_bsp_hrd_present_flag, "vps_vui_bsp_hrd_present_flag"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( cross_layer_pic_type_aligned_flag== 0 )
			{
				size += stream.WriteUnsignedInt(1, this.cross_layer_irap_aligned_flag, "cross_layer_irap_aligned_flag"); 
			}

			if ( cross_layer_irap_aligned_flag != 0 )
			{
				size += stream.WriteUnsignedInt(1, this.all_layers_idr_aligned_flag, "all_layers_idr_aligned_flag"); 
			}
			size += stream.WriteUnsignedInt(1, this.bit_rate_present_vps_flag, "bit_rate_present_vps_flag"); 
			size += stream.WriteUnsignedInt(1, this.pic_rate_present_vps_flag, "pic_rate_present_vps_flag"); 
			...
			if ( bit_rate_present_vps_flag != 0  ||  pic_rate_present_vps_flag != 0 )
			{
				...
				for ( i = (uint)(ituContext.VideoParameterSetRbsp.VpsBaseLayerInternalFlag != 0 ? 0 : 1); i < (ituContext.VideoParameterSetRbsp.VpsNumLayerSetsMinus1 + 1 + ituContext.VideoParameterSetRbsp.VpsExtension.NumAddLayerSets); i++ )
				{
					...
					for ( j = 0; j <= ituContext.MaxSubLayersInLayerSetMinus1[ i ]; j++ )
					{
						...
						if ( bit_rate_present_vps_flag != 0 )
						{
							size += stream.WriteUnsignedInt(1, this.bit_rate_present_flag[ i ][ j ], "bit_rate_present_flag"); 
						}

						if ( pic_rate_present_vps_flag != 0 )
						{
							size += stream.WriteUnsignedInt(1, this.pic_rate_present_flag[ i ][ j ], "pic_rate_present_flag"); 
						}

						if ( bit_rate_present_flag[ i ][ j ] != 0 )
						{
							size += stream.WriteUnsignedInt(16, this.avg_bit_rate[ i ][ j ], "avg_bit_rate"); 
							size += stream.WriteUnsignedInt(16, this.max_bit_rate[ i ][ j ], "max_bit_rate"); 
						}

						if ( pic_rate_present_flag[ i ][ j ] != 0 )
						{
							size += stream.WriteUnsignedInt(2, this.constant_pic_rate_idc[ i ][ j ], "constant_pic_rate_idc"); 
							size += stream.WriteUnsignedInt(16, this.avg_pic_rate[ i ][ j ], "avg_pic_rate"); 
						}
					}
				}
			}
			size += stream.WriteUnsignedInt(1, this.video_signal_info_idx_present_flag, "video_signal_info_idx_present_flag"); 

			if ( video_signal_info_idx_present_flag != 0 )
			{
				size += stream.WriteUnsignedInt(4, this.vps_num_video_signal_info_minus1, "vps_num_video_signal_info_minus1"); 
			}

			for ( i = 0; i <= vps_num_video_signal_info_minus1; i++ )
			{
				size += stream.WriteClass<VideoSignalInfo>(context, this.video_signal_info[ i ], "video_signal_info"); 
			}
			...
			size += stream.WriteUnsignedInt(1, this.tiles_not_in_use_flag, "tiles_not_in_use_flag"); 
			...
			if ( tiles_not_in_use_flag== 0 )
			{
				...
				for ( i = (uint)(ituContext.VideoParameterSetRbsp.VpsBaseLayerInternalFlag != 0 ? 0 : 1); i <= Math.Min( 62, ituContext.VideoParameterSetRbsp.VpsMaxLayersMinus1); i++ )
				{
					...
					if ( tiles_in_use_flag[ i ] != 0 )
					{
						size += stream.WriteUnsignedInt(1, this.loop_filter_not_across_tiles_flag[ i ], "loop_filter_not_across_tiles_flag"); 
					}
				}
				...
				for ( i = (uint)(ituContext.VideoParameterSetRbsp.VpsBaseLayerInternalFlag != 0 ? 1 : 2); i <= Math.Min( 62, ituContext.VideoParameterSetRbsp.VpsMaxLayersMinus1); i++ )
				{
					...
					for ( j = 0; j < ituContext.NumDirectRefLayers[ ituContext.VideoParameterSetRbsp.VpsExtension.LayerIdInNuh[ i ] ]; j++ )
					{
						...
						if ( tiles_in_use_flag[ i ] != 0  &&  tiles_in_use_flag[ layerIdx ] != 0 )
						{
							size += stream.WriteUnsignedInt(1, this.tile_boundaries_aligned_flag[ i ][ j ], "tile_boundaries_aligned_flag"); 
						}
					}
				}
			}
			size += stream.WriteUnsignedInt(1, this.wpp_not_in_use_flag, "wpp_not_in_use_flag"); 
			...
			size += stream.WriteUnsignedInt(1, this.single_layer_for_non_irap_flag, "single_layer_for_non_irap_flag"); 
			size += stream.WriteUnsignedInt(1, this.higher_layer_irap_skip_flag, "higher_layer_irap_skip_flag"); 
			size += stream.WriteUnsignedInt(1, this.ilp_restricted_ref_layers_flag, "ilp_restricted_ref_layers_flag"); 
        ...
        ituContext.IdDirectRefLayer[ ituContext.VideoParameterSetRbsp.VpsExtension.LayerIdInNuh[ i ] ][ j ] > 0 )
						{
							...
							if ( min_spatial_segment_offset_plus1[ i ][ j ] > 0 )
							{
								size += stream.WriteUnsignedInt(1, this.ctu_based_offset_enabled_flag[ i ][ j ], "ctu_based_offset_enabled_flag"); 

								if ( ctu_based_offset_enabled_flag[ i ][ j ] != 0 )
								{
									size += stream.WriteUnsignedIntGolomb( this.min_horizontal_ctu_offset_plus1[ i ][ j ], "min_horizontal_ctu_offset_plus1"); 
								}
							}
						}
					}
			...
			size += stream.WriteUnsignedInt(1, this.vps_vui_bsp_hrd_present_flag, "vps_vui_bsp_hrd_present_flag"); 
    ...
    public class VideoSignalInfo : IItuSerializable
    {
		...
		public uint MatrixCoeffsVps { get { return matrix_coeffs_vps; } set { matrix_coeffs_vps = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			size += stream.ReadUnsignedInt(size, 1, out this.video_full_range_vps_flag, "video_full_range_vps_flag"); 
			size += stream.ReadUnsignedInt(size, 8, out this.colour_primaries_vps, "colour_primaries_vps"); 
			size += stream.ReadUnsignedInt(size, 8, out this.transfer_characteristics_vps, "transfer_characteristics_vps"); 
			size += stream.ReadUnsignedInt(size, 8, out this.matrix_coeffs_vps, "matrix_coeffs_vps"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			size += stream.WriteUnsignedInt(1, this.video_full_range_vps_flag, "video_full_range_vps_flag"); 
			size += stream.WriteUnsignedInt(8, this.colour_primaries_vps, "colour_primaries_vps"); 
			size += stream.WriteUnsignedInt(8, this.transfer_characteristics_vps, "transfer_characteristics_vps"); 
			size += stream.WriteUnsignedInt(8, this.matrix_coeffs_vps, "matrix_coeffs_vps"); 
 ...
 if( vps_num_hrd_parameters + vps_num_add_hrd_params > 0 )  
  for( h = 1; h < NumOutputLayerSets; h++ ) {  
    ...
    */
    ...
    {
		private ulong vps_num_add_hrd_params;
		public ulong VpsNumAddHrdParams { get { return vps_num_add_hrd_params; } set { vps_num_add_hrd_params = value; } }
		...
		private ulong[] num_sub_layer_hrd_minus1;
		public ulong[] NumSubLayerHrdMinus1 { get { return num_sub_layer_hrd_minus1; } set { num_sub_layer_hrd_minus1 = value; } }
		private HrdParameters[] hrd_parameters;
		public HrdParameters[] HrdParameters { get { return hrd_parameters; } set { hrd_parameters = value; } }
		private ulong[] num_signalled_partitioning_schemes;
		public ulong[] NumSignalledPartitioningSchemes { get { return num_signalled_partitioning_schemes; } set { num_signalled_partitioning_schemes = value; } }
		private ulong[][] num_partitions_in_scheme_minus1;
		public ulong[][] NumPartitionsInSchemeMinus1 { get { return num_partitions_in_scheme_minus1; } set { num_partitions_in_scheme_minus1 = value; } }
		...
		private ulong[][][] num_bsp_schedules_minus1;
		public ulong[][][] NumBspSchedulesMinus1 { get { return num_bsp_schedules_minus1; } set { num_bsp_schedules_minus1 = value; } }
		private ulong[][][][][] bsp_hrd_idx;
		public ulong[][][][][] BspHrdIdx { get { return bsp_hrd_idx; } set { bsp_hrd_idx = value; } }
		private ulong[][][][][] bsp_sched_idx;
		public ulong[][][][][] BspSchedIdx { get { return bsp_sched_idx; } set { bsp_sched_idx = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
                  ...
                  vps_num_add_hrd_params; i++ )
			{
				...
				if ( i > 0 )
				{
					size += stream.ReadUnsignedInt(size, 1, out this.cprms_add_present_flag[ i ], "cprms_add_present_flag"); 
				}
				size += stream.ReadUnsignedIntGolomb(size, out this.num_sub_layer_hrd_minus1[ i ], "num_sub_layer_hrd_minus1"); 
			...
			if ( (uint)ituContext.VideoParameterSetRbsp.VpsNumHrdParameters + vps_num_add_hrd_params > 0 )
			{
				...
				for ( h = 1; h < ituContext.VideoParameterSetRbsp.VpsExtension.NumOutputLayerSets; h++ )
				{
					...
					this.num_partitions_in_scheme_minus1[ h ] = new ulong[ num_signalled_partitioning_schemes[ h ] + 1];
					this.layer_included_in_partition_flag[ h ] = new byte[ num_signalled_partitioning_schemes[ h ] + 1][][];
					for ( j = 1; j < num_signalled_partitioning_schemes[ h ] + 1; j++ )
					{
						size += stream.ReadUnsignedIntGolomb(size, out this.num_partitions_in_scheme_minus1[ h ][ j ], "num_partitions_in_scheme_minus1"); 

						this.layer_included_in_partition_flag[ h ][ j ] = new byte[ num_partitions_in_scheme_minus1[ h ][ j ] + 1][];
						for ( k = 0; k <= num_partitions_in_scheme_minus1[ h ][ j ]; k++ )
						{

							this.layer_included_in_partition_flag[ h ][ j ][ k ] = new byte[ ituContext.NumLayersInIdList[ ituContext.OlsIdxToLsIdx[ h ] ]];
							for ( r = 0; r < ituContext.NumLayersInIdList[ ituContext.OlsIdxToLsIdx[ h ] ]; r++ )
							{
					...
					this.num_bsp_schedules_minus1[ h ] = new ulong[ num_signalled_partitioning_schemes[ h ] + 1][];
					this.bsp_hrd_idx[ h ] = new ulong[ num_signalled_partitioning_schemes[ h ] + 1][][][];
					this.bsp_sched_idx[ h ] = new ulong[ num_signalled_partitioning_schemes[ h ] + 1][][][];
					for ( i = 0; i < num_signalled_partitioning_schemes[ h ] + 1; i++ )
					{

						this.num_bsp_schedules_minus1[ h ][ i ] = new ulong[ ituContext.MaxSubLayersInLayerSetMinus1 + 1[ ituContext.OlsIdxToLsIdx[ h ] ]];
						this.bsp_hrd_idx[ h ][ i ] = new ulong[ ituContext.MaxSubLayersInLayerSetMinus1 + 1[ ituContext.OlsIdxToLsIdx[ h ] ]][][];
						this.bsp_sched_idx[ h ][ i ] = new ulong[ ituContext.MaxSubLayersInLayerSetMinus1 + 1[ ituContext.OlsIdxToLsIdx[ h ] ]][][];
						for ( t = 0; t <= ituContext.MaxSubLayersInLayerSetMinus1[ ituContext.OlsIdxToLsIdx[ h ] ]; t++ )
						{
							...
							for ( j = 0; j <= num_bsp_schedules_minus1[ h ][ i ][ t ]; j++ )
							{
								...
								this.bsp_hrd_idx[ h ][ i ][ t ][ j ] = new ulong[ num_partitions_in_scheme_minus1[ h ][ i ] + 1];
								this.bsp_sched_idx[ h ][ i ][ t ][ j ] = new ulong[ num_partitions_in_scheme_minus1[ h ][ i ] + 1];
								for ( k = 0; k <= num_partitions_in_scheme_minus1[ h ][ i ]; k++ )
								{

									if ( (uint)ituContext.VideoParameterSetRbsp.VpsNumHrdParameters + vps_num_add_hrd_params > 1 )
									{
										size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling( MathEx.Log2(ituContext.VideoParameterSetRbsp.VpsNumHrdParameters + vps_num_add_hrd_params ) ), out this.bsp_hrd_idx[ h ][ i ][ t ][ j ][ k ], "bsp_hrd_idx"); 
									}
									size += stream.ReadUnsignedIntGolomb(size, out this.bsp_sched_idx[ h ][ i ][ t ][ j ][ k ], "bsp_sched_idx"); 
								}
							}
						}
					}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
                  ...
                  vps_num_add_hrd_params; i++ )
			{
				...
				if ( i > 0 )
				{
					size += stream.WriteUnsignedInt(1, this.cprms_add_present_flag[ i ], "cprms_add_present_flag"); 
				}
				size += stream.WriteUnsignedIntGolomb( this.num_sub_layer_hrd_minus1[ i ], "num_sub_layer_hrd_minus1"); 
			...
			if ( (uint)ituContext.VideoParameterSetRbsp.VpsNumHrdParameters + vps_num_add_hrd_params > 0 )
			{
				...
				for ( h = 1; h < ituContext.VideoParameterSetRbsp.VpsExtension.NumOutputLayerSets; h++ )
				{
					...
					for ( j = 1; j < num_signalled_partitioning_schemes[ h ] + 1; j++ )
					{
						size += stream.WriteUnsignedIntGolomb( this.num_partitions_in_scheme_minus1[ h ][ j ], "num_partitions_in_scheme_minus1"); 
						...
						for ( t = 0; t <= ituContext.MaxSubLayersInLayerSetMinus1[ ituContext.OlsIdxToLsIdx[ h ] ]; t++ )
						{
							...
							for ( j = 0; j <= num_bsp_schedules_minus1[ h ][ i ][ t ]; j++ )
							{
								...
								for ( k = 0; k <= num_partitions_in_scheme_minus1[ h ][ i ]; k++ )
								{
									...
									if ( (uint)ituContext.VideoParameterSetRbsp.VpsNumHrdParameters + vps_num_add_hrd_params > 1 )
									{
										size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling( MathEx.Log2(ituContext.VideoParameterSetRbsp.VpsNumHrdParameters + vps_num_add_hrd_params ) ), this.bsp_hrd_idx[ h ][ i ][ t ][ j ][ k ], "bsp_hrd_idx"); 
									}
									size += stream.WriteUnsignedIntGolomb( this.bsp_sched_idx[ h ][ i ][ t ][ j ][ k ], "bsp_sched_idx"); 
								}
							}
						}
					}
 ...
 rbsp_trailing_bits()  
    ...
    */
    public class SeqParameterSetRbsp : IItuSerializable
    {
		...
		private ProfileTierLevel profile_tier_level;
		public ProfileTierLevel ProfileTierLevel { get { return profile_tier_level; } set { profile_tier_level = value; } }
		private ulong sps_seq_parameter_set_id;
		public ulong SpsSeqParameterSetId { get { return sps_seq_parameter_set_id; } set { sps_seq_parameter_set_id = value; } }
		...
		private ulong chroma_format_idc;
		...
		private ulong pic_width_in_luma_samples;
		public ulong PicWidthInLumaSamples { get { return pic_width_in_luma_samples; } set { pic_width_in_luma_samples = value; } }
		private ulong pic_height_in_luma_samples;
		public ulong PicHeightInLumaSamples { get { return pic_height_in_luma_samples; } set { pic_height_in_luma_samples = value; } }
		...
		private ulong conf_win_left_offset;
		public ulong ConfWinLeftOffset { get { return conf_win_left_offset; } set { conf_win_left_offset = value; } }
		private ulong conf_win_right_offset;
		public ulong ConfWinRightOffset { get { return conf_win_right_offset; } set { conf_win_right_offset = value; } }
		private ulong conf_win_top_offset;
		public ulong ConfWinTopOffset { get { return conf_win_top_offset; } set { conf_win_top_offset = value; } }
		private ulong conf_win_bottom_offset;
		public ulong ConfWinBottomOffset { get { return conf_win_bottom_offset; } set { conf_win_bottom_offset = value; } }
		...
		private ulong[] sps_max_dec_pic_buffering_minus1;
		public ulong[] SpsMaxDecPicBufferingMinus1 { get { return sps_max_dec_pic_buffering_minus1; } set { sps_max_dec_pic_buffering_minus1 = value; } }
		private ulong[] sps_max_num_reorder_pics;
		public ulong[] SpsMaxNumReorderPics { get { return sps_max_num_reorder_pics; } set { sps_max_num_reorder_pics = value; } }
		private ulong[] sps_max_latency_increase_plus1;
		public ulong[] SpsMaxLatencyIncreasePlus1 { get { return sps_max_latency_increase_plus1; } set { sps_max_latency_increase_plus1 = value; } }
		private ulong log2_min_luma_coding_block_size_minus3;
		public ulong Log2MinLumaCodingBlockSizeMinus3 { get { return log2_min_luma_coding_block_size_minus3; } set { log2_min_luma_coding_block_size_minus3 = value; } }
		private ulong log2_diff_max_min_luma_coding_block_size;
		public ulong Log2DiffMaxMinLumaCodingBlockSize { get { return log2_diff_max_min_luma_coding_block_size; } set { log2_diff_max_min_luma_coding_block_size = value; } }
		private ulong log2_min_luma_transform_block_size_minus2;
		public ulong Log2MinLumaTransformBlockSizeMinus2 { get { return log2_min_luma_transform_block_size_minus2; } set { log2_min_luma_transform_block_size_minus2 = value; } }
		private ulong log2_diff_max_min_luma_transform_block_size;
		public ulong Log2DiffMaxMinLumaTransformBlockSize { get { return log2_diff_max_min_luma_transform_block_size; } set { log2_diff_max_min_luma_transform_block_size = value; } }
		private ulong max_transform_hierarchy_depth_inter;
		public ulong MaxTransformHierarchyDepthInter { get { return max_transform_hierarchy_depth_inter; } set { max_transform_hierarchy_depth_inter = value; } }
		private ulong max_transform_hierarchy_depth_intra;
		public ulong MaxTransformHierarchyDepthIntra { get { return max_transform_hierarchy_depth_intra; } set { max_transform_hierarchy_depth_intra = value; } }
		...
		private ulong log2_min_pcm_luma_coding_block_size_minus3;
		public ulong Log2MinPcmLumaCodingBlockSizeMinus3 { get { return log2_min_pcm_luma_coding_block_size_minus3; } set { log2_min_pcm_luma_coding_block_size_minus3 = value; } }
		private ulong log2_diff_max_min_pcm_luma_coding_block_size;
		public ulong Log2DiffMaxMinPcmLumaCodingBlockSize { get { return log2_diff_max_min_pcm_luma_coding_block_size; } set { log2_diff_max_min_pcm_luma_coding_block_size = value; } }
		...
		private ulong num_short_term_ref_pic_sets;
		public ulong NumShortTermRefPicSets { get { return num_short_term_ref_pic_sets; } set { num_short_term_ref_pic_sets = value; } }
		...
		private ulong num_long_term_ref_pics_sps;
		public ulong NumLongTermRefPicsSps { get { return num_long_term_ref_pics_sps; } set { num_long_term_ref_pics_sps = value; } }
		private ulong[] lt_ref_pic_poc_lsb_sps;
		public ulong[] LtRefPicPocLsbSps { get { return lt_ref_pic_poc_lsb_sps; } set { lt_ref_pic_poc_lsb_sps = value; } }
		...
		public RbspTrailingBits RbspTrailingBits { get { return rbsp_trailing_bits; } set { rbsp_trailing_bits = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			if ( MultiLayerExtSpsFlag != 0 )
			{
				size += stream.ReadUnsignedInt(size, 1, out this.update_rep_format_flag, "update_rep_format_flag"); 

				if ( update_rep_format_flag != 0 )
				{
					size += stream.ReadUnsignedInt(size, 8, out this.sps_rep_format_idx, "sps_rep_format_idx"); 
				}
			}
			else 
			{
				...
				size += stream.ReadUnsignedIntGolomb(size, out this.pic_width_in_luma_samples, "pic_width_in_luma_samples"); 
				size += stream.ReadUnsignedIntGolomb(size, out this.pic_height_in_luma_samples, "pic_height_in_luma_samples"); 
				size += stream.ReadUnsignedInt(size, 1, out this.conformance_window_flag, "conformance_window_flag"); 

				if ( conformance_window_flag != 0 )
				{
					size += stream.ReadUnsignedIntGolomb(size, out this.conf_win_left_offset, "conf_win_left_offset"); 
					size += stream.ReadUnsignedIntGolomb(size, out this.conf_win_right_offset, "conf_win_right_offset"); 
					size += stream.ReadUnsignedIntGolomb(size, out this.conf_win_top_offset, "conf_win_top_offset"); 
					size += stream.ReadUnsignedIntGolomb(size, out this.conf_win_bottom_offset, "conf_win_bottom_offset"); 
				}
    ...
    i <= sps_max_sub_layers_minus1; i++ )
				{
					size += stream.ReadUnsignedIntGolomb(size, out this.sps_max_dec_pic_buffering_minus1[ i ], "sps_max_dec_pic_buffering_minus1"); 
					size += stream.ReadUnsignedIntGolomb(size, out this.sps_max_num_reorder_pics[ i ], "sps_max_num_reorder_pics"); 
					size += stream.ReadUnsignedIntGolomb(size, out this.sps_max_latency_increase_plus1[ i ], "sps_max_latency_increase_plus1"); 
				}
			}
			...
			size += stream.ReadUnsignedIntGolomb(size, out this.max_transform_hierarchy_depth_intra, "max_transform_hierarchy_depth_intra"); 
			size += stream.ReadUnsignedInt(size, 1, out this.scaling_list_enabled_flag, "scaling_list_enabled_flag"); 
			...
			if ( scaling_list_enabled_flag != 0 )
			{
				...
				if ( MultiLayerExtSpsFlag != 0 )
				{
					size += stream.ReadUnsignedInt(size, 1, out this.sps_infer_scaling_list_flag, "sps_infer_scaling_list_flag"); 
				}

				if ( sps_infer_scaling_list_flag != 0 )
				{
					size += stream.ReadUnsignedInt(size, 6, out this.sps_scaling_list_ref_layer_id, "sps_scaling_list_ref_layer_id"); 
				}
				else 
				{
					size += stream.ReadUnsignedInt(size, 1, out this.sps_scaling_list_data_present_flag, "sps_scaling_list_data_present_flag"); 
			...
			size += stream.ReadUnsignedInt(size, 1, out this.amp_enabled_flag, "amp_enabled_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.sample_adaptive_offset_enabled_flag, "sample_adaptive_offset_enabled_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.pcm_enabled_flag, "pcm_enabled_flag"); 

			if ( pcm_enabled_flag != 0 )
			{
				size += stream.ReadUnsignedInt(size, 4, out this.pcm_sample_bit_depth_luma_minus1, "pcm_sample_bit_depth_luma_minus1"); 
				size += stream.ReadUnsignedInt(size, 4, out this.pcm_sample_bit_depth_chroma_minus1, "pcm_sample_bit_depth_chroma_minus1"); 
				size += stream.ReadUnsignedIntGolomb(size, out this.log2_min_pcm_luma_coding_block_size_minus3, "log2_min_pcm_luma_coding_block_size_minus3"); 
				size += stream.ReadUnsignedIntGolomb(size, out this.log2_diff_max_min_pcm_luma_coding_block_size, "log2_diff_max_min_pcm_luma_coding_block_size"); 
				size += stream.ReadUnsignedInt(size, 1, out this.pcm_loop_filter_disabled_flag, "pcm_loop_filter_disabled_flag"); 
			}
			...
			for ( i = 0; i < num_short_term_ref_pic_sets; i++ )
			{
				...
				size +=  stream.ReadClass<StRefPicSet>(size, context, this.st_ref_pic_set[ i ], "st_ref_pic_set"); 
			}
			size += stream.ReadUnsignedInt(size, 1, out this.long_term_ref_pics_present_flag, "long_term_ref_pics_present_flag"); 
			...
			if ( long_term_ref_pics_present_flag != 0 )
			{
				...
				for ( i = 0; i < num_long_term_ref_pics_sps; i++ )
				{
					size += stream.ReadUnsignedIntVariable(size, (ituContext.SeqParameterSetRbsp.Log2MaxPicOrderCntLsbMinus4 + 4), out this.lt_ref_pic_poc_lsb_sps[ i ], "lt_ref_pic_poc_lsb_sps"); 
					size += stream.ReadUnsignedInt(size, 1, out this.used_by_curr_pic_lt_sps_flag[ i ], "used_by_curr_pic_lt_sps_flag"); 
				}
			}
			size += stream.ReadUnsignedInt(size, 1, out this.sps_temporal_mvp_enabled_flag, "sps_temporal_mvp_enabled_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.strong_intra_smoothing_enabled_flag, "strong_intra_smoothing_enabled_flag"); 
			...
			size += stream.ReadUnsignedInt(size, 1, out this.sps_extension_present_flag, "sps_extension_present_flag"); 

			if ( sps_extension_present_flag != 0 )
			{
				size += stream.ReadUnsignedInt(size, 1, out this.sps_range_extension_flag, "sps_range_extension_flag"); 
			...
			if ( sps_range_extension_flag != 0 )
			{
				...
				size +=  stream.ReadClass<SpsRangeExtension>(size, context, this.sps_range_extension, "sps_range_extension"); 
			}

			if ( sps_multilayer_extension_flag != 0 )
			{
				this.sps_multilayer_extension =  new SpsMultilayerExtension() ;
				size +=  stream.ReadClass<SpsMultilayerExtension>(size, context, this.sps_multilayer_extension, "sps_multilayer_extension"); 
			}

			if ( sps_3d_extension_flag != 0 )
			{
				this.sps_3d_extension =  new Sps3dExtension() ;
				size +=  stream.ReadClass<Sps3dExtension>(size, context, this.sps_3d_extension, "sps_3d_extension"); // specified in Annex I 
			}

			if ( sps_scc_extension_flag != 0 )
			{
				this.sps_scc_extension =  new SpsSccExtension() ;
				size +=  stream.ReadClass<SpsSccExtension>(size, context, this.sps_scc_extension, "sps_scc_extension"); 
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( MultiLayerExtSpsFlag== 0 )
			{
				size += stream.WriteUnsignedInt(1, this.sps_temporal_id_nesting_flag, "sps_temporal_id_nesting_flag"); 
				size += stream.WriteClass<ProfileTierLevel>(context, this.profile_tier_level, "profile_tier_level"); 
			}
			...
			if ( MultiLayerExtSpsFlag != 0 )
			{
				size += stream.WriteUnsignedInt(1, this.update_rep_format_flag, "update_rep_format_flag"); 

				if ( update_rep_format_flag != 0 )
				{
					size += stream.WriteUnsignedInt(8, this.sps_rep_format_idx, "sps_rep_format_idx"); 
				}
			}
			else 
			{
				...
				size += stream.WriteUnsignedIntGolomb( this.pic_width_in_luma_samples, "pic_width_in_luma_samples"); 
				size += stream.WriteUnsignedIntGolomb( this.pic_height_in_luma_samples, "pic_height_in_luma_samples"); 
				size += stream.WriteUnsignedInt(1, this.conformance_window_flag, "conformance_window_flag"); 

				if ( conformance_window_flag != 0 )
				{
					size += stream.WriteUnsignedIntGolomb( this.conf_win_left_offset, "conf_win_left_offset"); 
					size += stream.WriteUnsignedIntGolomb( this.conf_win_right_offset, "conf_win_right_offset"); 
					size += stream.WriteUnsignedIntGolomb( this.conf_win_top_offset, "conf_win_top_offset"); 
					size += stream.WriteUnsignedIntGolomb( this.conf_win_bottom_offset, "conf_win_bottom_offset"); 
				}
			...
			if ( MultiLayerExtSpsFlag== 0 )
			{
				size += stream.WriteUnsignedInt(1, this.sps_sub_layer_ordering_info_present_flag, "sps_sub_layer_ordering_info_present_flag"); 

				for ( i = ( sps_sub_layer_ordering_info_present_flag != 0 ?  0 : sps_max_sub_layers_minus1 ); 
    i <= sps_max_sub_layers_minus1; i++ )
				{
					size += stream.WriteUnsignedIntGolomb( this.sps_max_dec_pic_buffering_minus1[ i ], "sps_max_dec_pic_buffering_minus1"); 
					size += stream.WriteUnsignedIntGolomb( this.sps_max_num_reorder_pics[ i ], "sps_max_num_reorder_pics"); 
					size += stream.WriteUnsignedIntGolomb( this.sps_max_latency_increase_plus1[ i ], "sps_max_latency_increase_plus1"); 
				}
			}
			...
			size += stream.WriteUnsignedIntGolomb( this.max_transform_hierarchy_depth_intra, "max_transform_hierarchy_depth_intra"); 
			size += stream.WriteUnsignedInt(1, this.scaling_list_enabled_flag, "scaling_list_enabled_flag"); 
			...
			if ( scaling_list_enabled_flag != 0 )
			{
				...
				if ( MultiLayerExtSpsFlag != 0 )
				{
					size += stream.WriteUnsignedInt(1, this.sps_infer_scaling_list_flag, "sps_infer_scaling_list_flag"); 
				}

				if ( sps_infer_scaling_list_flag != 0 )
				{
					size += stream.WriteUnsignedInt(6, this.sps_scaling_list_ref_layer_id, "sps_scaling_list_ref_layer_id"); 
				}
				else 
				{
					size += stream.WriteUnsignedInt(1, this.sps_scaling_list_data_present_flag, "sps_scaling_list_data_present_flag"); 
			...
			size += stream.WriteUnsignedInt(1, this.amp_enabled_flag, "amp_enabled_flag"); 
			size += stream.WriteUnsignedInt(1, this.sample_adaptive_offset_enabled_flag, "sample_adaptive_offset_enabled_flag"); 
			size += stream.WriteUnsignedInt(1, this.pcm_enabled_flag, "pcm_enabled_flag"); 

			if ( pcm_enabled_flag != 0 )
			{
				size += stream.WriteUnsignedInt(4, this.pcm_sample_bit_depth_luma_minus1, "pcm_sample_bit_depth_luma_minus1"); 
				size += stream.WriteUnsignedInt(4, this.pcm_sample_bit_depth_chroma_minus1, "pcm_sample_bit_depth_chroma_minus1"); 
				size += stream.WriteUnsignedIntGolomb( this.log2_min_pcm_luma_coding_block_size_minus3, "log2_min_pcm_luma_coding_block_size_minus3"); 
				size += stream.WriteUnsignedIntGolomb( this.log2_diff_max_min_pcm_luma_coding_block_size, "log2_diff_max_min_pcm_luma_coding_block_size"); 
				size += stream.WriteUnsignedInt(1, this.pcm_loop_filter_disabled_flag, "pcm_loop_filter_disabled_flag"); 
			}
			size += stream.WriteUnsignedIntGolomb( this.num_short_term_ref_pic_sets, "num_short_term_ref_pic_sets"); 

			for ( i = 0; i < num_short_term_ref_pic_sets; i++ )
			{
				size += stream.WriteClass<StRefPicSet>(context, this.st_ref_pic_set[ i ], "st_ref_pic_set"); 
			}
			size += stream.WriteUnsignedInt(1, this.long_term_ref_pics_present_flag, "long_term_ref_pics_present_flag"); 

			if ( long_term_ref_pics_present_flag != 0 )
			{
				size += stream.WriteUnsignedIntGolomb( this.num_long_term_ref_pics_sps, "num_long_term_ref_pics_sps"); 

				for ( i = 0; i < num_long_term_ref_pics_sps; i++ )
				{
					size += stream.WriteUnsignedIntVariable((ituContext.SeqParameterSetRbsp.Log2MaxPicOrderCntLsbMinus4 + 4), this.lt_ref_pic_poc_lsb_sps[ i ], "lt_ref_pic_poc_lsb_sps"); 
					size += stream.WriteUnsignedInt(1, this.used_by_curr_pic_lt_sps_flag[ i ], "used_by_curr_pic_lt_sps_flag"); 
				}
			}
			size += stream.WriteUnsignedInt(1, this.sps_temporal_mvp_enabled_flag, "sps_temporal_mvp_enabled_flag"); 
			size += stream.WriteUnsignedInt(1, this.strong_intra_smoothing_enabled_flag, "strong_intra_smoothing_enabled_flag"); 
			...
			size += stream.WriteUnsignedInt(1, this.sps_extension_present_flag, "sps_extension_present_flag"); 

			if ( sps_extension_present_flag != 0 )
			{
				size += stream.WriteUnsignedInt(1, this.sps_range_extension_flag, "sps_range_extension_flag"); 
			...
			if ( sps_range_extension_flag != 0 )
			{
				size += stream.WriteClass<SpsRangeExtension>(context, this.sps_range_extension, "sps_range_extension"); 
			}

			if ( sps_multilayer_extension_flag != 0 )
			{
				size += stream.WriteClass<SpsMultilayerExtension>(context, this.sps_multilayer_extension, "sps_multilayer_extension"); 
			}

			if ( sps_3d_extension_flag != 0 )
			{
				size += stream.WriteClass<Sps3dExtension>(context, this.sps_3d_extension, "sps_3d_extension"); // specified in Annex I 
			}

			if ( sps_scc_extension_flag != 0 )
			{
				size += stream.WriteClass<SpsSccExtension>(context, this.sps_scc_extension, "sps_scc_extension"); 
			}
  ...
  colour_mapping_table()  
    ...
    */
    public class PpsMultilayerExtension : IItuSerializable
    {
		...
		private ulong num_ref_loc_offsets;
		public ulong NumRefLocOffsets { get { return num_ref_loc_offsets; } set { num_ref_loc_offsets = value; } }
		...
		private long[] ref_region_left_offset;
		public long[] RefRegionLeftOffset { get { return ref_region_left_offset; } set { ref_region_left_offset = value; } }
		private long[] ref_region_top_offset;
		public long[] RefRegionTopOffset { get { return ref_region_top_offset; } set { ref_region_top_offset = value; } }
		private long[] ref_region_right_offset;
		public long[] RefRegionRightOffset { get { return ref_region_right_offset; } set { ref_region_right_offset = value; } }
		private long[] ref_region_bottom_offset;
		public long[] RefRegionBottomOffset { get { return ref_region_bottom_offset; } set { ref_region_bottom_offset = value; } }
		...
		private ulong[] phase_hor_luma;
		public ulong[] PhaseHorLuma { get { return phase_hor_luma; } set { phase_hor_luma = value; } }
		private ulong[] phase_ver_luma;
		public ulong[] PhaseVerLuma { get { return phase_ver_luma; } set { phase_ver_luma = value; } }
		private ulong[] phase_hor_chroma_plus8;
		public ulong[] PhaseHorChromaPlus8 { get { return phase_hor_chroma_plus8; } set { phase_hor_chroma_plus8 = value; } }
		private ulong[] phase_ver_chroma_plus8;
		public ulong[] PhaseVerChromaPlus8 { get { return phase_ver_chroma_plus8; } set { phase_ver_chroma_plus8 = value; } }
		...
		public ColourMappingTable ColourMappingTable { get { return colour_mapping_table; } set { colour_mapping_table = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			size += stream.ReadUnsignedInt(size, 1, out this.poc_reset_info_present_flag, "poc_reset_info_present_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.pps_infer_scaling_list_flag, "pps_infer_scaling_list_flag"); 

			if ( pps_infer_scaling_list_flag != 0 )
			{
				size += stream.ReadUnsignedInt(size, 6, out this.pps_scaling_list_ref_layer_id, "pps_scaling_list_ref_layer_id"); 
			}
			...
			for ( i = 0; i < num_ref_loc_offsets; i++ )
			{
				...
				size += stream.ReadUnsignedInt(size, 1, out this.scaled_ref_layer_offset_present_flag[ i ], "scaled_ref_layer_offset_present_flag"); 

				if ( scaled_ref_layer_offset_present_flag[ i ] != 0 )
				{
					size += stream.ReadSignedIntGolomb(size, out this.scaled_ref_layer_left_offset[ ref_loc_offset_layer_id[ i ] ], "scaled_ref_layer_left_offset"); 
					size += stream.ReadSignedIntGolomb(size, out this.scaled_ref_layer_top_offset[ ref_loc_offset_layer_id[ i ] ], "scaled_ref_layer_top_offset"); 
					size += stream.ReadSignedIntGolomb(size, out this.scaled_ref_layer_right_offset[ ref_loc_offset_layer_id[ i ] ], "scaled_ref_layer_right_offset"); 
					size += stream.ReadSignedIntGolomb(size, out this.scaled_ref_layer_bottom_offset[ ref_loc_offset_layer_id[ i ] ], "scaled_ref_layer_bottom_offset"); 
				}
				size += stream.ReadUnsignedInt(size, 1, out this.ref_region_offset_present_flag[ i ], "ref_region_offset_present_flag"); 

				if ( ref_region_offset_present_flag[ i ] != 0 )
				{
					size += stream.ReadSignedIntGolomb(size, out this.ref_region_left_offset[ ref_loc_offset_layer_id[ i ] ], "ref_region_left_offset"); 
					size += stream.ReadSignedIntGolomb(size, out this.ref_region_top_offset[ ref_loc_offset_layer_id[ i ] ], "ref_region_top_offset"); 
					size += stream.ReadSignedIntGolomb(size, out this.ref_region_right_offset[ ref_loc_offset_layer_id[ i ] ], "ref_region_right_offset"); 
					size += stream.ReadSignedIntGolomb(size, out this.ref_region_bottom_offset[ ref_loc_offset_layer_id[ i ] ], "ref_region_bottom_offset"); 
				}
				size += stream.ReadUnsignedInt(size, 1, out this.resample_phase_set_present_flag[ i ], "resample_phase_set_present_flag"); 

				if ( resample_phase_set_present_flag[ i ] != 0 )
				{
					size += stream.ReadUnsignedIntGolomb(size, out this.phase_hor_luma[ ref_loc_offset_layer_id[ i ] ], "phase_hor_luma"); 
					size += stream.ReadUnsignedIntGolomb(size, out this.phase_ver_luma[ ref_loc_offset_layer_id[ i ] ], "phase_ver_luma"); 
					size += stream.ReadUnsignedIntGolomb(size, out this.phase_hor_chroma_plus8[ ref_loc_offset_layer_id[ i ] ], "phase_hor_chroma_plus8"); 
					size += stream.ReadUnsignedIntGolomb(size, out this.phase_ver_chroma_plus8[ ref_loc_offset_layer_id[ i ] ], "phase_ver_chroma_plus8"); 
				}
			}
			size += stream.ReadUnsignedInt(size, 1, out this.colour_mapping_enabled_flag, "colour_mapping_enabled_flag"); 

			if ( colour_mapping_enabled_flag != 0 )
			{
				this.colour_mapping_table =  new ColourMappingTable() ;
				size +=  stream.ReadClass<ColourMappingTable>(size, context, this.colour_mapping_table, "colour_mapping_table"); 
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			size += stream.WriteUnsignedInt(1, this.poc_reset_info_present_flag, "poc_reset_info_present_flag"); 
			size += stream.WriteUnsignedInt(1, this.pps_infer_scaling_list_flag, "pps_infer_scaling_list_flag"); 

			if ( pps_infer_scaling_list_flag != 0 )
			{
				size += stream.WriteUnsignedInt(6, this.pps_scaling_list_ref_layer_id, "pps_scaling_list_ref_layer_id"); 
			}
			size += stream.WriteUnsignedIntGolomb( this.num_ref_loc_offsets, "num_ref_loc_offsets"); 

			for ( i = 0; i < num_ref_loc_offsets; i++ )
			{
				size += stream.WriteUnsignedInt(6, this.ref_loc_offset_layer_id[ i ], "ref_loc_offset_layer_id"); 
				size += stream.WriteUnsignedInt(1, this.scaled_ref_layer_offset_present_flag[ i ], "scaled_ref_layer_offset_present_flag"); 

				if ( scaled_ref_layer_offset_present_flag[ i ] != 0 )
				{
					size += stream.WriteSignedIntGolomb( this.scaled_ref_layer_left_offset[ ref_loc_offset_layer_id[ i ] ], "scaled_ref_layer_left_offset"); 
					size += stream.WriteSignedIntGolomb( this.scaled_ref_layer_top_offset[ ref_loc_offset_layer_id[ i ] ], "scaled_ref_layer_top_offset"); 
					size += stream.WriteSignedIntGolomb( this.scaled_ref_layer_right_offset[ ref_loc_offset_layer_id[ i ] ], "scaled_ref_layer_right_offset"); 
					size += stream.WriteSignedIntGolomb( this.scaled_ref_layer_bottom_offset[ ref_loc_offset_layer_id[ i ] ], "scaled_ref_layer_bottom_offset"); 
				}
				size += stream.WriteUnsignedInt(1, this.ref_region_offset_present_flag[ i ], "ref_region_offset_present_flag"); 

				if ( ref_region_offset_present_flag[ i ] != 0 )
				{
					size += stream.WriteSignedIntGolomb( this.ref_region_left_offset[ ref_loc_offset_layer_id[ i ] ], "ref_region_left_offset"); 
					size += stream.WriteSignedIntGolomb( this.ref_region_top_offset[ ref_loc_offset_layer_id[ i ] ], "ref_region_top_offset"); 
					size += stream.WriteSignedIntGolomb( this.ref_region_right_offset[ ref_loc_offset_layer_id[ i ] ], "ref_region_right_offset"); 
					size += stream.WriteSignedIntGolomb( this.ref_region_bottom_offset[ ref_loc_offset_layer_id[ i ] ], "ref_region_bottom_offset"); 
				}
				size += stream.WriteUnsignedInt(1, this.resample_phase_set_present_flag[ i ], "resample_phase_set_present_flag"); 

				if ( resample_phase_set_present_flag[ i ] != 0 )
				{
					size += stream.WriteUnsignedIntGolomb( this.phase_hor_luma[ ref_loc_offset_layer_id[ i ] ], "phase_hor_luma"); 
					size += stream.WriteUnsignedIntGolomb( this.phase_ver_luma[ ref_loc_offset_layer_id[ i ] ], "phase_ver_luma"); 
					size += stream.WriteUnsignedIntGolomb( this.phase_hor_chroma_plus8[ ref_loc_offset_layer_id[ i ] ], "phase_hor_chroma_plus8"); 
					size += stream.WriteUnsignedIntGolomb( this.phase_ver_chroma_plus8[ ref_loc_offset_layer_id[ i ] ], "phase_ver_chroma_plus8"); 
				}
			}
			size += stream.WriteUnsignedInt(1, this.colour_mapping_enabled_flag, "colour_mapping_enabled_flag"); 

			if ( colour_mapping_enabled_flag != 0 )
			{
				size += stream.WriteClass<ColourMappingTable>(context, this.colour_mapping_table, "colour_mapping_table"); 
			}
...
colour_mapping_table() {  
 ...
 colour_mapping_octants( 0, 0, 0, 0, (uint)(1  <<  (int)cm_octant_depth) )  
}
    */
    public class ColourMappingTable : IItuSerializable
    {
		private ulong num_cm_ref_layers_minus1;
		public ulong NumCmRefLayersMinus1 { get { return num_cm_ref_layers_minus1; } set { num_cm_ref_layers_minus1 = value; } }
		...
		private ulong luma_bit_depth_cm_input_minus8;
		public ulong LumaBitDepthCmInputMinus8 { get { return luma_bit_depth_cm_input_minus8; } set { luma_bit_depth_cm_input_minus8 = value; } }
		private ulong chroma_bit_depth_cm_input_minus8;
		public ulong ChromaBitDepthCmInputMinus8 { get { return chroma_bit_depth_cm_input_minus8; } set { chroma_bit_depth_cm_input_minus8 = value; } }
		private ulong luma_bit_depth_cm_output_minus8;
		public ulong LumaBitDepthCmOutputMinus8 { get { return luma_bit_depth_cm_output_minus8; } set { luma_bit_depth_cm_output_minus8 = value; } }
		private ulong chroma_bit_depth_cm_output_minus8;
		public ulong ChromaBitDepthCmOutputMinus8 { get { return chroma_bit_depth_cm_output_minus8; } set { chroma_bit_depth_cm_output_minus8 = value; } }
		...
		private long cm_adapt_threshold_u_delta;
		public long CmAdaptThresholduDelta { get { return cm_adapt_threshold_u_delta; } set { cm_adapt_threshold_u_delta = value; } }
		private long cm_adapt_threshold_v_delta;
		public long CmAdaptThresholdvDelta { get { return cm_adapt_threshold_v_delta; } set { cm_adapt_threshold_v_delta = value; } }
		...
		public ColourMappingOctants ColourMappingOctants { get { return colour_mapping_octants; } set { colour_mapping_octants = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			for ( i = 0; i <= num_cm_ref_layers_minus1; i++ )
			{
				size += stream.ReadUnsignedInt(size, 6, out this.cm_ref_layer_id[ i ], "cm_ref_layer_id"); 
			}
			size += stream.ReadUnsignedInt(size, 2, out this.cm_octant_depth, "cm_octant_depth"); 
			size += stream.ReadUnsignedInt(size, 2, out this.cm_y_part_num_log2, "cm_y_part_num_log2"); 
			size += stream.ReadUnsignedIntGolomb(size, out this.luma_bit_depth_cm_input_minus8, "luma_bit_depth_cm_input_minus8"); 
			size += stream.ReadUnsignedIntGolomb(size, out this.chroma_bit_depth_cm_input_minus8, "chroma_bit_depth_cm_input_minus8"); 
			size += stream.ReadUnsignedIntGolomb(size, out this.luma_bit_depth_cm_output_minus8, "luma_bit_depth_cm_output_minus8"); 
			size += stream.ReadUnsignedIntGolomb(size, out this.chroma_bit_depth_cm_output_minus8, "chroma_bit_depth_cm_output_minus8"); 
			size += stream.ReadUnsignedInt(size, 2, out this.cm_res_quant_bits, "cm_res_quant_bits"); 
			size += stream.ReadUnsignedInt(size, 2, out this.cm_delta_flc_bits_minus1, "cm_delta_flc_bits_minus1"); 

			if ( cm_octant_depth == 1 )
			{
				size += stream.ReadSignedIntGolomb(size, out this.cm_adapt_threshold_u_delta, "cm_adapt_threshold_u_delta"); 
				size += stream.ReadSignedIntGolomb(size, out this.cm_adapt_threshold_v_delta, "cm_adapt_threshold_v_delta"); 
			}
			this.colour_mapping_octants =  new ColourMappingOctants( 0,  0,  0,  0,  (uint)(1  <<  (int)cm_octant_depth) ) ;
			size +=  stream.ReadClass<ColourMappingOctants>(size, context, this.colour_mapping_octants, "colour_mapping_octants"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			size += stream.WriteUnsignedIntGolomb( this.num_cm_ref_layers_minus1, "num_cm_ref_layers_minus1"); 

			for ( i = 0; i <= num_cm_ref_layers_minus1; i++ )
			{
				size += stream.WriteUnsignedInt(6, this.cm_ref_layer_id[ i ], "cm_ref_layer_id"); 
			}
			size += stream.WriteUnsignedInt(2, this.cm_octant_depth, "cm_octant_depth"); 
			size += stream.WriteUnsignedInt(2, this.cm_y_part_num_log2, "cm_y_part_num_log2"); 
			size += stream.WriteUnsignedIntGolomb( this.luma_bit_depth_cm_input_minus8, "luma_bit_depth_cm_input_minus8"); 
			size += stream.WriteUnsignedIntGolomb( this.chroma_bit_depth_cm_input_minus8, "chroma_bit_depth_cm_input_minus8"); 
			size += stream.WriteUnsignedIntGolomb( this.luma_bit_depth_cm_output_minus8, "luma_bit_depth_cm_output_minus8"); 
			size += stream.WriteUnsignedIntGolomb( this.chroma_bit_depth_cm_output_minus8, "chroma_bit_depth_cm_output_minus8"); 
			size += stream.WriteUnsignedInt(2, this.cm_res_quant_bits, "cm_res_quant_bits"); 
			size += stream.WriteUnsignedInt(2, this.cm_delta_flc_bits_minus1, "cm_delta_flc_bits_minus1"); 

			if ( cm_octant_depth == 1 )
			{
				size += stream.WriteSignedIntGolomb( this.cm_adapt_threshold_u_delta, "cm_adapt_threshold_u_delta"); 
				size += stream.WriteSignedIntGolomb( this.cm_adapt_threshold_v_delta, "cm_adapt_threshold_v_delta"); 
			}
			size += stream.WriteClass<ColourMappingOctants>(context, this.colour_mapping_octants, "colour_mapping_octants"); 
  ...
  for( i = 0; i < PartNumY; i++ ) {  
    ...
    */
    public class ColourMappingOctants : IItuSerializable
    {
		...
		private ulong[][][][][] res_coeff_q;
		public ulong[][][][][] ResCoeffq { get { return res_coeff_q; } set { res_coeff_q = value; } }
		private ulong[][][][][] res_coeff_r;
		public ulong[][][][][] ResCoeffr { get { return res_coeff_r; } set { res_coeff_r = value; } }
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( split_octant_flag != 0 )
			{
				...
				for ( k = 0; k < 2; k++ )
				{
					...
					for ( m = 0; m < 2; m++ )
					{
						...
						for ( n = 0; n < 2; n++ )
						{
							size += stream.WriteClass<ColourMappingOctants>(context, this.colour_mapping_octants[ k ][ m ][ n ], "colour_mapping_octants"); 
						}
					}
				}
			}
			else 
			{
				...
				for ( i = 0; i < (1u  <<  (int)ituContext.PicParameterSetRbsp.PpsMultilayerExtension.ColourMappingTable.CmyPartNumLog2); i++ )
				{
					...
					for ( j = 0; j < 4; j++ )
					{
						size += stream.WriteUnsignedInt(1, this.coded_res_flag[ idxShiftY ][ idxCb ][ idxCr ][ j ], "coded_res_flag"); 
						...
						if ( coded_res_flag[ idxShiftY ][ idxCb ][ idxCr ][ j ] != 0 )
						{
							...
							for ( c = 0; c < 3; c++ )
							{
								size += stream.WriteUnsignedIntGolomb( this.res_coeff_q[ idxShiftY ][ idxCb ][ idxCr ][ j ][ c ], "res_coeff_q"); 
								size += stream.WriteUnsignedIntVariable(((uint)Math.Max( 0, ( 10 + (8 + ituContext.PicParameterSetRbsp.PpsMultilayerExtension.ColourMappingTable.LumaBitDepthCmInputMinus8) - (8 + ituContext.PicParameterSetRbsp.PpsMultilayerExtension.ColourMappingTable.LumaBitDepthCmOutputMinus8) - ituContext.PicParameterSetRbsp.PpsMultilayerExtension.ColourMappingTable.CmResQuantBits - ( ituContext.PicParameterSetRbsp.PpsMultilayerExtension.ColourMappingTable.CmDeltaFlcBitsMinus1 + 1 ) ) )), this.res_coeff_r[ idxShiftY ][ idxCb ][ idxCr ][ j ][ c ], "res_coeff_r"); 

								if ( res_coeff_q[ idxShiftY ][ idxCb ][ idxCr ][ j ][ c ] != 0  ||  
        res_coeff_r[ idxShiftY ][ idxCb ][ idxCr ][ j ][ c ] != 0 )
								{
									size += stream.WriteUnsignedInt(1, this.res_coeff_s[ idxShiftY ][ idxCb ][ idxCr ][ j ][ c ], "res_coeff_s"); 
								}
							}
						}
					}
  ...
  all_tiles_ilc_idc u(2) 
    ...
    */
    public class InterLayerConstrainedTileSets : IItuSerializable
    {
		...
		private ulong il_num_sets_in_message_minus1;
		public ulong IlNumSetsInMessageMinus1 { get { return il_num_sets_in_message_minus1; } set { il_num_sets_in_message_minus1 = value; } }
		...
		private ulong[] ilcts_id;
		public ulong[] IlctsId { get { return ilcts_id; } set { ilcts_id = value; } }
		private ulong[] il_num_tile_rects_in_set_minus1;
		public ulong[] IlNumTileRectsInSetMinus1 { get { return il_num_tile_rects_in_set_minus1; } set { il_num_tile_rects_in_set_minus1 = value; } }
		private ulong[][] il_top_left_tile_idx;
		public ulong[][] IlTopLeftTileIdx { get { return il_top_left_tile_idx; } set { il_top_left_tile_idx = value; } }
		private ulong[][] il_bottom_right_tile_idx;
		public ulong[][] IlBottomRightTileIdx { get { return il_bottom_right_tile_idx; } set { il_bottom_right_tile_idx = value; } }
		...
		public uint AllTilesIlcIdc { get { return all_tiles_ilc_idc; } set { all_tiles_ilc_idc = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			uint j = 0;
			size += stream.ReadUnsignedInt(size, 1, out this.il_all_tiles_exact_sample_value_match_flag, "il_all_tiles_exact_sample_value_match_flag"); 
			size += stream.ReadUnsignedInt(size, 1, out this.il_one_tile_per_tile_set_flag, "il_one_tile_per_tile_set_flag"); 

			if ( il_one_tile_per_tile_set_flag== 0 )
			{
				size += stream.ReadUnsignedIntGolomb(size, out this.il_num_sets_in_message_minus1, "il_num_sets_in_message_minus1"); 

				if ( il_num_sets_in_message_minus1 != 0 )
				{
					size += stream.ReadUnsignedInt(size, 1, out this.skipped_tile_set_present_flag, "skipped_tile_set_present_flag"); 
				}
				numSignificantSets= il_num_sets_in_message_minus1 - skipped_tile_set_present_flag + 1;
				...
				for ( i = 0; i < numSignificantSets; i++ )
				{
					size += stream.ReadUnsignedIntGolomb(size, out this.ilcts_id[ i ], "ilcts_id"); 
					size += stream.ReadUnsignedIntGolomb(size, out this.il_num_tile_rects_in_set_minus1[ i ], "il_num_tile_rects_in_set_minus1"); 

					this.il_top_left_tile_idx[ i ] = new ulong[ il_num_tile_rects_in_set_minus1[ i ] + 1];
					this.il_bottom_right_tile_idx[ i ] = new ulong[ il_num_tile_rects_in_set_minus1[ i ] + 1];
					for ( j = 0; j <= il_num_tile_rects_in_set_minus1[ i ]; j++ )
					{
						size += stream.ReadUnsignedIntGolomb(size, out this.il_top_left_tile_idx[ i ][ j ], "il_top_left_tile_idx"); 
						size += stream.ReadUnsignedIntGolomb(size, out this.il_bottom_right_tile_idx[ i ][ j ], "il_bottom_right_tile_idx"); 
					}
					size += stream.ReadUnsignedInt(size, 2, out this.ilc_idc[ i ], "ilc_idc"); 

					if ( il_all_tiles_exact_sample_value_match_flag== 0 )
					{
						size += stream.ReadUnsignedInt(size, 1, out this.il_exact_sample_value_match_flag[ i ], "il_exact_sample_value_match_flag"); 
					}
				}
			}
			else 
			{
				size += stream.ReadUnsignedInt(size, 2, out this.all_tiles_ilc_idc, "all_tiles_ilc_idc"); 
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			uint j = 0;
			size += stream.WriteUnsignedInt(1, this.il_all_tiles_exact_sample_value_match_flag, "il_all_tiles_exact_sample_value_match_flag"); 
			size += stream.WriteUnsignedInt(1, this.il_one_tile_per_tile_set_flag, "il_one_tile_per_tile_set_flag"); 

			if ( il_one_tile_per_tile_set_flag== 0 )
			{
				size += stream.WriteUnsignedIntGolomb( this.il_num_sets_in_message_minus1, "il_num_sets_in_message_minus1"); 

				if ( il_num_sets_in_message_minus1 != 0 )
				{
					size += stream.WriteUnsignedInt(1, this.skipped_tile_set_present_flag, "skipped_tile_set_present_flag"); 
				}
				numSignificantSets= il_num_sets_in_message_minus1 - skipped_tile_set_present_flag + 1;

				for ( i = 0; i < numSignificantSets; i++ )
				{
					size += stream.WriteUnsignedIntGolomb( this.ilcts_id[ i ], "ilcts_id"); 
					size += stream.WriteUnsignedIntGolomb( this.il_num_tile_rects_in_set_minus1[ i ], "il_num_tile_rects_in_set_minus1"); 

					for ( j = 0; j <= il_num_tile_rects_in_set_minus1[ i ]; j++ )
					{
						size += stream.WriteUnsignedIntGolomb( this.il_top_left_tile_idx[ i ][ j ], "il_top_left_tile_idx"); 
						size += stream.WriteUnsignedIntGolomb( this.il_bottom_right_tile_idx[ i ][ j ], "il_bottom_right_tile_idx"); 
					}
					size += stream.WriteUnsignedInt(2, this.ilc_idc[ i ], "ilc_idc"); 

					if ( il_all_tiles_exact_sample_value_match_flag== 0 )
					{
						size += stream.WriteUnsignedInt(1, this.il_exact_sample_value_match_flag[ i ], "il_exact_sample_value_match_flag"); 
					}
				}
			}
			else 
			{
				size += stream.WriteUnsignedInt(2, this.all_tiles_ilc_idc, "all_tiles_ilc_idc"); 
			}
  ...
  sei_message()  
    ...
    */
    public class BspNesting : IItuSerializable
    {
		private uint payloadSize;
		public uint PayloadSize { get { return payloadSize; } set { payloadSize = value; } }
		private ulong sei_ols_idx;
		public ulong SeiOlsIdx { get { return sei_ols_idx; } set { sei_ols_idx = value; } }
		private ulong sei_partitioning_scheme_idx;
		public ulong SeiPartitioningSchemeIdx { get { return sei_partitioning_scheme_idx; } set { sei_partitioning_scheme_idx = value; } }
		private ulong bsp_idx;
		...
		public SeiMessage[] SeiMessage { get { return sei_message; } set { sei_message = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			int whileIndex = -1;
			uint i = 0;
			size += stream.ReadUnsignedIntGolomb(size, out this.sei_ols_idx, "sei_ols_idx"); 
			size += stream.ReadUnsignedIntGolomb(size, out this.sei_partitioning_scheme_idx, "sei_partitioning_scheme_idx"); 
			size += stream.ReadUnsignedIntGolomb(size, out this.bsp_idx, "bsp_idx"); 
			size += stream.ReadUnsignedIntGolomb(size, out this.num_seis_in_bsp_minus1, "num_seis_in_bsp_minus1"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			int whileIndex = -1;
			uint i = 0;
			size += stream.WriteUnsignedIntGolomb( this.sei_ols_idx, "sei_ols_idx"); 
			size += stream.WriteUnsignedIntGolomb( this.sei_partitioning_scheme_idx, "sei_partitioning_scheme_idx"); 
			size += stream.WriteUnsignedIntGolomb( this.bsp_idx, "bsp_idx"); 
			size += stream.WriteUnsignedIntGolomb( this.num_seis_in_bsp_minus1, "num_seis_in_bsp_minus1"); 
  ...
  for( i = 0; i < BspSchedCnt[ sei_ols_idx ][ psIdx ][ MaxTemporalId[ 0 ] ]; i++ )  
    ...
    */
    public class BspInitialArrivalTime : IItuSerializable
    {
		private uint payloadSize;
		public uint PayloadSize { get { return payloadSize; } set { payloadSize = value; } }
		private ulong[] nal_initial_arrival_delay;
		public ulong[] NalInitialArrivalDelay { get { return nal_initial_arrival_delay; } set { nal_initial_arrival_delay = value; } }
		private ulong[] vcl_initial_arrival_delay;
		public ulong[] VclInitialArrivalDelay { get { return vcl_initial_arrival_delay; } set { vcl_initial_arrival_delay = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			if ( ituContext.NalInitialArrivalDelayPresent != 0 )
			{
				...
				{
					size += stream.ReadUnsignedIntVariable(size, (ituContext.VideoParameterSetRbsp.HrdParameters[i].InitialCpbRemovalDelayLengthMinus1 + 1), out this.nal_initial_arrival_delay[ i ], "nal_initial_arrival_delay"); 
				}
			}
			...
			if ( ituContext.VclInitialArrivalDelayPresent != 0 )
			{
				...
				for ( i = 0; i < ituContext.BspSchedCnt[ ituContext.SeiPayload.BspNesting.SeiOlsIdx ][ psIdx ][ ituContext.MaxTemporalId[ 0 ] ]; i++ )
				{
					size += stream.ReadUnsignedIntVariable(size, (ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), out this.vcl_initial_arrival_delay[ i ], "vcl_initial_arrival_delay"); 
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( ituContext.NalInitialArrivalDelayPresent != 0 )
			{
				...
				for ( i = 0; i < ituContext.BspSchedCnt[ ituContext.SeiPayload.BspNesting.SeiOlsIdx ][ psIdx ][ ituContext.MaxTemporalId[ 0 ] ]; i++ )
				{
					size += stream.WriteUnsignedIntVariable((ituContext.VideoParameterSetRbsp.HrdParameters[i].InitialCpbRemovalDelayLengthMinus1 + 1), this.nal_initial_arrival_delay[ i ], "nal_initial_arrival_delay"); 
				}
			}
			...
			if ( ituContext.VclInitialArrivalDelayPresent != 0 )
			{
				...
				for ( i = 0; i < ituContext.BspSchedCnt[ ituContext.SeiPayload.BspNesting.SeiOlsIdx ][ psIdx ][ ituContext.MaxTemporalId[ 0 ] ]; i++ )
				{
					size += stream.WriteUnsignedIntVariable((ituContext.SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), this.vcl_initial_arrival_delay[ i ], "vcl_initial_arrival_delay"); 
				}
			}
  ...
  max_sb_property_bit_rate[ i ] u(16) 
    ...
    */
    public class SubBitstreamProperty : IItuSerializable
    {
		...
		private ulong num_additional_sub_streams_minus1;
		public ulong NumAdditionalSubStreamsMinus1 { get { return num_additional_sub_streams_minus1; } set { num_additional_sub_streams_minus1 = value; } }
		private uint[] sub_bitstream_mode;
		public uint[] SubBitstreamMode { get { return sub_bitstream_mode; } set { sub_bitstream_mode = value; } }
		private ulong[] ols_idx_to_vps;
		public ulong[] OlsIdxToVps { get { return ols_idx_to_vps; } set { ols_idx_to_vps = value; } }
		...
		public uint[] MaxSbPropertyBitRate { get { return max_sb_property_bit_rate; } set { max_sb_property_bit_rate = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			for ( i = 0; i <= num_additional_sub_streams_minus1; i++ )
			{
				size += stream.ReadUnsignedInt(size, 2, out this.sub_bitstream_mode[ i ], "sub_bitstream_mode"); 
				size += stream.ReadUnsignedIntGolomb(size, out this.ols_idx_to_vps[ i ], "ols_idx_to_vps"); 
				size += stream.ReadUnsignedInt(size, 3, out this.highest_sublayer_id[ i ], "highest_sublayer_id"); 
				size += stream.ReadUnsignedInt(size, 16, out this.avg_sb_property_bit_rate[ i ], "avg_sb_property_bit_rate"); 
				size += stream.ReadUnsignedInt(size, 16, out this.max_sb_property_bit_rate[ i ], "max_sb_property_bit_rate"); 
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			size += stream.WriteUnsignedInt(4, this.sb_property_active_vps_id, "sb_property_active_vps_id"); 
			size += stream.WriteUnsignedIntGolomb( this.num_additional_sub_streams_minus1, "num_additional_sub_streams_minus1"); 

			for ( i = 0; i <= num_additional_sub_streams_minus1; i++ )
			{
				size += stream.WriteUnsignedInt(2, this.sub_bitstream_mode[ i ], "sub_bitstream_mode"); 
				size += stream.WriteUnsignedIntGolomb( this.ols_idx_to_vps[ i ], "ols_idx_to_vps"); 
				size += stream.WriteUnsignedInt(3, this.highest_sublayer_id[ i ], "highest_sublayer_id"); 
				size += stream.WriteUnsignedInt(16, this.avg_sb_property_bit_rate[ i ], "avg_sb_property_bit_rate"); 
				size += stream.WriteUnsignedInt(16, this.max_sb_property_bit_rate[ i ], "max_sb_property_bit_rate"); 
			}
    ...
    public class AlphaChannelInfo : IItuSerializable
    {
		...
		public byte AlphaChannelClipTypeFlag { get { return alpha_channel_clip_type_flag; } set { alpha_channel_clip_type_flag = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			{
				size += stream.ReadUnsignedInt(size, 3, out this.alpha_channel_use_idc, "alpha_channel_use_idc"); 
				size += stream.ReadUnsignedInt(size, 3, out this.alpha_channel_bit_depth_minus8, "alpha_channel_bit_depth_minus8"); 
				size += stream.ReadUnsignedIntVariable(size, alpha_channel_bit_depth_minus8 + 9, out this.alpha_transparent_value, "alpha_transparent_value"); 
				size += stream.ReadUnsignedIntVariable(size, alpha_channel_bit_depth_minus8 + 9, out this.alpha_opaque_value, "alpha_opaque_value"); 
				size += stream.ReadUnsignedInt(size, 1, out this.alpha_channel_incr_flag, "alpha_channel_incr_flag"); 
				size += stream.ReadUnsignedInt(size, 1, out this.alpha_channel_clip_flag, "alpha_channel_clip_flag"); 

				if ( alpha_channel_clip_flag != 0 )
				{
					size += stream.ReadUnsignedInt(size, 1, out this.alpha_channel_clip_type_flag, "alpha_channel_clip_type_flag"); 
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( alpha_channel_cancel_flag== 0 )
			{
				size += stream.WriteUnsignedInt(3, this.alpha_channel_use_idc, "alpha_channel_use_idc"); 
				size += stream.WriteUnsignedInt(3, this.alpha_channel_bit_depth_minus8, "alpha_channel_bit_depth_minus8"); 
				size += stream.WriteUnsignedIntVariable(alpha_channel_bit_depth_minus8 + 9, this.alpha_transparent_value, "alpha_transparent_value"); 
				size += stream.WriteUnsignedIntVariable(alpha_channel_bit_depth_minus8 + 9, this.alpha_opaque_value, "alpha_opaque_value"); 
				size += stream.WriteUnsignedInt(1, this.alpha_channel_incr_flag, "alpha_channel_incr_flag"); 
				size += stream.WriteUnsignedInt(1, this.alpha_channel_clip_flag, "alpha_channel_clip_flag"); 

				if ( alpha_channel_clip_flag != 0 )
				{
					size += stream.WriteUnsignedInt(1, this.alpha_channel_clip_type_flag, "alpha_channel_clip_type_flag"); 
				}
			}
  ...
  overlay_info_persistence_flag u(1) 
    ...
    */
    public class OverlayInfo : IItuSerializable
    {
		...
		private ulong overlay_content_aux_id_minus128;
		public ulong OverlayContentAuxIdMinus128 { get { return overlay_content_aux_id_minus128; } set { overlay_content_aux_id_minus128 = value; } }
		private ulong overlay_label_aux_id_minus128;
		public ulong OverlayLabelAuxIdMinus128 { get { return overlay_label_aux_id_minus128; } set { overlay_label_aux_id_minus128 = value; } }
		private ulong overlay_alpha_aux_id_minus128;
		public ulong OverlayAlphaAuxIdMinus128 { get { return overlay_alpha_aux_id_minus128; } set { overlay_alpha_aux_id_minus128 = value; } }
		private ulong overlay_element_label_value_length_minus8;
		public ulong OverlayElementLabelValueLengthMinus8 { get { return overlay_element_label_value_length_minus8; } set { overlay_element_label_value_length_minus8 = value; } }
		private ulong num_overlays_minus1;
		public ulong NumOverlaysMinus1 { get { return num_overlays_minus1; } set { num_overlays_minus1 = value; } }
		private ulong[] overlay_idx;
		public ulong[] OverlayIdx { get { return overlay_idx; } set { overlay_idx = value; } }
		...
		private ulong[] num_overlay_elements_minus1;
		public ulong[] NumOverlayElementsMinus1 { get { return num_overlay_elements_minus1; } set { num_overlay_elements_minus1 = value; } }
		private ulong[][] overlay_element_label_min;
		...
		public byte OverlayInfoPersistenceFlag { get { return overlay_info_persistence_flag; } set { overlay_info_persistence_flag = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			uint j = 0;
			int whileIndex = -1;
			size += stream.ReadUnsignedInt(size, 1, out this.overlay_info_cancel_flag, "overlay_info_cancel_flag"); 

			if ( overlay_info_cancel_flag== 0 )
			{
				size += stream.ReadUnsignedIntGolomb(size, out this.overlay_content_aux_id_minus128, "overlay_content_aux_id_minus128"); 
				size += stream.ReadUnsignedIntGolomb(size, out this.overlay_label_aux_id_minus128, "overlay_label_aux_id_minus128"); 
				size += stream.ReadUnsignedIntGolomb(size, out this.overlay_alpha_aux_id_minus128, "overlay_alpha_aux_id_minus128"); 
				...
				for ( i = 0; i <= num_overlays_minus1; i++ )
				{
					size += stream.ReadUnsignedIntGolomb(size, out this.overlay_idx[ i ], "overlay_idx"); 
					size += stream.ReadUnsignedInt(size, 1, out this.language_overlay_present_flag[ i ], "language_overlay_present_flag"); 
					size += stream.ReadUnsignedInt(size, 6, out this.overlay_content_layer_id[ i ], "overlay_content_layer_id"); 
					size += stream.ReadUnsignedInt(size, 1, out this.overlay_label_present_flag[ i ], "overlay_label_present_flag"); 

					if ( overlay_label_present_flag[ i ] != 0 )
					{
						size += stream.ReadUnsignedInt(size, 6, out this.overlay_label_layer_id[ i ], "overlay_label_layer_id"); 
					}
					size += stream.ReadUnsignedInt(size, 1, out this.overlay_alpha_present_flag[ i ], "overlay_alpha_present_flag"); 

					if ( overlay_alpha_present_flag[ i ] != 0 )
					{
						size += stream.ReadUnsignedInt(size, 6, out this.overlay_alpha_layer_id[ i ], "overlay_alpha_layer_id"); 
					}

					if ( overlay_label_present_flag[ i ] != 0 )
					{
						size += stream.ReadUnsignedIntGolomb(size, out this.num_overlay_elements_minus1[ i ], "num_overlay_elements_minus1"); 

						this.overlay_element_label_min[ i ] = new ulong[ num_overlay_elements_minus1[ i ] + 1];
						this.overlay_element_label_max[ i ] = new ulong[ num_overlay_elements_minus1[ i ] + 1];
						for ( j = 0; j <= num_overlay_elements_minus1[ i ]; j++ )
						{
							size += stream.ReadUnsignedIntVariable(size, (overlay_element_label_value_length_minus8 + 8), out this.overlay_element_label_min[ i ][ j ], "overlay_element_label_min"); 
							size += stream.ReadUnsignedIntVariable(size, (overlay_element_label_value_length_minus8 + 8), out this.overlay_element_label_max[ i ][ j ], "overlay_element_label_max"); 
						}
					}
				}
				...
				for ( i = 0; i <= num_overlays_minus1; i++ )
				{
					...
					{
						size += stream.ReadUtf8String(size, out this.overlay_language[ i ], "overlay_language"); 
					}
					size += stream.ReadUtf8String(size, out this.overlay_name[ i ], "overlay_name"); 
					...
					if ( overlay_label_present_flag[ i ] != 0 )
					{
						...
						for ( j = 0; j <= num_overlay_elements_minus1[ i ]; j++ )
						{
							size += stream.ReadUtf8String(size, out this.overlay_element_name[ i ][ j ], "overlay_element_name"); 
						}
					}
				}
				size += stream.ReadUnsignedInt(size, 1, out this.overlay_info_persistence_flag, "overlay_info_persistence_flag"); 
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			uint j = 0;
			int whileIndex = -1;
			size += stream.WriteUnsignedInt(1, this.overlay_info_cancel_flag, "overlay_info_cancel_flag"); 

			if ( overlay_info_cancel_flag== 0 )
			{
				size += stream.WriteUnsignedIntGolomb( this.overlay_content_aux_id_minus128, "overlay_content_aux_id_minus128"); 
				size += stream.WriteUnsignedIntGolomb( this.overlay_label_aux_id_minus128, "overlay_label_aux_id_minus128"); 
				size += stream.WriteUnsignedIntGolomb( this.overlay_alpha_aux_id_minus128, "overlay_alpha_aux_id_minus128"); 
				size += stream.WriteUnsignedIntGolomb( this.overlay_element_label_value_length_minus8, "overlay_element_label_value_length_minus8"); 
				size += stream.WriteUnsignedIntGolomb( this.num_overlays_minus1, "num_overlays_minus1"); 

				for ( i = 0; i <= num_overlays_minus1; i++ )
				{
					size += stream.WriteUnsignedIntGolomb( this.overlay_idx[ i ], "overlay_idx"); 
					size += stream.WriteUnsignedInt(1, this.language_overlay_present_flag[ i ], "language_overlay_present_flag"); 
					size += stream.WriteUnsignedInt(6, this.overlay_content_layer_id[ i ], "overlay_content_layer_id"); 
					size += stream.WriteUnsignedInt(1, this.overlay_label_present_flag[ i ], "overlay_label_present_flag"); 

					if ( overlay_label_present_flag[ i ] != 0 )
					{
						size += stream.WriteUnsignedInt(6, this.overlay_label_layer_id[ i ], "overlay_label_layer_id"); 
					}
					size += stream.WriteUnsignedInt(1, this.overlay_alpha_present_flag[ i ], "overlay_alpha_present_flag"); 

					if ( overlay_alpha_present_flag[ i ] != 0 )
					{
						size += stream.WriteUnsignedInt(6, this.overlay_alpha_layer_id[ i ], "overlay_alpha_layer_id"); 
					}

					if ( overlay_label_present_flag[ i ] != 0 )
					{
						size += stream.WriteUnsignedIntGolomb( this.num_overlay_elements_minus1[ i ], "num_overlay_elements_minus1"); 

						for ( j = 0; j <= num_overlay_elements_minus1[ i ]; j++ )
						{
							size += stream.WriteUnsignedIntVariable((overlay_element_label_value_length_minus8 + 8), this.overlay_element_label_min[ i ][ j ], "overlay_element_label_min"); 
							size += stream.WriteUnsignedIntVariable((overlay_element_label_value_length_minus8 + 8), this.overlay_element_label_max[ i ][ j ], "overlay_element_label_max"); 
						}
					}
				}
				...
				for ( i = 0; i <= num_overlays_minus1; i++ )
				{
					...
					if ( language_overlay_present_flag[ i ] != 0 )
					{
						size += stream.WriteUtf8String( this.overlay_language[ i ], "overlay_language"); 
					}
					size += stream.WriteUtf8String( this.overlay_name[ i ], "overlay_name"); 
					...
					if ( overlay_label_present_flag[ i ] != 0 )
					{
						...
						for ( j = 0; j <= num_overlay_elements_minus1[ i ]; j++ )
						{
							size += stream.WriteUtf8String( this.overlay_element_name[ i ][ j ], "overlay_element_name"); 
						}
					}
				}
				size += stream.WriteUnsignedInt(1, this.overlay_info_persistence_flag, "overlay_info_persistence_flag"); 
			}
    ...
    public class TemporalMvPredictionConstraints : IItuSerializable
    {
		...
		public byte NoIntraLayerColPicFlag { get { return no_intra_layer_col_pic_flag; } set { no_intra_layer_col_pic_flag = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			size += stream.ReadUnsignedInt(size, 1, out this.no_intra_layer_col_pic_flag, "no_intra_layer_col_pic_flag"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			size += stream.WriteUnsignedInt(1, this.no_intra_layer_col_pic_flag, "no_intra_layer_col_pic_flag"); 
    ...
    public class FrameFieldInfo : IItuSerializable
    {
		...
		public byte FfinfoDuplicateFlag { get { return ffinfo_duplicate_flag; } set { ffinfo_duplicate_flag = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			size += stream.ReadUnsignedInt(size, 2, out this.ffinfo_source_scan_type, "ffinfo_source_scan_type"); 
			size += stream.ReadUnsignedInt(size, 1, out this.ffinfo_duplicate_flag, "ffinfo_duplicate_flag"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			size += stream.WriteUnsignedInt(2, this.ffinfo_source_scan_type, "ffinfo_source_scan_type"); 
			size += stream.WriteUnsignedInt(1, this.ffinfo_duplicate_flag, "ffinfo_duplicate_flag"); 
...
three_dimensional_reference_displays_extension_flag u(1) 
    ...
    */
    public class ThreeDimensionalReferenceDisplaysInfo : IItuSerializable
    {
		...
		private ulong[] left_view_id;
		public ulong[] LeftViewId { get { return left_view_id; } set { left_view_id = value; } }
		private ulong[] right_view_id;
		public ulong[] RightViewId { get { return right_view_id; } set { right_view_id = value; } }
		...
		public byte ThreeDimensionalReferenceDisplaysExtensionFlag { get { return three_dimensional_reference_displays_extension_flag; } set { three_dimensional_reference_displays_extension_flag = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			for ( i = 0; i <= num_ref_displays_minus1; i++ )
			{
				size += stream.ReadUnsignedIntGolomb(size, out this.left_view_id[ i ], "left_view_id"); 
				size += stream.ReadUnsignedIntGolomb(size, out this.right_view_id[ i ], "right_view_id"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			for ( i = 0; i <= num_ref_displays_minus1; i++ )
			{
				size += stream.WriteUnsignedIntGolomb( this.left_view_id[ i ], "left_view_id"); 
				size += stream.WriteUnsignedIntGolomb( this.right_view_id[ i ], "right_view_id"); 
    ...
    public class DepthRepresentationInfo : IItuSerializable
    {
		...
		public uint[] DepthNonlinearRepresentationModel { get { return depth_nonlinear_representation_model; } set { depth_nonlinear_representation_model = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			{
				size += stream.ReadUnsignedIntGolomb(size, out this.disparity_ref_view_id, "disparity_ref_view_id"); 
			}

			if ( z_near_flag != 0 )
			{
				this.depth_rep_info_element =  new DepthRepInfoElement() ;
				size +=  stream.ReadClass<DepthRepInfoElement>(size, context, this.depth_rep_info_element, "depth_rep_info_element"); 
			}

			if ( z_far_flag != 0 )
			{
				this.depth_rep_info_element0 =  new DepthRepInfoElement() ;
				size +=  stream.ReadClass<DepthRepInfoElement>(size, context, this.depth_rep_info_element0, "depth_rep_info_element0"); 
			}

			if ( d_min_flag != 0 )
			{
				this.depth_rep_info_element1 =  new DepthRepInfoElement() ;
				size +=  stream.ReadClass<DepthRepInfoElement>(size, context, this.depth_rep_info_element1, "depth_rep_info_element1"); 
			}

			if ( d_max_flag != 0 )
			{
				this.depth_rep_info_element2 =  new DepthRepInfoElement() ;
				size +=  stream.ReadClass<DepthRepInfoElement>(size, context, this.depth_rep_info_element2, "depth_rep_info_element2"); 
			}
			...
			if ( depth_representation_type == 3 )
			{
				...
				for ( i = 1; i <= depth_nonlinear_representation_num_minus1 + 1; i++ )
				{
					size += stream.ReadUnsignedInt(size, 8, out this.depth_nonlinear_representation_model[ i ], "depth_nonlinear_representation_model"); 
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if ( d_min_flag != 0  ||  d_max_flag != 0 )
			{
				size += stream.WriteUnsignedIntGolomb( this.disparity_ref_view_id, "disparity_ref_view_id"); 
			}

			if ( z_near_flag != 0 )
			{
				size += stream.WriteClass<DepthRepInfoElement>(context, this.depth_rep_info_element, "depth_rep_info_element"); 
			}

			if ( z_far_flag != 0 )
			{
				size += stream.WriteClass<DepthRepInfoElement>(context, this.depth_rep_info_element0, "depth_rep_info_element0"); 
			}

			if ( d_min_flag != 0 )
			{
				size += stream.WriteClass<DepthRepInfoElement>(context, this.depth_rep_info_element1, "depth_rep_info_element1"); 
			}

			if ( d_max_flag != 0 )
			{
				size += stream.WriteClass<DepthRepInfoElement>(context, this.depth_rep_info_element2, "depth_rep_info_element2"); 
			}
			...
			if ( depth_representation_type == 3 )
			{
				...
				for ( i = 1; i <= depth_nonlinear_representation_num_minus1 + 1; i++ )
				{
					size += stream.WriteUnsignedInt(8, this.depth_nonlinear_representation_model[ i ], "depth_nonlinear_representation_model"); 
				}
			}
 ...
 max_disparity_range ue(v) 
    ...
    */
    public class MultiviewSceneInfo : IItuSerializable
    {
		private uint payloadSize;
		public uint PayloadSize { get { return payloadSize; } set { payloadSize = value; } }
		private long min_disparity;
		public long MinDisparity { get { return min_disparity; } set { min_disparity = value; } }
		private ulong max_disparity_range;
		public ulong MaxDisparityRange { get { return max_disparity_range; } set { max_disparity_range = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			size += stream.ReadUnsignedIntGolomb(size, out this.max_disparity_range, "max_disparity_range"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			size += stream.WriteUnsignedIntGolomb( this.max_disparity_range, "max_disparity_range"); 
 ...
 rbsp_trailing_bits()  
    ...
    */
    public class VideoParameterSetRbsp : IItuSerializable
    {
		...
		private ulong[] vps_max_dec_pic_buffering_minus1;
		public ulong[] VpsMaxDecPicBufferingMinus1 { get { return vps_max_dec_pic_buffering_minus1; } set { vps_max_dec_pic_buffering_minus1 = value; } }
		private ulong[] vps_max_num_reorder_pics;
		public ulong[] VpsMaxNumReorderPics { get { return vps_max_num_reorder_pics; } set { vps_max_num_reorder_pics = value; } }
		private ulong[] vps_max_latency_increase_plus1;
		public ulong[] VpsMaxLatencyIncreasePlus1 { get { return vps_max_latency_increase_plus1; } set { vps_max_latency_increase_plus1 = value; } }
		private uint vps_max_layer_id;
		public uint VpsMaxLayerId { get { return vps_max_layer_id; } set { vps_max_layer_id = value; } }
		private ulong vps_num_layer_sets_minus1;
		public ulong VpsNumLayerSetsMinus1 { get { return vps_num_layer_sets_minus1; } set { vps_num_layer_sets_minus1 = value; } }
		...
		private ulong vps_num_ticks_poc_diff_one_minus1;
		public ulong VpsNumTicksPocDiffOneMinus1 { get { return vps_num_ticks_poc_diff_one_minus1; } set { vps_num_ticks_poc_diff_one_minus1 = value; } }
		private ulong vps_num_hrd_parameters;
		public ulong VpsNumHrdParameters { get { return vps_num_hrd_parameters; } set { vps_num_hrd_parameters = value; } }
		private ulong[] hrd_layer_set_idx;
		public ulong[] HrdLayerSetIdx { get { return hrd_layer_set_idx; } set { hrd_layer_set_idx = value; } }
		...
		public RbspTrailingBits RbspTrailingBits { get { return rbsp_trailing_bits; } set { rbsp_trailing_bits = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			for ( i = ( vps_sub_layer_ordering_info_present_flag != 0 ?  0 : vps_max_sub_layers_minus1 ); i<= vps_max_sub_layers_minus1; i++ )
			{
				size += stream.ReadUnsignedIntGolomb(size, out this.vps_max_dec_pic_buffering_minus1[ i ], "vps_max_dec_pic_buffering_minus1"); 
				size += stream.ReadUnsignedIntGolomb(size, out this.vps_max_num_reorder_pics[ i ], "vps_max_num_reorder_pics"); 
				size += stream.ReadUnsignedIntGolomb(size, out this.vps_max_latency_increase_plus1[ i ], "vps_max_latency_increase_plus1"); 
			}
			...
			{
				size += stream.ReadUnsignedInt(size, 32, out this.vps_num_units_in_tick, "vps_num_units_in_tick"); 
				size += stream.ReadUnsignedInt(size, 32, out this.vps_time_scale, "vps_time_scale"); 
				size += stream.ReadUnsignedInt(size, 1, out this.vps_poc_proportional_to_timing_flag, "vps_poc_proportional_to_timing_flag"); 

				if ( vps_poc_proportional_to_timing_flag != 0 )
				{
					size += stream.ReadUnsignedIntGolomb(size, out this.vps_num_ticks_poc_diff_one_minus1, "vps_num_ticks_poc_diff_one_minus1"); 
				}
				...
				for ( i = 0; i < vps_num_hrd_parameters; i++ )
				{
					size += stream.ReadUnsignedIntGolomb(size, out this.hrd_layer_set_idx[ i ], "hrd_layer_set_idx"); 
			...
			size += stream.ReadUnsignedInt(size, 1, out this.vps_extension_flag, "vps_extension_flag"); 
			...
			if ( vps_extension_flag != 0 )
			{
				...
				size += stream.ReadUnsignedInt(size, 1, out this.vps_extension2_flag, "vps_extension2_flag"); 

				if ( vps_extension2_flag != 0 )
				{
					size += stream.ReadUnsignedInt(size, 1, out this.vps_3d_extension_flag, "vps_3d_extension_flag"); 
					...
					size += stream.ReadUnsignedInt(size, 1, out this.vps_extension3_flag, "vps_extension3_flag"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			size += stream.WriteClass<ProfileTierLevel>(context, this.profile_tier_level, "profile_tier_level"); 
			size += stream.WriteUnsignedInt(1, this.vps_sub_layer_ordering_info_present_flag, "vps_sub_layer_ordering_info_present_flag"); 

			for ( i = ( vps_sub_layer_ordering_info_present_flag != 0 ?  0 : vps_max_sub_layers_minus1 ); i<= vps_max_sub_layers_minus1; i++ )
			{
				size += stream.WriteUnsignedIntGolomb( this.vps_max_dec_pic_buffering_minus1[ i ], "vps_max_dec_pic_buffering_minus1"); 
				size += stream.WriteUnsignedIntGolomb( this.vps_max_num_reorder_pics[ i ], "vps_max_num_reorder_pics"); 
				size += stream.WriteUnsignedIntGolomb( this.vps_max_latency_increase_plus1[ i ], "vps_max_latency_increase_plus1"); 
			}
			...
			if ( vps_timing_info_present_flag != 0 )
			{
				size += stream.WriteUnsignedInt(32, this.vps_num_units_in_tick, "vps_num_units_in_tick"); 
				size += stream.WriteUnsignedInt(32, this.vps_time_scale, "vps_time_scale"); 
				size += stream.WriteUnsignedInt(1, this.vps_poc_proportional_to_timing_flag, "vps_poc_proportional_to_timing_flag"); 

				if ( vps_poc_proportional_to_timing_flag != 0 )
				{
					size += stream.WriteUnsignedIntGolomb( this.vps_num_ticks_poc_diff_one_minus1, "vps_num_ticks_poc_diff_one_minus1"); 
				}
				size += stream.WriteUnsignedIntGolomb( this.vps_num_hrd_parameters, "vps_num_hrd_parameters"); 

				for ( i = 0; i < vps_num_hrd_parameters; i++ )
				{
					size += stream.WriteUnsignedIntGolomb( this.hrd_layer_set_idx[ i ], "hrd_layer_set_idx"); 

					if ( i > 0 )
					{
						size += stream.WriteUnsignedInt(1, this.cprms_present_flag[ i ], "cprms_present_flag"); 
					}
					size += stream.WriteClass<HrdParameters>(context, this.hrd_parameters[ i ], "hrd_parameters"); 
				}
			}
			size += stream.WriteUnsignedInt(1, this.vps_extension_flag, "vps_extension_flag"); 
			...
			if ( vps_extension_flag != 0 )
			{
				...
				if ( vps_extension2_flag != 0 )
				{
					size += stream.WriteUnsignedInt(1, this.vps_3d_extension_flag, "vps_3d_extension_flag"); 
					...
					size += stream.WriteUnsignedInt(1, this.vps_extension3_flag, "vps_extension3_flag"); 
 ...
 for( n = 1; n < NumViews; n++ ) {  
  ...
  if( num_cp[ i ] > 0 ) {  
    ...
    */
    ...
    {
		private ulong cp_precision;
		public ulong CpPrecision { get { return cp_precision; } set { cp_precision = value; } }
		private uint[] num_cp;
		...
		public long[][][] VpsCpInvOffPlusOff { get { return vps_cp_inv_off_plus_off; } set { vps_cp_inv_off_plus_off = value; } }
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			for ( n = 1; n < ituContext.NumViews; n++ )
			{
				...
				if ( num_cp[ i ] > 0 )
				{
					size += stream.WriteUnsignedInt(1, this.cp_in_slice_segment_header_flag[ i ], "cp_in_slice_segment_header_flag"); 
  ...
  if( d == 0 ) {  
    ...
    */
    public class Sps3dExtension : IItuSerializable
    {
		...
		private ulong[] log2_ivmc_sub_pb_size_minus3;
		public ulong[] Log2IvmcSubPbSizeMinus3 { get { return log2_ivmc_sub_pb_size_minus3; } set { log2_ivmc_sub_pb_size_minus3 = value; } }
		...
		private ulong[] log2_texmc_sub_pb_size_minus3;
		public ulong[] Log2TexmcSubPbSizeMinus3 { get { return log2_texmc_sub_pb_size_minus3; } set { log2_texmc_sub_pb_size_minus3 = value; } }
		...
		public byte[] SkipIntraEnabledFlag { get { return skip_intra_enabled_flag; } set { skip_intra_enabled_flag = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			for ( d = 0; d <= 1; d++ )
			{
				...
				size += stream.ReadUnsignedInt(size, 1, out this.iv_mv_scal_enabled_flag[ d ], "iv_mv_scal_enabled_flag"); 

				if ( d == 0 )
				{
					size += stream.ReadUnsignedIntGolomb(size, out this.log2_ivmc_sub_pb_size_minus3[ d ], "log2_ivmc_sub_pb_size_minus3"); 
					size += stream.ReadUnsignedInt(size, 1, out this.iv_res_pred_enabled_flag[ d ], "iv_res_pred_enabled_flag"); 
					size += stream.ReadUnsignedInt(size, 1, out this.depth_ref_enabled_flag[ d ], "depth_ref_enabled_flag"); 
					size += stream.ReadUnsignedInt(size, 1, out this.vsp_mc_enabled_flag[ d ], "vsp_mc_enabled_flag"); 
					size += stream.ReadUnsignedInt(size, 1, out this.dbbp_enabled_flag[ d ], "dbbp_enabled_flag"); 
				}
				else 
				{
					size += stream.ReadUnsignedInt(size, 1, out this.tex_mc_enabled_flag[ d ], "tex_mc_enabled_flag"); 
					size += stream.ReadUnsignedIntGolomb(size, out this.log2_texmc_sub_pb_size_minus3[ d ], "log2_texmc_sub_pb_size_minus3"); 
					size += stream.ReadUnsignedInt(size, 1, out this.intra_contour_enabled_flag[ d ], "intra_contour_enabled_flag"); 
					size += stream.ReadUnsignedInt(size, 1, out this.intra_dc_only_wedge_enabled_flag[ d ], "intra_dc_only_wedge_enabled_flag"); 
					size += stream.ReadUnsignedInt(size, 1, out this.cqt_cu_part_pred_enabled_flag[ d ], "cqt_cu_part_pred_enabled_flag"); 
					size += stream.ReadUnsignedInt(size, 1, out this.inter_dc_only_enabled_flag[ d ], "inter_dc_only_enabled_flag"); 
					size += stream.ReadUnsignedInt(size, 1, out this.skip_intra_enabled_flag[ d ], "skip_intra_enabled_flag"); 
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			for ( d = 0; d <= 1; d++ )
			{
				size += stream.WriteUnsignedInt(1, this.iv_di_mc_enabled_flag[ d ], "iv_di_mc_enabled_flag"); 
				size += stream.WriteUnsignedInt(1, this.iv_mv_scal_enabled_flag[ d ], "iv_mv_scal_enabled_flag"); 

				if ( d == 0 )
				{
					size += stream.WriteUnsignedIntGolomb( this.log2_ivmc_sub_pb_size_minus3[ d ], "log2_ivmc_sub_pb_size_minus3"); 
					size += stream.WriteUnsignedInt(1, this.iv_res_pred_enabled_flag[ d ], "iv_res_pred_enabled_flag"); 
					size += stream.WriteUnsignedInt(1, this.depth_ref_enabled_flag[ d ], "depth_ref_enabled_flag"); 
					size += stream.WriteUnsignedInt(1, this.vsp_mc_enabled_flag[ d ], "vsp_mc_enabled_flag"); 
					size += stream.WriteUnsignedInt(1, this.dbbp_enabled_flag[ d ], "dbbp_enabled_flag"); 
				}
				else 
				{
					size += stream.WriteUnsignedInt(1, this.tex_mc_enabled_flag[ d ], "tex_mc_enabled_flag"); 
					size += stream.WriteUnsignedIntGolomb( this.log2_texmc_sub_pb_size_minus3[ d ], "log2_texmc_sub_pb_size_minus3"); 
					size += stream.WriteUnsignedInt(1, this.intra_contour_enabled_flag[ d ], "intra_contour_enabled_flag"); 
					size += stream.WriteUnsignedInt(1, this.intra_dc_only_wedge_enabled_flag[ d ], "intra_dc_only_wedge_enabled_flag"); 
					size += stream.WriteUnsignedInt(1, this.cqt_cu_part_pred_enabled_flag[ d ], "cqt_cu_part_pred_enabled_flag"); 
					size += stream.WriteUnsignedInt(1, this.inter_dc_only_enabled_flag[ d ], "inter_dc_only_enabled_flag"); 
					size += stream.WriteUnsignedInt(1, this.skip_intra_enabled_flag[ d ], "skip_intra_enabled_flag"); 
				}
			}
    ...
    public class Pps3dExtension : IItuSerializable
    {
		...
		public DeltaDlt[] DeltaDlt { get { return delta_dlt; } set { delta_dlt = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			uint j = 0;
			size += stream.ReadUnsignedInt(size, 1, out this.dlts_present_flag, "dlts_present_flag"); 
			...
			if ( dlts_present_flag != 0 )
			{
				...
				for ( i = 0; i <= pps_depth_layers_minus1; i++ )
				{
					size += stream.ReadUnsignedInt(size, 1, out this.dlt_flag[ i ], "dlt_flag"); 

					if ( dlt_flag[ i ] != 0 )
					{
						size += stream.ReadUnsignedInt(size, 1, out this.dlt_pred_flag[ i ], "dlt_pred_flag"); 

						if ( dlt_pred_flag[ i ]== 0 )
						{
							size += stream.ReadUnsignedInt(size, 1, out this.dlt_val_flags_present_flag[ i ], "dlt_val_flags_present_flag"); 
						}
						...
						else 
						{
							...
							size +=  stream.ReadClass<DeltaDlt>(size, context, this.delta_dlt[ i ], "delta_dlt"); 
						}
					}
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			uint i = 0;
			uint j = 0;
			size += stream.WriteUnsignedInt(1, this.dlts_present_flag, "dlts_present_flag"); 

			if ( dlts_present_flag != 0 )
			{
				size += stream.WriteUnsignedInt(6, this.pps_depth_layers_minus1, "pps_depth_layers_minus1"); 
				size += stream.WriteUnsignedInt(4, this.pps_bit_depth_for_depth_layers_minus8, "pps_bit_depth_for_depth_layers_minus8"); 

				for ( i = 0; i <= pps_depth_layers_minus1; i++ )
				{
					size += stream.WriteUnsignedInt(1, this.dlt_flag[ i ], "dlt_flag"); 

					if ( dlt_flag[ i ] != 0 )
					{
						size += stream.WriteUnsignedInt(1, this.dlt_pred_flag[ i ], "dlt_pred_flag"); 

						if ( dlt_pred_flag[ i ]== 0 )
						{
							size += stream.WriteUnsignedInt(1, this.dlt_val_flags_present_flag[ i ], "dlt_val_flags_present_flag"); 
						}
						...
						{
							size += stream.WriteClass<DeltaDlt>(context, this.delta_dlt[ i ], "delta_dlt"); 
						}
					}
				}
			}
 ...
 if( num_val_delta_dlt > 0 ) {  
  ...
  if( max_diff > ( min_diff_minus1 + 1 ) )  
    ...
    */
    ...
    {
		private ulong num_val_delta_dlt;
		public ulong NumValDeltaDlt { get { return num_val_delta_dlt; } set { num_val_delta_dlt = value; } }
		private ulong max_diff;
		public ulong MaxDiff { get { return max_diff; } set { max_diff = value; } }
		private ulong min_diff_minus1;
		public ulong MinDiffMinus1 { get { return min_diff_minus1; } set { min_diff_minus1 = value; } }
		private ulong delta_dlt_val0;
		public ulong DeltaDltVal0 { get { return delta_dlt_val0; } set { delta_dlt_val0 = value; } }
		private ulong[] delta_val_diff_minus_min;
		public ulong[] DeltaValDiffMinusMin { get { return delta_val_diff_minus_min; } set { delta_val_diff_minus_min = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			uint k = 0;
			size += stream.ReadUnsignedIntVariable(size, ituContext.PicParameterSetRbsp.Pps3dExtension.PpsBitDepthForDepthLayersMinus8 + 8, out this.num_val_delta_dlt, "num_val_delta_dlt"); 
			...
			if ( num_val_delta_dlt > 0 )
			{
				...
				if ( num_val_delta_dlt > 1 )
				{
					size += stream.ReadUnsignedIntVariable(size, ituContext.PicParameterSetRbsp.Pps3dExtension.PpsBitDepthForDepthLayersMinus8 + 8, out this.max_diff, "max_diff"); 
				}

				if ( num_val_delta_dlt > 2  &&  max_diff > 0 )
				{
					size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling( MathEx.Log2( max_diff + 1 ) ), out this.min_diff_minus1, "min_diff_minus1"); 
				}
				size += stream.ReadUnsignedIntVariable(size, ituContext.PicParameterSetRbsp.Pps3dExtension.PpsBitDepthForDepthLayersMinus8 + 8, out this.delta_dlt_val0, "delta_dlt_val0"); 
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			uint k = 0;
			size += stream.WriteUnsignedIntVariable(ituContext.PicParameterSetRbsp.Pps3dExtension.PpsBitDepthForDepthLayersMinus8 + 8, this.num_val_delta_dlt, "num_val_delta_dlt"); 
			...
			if ( num_val_delta_dlt > 0 )
			{
				...
				if ( num_val_delta_dlt > 1 )
				{
					size += stream.WriteUnsignedIntVariable(ituContext.PicParameterSetRbsp.Pps3dExtension.PpsBitDepthForDepthLayersMinus8 + 8, this.max_diff, "max_diff"); 
				}

				if ( num_val_delta_dlt > 2  &&  max_diff > 0 )
				{
					size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling( MathEx.Log2( max_diff + 1 ) ), this.min_diff_minus1, "min_diff_minus1"); 
				}
				size += stream.WriteUnsignedIntVariable(ituContext.PicParameterSetRbsp.Pps3dExtension.PpsBitDepthForDepthLayersMinus8 + 8, this.delta_dlt_val0, "delta_dlt_val0"); 
  ...
  if( depth_type == 1 ) {  
    ...
    */
    public class AlternativeDepthInfo : IItuSerializable
    {
		...
		private long min_offset_x_int;
		public long MinOffsetxInt { get { return min_offset_x_int; } set { min_offset_x_int = value; } }
		private uint min_offset_x_frac;
		public uint MinOffsetxFrac { get { return min_offset_x_frac; } set { min_offset_x_frac = value; } }
		private long max_offset_x_int;
		public long MaxOffsetxInt { get { return max_offset_x_int; } set { max_offset_x_int = value; } }
		...
		private long min_offset_y_int;
		public long MinOffsetyInt { get { return min_offset_y_int; } set { min_offset_y_int = value; } }
		private uint min_offset_y_frac;
		public uint MinOffsetyFrac { get { return min_offset_y_frac; } set { min_offset_y_frac = value; } }
		private long max_offset_y_int;
		public long MaxOffsetyInt { get { return max_offset_y_int; } set { max_offset_y_int = value; } }
		...
		private ulong warp_map_width_minus2;
		public ulong WarpMapWidthMinus2 { get { return warp_map_width_minus2; } set { warp_map_width_minus2 = value; } }
		private ulong warp_map_height_minus2;
		public ulong WarpMapHeightMinus2 { get { return warp_map_height_minus2; } set { warp_map_height_minus2 = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			uint j = 0;
			uint k = 0;
			size += stream.ReadUnsignedInt(size, 1, out this.alternative_depth_info_cancel_flag, "alternative_depth_info_cancel_flag"); 

			if ( alternative_depth_info_cancel_flag == 0 )
			{
				size += stream.ReadUnsignedInt(size, 2, out this.depth_type, "depth_type"); 
...
/*  column  */
				...
				if ( depth_type == 1 )
				{
					size += stream.ReadSignedIntGolomb(size, out this.min_offset_x_int, "min_offset_x_int"); 
					size += stream.ReadUnsignedInt(size, 8, out this.min_offset_x_frac, "min_offset_x_frac"); 
					size += stream.ReadSignedIntGolomb(size, out this.max_offset_x_int, "max_offset_x_int"); 
					size += stream.ReadUnsignedInt(size, 8, out this.max_offset_x_frac, "max_offset_x_frac"); 
					size += stream.ReadUnsignedInt(size, 1, out this.offset_y_present_flag, "offset_y_present_flag"); 

					if ( offset_y_present_flag != 0 )
					{
						size += stream.ReadSignedIntGolomb(size, out this.min_offset_y_int, "min_offset_y_int"); 
						size += stream.ReadUnsignedInt(size, 8, out this.min_offset_y_frac, "min_offset_y_frac"); 
						size += stream.ReadSignedIntGolomb(size, out this.max_offset_y_int, "max_offset_y_int"); 
						size += stream.ReadUnsignedInt(size, 8, out this.max_offset_y_frac, "max_offset_y_frac"); 
					}
					size += stream.ReadUnsignedInt(size, 1, out this.warp_map_size_present_flag, "warp_map_size_present_flag"); 

					if ( warp_map_size_present_flag != 0 )
					{
						size += stream.ReadUnsignedIntGolomb(size, out this.warp_map_width_minus2, "warp_map_width_minus2"); 
						size += stream.ReadUnsignedIntGolomb(size, out this.warp_map_height_minus2, "warp_map_height_minus2"); 
					}
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			uint j = 0;
			uint k = 0;
			size += stream.WriteUnsignedInt(1, this.alternative_depth_info_cancel_flag, "alternative_depth_info_cancel_flag"); 

			if ( alternative_depth_info_cancel_flag == 0 )
			{
				size += stream.WriteUnsignedInt(2, this.depth_type, "depth_type"); 
...
/*  column  */
				...
				if ( depth_type == 1 )
				{
					size += stream.WriteSignedIntGolomb( this.min_offset_x_int, "min_offset_x_int"); 
					size += stream.WriteUnsignedInt(8, this.min_offset_x_frac, "min_offset_x_frac"); 
					size += stream.WriteSignedIntGolomb( this.max_offset_x_int, "max_offset_x_int"); 
					size += stream.WriteUnsignedInt(8, this.max_offset_x_frac, "max_offset_x_frac"); 
					size += stream.WriteUnsignedInt(1, this.offset_y_present_flag, "offset_y_present_flag"); 

					if ( offset_y_present_flag != 0 )
					{
						size += stream.WriteSignedIntGolomb( this.min_offset_y_int, "min_offset_y_int"); 
						size += stream.WriteUnsignedInt(8, this.min_offset_y_frac, "min_offset_y_frac"); 
						size += stream.WriteSignedIntGolomb( this.max_offset_y_int, "max_offset_y_int"); 
						size += stream.WriteUnsignedInt(8, this.max_offset_y_frac, "max_offset_y_frac"); 
					}
					size += stream.WriteUnsignedInt(1, this.warp_map_size_present_flag, "warp_map_size_present_flag"); 

					if ( warp_map_size_present_flag != 0 )
					{
						size += stream.WriteUnsignedIntGolomb( this.warp_map_width_minus2, "warp_map_width_minus2"); 
						size += stream.WriteUnsignedIntGolomb( this.warp_map_height_minus2, "warp_map_height_minus2"); 
					}
				}
			}
    ...
    public class SliceSegmentLayerRbsp : IItuSerializable
    {
		...
		public SliceSegmentHeader SliceSegmentHeader { get { return slice_segment_header; } set { slice_segment_header = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			size +=  stream.ReadClass<SliceSegmentHeader>(size, context, this.slice_segment_header, "slice_segment_header"); //slice_segment_data()  
/*  rbsp_slice_segment_trailing_bits()    */
...
slice_segment_header() {  
    ...
    */
    public class SliceSegmentHeader : IItuSerializable
    {
		...
		private ulong slice_pic_parameter_set_id;
		public ulong SlicePicParameterSetId { get { return slice_pic_parameter_set_id; } set { slice_pic_parameter_set_id = value; } }
		...
		private ulong slice_segment_address;
		public ulong SliceSegmentAddress { get { return slice_segment_address; } set { slice_segment_address = value; } }
		...
		private ulong slice_pic_order_cnt_lsb;
		public ulong SlicePicOrderCntLsb { get { return slice_pic_order_cnt_lsb; } set { slice_pic_order_cnt_lsb = value; } }
		...
		private StRefPicSet st_ref_pic_set;
		public StRefPicSet StRefPicSet { get { return st_ref_pic_set; } set { st_ref_pic_set = value; } }
		private ulong short_term_ref_pic_set_idx;
		public ulong ShortTermRefPicSetIdx { get { return short_term_ref_pic_set_idx; } set { short_term_ref_pic_set_idx = value; } }
		private ulong num_long_term_sps;
		public ulong NumLongTermSps { get { return num_long_term_sps; } set { num_long_term_sps = value; } }
		private ulong num_long_term_pics;
		public ulong NumLongTermPics { get { return num_long_term_pics; } set { num_long_term_pics = value; } }
		private ulong[] lt_idx_sps;
		public ulong[] LtIdxSps { get { return lt_idx_sps; } set { lt_idx_sps = value; } }
		...
		private ulong num_inter_layer_ref_pics_minus1;
		public ulong NumInterLayerRefPicsMinus1 { get { return num_inter_layer_ref_pics_minus1; } set { num_inter_layer_ref_pics_minus1 = value; } }
		private ulong[] inter_layer_pred_layer_idc;
		public ulong[] InterLayerPredLayerIdc { get { return inter_layer_pred_layer_idc; } set { inter_layer_pred_layer_idc = value; } }
		...
		private byte collocated_from_l0_flag= 1;
		public byte CollocatedFromL0Flag { get { return collocated_from_l0_flag; } set { collocated_from_l0_flag = value; } }
		private ulong collocated_ref_idx;
		public ulong CollocatedRefIdx { get { return collocated_ref_idx; } set { collocated_ref_idx = value; } }
		...
		private long slice_tc_offset_div2;
		...
		public ulong OffsetLenMinus1 { get { return offset_len_minus1; } set { offset_len_minus1 = value; } }
		private ulong[] entry_point_offset_minus1;
		public ulong[] EntryPointOffsetMinus1 { get { return entry_point_offset_minus1; } set { entry_point_offset_minus1 = value; } }
		private ulong slice_segment_header_extension_length;
		public ulong SliceSegmentHeaderExtensionLength { get { return slice_segment_header_extension_length; } set { slice_segment_header_extension_length = value; } }
		...
		private ulong poc_lsb_val;
		public ulong PocLsbVal { get { return poc_lsb_val; } set { poc_lsb_val = value; } }
		...
		public ByteAlignment ByteAlignment { get { return byte_alignment; } set { byte_alignment = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			if (first_slice_segment_in_pic_flag== 0)
			{
				...
				size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling( MathEx.Log2( ituContext.PicSizeInCtbsY ) ), out this.slice_segment_address, "slice_segment_address"); 
			}
            ...
            (ituContext.NalHeader.NalUnitHeader.NalUnitType != H265NALTypes.IDR_W_RADL && ituContext.NalHeader.NalUnitHeader.NalUnitType != H265NALTypes.IDR_N_LP))
				{
					size += stream.ReadUnsignedIntVariable(size, ituContext.SeqParameterSetRbsp.Log2MaxPicOrderCntLsbMinus4 + 4, out this.slice_pic_order_cnt_lsb, "slice_pic_order_cnt_lsb"); 
				}
				...
				if (ituContext.NalHeader.NalUnitHeader.NalUnitType != H265NALTypes.IDR_W_RADL && ituContext.NalHeader.NalUnitHeader.NalUnitType != H265NALTypes.IDR_N_LP)
				{
					...
					{
						size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling( MathEx.Log2( ituContext.SeqParameterSetRbsp.NumShortTermRefPicSets ) ), out this.short_term_ref_pic_set_idx, "short_term_ref_pic_set_idx"); 
					...
					if (ituContext.SeqParameterSetRbsp.LongTermRefPicsPresentFlag != 0)
					{
						...
						for (i = 0; i < num_long_term_sps + num_long_term_pics; i++)
						{
							...
							if (i < num_long_term_sps)
							{
								...
								{
									size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling( MathEx.Log2( ituContext.SeqParameterSetRbsp.NumLongTermRefPicsSps ) ), out this.lt_idx_sps[i], "lt_idx_sps"); 
								}
							}
							else 
							{
								size += stream.ReadUnsignedIntVariable(size, ( ituContext.SeqParameterSetRbsp.Log2MaxPicOrderCntLsbMinus4 + 4), out this.poc_lsb_lt[i], "poc_lsb_lt"); 
							...
							{
								size += stream.ReadUnsignedIntGolomb(size, out this.delta_poc_msb_cycle_lt[i], "delta_poc_msb_cycle_lt"); 
							}
						}
					}
            ...
            ituContext.NumRefListLayers[ituContext.NalHeader.NalUnitHeader.NuhLayerId] > 0)
				{
					...
					if (inter_layer_pred_enabled_flag != 0 && ituContext.NumRefListLayers[ituContext.NalHeader.NalUnitHeader.NuhLayerId] > 1)
					{
						...
						{
							size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling( MathEx.Log2( ituContext.NumDirectRefLayers[ ituContext.NalHeader.NalUnitHeader.NuhLayerId ] ) ), out this.num_inter_layer_ref_pics_minus1, "num_inter_layer_ref_pics_minus1"); 
						...
						if (ituContext.NumActiveRefLayerPics != ituContext.NumRefListLayers[ituContext.NalHeader.NalUnitHeader.NuhLayerId])
						{
							...
							{
								size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling( MathEx.Log2( ituContext.NumDirectRefLayers[ ituContext.NalHeader.NalUnitHeader.NuhLayerId ] ) ), out this.inter_layer_pred_layer_idc[i], "inter_layer_pred_layer_idc"); 
				...
				if (H265FrameTypes.IsP(slice_type) || H265FrameTypes.IsB(slice_type))
				{
					...
					if (slice_temporal_mvp_enabled_flag != 0)
					{
						...
						if (H265FrameTypes.IsB(slice_type))
						{
							size += stream.ReadUnsignedInt(size, 1, out this.collocated_from_l0_flag, "collocated_from_l0_flag"); 
						}

						if ((collocated_from_l0_flag != 0 && num_ref_idx_l0_active_minus1 > 0) ||
                    (collocated_from_l0_flag == 0 && num_ref_idx_l1_active_minus1 > 0))
						{
							size += stream.ReadUnsignedIntGolomb(size, out this.collocated_ref_idx, "collocated_ref_idx"); 
						}
					}
                ...
                (ituContext.PicParameterSetRbsp.WeightedBipredFlag != 0 && H265FrameTypes.IsB(slice_type)))
					...
					else if (ituContext.DepthLayerFlag[ ituContext.NalHeader.NalUnitHeader.NuhLayerId ]== 0 && ituContext.NumRefListLayers[ituContext.NalHeader.NalUnitHeader.NuhLayerId] > 0)
					{
						...
						{
							size += stream.ReadUnsignedInt(size, 1, out this.slice_ic_disabled_merge_zero_idx_flag, "slice_ic_disabled_merge_zero_idx_flag"); 
						}
					}
				...
				{
					size += stream.ReadUnsignedInt(size, 1, out this.slice_deblocking_filter_disabled_flag, "slice_deblocking_filter_disabled_flag"); 
					...
					if (slice_deblocking_filter_disabled_flag== 0)
					{
						...
						size += stream.ReadSignedIntGolomb(size, out this.slice_tc_offset_div2, "slice_tc_offset_div2"); 
					}
				}
			...
			if (ituContext.PicParameterSetRbsp.TilesEnabledFlag != 0 || ituContext.PicParameterSetRbsp.EntropyCodingSyncEnabledFlag != 0)
			{
				...
				if (num_entry_point_offsets > 0)
				{
					...
					for (i = 0; i < num_entry_point_offsets; i++)
					{
						size += stream.ReadUnsignedIntVariable(size, (offset_len_minus1 + 1), out this.entry_point_offset_minus1[i], "entry_point_offset_minus1"); 
					}
				}
			}
			...
			if (ituContext.PicParameterSetRbsp.SliceSegmentHeaderExtensionPresentFlag != 0)
			{
				...
				if (poc_reset_idc != 0)
				{
					size += stream.ReadUnsignedInt(size, 6, out this.poc_reset_period_id, "poc_reset_period_id"); 
				}

				if (poc_reset_idc == 3)
				{
					size += stream.ReadUnsignedInt(size, 1, out this.full_poc_reset_flag, "full_poc_reset_flag"); 
					size += stream.ReadUnsignedIntVariable(size, ituContext.SeqParameterSetRbsp.Log2MaxPicOrderCntLsbMinus4 + 4, out this.poc_lsb_val, "poc_lsb_val"); 
				}
				...
				{
					size += stream.ReadUnsignedIntGolomb(size, out this.poc_msb_cycle_val, "poc_msb_cycle_val"); 
				}

				while (stream.ReadMoreRbspData(this, slice_segment_header_extension_length))
				{
					whileIndex++;
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if (first_slice_segment_in_pic_flag== 0)
			{
				...
				size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling( MathEx.Log2( ituContext.PicSizeInCtbsY ) ), this.slice_segment_address, "slice_segment_address"); 
			}
            ...
            (ituContext.NalHeader.NalUnitHeader.NalUnitType != H265NALTypes.IDR_W_RADL && ituContext.NalHeader.NalUnitHeader.NalUnitType != H265NALTypes.IDR_N_LP))
				{
					size += stream.WriteUnsignedIntVariable(ituContext.SeqParameterSetRbsp.Log2MaxPicOrderCntLsbMinus4 + 4, this.slice_pic_order_cnt_lsb, "slice_pic_order_cnt_lsb"); 
				}
				...
				if (ituContext.NalHeader.NalUnitHeader.NalUnitType != H265NALTypes.IDR_W_RADL && ituContext.NalHeader.NalUnitHeader.NalUnitType != H265NALTypes.IDR_N_LP)
				{
					...
					{
						size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling( MathEx.Log2( ituContext.SeqParameterSetRbsp.NumShortTermRefPicSets ) ), this.short_term_ref_pic_set_idx, "short_term_ref_pic_set_idx"); 
						ituContext.OnShortTermRefPicSetIdx();
					}
					...
					if (ituContext.SeqParameterSetRbsp.LongTermRefPicsPresentFlag != 0)
					{
						...
						size += stream.WriteUnsignedIntGolomb( this.num_long_term_pics, "num_long_term_pics"); 
						...
						for (i = 0; i < num_long_term_sps + num_long_term_pics; i++)
						{
							...
							if (i < num_long_term_sps)
							{
								...
								if (ituContext.SeqParameterSetRbsp.NumLongTermRefPicsSps > 1)
								{
									size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling( MathEx.Log2( ituContext.SeqParameterSetRbsp.NumLongTermRefPicsSps ) ), this.lt_idx_sps[i], "lt_idx_sps"); 
								}
							}
							else 
							{
								size += stream.WriteUnsignedIntVariable(( ituContext.SeqParameterSetRbsp.Log2MaxPicOrderCntLsbMinus4 + 4), this.poc_lsb_lt[i], "poc_lsb_lt"); 
							...
							if (delta_poc_msb_present_flag[i] != 0)
							{
								size += stream.WriteUnsignedIntGolomb( this.delta_poc_msb_cycle_lt[i], "delta_poc_msb_cycle_lt"); 
							}
						}
					}
            ...
            ituContext.NumRefListLayers[ituContext.NalHeader.NalUnitHeader.NuhLayerId] > 0)
				{
					...
					if (inter_layer_pred_enabled_flag != 0 && ituContext.NumRefListLayers[ituContext.NalHeader.NalUnitHeader.NuhLayerId] > 1)
					{
						...
						if (ituContext.VideoParameterSetRbsp.VpsExtension.MaxOneActiveRefLayerFlag== 0)
						{
							size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling( MathEx.Log2( ituContext.NumDirectRefLayers[ ituContext.NalHeader.NalUnitHeader.NuhLayerId ] ) ), this.num_inter_layer_ref_pics_minus1, "num_inter_layer_ref_pics_minus1"); 
							ituContext.OnNumInterLayerRefPicsMinus1();
						}
						...
						if (ituContext.NumActiveRefLayerPics != ituContext.NumRefListLayers[ituContext.NalHeader.NalUnitHeader.NuhLayerId])
						{
							...
							for (i = 0; i < ituContext.NumActiveRefLayerPics; i++)
							{
								size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling( MathEx.Log2( ituContext.NumDirectRefLayers[ ituContext.NalHeader.NalUnitHeader.NuhLayerId ] ) ), this.inter_layer_pred_layer_idc[i], "inter_layer_pred_layer_idc"); 
								ituContext.OnInterLayerPredLayerIdc();
							}
						}
					}
				...
				if (H265FrameTypes.IsP(slice_type) || H265FrameTypes.IsB(slice_type))
				{
					...
					if (slice_temporal_mvp_enabled_flag != 0)
					{
						...
						if (H265FrameTypes.IsB(slice_type))
						{
							size += stream.WriteUnsignedInt(1, this.collocated_from_l0_flag, "collocated_from_l0_flag"); 
						}

						if ((collocated_from_l0_flag != 0 && num_ref_idx_l0_active_minus1 > 0) ||
                    (collocated_from_l0_flag == 0 && num_ref_idx_l1_active_minus1 > 0))
						{
							size += stream.WriteUnsignedIntGolomb( this.collocated_ref_idx, "collocated_ref_idx"); 
						}
					}
                ...
                (ituContext.PicParameterSetRbsp.WeightedBipredFlag != 0 && H265FrameTypes.IsB(slice_type)))
					...
					else if (ituContext.DepthLayerFlag[ ituContext.NalHeader.NalUnitHeader.NuhLayerId ]== 0 && ituContext.NumRefListLayers[ituContext.NalHeader.NalUnitHeader.NuhLayerId] > 0)
					{
						...
						if (slice_ic_enabled_flag != 0)
						{
							size += stream.WriteUnsignedInt(1, this.slice_ic_disabled_merge_zero_idx_flag, "slice_ic_disabled_merge_zero_idx_flag"); 
						}
					}
				...
				if (deblocking_filter_override_flag != 0)
				{
					size += stream.WriteUnsignedInt(1, this.slice_deblocking_filter_disabled_flag, "slice_deblocking_filter_disabled_flag"); 

					if (slice_deblocking_filter_disabled_flag== 0)
					{
						size += stream.WriteSignedIntGolomb( this.slice_beta_offset_div2, "slice_beta_offset_div2"); 
						size += stream.WriteSignedIntGolomb( this.slice_tc_offset_div2, "slice_tc_offset_div2"); 
					}
				}
			...
			if (ituContext.PicParameterSetRbsp.TilesEnabledFlag != 0 || ituContext.PicParameterSetRbsp.EntropyCodingSyncEnabledFlag != 0)
			{
				...
				if (num_entry_point_offsets > 0)
				{
					size += stream.WriteUnsignedIntGolomb( this.offset_len_minus1, "offset_len_minus1"); 

					for (i = 0; i < num_entry_point_offsets; i++)
					{
						size += stream.WriteUnsignedIntVariable((offset_len_minus1 + 1), this.entry_point_offset_minus1[i], "entry_point_offset_minus1"); 
					}
				}
			}
			...
			if (ituContext.PicParameterSetRbsp.SliceSegmentHeaderExtensionPresentFlag != 0)
			{
				...
				if (poc_reset_idc != 0)
				{
					size += stream.WriteUnsignedInt(6, this.poc_reset_period_id, "poc_reset_period_id"); 
				}

				if (poc_reset_idc == 3)
				{
					size += stream.WriteUnsignedInt(1, this.full_poc_reset_flag, "full_poc_reset_flag"); 
					size += stream.WriteUnsignedIntVariable(ituContext.SeqParameterSetRbsp.Log2MaxPicOrderCntLsbMinus4 + 4, this.poc_lsb_val, "poc_lsb_val"); 
				}
				...
				if (poc_msb_cycle_val_present_flag != 0)
				{
					size += stream.WriteUnsignedIntGolomb( this.poc_msb_cycle_val, "poc_msb_cycle_val"); 
				}

				while (stream.WriteMoreRbspData(this, slice_segment_header_extension_length))
				{
					whileIndex++;
		...
		public long[][] DeltaChromaOffsetL1 { get { return delta_chroma_offset_l1; } set { delta_chroma_offset_l1 = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			for (i = 0; i <= ituContext.SliceSegmentLayerRbsp.SliceSegmentHeader.NumRefIdxL0ActiveMinus1; i++)
			{
				...
				{
					size += stream.ReadSignedIntGolomb(size, out this.delta_luma_weight_l0[i], "delta_luma_weight_l0"); 
				...
				if (chroma_weight_l0_flag[i] != 0)
				{
					...
					for (j = 0; j < 2; j++)
					{
						...
						size += stream.ReadSignedIntGolomb(size, out this.delta_chroma_offset_l0[i][j], "delta_chroma_offset_l0"); 
					}
				}
			}
			...
			if (H265FrameTypes.IsB(ituContext.SliceSegmentLayerRbsp.SliceSegmentHeader.SliceType))
			{
				...
				for (i = 0; i <= ituContext.SliceSegmentLayerRbsp.SliceSegmentHeader.NumRefIdxL1ActiveMinus1; i++)
				{
					...
					{
						size += stream.ReadSignedIntGolomb(size, out this.delta_luma_weight_l1[i], "delta_luma_weight_l1"); 
					...
					if (chroma_weight_l1_flag[i] != 0)
					{
						...
						for (j = 0; j < 2; j++)
						{
							...
							size += stream.ReadSignedIntGolomb(size, out this.delta_chroma_offset_l1[i][j], "delta_chroma_offset_l1"); 
						}
					}
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			for (i = 0; i <= ituContext.SliceSegmentLayerRbsp.SliceSegmentHeader.NumRefIdxL0ActiveMinus1; i++)
			{
				...
				if (luma_weight_l0_flag[i] != 0)
				{
					size += stream.WriteSignedIntGolomb( this.delta_luma_weight_l0[i], "delta_luma_weight_l0"); 
				...
				if (chroma_weight_l0_flag[i] != 0)
				{
					...
					for (j = 0; j < 2; j++)
					{
						size += stream.WriteSignedIntGolomb( this.delta_chroma_weight_l0[i][j], "delta_chroma_weight_l0"); 
						size += stream.WriteSignedIntGolomb( this.delta_chroma_offset_l0[i][j], "delta_chroma_offset_l0"); 
					}
				}
			}
			...
			if (H265FrameTypes.IsB(ituContext.SliceSegmentLayerRbsp.SliceSegmentHeader.SliceType))
			{
				...
				for (i = 0; i <= ituContext.SliceSegmentLayerRbsp.SliceSegmentHeader.NumRefIdxL1ActiveMinus1; i++)
				{
					...
					if (luma_weight_l1_flag[i] != 0)
					{
						size += stream.WriteSignedIntGolomb( this.delta_luma_weight_l1[i], "delta_luma_weight_l1"); 
					...
					if (chroma_weight_l1_flag[i] != 0)
					{
						...
						for (j = 0; j < 2; j++)
						{
							size += stream.WriteSignedIntGolomb( this.delta_chroma_weight_l1[i][j], "delta_chroma_weight_l1"); 
							size += stream.WriteSignedIntGolomb( this.delta_chroma_offset_l1[i][j], "delta_chroma_offset_l1"); 
						}
					}
				}
			}
...
ref_pic_lists_modification() { 
    ...
    */
    public class RefPicListsModification : IItuSerializable
    {
		...
		private ulong[] list_entry_l0;
		public ulong[] ListEntryL0 { get { return list_entry_l0; } set { list_entry_l0 = value; } }
		...
		private ulong[] list_entry_l1;
		public ulong[] ListEntryL1 { get { return list_entry_l1; } set { list_entry_l1 = value; } }
         ...
         public ulong Read(IItuContext context, ItuStream stream)
         {
			...
			if (ref_pic_list_modification_flag_l0 != 0)
			{
				...
				for (i = 0; i <= ituContext.SliceSegmentLayerRbsp.SliceSegmentHeader.NumRefIdxL0ActiveMinus1; i++)
				{
					size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling( MathEx.Log2( ituContext.NumPicTotalCurr ) ) , out this.list_entry_l0[i], "list_entry_l0"); 
			...
			if (H265FrameTypes.IsB(ituContext.SliceSegmentLayerRbsp.SliceSegmentHeader.SliceType))
			{
				...
				if (ref_pic_list_modification_flag_l1 != 0)
				{
					...
					for (i = 0; i <= ituContext.SliceSegmentLayerRbsp.SliceSegmentHeader.NumRefIdxL1ActiveMinus1; i++)
					{
						size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling( MathEx.Log2( ituContext.NumPicTotalCurr ) ) , out this.list_entry_l1[i], "list_entry_l1"); 
					}
				}
			}
         ...
         public ulong Write(IItuContext context, ItuStream stream)
         {
			...
			if (ref_pic_list_modification_flag_l0 != 0)
			{
				...
				for (i = 0; i <= ituContext.SliceSegmentLayerRbsp.SliceSegmentHeader.NumRefIdxL0ActiveMinus1; i++)
				{
					size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling( MathEx.Log2( ituContext.NumPicTotalCurr ) ) , this.list_entry_l0[i], "list_entry_l0"); 
					ituContext.OnListEntryL0();
				}
			}
			...
			if (H265FrameTypes.IsB(ituContext.SliceSegmentLayerRbsp.SliceSegmentHeader.SliceType))
			{
				...
				if (ref_pic_list_modification_flag_l1 != 0)
				{
					...
					for (i = 0; i <= ituContext.SliceSegmentLayerRbsp.SliceSegmentHeader.NumRefIdxL1ActiveMinus1; i++)
					{
						size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling( MathEx.Log2( ituContext.NumPicTotalCurr ) ) , this.list_entry_l1[i], "list_entry_l1"); 
					}
				}
			}
