            ...
            for (sizeId = 0; sizeId < 4; sizeId++)
            {
                ...
                for (matrixId = 0; matrixId < 6; matrixId += (sizeId == 3) ? 3 : 1)
                {
                    ...
                    else
                    {
                        ...
                        if (sizeId > 1)
                        {
                            size += stream.ReadSignedIntGolomb(size, out this.scaling_list_dc_coef_minus8[sizeId - 2][matrixId][sizeId]);
                            nextCoef = scaling_list_dc_coef_minus8[sizeId - 2][matrixId] + 8;
                        }
            ...
            for (sizeId = 0; sizeId < 4; sizeId++)
            {
                ...
                for (matrixId = 0; matrixId < 6; matrixId += (sizeId == 3) ? 3 : 1)
                {
                    ...
                    else
                    {
                        ...
                        if (sizeId > 1)
                        {
                            size += stream.WriteSignedIntGolomb(this.scaling_list_dc_coef_minus8[sizeId - 2][matrixId][sizeId]);
                            nextCoef = scaling_list_dc_coef_minus8[sizeId - 2][matrixId] + 8;
                        }
 ...
 irap_pic_id u(8) 
    ...
    */
    public class TemporalSubLayerZeroIdx : IItuSerializable
    {
        ...
        public uint TemporalSubLayerZeroIdx { get { return temporal_sub_layer_zero_idx; } set { temporal_sub_layer_zero_idx = value; } }
