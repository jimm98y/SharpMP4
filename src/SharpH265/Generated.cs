...
namespace SharpH265
{
    ...
    public class H265Context : IItuContext
    {
        ...
        public SeqParameterSetAnnexfRbsp SeqParameterSetAnnexfRbsp { get; set; }
        public VideoParameterSetAnnexfRbsp VideoParameterSetAnnexfRbsp { get; set; }
...
video_parameter_set_rbsp() {  
 ...
 vps_sub_layer_ordering_info_present_flag u(1)
    for (i = (vps_sub_layer_ordering_info_present_flag != 0 ?  0 : vps_max_sub_layers_minus1);
    ...
    public class SeqParameterSetRbsp : IItuSerializable
    {
        ...
        i <= sps_max_sub_layers_minus1; i++)
            ...
            if (long_term_ref_pics_present_flag != 0)
            {
                ...
                for (i = 0; i < num_long_term_ref_pics_sps; i++)
                {
                    size += stream.ReadUnsignedIntVariable(size, (((H265Context)context).SeqParameterSetRbsp.Log2MaxPicOrderCntLsbMinus4 + 4), out this.lt_ref_pic_poc_lsb_sps[i]);
            ...
            if (sps_extension_present_flag != 0)
            {
                ...
                size += stream.ReadUnsignedInt(size, 4, out this.sps_extension_4bits);
            }
            ...
            if (sps_multilayer_extension_flag != 0)
            {
                ...
                size += stream.ReadClass<SpsMultilayerExtension>(size, context, this.sps_multilayer_extension); // specified in Annex F 
            }
        ...
        i <= sps_max_sub_layers_minus1; i++)
            ...
            if (long_term_ref_pics_present_flag != 0)
            {
                ...
                for (i = 0; i < num_long_term_ref_pics_sps; i++)
                {
                    size += stream.WriteUnsignedIntVariable((((H265Context)context).SeqParameterSetRbsp.Log2MaxPicOrderCntLsbMinus4 + 4), this.lt_ref_pic_poc_lsb_sps[i]);
            ...
            if (sps_extension_present_flag != 0)
            {
                ...
                size += stream.WriteUnsignedInt(4, this.sps_extension_4bits);
            }
            ...
            if (sps_multilayer_extension_flag != 0)
            {
                size += stream.WriteClass<SpsMultilayerExtension>(context, this.sps_multilayer_extension); // specified in Annex F 
            }
    ...
    public class RefPicListsModification : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (ref_pic_list_modification_flag_l0 != 0)
            {
                ...
                {
                    size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(H265Helpers.GetNumPicTotalCurr(context))), out this.list_entry_l0[i]);
                }
            }
            ...
            if (H265FrameTypes.IsB(((H265Context)context).SliceSegmentLayerRbsp.SliceSegmentHeader.SliceType))
            {
                ...
                if (ref_pic_list_modification_flag_l1 != 0)
                {
                    ...
                    {
                        size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(H265Helpers.GetNumPicTotalCurr(context))), out this.list_entry_l1[i]);
                    }
                }
            }
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            if (ref_pic_list_modification_flag_l0 != 0)
            {
                ...
                for (i = 0; i <= ((H265Context)context).SliceSegmentLayerRbsp.SliceSegmentHeader.NumRefIdxL0ActiveMinus1; i++)
                {
                    size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(H265Helpers.GetNumPicTotalCurr(context))), this.list_entry_l0[i]);
                }
            }
            ...
            if (H265FrameTypes.IsB(((H265Context)context).SliceSegmentLayerRbsp.SliceSegmentHeader.SliceType))
            {
                ...
                if (ref_pic_list_modification_flag_l1 != 0)
                {
                    ...
                    for (i = 0; i <= ((H265Context)context).SliceSegmentLayerRbsp.SliceSegmentHeader.NumRefIdxL1ActiveMinus1; i++)
                    {
                        size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(H265Helpers.GetNumPicTotalCurr(context))), this.list_entry_l1[i]);
                    }
                }
            }
    ...
    public class PredWeightTable : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            for (i = 0; i <= ((H265Context)context).SliceSegmentLayerRbsp.SliceSegmentHeader.NumRefIdxL0ActiveMinus1; i++)
            {
                ...
                if ((H265Helpers.GetPicLayerId(H265Helpers.GetRefPicList0(context)[i]) != ((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId) ||
   (H265Helpers.GetPicOrderCnt(H265Helpers.GetRefPicList0(context)[i]) != H265Helpers.GetPicOrderCnt(H265Helpers.GetCurrPic(context))))
                {
    ...
    (H265Helpers.GetPicOrderCnt(H265Helpers.GetRefPicList0(context)[i]) != H265Helpers.GetPicOrderCnt(H265Helpers.GetCurrPic(context))))
            ...
            if (H265FrameTypes.IsB(((H265Context)context).SliceSegmentLayerRbsp.SliceSegmentHeader.SliceType))
            {
                ...
                for (i = 0; i <= ((H265Context)context).SliceSegmentLayerRbsp.SliceSegmentHeader.NumRefIdxL1ActiveMinus1; i++)
                {
                    ...
                    if ((H265Helpers.GetPicLayerId(H265Helpers.GetRefPicList0(context)[i]) != ((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId) ||
    (H265Helpers.GetPicOrderCnt(H265Helpers.GetRefPicList1(context)[i]) != H265Helpers.GetPicOrderCnt(H265Helpers.GetCurrPic(context))))
                    {
    ...
    public class StRefPicSet : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (inter_ref_pic_set_prediction_flag != 0)
            {
                ...
                this.used_by_curr_pic_flag = new byte[H265Helpers.GetNumDeltaPocs(context)[H265Helpers.GetRefRpsIdx(context)]];
                this.use_delta_flag = new byte[H265Helpers.GetNumDeltaPocs(context)[H265Helpers.GetRefRpsIdx(context)]];
                for (j = 0; j <= H265Helpers.GetNumDeltaPocs(context)[H265Helpers.GetRefRpsIdx(context)]; j++)
                {
    ...
    public class BufferingPeriod : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.NalHrdParametersPresentFlag != 0)
            {
                ...
                this.nal_initial_cpb_removal_delay = new uint[H265Helpers.GetCpbCnt(context)];
                this.nal_initial_cpb_removal_offset = new uint[H265Helpers.GetCpbCnt(context)];
                this.nal_initial_alt_cpb_removal_delay = new uint[H265Helpers.GetCpbCnt(context)];
                this.nal_initial_alt_cpb_removal_offset = new uint[H265Helpers.GetCpbCnt(context)];
                for (i = 0; i < H265Helpers.GetCpbCnt(context); i++)
                {
                    size += stream.ReadUnsignedIntVariable(size, (((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), out this.nal_initial_cpb_removal_delay[i]);
                    size += stream.ReadUnsignedIntVariable(size, (((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), out this.nal_initial_cpb_removal_offset[i]);
                    ...
                    {
                        size += stream.ReadUnsignedIntVariable(size, (((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), out this.nal_initial_alt_cpb_removal_delay[i]);
                        size += stream.ReadUnsignedIntVariable(size, (((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), out this.nal_initial_alt_cpb_removal_offset[i]);
                    }
                }
            }
            ...
            if (((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.VclHrdParametersPresentFlag != 0)
            {
                ...
                this.vcl_initial_cpb_removal_delay = new uint[H265Helpers.GetCpbCnt(context)];
                this.vcl_initial_cpb_removal_offset = new uint[H265Helpers.GetCpbCnt(context)];
                this.vcl_initial_alt_cpb_removal_delay = new uint[H265Helpers.GetCpbCnt(context)];
                this.vcl_initial_alt_cpb_removal_offset = new uint[H265Helpers.GetCpbCnt(context)];
                for (i = 0; i < H265Helpers.GetCpbCnt(context); i++)
                {
                    size += stream.ReadUnsignedIntVariable(size, (((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), out this.vcl_initial_cpb_removal_delay[i]);
                    size += stream.ReadUnsignedIntVariable(size, (((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), out this.vcl_initial_cpb_removal_offset[i]);

                    if (((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.SubPicHrdParamsPresentFlag != 0 || irap_cpb_params_present_flag != 0)
                    {
                        size += stream.ReadUnsignedIntVariable(size, (((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), out this.vcl_initial_alt_cpb_removal_delay[i]);
                        size += stream.ReadUnsignedIntVariable(size, (((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), out this.vcl_initial_alt_cpb_removal_offset[i]);
                    }
                }
            }
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            if (((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.NalHrdParametersPresentFlag != 0)
            {
                ...
                for (i = 0; i < H265Helpers.GetCpbCnt(context); i++)
                {
                    size += stream.WriteUnsignedIntVariable((((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), this.nal_initial_cpb_removal_delay[i]);
                    size += stream.WriteUnsignedIntVariable((((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), this.nal_initial_cpb_removal_offset[i]);

                    if (((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.SubPicHrdParamsPresentFlag != 0 || irap_cpb_params_present_flag != 0)
                    {
                        size += stream.WriteUnsignedIntVariable((((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), this.nal_initial_alt_cpb_removal_delay[i]);
                        size += stream.WriteUnsignedIntVariable((((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), this.nal_initial_alt_cpb_removal_offset[i]);
                    }
                }
            }
            ...
            if (((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.VclHrdParametersPresentFlag != 0)
            {
                ...
                for (i = 0; i < H265Helpers.GetCpbCnt(context); i++)
                {
                    size += stream.WriteUnsignedIntVariable((((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), this.vcl_initial_cpb_removal_delay[i]);
                    size += stream.WriteUnsignedIntVariable((((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), this.vcl_initial_cpb_removal_offset[i]);

                    if (((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.SubPicHrdParamsPresentFlag != 0 || irap_cpb_params_present_flag != 0)
                    {
                        size += stream.WriteUnsignedIntVariable((((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), this.vcl_initial_alt_cpb_removal_delay[i]);
                        size += stream.WriteUnsignedIntVariable((((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.InitialCpbRemovalDelayLengthMinus1 + 1), this.vcl_initial_alt_cpb_removal_offset[i]);
                    }
                }
            }
    ...
    ((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.SubPicCpbParamsInPicTimingSeiFlag != 0)
                {
                    ...
                    for (i = 0; i <= num_decoding_units_minus1; i++)
                    {
                        ...
                        {
                            size += stream.ReadUnsignedIntVariable(size, (((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.DuCpbRemovalDelayIncrementLengthMinus1 + 1), out this.du_cpb_removal_delay_increment_minus1[i]);
                        }
                    }
                }
            }
    ...
    ((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.SubPicCpbParamsInPicTimingSeiFlag != 0)
                {
                    ...
                    for (i = 0; i <= num_decoding_units_minus1; i++)
                    {
                        ...
                        if (du_common_cpb_removal_delay_flag == 0 && i < num_decoding_units_minus1)
                        {
                            size += stream.WriteUnsignedIntVariable((((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.DuCpbRemovalDelayIncrementLengthMinus1 + 1), this.du_cpb_removal_delay_increment_minus1[i]);
                        }
                    }
                }
            }
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (tone_map_cancel_flag == 0)
            {
                ...
                else if (tone_map_model_id == 2)
                {
                    ...
                    {
                        size += stream.ReadUnsignedIntVariable(size, ((coded_data_bit_depth + 7) >> 3) << 3, out this.start_of_coded_interval[i]);
                    }
                }
                else if (tone_map_model_id == 3)
                {
                    ...
                    for (i = 0; i < num_pivots; i++)
                    {
                        size += stream.ReadUnsignedIntVariable(size, ((coded_data_bit_depth + 7) >> 3) << 3, out this.coded_pivot_value[i]);
                        size += stream.ReadUnsignedIntVariable(size, ((target_bit_depth + 7) >> 3) << 3, out this.target_pivot_value[i]);
                    }
                }
                else if (tone_map_model_id == 4)
                {
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            if (tone_map_cancel_flag == 0)
            {
                ...
                else if (tone_map_model_id == 2)
                {
                    ...
                    for (i = 0; i < (1 << (int)target_bit_depth); i++)
                    {
                        size += stream.WriteUnsignedIntVariable(((coded_data_bit_depth + 7) >> 3) << 3, this.start_of_coded_interval[i]);
                    }
                }
                else if (tone_map_model_id == 3)
                {
                    ...
                    for (i = 0; i < num_pivots; i++)
                    {
                        size += stream.WriteUnsignedIntVariable(((coded_data_bit_depth + 7) >> 3) << 3, this.coded_pivot_value[i]);
                        size += stream.WriteUnsignedIntVariable(((target_bit_depth + 7) >> 3) << 3, this.target_pivot_value[i]);
                    }
                }
                else if (tone_map_model_id == 4)
                {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            for (i = 0; i < num_clock_ts; i++)
            {
                ...
                if (clock_timestamp_flag[i] != 0)
                {
                    ...
                    if (time_offset_length[i] > 0)
                    {
                        size += stream.ReadSignedIntVariable(size, time_offset_length[i], out this.time_offset_value[i]);
                    }
                }
            }
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            for (i = 0; i < num_clock_ts; i++)
            {
                ...
                if (clock_timestamp_flag[i] != 0)
                {
                    ...
                    if (time_offset_length[i] > 0)
                    {
                        size += stream.WriteSignedIntVariable(time_offset_length[i], this.time_offset_value[i]);
                    }
                }
            }
            ...
            if (colour_remap_cancel_flag == 0)
            {
                ...
                for (c = 0; c < 3; c++)
                {
                    ...
                    if (pre_lut_num_val_minus1[c] > 0)
                    {
                        ...
                        for (i = 0; i <= pre_lut_num_val_minus1[c]; i++)
                        {
                            size += stream.ReadUnsignedIntVariable(size, (((colour_remap_input_bit_depth + 7) >> 3) << 3), out this.pre_lut_coded_value[c][i]);
                            size += stream.ReadUnsignedIntVariable(size, (((colour_remap_output_bit_depth + 7) >> 3) << 3), out this.pre_lut_target_value[c][i]);
                        }
                    }
                }
                ...
                for (c = 0; c < 3; c++)
                {
                    ...
                    if (post_lut_num_val_minus1[c] > 0)
                    {
                        ...
                        for (i = 0; i <= post_lut_num_val_minus1[c]; i++)
                        {
                            size += stream.ReadUnsignedIntVariable(size, (((colour_remap_input_bit_depth + 7) >> 3) << 3), out this.post_lut_coded_value[c][i]);
                            size += stream.ReadUnsignedIntVariable(size, (((colour_remap_output_bit_depth + 7) >> 3) << 3), out this.post_lut_target_value[c][i]);
                        }
                    }
                }
            }
            ...
            if (colour_remap_cancel_flag == 0)
            {
                ...
                for (c = 0; c < 3; c++)
                {
                    ...
                    if (pre_lut_num_val_minus1[c] > 0)
                    {
                        ...
                        for (i = 0; i <= pre_lut_num_val_minus1[c]; i++)
                        {
                            size += stream.WriteUnsignedIntVariable((((colour_remap_input_bit_depth + 7) >> 3) << 3), this.pre_lut_coded_value[c][i]);
                            size += stream.WriteUnsignedIntVariable((((colour_remap_output_bit_depth + 7) >> 3) << 3), this.pre_lut_target_value[c][i]);
                        }
                    }
                }
                ...
                for (c = 0; c < 3; c++)
                {
                    ...
                    if (post_lut_num_val_minus1[c] > 0)
                    {
                        ...
                        for (i = 0; i <= post_lut_num_val_minus1[c]; i++)
                        {
                            size += stream.WriteUnsignedIntVariable((((colour_remap_input_bit_depth + 7) >> 3) << 3), this.post_lut_coded_value[c][i]);
                            size += stream.WriteUnsignedIntVariable((((colour_remap_output_bit_depth + 7) >> 3) << 3), this.post_lut_target_value[c][i]);
                        }
                    }
                }
            }
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            for (i = 0; i <= num_info_sets_minus1; i++)
            {
                ...
                if (slice_reordering_enabled_flag[i] != 0)
                {
                    ...
                    for (j = 0; j <= num_slice_segments_minus1[i]; j++)
                    {
                        size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(H265Helpers.GetPicSizeInCtbsY(context))), out this.output_slice_segment_address[i][j]);
                    }
                }
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            for (i = 0; i <= num_info_sets_minus1; i++)
            {
                ...
                if (slice_reordering_enabled_flag[i] != 0)
                {
                    ...
                    for (j = 0; j <= num_slice_segments_minus1[i]; j++)
                    {
                        size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(H265Helpers.GetPicSizeInCtbsY(context))), this.output_slice_segment_address[i][j]);
                    }
                }
    ...
    */
    public class SubLayerHrdParameters : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            this.bit_rate_value_minus1 = new uint[H265Helpers.GetCpbCnt(context)];
            this.cpb_size_value_minus1 = new uint[H265Helpers.GetCpbCnt(context)];
            this.cpb_size_du_value_minus1 = new uint[H265Helpers.GetCpbCnt(context)];
            this.bit_rate_du_value_minus1 = new uint[H265Helpers.GetCpbCnt(context)];
            this.cbr_flag = new byte[H265Helpers.GetCpbCnt(context)];
            for (i = 0; i < H265Helpers.GetCpbCnt(context); i++)
            {
  ...
  vps_vui()  
    ...
    public class VpsExtension : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (view_id_len > 0)
            {
                ...
                this.view_id_val = new uint[H265Helpers.GetNumViews(context)];
                for (i = 0; i < H265Helpers.GetNumViews(context); i++)
                {
                    size += stream.ReadUnsignedIntVariable(size, view_id_len, out this.view_id_val[i]);
                }
            }
            ...
            if (H265Helpers.GetNumIndependentLayers(context) > 1)
            {
            ...
            for (i = 0; i < num_add_layer_sets; i++)
            {
                ...
                this.highest_layer_idx_plus1[i] = new uint[H265Helpers.GetNumIndependentLayers(context)];
                for (j = 1; j < H265Helpers.GetNumIndependentLayers(context); j++)
                {
                    size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(H265Helpers.GetNumLayersInTreePartition(context)[j] + 1)), out this.highest_layer_idx_plus1[i][j]);
                }
            }
          ...
          i <= vps_num_profile_tier_level_minus1; i++)
            ...
            if ((((H265Context)context).VideoParameterSetAnnexfRbsp.VpsNumLayerSetsMinus1 + 1 + ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumAddLayerSets) > 1)
            {
            ...
            NumOutputLayerSets = num_add_olss + (((H265Context)context).VideoParameterSetAnnexfRbsp.VpsNumLayerSetsMinus1 + 1 + ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumAddLayerSets);
            ...
            for (i = 1; i < NumOutputLayerSets; i++)
            {
                ...
                if ((((H265Context)context).VideoParameterSetAnnexfRbsp.VpsNumLayerSetsMinus1 + 1 + ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumAddLayerSets) > 2 && i >= (((H265Context)context).VideoParameterSetAnnexfRbsp.VpsNumLayerSetsMinus1 + 1 + ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumAddLayerSets))
                {
                    size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2((((H265Context)context).VideoParameterSetAnnexfRbsp.VpsNumLayerSetsMinus1 + 1 + ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumAddLayerSets) - 1)), out this.layer_set_idx_for_ols_minus1[i]);
                }

                if (i > ((H265Context)context).VideoParameterSetRbsp.VpsNumLayerSetsMinus1 || Math.Min(((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.DefaultOutputLayerIdc, 2) == 2)
                {

                    this.output_layer_flag[i] = new byte[H265Helpers.GetNumLayersInIdList(context)[H265Helpers.GetOlsIdxToLsIdx(context)[i]]];
                    for (j = 0; j < H265Helpers.GetNumLayersInIdList(context)[H265Helpers.GetOlsIdxToLsIdx(context)[i]]; j++)
                    {
                        size += stream.ReadUnsignedInt(size, 1, out this.output_layer_flag[i][j]);
                    }
                }

                this.profile_tier_level_idx[i] = new uint[H265Helpers.GetNumLayersInIdList(context)[H265Helpers.GetOlsIdxToLsIdx(context)[i]]];
                for (j = 0; j < H265Helpers.GetNumLayersInIdList(context)[H265Helpers.GetOlsIdxToLsIdx(context)[i]]; j++)
                {

                    if (H265Helpers.GetNecessaryLayerFlag(context)[i][j] != 0 && vps_num_profile_tier_level_minus1 > 0)
                    {
                        size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(vps_num_profile_tier_level_minus1 + 1)), out this.profile_tier_level_idx[i][j]);
                    }
                }

                if (H265Helpers.GetNumOutputLayersInOutputLayerSet(context)[i] == 1
   && H265Helpers.GetNumDirectRefLayers(context)[H265Helpers.GetOlsHighestOutputLayerId(context)[i]] > 0)
                {
            ...
            if (rep_format_idx_present_flag != 0)
            {
                ...
                {
                    size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(vps_num_rep_formats_minus1 + 1)), out this.vps_rep_format_idx[i]);
                }
            }
            ...
            for (i = 1; i <= Math.Min(62, ((H265Context)context).VideoParameterSetRbsp.VpsMaxLayersMinus1); i++)
            {
                ...
                if (H265Helpers.GetNumDirectRefLayers(context)[layer_id_in_nuh[i]] == 0)
                {
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            if (view_id_len > 0)
            {
                ...
                for (i = 0; i < H265Helpers.GetNumViews(context); i++)
                {
                    size += stream.WriteUnsignedIntVariable(view_id_len, this.view_id_val[i]);
                }
            }
            ...
            for (i = 0; i < num_add_layer_sets; i++)
            {
                ...
                for (j = 1; j < H265Helpers.GetNumIndependentLayers(context); j++)
                {
                    size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(H265Helpers.GetNumLayersInTreePartition(context)[j] + 1)), this.highest_layer_idx_plus1[i][j]);
                }
            }
          ...
          i <= vps_num_profile_tier_level_minus1; i++)
            ...
            for (i = 1; i < NumOutputLayerSets; i++)
            {
                ...
                if ((((H265Context)context).VideoParameterSetAnnexfRbsp.VpsNumLayerSetsMinus1 + 1 + ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumAddLayerSets) > 2 && i >= (((H265Context)context).VideoParameterSetAnnexfRbsp.VpsNumLayerSetsMinus1 + 1 + ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumAddLayerSets))
                {
                    size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2((((H265Context)context).VideoParameterSetAnnexfRbsp.VpsNumLayerSetsMinus1 + 1 + ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumAddLayerSets) - 1)), this.layer_set_idx_for_ols_minus1[i]);
                }
                ...
                for (j = 0; j < H265Helpers.GetNumLayersInIdList(context)[H265Helpers.GetOlsIdxToLsIdx(context)[i]]; j++)
                {
                    ...
                    if (H265Helpers.GetNecessaryLayerFlag(context)[i][j] != 0 && vps_num_profile_tier_level_minus1 > 0)
                    {
                        size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(vps_num_profile_tier_level_minus1 + 1)), this.profile_tier_level_idx[i][j]);
                    }
                }
   ...
   && H265Helpers.GetNumDirectRefLayers(context)[H265Helpers.GetOlsHighestOutputLayerId(context)[i]] > 0)
            ...
            if (rep_format_idx_present_flag != 0)
            {
                ...
                for (i = (uint)(((H265Context)context).VideoParameterSetRbsp.VpsBaseLayerInternalFlag != 0 ? 1 : 0); i <= Math.Min(62, ((H265Context)context).VideoParameterSetRbsp.VpsMaxLayersMinus1); i++)
                {
                    size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(vps_num_rep_formats_minus1 + 1)), this.vps_rep_format_idx[i]);
                }
            }
    ...
    */
    public class DpbSize : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            this.sub_layer_flag_info_present_flag = new byte[((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumOutputLayerSets];
            this.sub_layer_dpb_info_present_flag = new byte[((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumOutputLayerSets][];
            this.max_vps_dec_pic_buffering_minus1 = new uint[((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumOutputLayerSets][][];
            this.max_vps_num_reorder_pics = new uint[((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumOutputLayerSets][];
            this.max_vps_latency_increase_plus1 = new uint[((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumOutputLayerSets][];
            for (i = 1; i < ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumOutputLayerSets; i++)
            {
                ...
                for (j = 0; j <= H265Helpers.GetMaxSubLayersInLayerSetMinus1(context)[currLsIdx]; j++)
                {
                    ...
                    if (sub_layer_dpb_info_present_flag[i][j] != 0)
                    {
                        ...
                        this.max_vps_dec_pic_buffering_minus1[i][j] = new uint[H265Helpers.GetNumLayersInIdList(context)[currLsIdx]];
                        for (k = 0; k < H265Helpers.GetNumLayersInIdList(context)[currLsIdx]; k++)
                        {

                            if (H265Helpers.GetNecessaryLayerFlag(context)[i][k] != 0 && (((H265Context)context).VideoParameterSetRbsp.VpsBaseLayerInternalFlag != 0 ||
      (H265Helpers.GetLayerSetLayerIdList(context)[currLsIdx][k] != 0)))
                            {
    ...
    public class VpsVui : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (bit_rate_present_vps_flag != 0 || pic_rate_present_vps_flag != 0)
            {
                ...
                this.bit_rate_present_flag = new byte[(((H265Context)context).VideoParameterSetAnnexfRbsp.VpsNumLayerSetsMinus1 + 1 + 1 + ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumAddLayerSets)][];
                this.pic_rate_present_flag = new byte[(((H265Context)context).VideoParameterSetAnnexfRbsp.VpsNumLayerSetsMinus1 + 1 + 1 + ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumAddLayerSets)][];
                this.avg_bit_rate = new uint[(((H265Context)context).VideoParameterSetAnnexfRbsp.VpsNumLayerSetsMinus1 + 1 + 1 + ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumAddLayerSets)][];
                this.max_bit_rate = new uint[(((H265Context)context).VideoParameterSetAnnexfRbsp.VpsNumLayerSetsMinus1 + 1 + 1 + ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumAddLayerSets)][];
                this.constant_pic_rate_idc = new uint[(((H265Context)context).VideoParameterSetAnnexfRbsp.VpsNumLayerSetsMinus1 + 1 + 1 + ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumAddLayerSets)][];
                this.avg_pic_rate = new uint[(((H265Context)context).VideoParameterSetAnnexfRbsp.VpsNumLayerSetsMinus1 + 1 + 1 + ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumAddLayerSets)][];
            ...
            if (tiles_not_in_use_flag == 0)
            {
                ...
                for (i = (uint)(((H265Context)context).VideoParameterSetRbsp.VpsBaseLayerInternalFlag != 0 ? 1 : 2); i <= Math.Min(62, ((H265Context)context).VideoParameterSetRbsp.VpsMaxLayersMinus1); i++)
                {
                    ...
                    this.tile_boundaries_aligned_flag[i] = new byte[H265Helpers.GetNumDirectRefLayers(context)[((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.LayerIdInNuh[i]]];
                    for (j = 0; j < H265Helpers.GetNumDirectRefLayers(context)[((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.LayerIdInNuh[i]]; j++)
                    {
                        layerIdx = H265Helpers.GetLayerIdxInVps(context)[H265Helpers.GetIdDirectRefLayer(context)[((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.LayerIdInNuh[i]][j]];
            ...
            if (ilp_restricted_ref_layers_flag != 0)
            {
                ...
                for (i = 1; i <= Math.Min(62, ((H265Context)context).VideoParameterSetRbsp.VpsMaxLayersMinus1); i++)
                {
                    ...
                    this.min_spatial_segment_offset_plus1[i] = new uint[H265Helpers.GetNumDirectRefLayers(context)[((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.LayerIdInNuh[i]]];
                    this.ctu_based_offset_enabled_flag[i] = new byte[H265Helpers.GetNumDirectRefLayers(context)[((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.LayerIdInNuh[i]]];
                    this.min_horizontal_ctu_offset_plus1[i] = new uint[H265Helpers.GetNumDirectRefLayers(context)[((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.LayerIdInNuh[i]]];
                    for (j = 0; j < H265Helpers.GetNumDirectRefLayers(context)[((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.LayerIdInNuh[i]]; j++)
                    {

                        if (((H265Context)context).VideoParameterSetRbsp.VpsBaseLayerInternalFlag != 0 ||
        H265Helpers.GetIdDirectRefLayer(context)[((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.LayerIdInNuh[i]][j] > 0)
                        {
            ...
            for (i = 1; i <= Math.Min(62, ((H265Context)context).VideoParameterSetRbsp.VpsMaxLayersMinus1); i++)
            {
                ...
                if (H265Helpers.GetNumDirectRefLayers(context)[((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.LayerIdInNuh[i]] == 0)
                {
    ...
    public class VpsVuiBspHrdParams : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (((H265Context)context).VideoParameterSetRbsp.VpsNumHrdParameters + vps_num_add_hrd_params > 0)
            {
                ...
                this.num_signalled_partitioning_schemes = new uint[((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumOutputLayerSets];
                this.num_partitions_in_scheme_minus1 = new uint[((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumOutputLayerSets][];
                this.layer_included_in_partition_flag = new byte[((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumOutputLayerSets][][][];
                this.num_bsp_schedules_minus1 = new uint[((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumOutputLayerSets][][];
                this.bsp_hrd_idx = new uint[((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumOutputLayerSets][][][][];
                this.bsp_sched_idx = new uint[((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumOutputLayerSets][][][][];
                for (h = 1; h < ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumOutputLayerSets; h++)
                {
                    ...
                    for (j = 1; j < num_signalled_partitioning_schemes[h] + 1; j++)
                    {
                        ...
                        for (k = 0; k <= num_partitions_in_scheme_minus1[h][j]; k++)
                        {
                            ...
                            this.layer_included_in_partition_flag[h][j][k] = new byte[H265Helpers.GetNumLayersInIdList(context)[H265Helpers.GetOlsIdxToLsIdx(context)[h]]];
                            for (r = 0; r < H265Helpers.GetNumLayersInIdList(context)[H265Helpers.GetOlsIdxToLsIdx(context)[h]]; r++)
                            {
                    ...
                    for (i = 0; i < num_signalled_partitioning_schemes[h] + 1; i++)
                    {
                        ...
                        this.num_bsp_schedules_minus1[h][i] = new uint[H265Helpers.GetMaxSubLayersInLayerSetMinus1(context)[H265Helpers.GetOlsIdxToLsIdx(context)[h]] + 1];
                        this.bsp_hrd_idx[h][i] = new uint[H265Helpers.GetMaxSubLayersInLayerSetMinus1(context)[H265Helpers.GetOlsIdxToLsIdx(context)[h]] + 1][][];
                        this.bsp_sched_idx[h][i] = new uint[H265Helpers.GetMaxSubLayersInLayerSetMinus1(context)[H265Helpers.GetOlsIdxToLsIdx(context)[h]] + 1][][];
                        for (t = 0; t <= H265Helpers.GetMaxSubLayersInLayerSetMinus1(context)[H265Helpers.GetOlsIdxToLsIdx(context)[h]]; t++)
                        {
...
seq_parameter_set_annex_f_rbsp() { 
 ...
 rbsp_trailing_bits()  
    ...
    */
    public class SeqParameterSetAnnexfRbsp : IItuSerializable
    {
        private uint sps_video_parameter_set_id;
        public uint SpsVideoParameterSetId { get { return sps_video_parameter_set_id; } set { sps_video_parameter_set_id = value; } }
        private uint sps_max_sub_layers_minus1;
        ...
        public SeqParameterSetAnnexfRbsp()
        {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            else
            {
                ...
                for (i = 0; i < (1u << (int)((H265Context)context).PicParameterSetRbsp.PpsMultilayerExtension.ColourMappingTable.CmyPartNumLog2); i++)
                {
                    ...
                    for (j = 0; j < 4; j++)
                    {
                        size += stream.ReadUnsignedInt(size, 1, out this.coded_res_flag[idxShiftY][idxCb][idxCr][j]);
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            else
            {
                ...
                for (i = 0; i < (1u << (int)((H265Context)context).PicParameterSetRbsp.PpsMultilayerExtension.ColourMappingTable.CmyPartNumLog2); i++)
                {
                    ...
                    for (j = 0; j < 4; j++)
                    {
                        size += stream.WriteUnsignedInt(1, this.coded_res_flag[idxShiftY][idxCb][idxCr][j]);
                        ...
                        if (coded_res_flag[idxShiftY][idxCb][idxCr][j] != 0)
                        {
                            ...
                            for (c = 0; c < 3; c++)
                            {
                                size += stream.WriteUnsignedIntGolomb(this.res_coeff_q[idxShiftY][idxCb][idxCr][j][c]);
                                size += stream.WriteUnsignedIntVariable(((uint)Math.Max(0, (10 + (8 + ((H265Context)context).PicParameterSetRbsp.PpsMultilayerExtension.ColourMappingTable.LumaBitDepthCmInputMinus8) - (8 + ((H265Context)context).PicParameterSetRbsp.PpsMultilayerExtension.ColourMappingTable.LumaBitDepthCmOutputMinus8) - ((H265Context)context).PicParameterSetRbsp.PpsMultilayerExtension.ColourMappingTable.CmResQuantBits - (((H265Context)context).PicParameterSetRbsp.PpsMultilayerExtension.ColourMappingTable.CmDeltaFlcBitsMinus1 + 1)))), this.res_coeff_r[idxShiftY][idxCb][idxCr][j][c]);

                                if (res_coeff_q[idxShiftY][idxCb][idxCr][j][c] != 0 ||
        res_coeff_r[idxShiftY][idxCb][idxCr][j][c] != 0)
                                {
                                    size += stream.WriteUnsignedInt(1, this.res_coeff_s[idxShiftY][idxCb][idxCr][j][c]);
                                }
                            }
                        }
                    }
    ...
    */
    public class BspInitialArrivalTime : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (H265Helpers.GetNalInitialArrivalDelayPresent(context) != 0)
            {

                this.nal_initial_arrival_delay = new uint[H265Helpers.GetBspSchedCnt(context)[((H265Context)context).SeiRbsp.SeiMessage.Last().Value.SeiPayload.BspNesting.SeiOlsIdx][psIdx][H265Helpers.GetMaxTemporalId(context)[0]]];
                for (i = 0; i < H265Helpers.GetBspSchedCnt(context)[((H265Context)context).SeiRbsp.SeiMessage.Last().Value.SeiPayload.BspNesting.SeiOlsIdx][psIdx][H265Helpers.GetMaxTemporalId(context)[0]]; i++)
                {
            ...
            if (H265Helpers.GetVclInitialArrivalDelayPresent(context) != 0)
            {

                this.vcl_initial_arrival_delay = new uint[H265Helpers.GetBspSchedCnt(context)[((H265Context)context).SeiRbsp.SeiMessage.Last().Value.SeiPayload.BspNesting.SeiOlsIdx][psIdx][H265Helpers.GetMaxTemporalId(context)[0]]];
                for (i = 0; i < H265Helpers.GetBspSchedCnt(context)[((H265Context)context).SeiRbsp.SeiMessage.Last().Value.SeiPayload.BspNesting.SeiOlsIdx][psIdx][H265Helpers.GetMaxTemporalId(context)[0]]; i++)
                {
...
layer_id_included_flag[ i ][ j ] u(1)
 ...
 rbsp_trailing_bits()  
    ...
    */
    public class VideoParameterSetAnnexfRbsp : IItuSerializable
    {
        private uint vps_video_parameter_set_id;
        public uint VpsVideoParameterSetId { get { return vps_video_parameter_set_id; } set { vps_video_parameter_set_id = value; } }
        private byte vps_base_layer_internal_flag;
        ...
        public VideoParameterSetAnnexfRbsp()
        {
    ...
    */
    public class Vps3dExtension : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            this.num_cp = new uint[H265Helpers.GetNumViews(context)];
            this.cp_in_slice_segment_header_flag = new byte[H265Helpers.GetNumViews(context)];
            this.cp_ref_voi = new uint[H265Helpers.GetNumViews(context)][];
            this.vps_cp_scale = new int[H265Helpers.GetNumViews(context)][][];
            this.vps_cp_off = new int[H265Helpers.GetNumViews(context)][][];
            this.vps_cp_inv_scale_plus_scale = new int[H265Helpers.GetNumViews(context)][][];
            this.vps_cp_inv_off_plus_off = new int[H265Helpers.GetNumViews(context)][][];
            for (n = 1; n < H265Helpers.GetNumViews(context); n++)
            {
                i = H265Helpers.GetViewOIdxList(context)[n];
                size += stream.ReadUnsignedInt(size, 6, out this.num_cp[i]);

                if (num_cp[i] > 0)
                {
                    size += stream.ReadUnsignedInt(size, 1, out this.cp_in_slice_segment_header_flag[i]);
                    ...
                    for (m = 0; m < num_cp[i]; m++)
                    {
                        size += stream.ReadUnsignedIntGolomb(size, out this.cp_ref_voi[i][m]);

                        if (cp_in_slice_segment_header_flag[i] == 0)
                        {
                            j = cp_ref_voi[i][m];
                            size += stream.ReadSignedIntGolomb(size, out this.vps_cp_scale[i][j][m]);
                            size += stream.ReadSignedIntGolomb(size, out this.vps_cp_off[i][j][m]);
                            size += stream.ReadSignedIntGolomb(size, out this.vps_cp_inv_scale_plus_scale[i][j][m]);
                            size += stream.ReadSignedIntGolomb(size, out this.vps_cp_inv_off_plus_off[i][j][m]);
                        }
                    }
                }
            }
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            {
                i = H265Helpers.GetViewOIdxList(context)[n];
                size += stream.WriteUnsignedInt(6, this.num_cp[i]);

                if (num_cp[i] > 0)
                {
                    size += stream.WriteUnsignedInt(1, this.cp_in_slice_segment_header_flag[i]);

                    for (m = 0; m < num_cp[i]; m++)
                    {
                        size += stream.WriteUnsignedIntGolomb(this.cp_ref_voi[i][m]);

                        if (cp_in_slice_segment_header_flag[i] == 0)
                        {
                            j = cp_ref_voi[i][m];
                            size += stream.WriteSignedIntGolomb(this.vps_cp_scale[i][j][m]);
                            size += stream.WriteSignedIntGolomb(this.vps_cp_off[i][j][m]);
                            size += stream.WriteSignedIntGolomb(this.vps_cp_inv_scale_plus_scale[i][j][m]);
                            size += stream.WriteSignedIntGolomb(this.vps_cp_inv_off_plus_off[i][j][m]);
                        }
                    }
                }
            }
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (num_val_delta_dlt > 0)
            {
                ...
                if (max_diff > (min_diff_minus1 + 1))
                {
                    ...
                    for (k = 1; k < num_val_delta_dlt; k++)
                    {
                        size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(max_diff - min_diff_minus1 + 1)), out this.delta_val_diff_minus_min[k]);
                    }
                }
            }
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            if (num_val_delta_dlt > 0)
            {
                ...
                if (max_diff > (min_diff_minus1 + 1))
                {
                    ...
                    for (k = 1; k < num_val_delta_dlt; k++)
                    {
                        size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(max_diff - min_diff_minus1 + 1)), this.delta_val_diff_minus_min[k]);
                    }
                }
            }
 ...
 byte_alignment()  
    ...
    */
    public class SliceSegmentHeader : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (dependent_slice_segment_flag == 0)
            {
                ...
                if ((((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId > 0 &&
    ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.PocLsbNotPresentFlag[H265Helpers.GetLayerIdxInVps(context)[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId]] == 0) ||
    (((H265Context)context).NalHeader.NalUnitHeader.NalUnitType != H265NALTypes.IDR_W_RADL && ((H265Context)context).NalHeader.NalUnitHeader.NalUnitType != H265NALTypes.IDR_N_LP))
                ...
                if (((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId > 0 && ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.DefaultRefLayersActiveFlag == 0 &&
      H265Helpers.GetNumRefListLayers(context)[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId] > 0)
                {
                    size += stream.ReadUnsignedInt(size, 1, out this.inter_layer_pred_enabled_flag);

                    if (inter_layer_pred_enabled_flag != 0 && H265Helpers.GetNumRefListLayers(context)[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId] > 1)
                    {

                        if (((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.MaxOneActiveRefLayerFlag == 0)
                        {
                            size += stream.ReadUnsignedIntVariable(size, num_inter_layer_ref_pics_minus1, out this.num_inter_layer_ref_pics_minus1);
                        }

                        if (H265Helpers.GetNumActiveRefLayerPics(context) != H265Helpers.GetNumRefListLayers(context)[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId])
                        {

                            this.inter_layer_pred_layer_idc = new uint[H265Helpers.GetNumActiveRefLayerPics(context)];
                            for (i = 0; i < H265Helpers.GetNumActiveRefLayerPics(context); i++)
                            {
                                size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(H265Helpers.GetNumDirectRefLayers(context)[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId])), out this.inter_layer_pred_layer_idc[i]);
                            }
                        }
                    }
                }

                if (H265Helpers.GetInCmpPredAvailFlag(context) != 0)
                {
                ...
                if (H265FrameTypes.IsP(slice_type) || H265FrameTypes.IsB(slice_type))
                {
                    ...
                    if (((H265Context)context).PicParameterSetRbsp.ListsModificationPresentFlag != 0 && H265Helpers.GetNumPicTotalCurr(context) > 1)
                    {
     ...
     (((H265Context)context).PicParameterSetRbsp.WeightedBipredFlag != 0 && H265FrameTypes.IsB(slice_type)))
                    ...
                    else if (H265Helpers.GetDepthLayerFlag(context)[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId] == 0 && H265Helpers.GetNumRefListLayers(context)[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId] > 0)
                    {
   ...
   (slice_sao_luma_flag != 0 || slice_sao_chroma_flag != 0 ||
    slice_deblocking_filter_disabled_flag == 0))
                ...
                if (((H265Context)context).VideoParameterSetAnnexfRbsp.Vps3dExtension.CpInSliceSegmentHeaderFlag[H265Helpers.GetViewOrderIdx(context)[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId]] != 0)
                {

                    this.cp_scale = new int[((H265Context)context).VideoParameterSetAnnexfRbsp.Vps3dExtension.NumCp[H265Helpers.GetViewOrderIdx(context)[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId]]][];
                    this.cp_off = new int[((H265Context)context).VideoParameterSetAnnexfRbsp.Vps3dExtension.NumCp[H265Helpers.GetViewOrderIdx(context)[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId]]][];
                    this.cp_inv_scale_plus_scale = new int[((H265Context)context).VideoParameterSetAnnexfRbsp.Vps3dExtension.NumCp[H265Helpers.GetViewOrderIdx(context)[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId]]][];
                    this.cp_inv_off_plus_off = new int[((H265Context)context).VideoParameterSetAnnexfRbsp.Vps3dExtension.NumCp[H265Helpers.GetViewOrderIdx(context)[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId]]][];
                    for (m = 0; m < ((H265Context)context).VideoParameterSetAnnexfRbsp.Vps3dExtension.NumCp[H265Helpers.GetViewOrderIdx(context)[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId]]; m++)
                    {
                        j = ((H265Context)context).VideoParameterSetAnnexfRbsp.Vps3dExtension.CpRefVoi[H265Helpers.GetViewOrderIdx(context)[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId]][m];
            ...
            if (((H265Context)context).PicParameterSetRbsp.SliceSegmentHeaderExtensionPresentFlag != 0)
            {
                ...
                if (((((H265Context)context).NalHeader.NalUnitHeader.NalUnitType == H265NALTypes.BLA_W_LP || ((H265Context)context).NalHeader.NalUnitHeader.NalUnitType == H265NALTypes.BLA_N_LP || ((H265Context)context).NalHeader.NalUnitHeader.NalUnitType == H265NALTypes.BLA_W_RADL || ((H265Context)context).NalHeader.NalUnitHeader.NalUnitType == H265NALTypes.CRA_NUT) && (((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.VpsPocLsbAlignedFlag == 0 || (((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.VpsPocLsbAlignedFlag != 0 && H265Helpers.GetNumDirectRefLayers(context)[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId] == 0)) ? 1 : 0) == 0 && ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.VpsPocLsbAlignedFlag != 0)
                {
      ...
      H265Helpers.GetNumRefListLayers(context)[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId] > 0)
                {
                    ...
                    if (inter_layer_pred_enabled_flag != 0 && H265Helpers.GetNumRefListLayers(context)[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId] > 1)
                    {
                        ...
                        if (H265Helpers.GetNumActiveRefLayerPics(context) != H265Helpers.GetNumRefListLayers(context)[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId])
                        {
                            ...
                            for (i = 0; i < H265Helpers.GetNumActiveRefLayerPics(context); i++)
                            {
                                size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(H265Helpers.GetNumDirectRefLayers(context)[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId])), this.inter_layer_pred_layer_idc[i]);
                            }
                        }
                    }
                }
