            ...
            if (palette_mode_enabled_flag != 0)
            {
                ...
                if (sps_palette_predictor_initializers_present_flag != 0)
                {
                    ...
                    for (comp = 0; comp < numComps; comp++)
                    {
                        ...
                        for (i = 0; i <= sps_num_palette_predictor_initializers_minus1; i++)
                        {
                            size += stream.ReadUnsignedIntVariable(size, (((H265Context)context).SeqParameterSetRbsp.BitDepthChromaMinus8 + 8), out this.sps_palette_predictor_initializer[comp][i], "sps_palette_predictor_initializer");
                        }
                    }
                }
            }
            ...
            if (palette_mode_enabled_flag != 0)
            {
                ...
                if (sps_palette_predictor_initializers_present_flag != 0)
                {
                    ...
                    for (comp = 0; comp < numComps; comp++)
                    {
                        ...
                        for (i = 0; i <= sps_num_palette_predictor_initializers_minus1; i++)
                        {
                            size += stream.WriteUnsignedIntVariable((((H265Context)context).SeqParameterSetRbsp.BitDepthChromaMinus8 + 8), this.sps_palette_predictor_initializer[comp][i], "sps_palette_predictor_initializer");
                        }
                    }
                }
            }
            ...
            if (pps_palette_predictor_initializers_present_flag != 0)
            {
                ...
                if (pps_num_palette_predictor_initializers > 0)
                {
                    ...
                    for (comp = 0; comp < numComps; comp++)
                    {
                        ...
                        for (i = 0; i < pps_num_palette_predictor_initializers; i++)
                        {
                            size += stream.ReadUnsignedIntVariable(size, comp == 0 ? (((H265Context)context).PicParameterSetRbsp.PpsSccExtension.LumaBitDepthEntryMinus8 + 8) : (((H265Context)context).PicParameterSetRbsp.PpsSccExtension.ChromaBitDepthEntryMinus8 + 8), out this.pps_palette_predictor_initializer[comp][i], "pps_palette_predictor_initializer");
                        }
                    }
                }
            }
            ...
            if (pps_palette_predictor_initializers_present_flag != 0)
            {
                ...
                if (pps_num_palette_predictor_initializers > 0)
                {
                    ...
                    for (comp = 0; comp < numComps; comp++)
                    {
                        ...
                        for (i = 0; i < pps_num_palette_predictor_initializers; i++)
                        {
                            size += stream.WriteUnsignedIntVariable(comp == 0 ? (((H265Context)context).PicParameterSetRbsp.PpsSccExtension.LumaBitDepthEntryMinus8 + 8) : (((H265Context)context).PicParameterSetRbsp.PpsSccExtension.ChromaBitDepthEntryMinus8 + 8), this.pps_palette_predictor_initializer[comp][i], "pps_palette_predictor_initializer");
                        }
                    }
                }
            }
    ...
    */
    public class BufferingPeriod : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            {
                size += stream.ReadUnsignedIntVariable(size, ((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.AuCpbRemovalDelayLengthMinus1 + 1, out this.cpb_delay_offset, "cpb_delay_offset");
                size += stream.ReadUnsignedIntVariable(size, ((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.DpbOutputDelayLengthMinus1 + 1, out this.dpb_delay_offset, "dpb_delay_offset");
            }
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            if (irap_cpb_params_present_flag != 0)
            {
                size += stream.WriteUnsignedIntVariable(((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.AuCpbRemovalDelayLengthMinus1 + 1, this.cpb_delay_offset, "cpb_delay_offset");
                size += stream.WriteUnsignedIntVariable(((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.DpbOutputDelayLengthMinus1 + 1, this.dpb_delay_offset, "dpb_delay_offset");
            }
    ...
    ((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.SubPicCpbParamsInPicTimingSeiFlag != 0)
                {
                    ...
                    for (i = 0; i <= num_decoding_units_minus1; i++)
                    {
                        ...
                        {
                            size += stream.ReadUnsignedIntVariable(size, (((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.DuCpbRemovalDelayIncrementLengthMinus1 + 1), out this.du_cpb_removal_delay_increment_minus1[i], "du_cpb_removal_delay_increment_minus1");
                        }
                    }
                }
            }
    ...
    ((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.SubPicCpbParamsInPicTimingSeiFlag != 0)
                {
                    ...
                    if (du_common_cpb_removal_delay_flag != 0)
                    {
                        size += stream.WriteUnsignedIntVariable(((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.DuCpbRemovalDelayIncrementLengthMinus1 + 1, this.du_common_cpb_removal_delay_increment_minus1, "du_common_cpb_removal_delay_increment_minus1");
                    }
                    ...
                    for (i = 0; i <= num_decoding_units_minus1; i++)
                    {
                        ...
                        if (du_common_cpb_removal_delay_flag == 0 && i < num_decoding_units_minus1)
                        {
                            size += stream.WriteUnsignedIntVariable((((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.DuCpbRemovalDelayIncrementLengthMinus1 + 1), this.du_cpb_removal_delay_increment_minus1[i], "du_cpb_removal_delay_increment_minus1");
                        }
                    }
                }
            }
    ...
    */
    public class DecodingUnitInfo : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            {
                size += stream.ReadUnsignedIntVariable(size, ((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.DpbOutputDelayDuLengthMinus1 + 1, out this.pic_spt_dpb_output_du_delay, "pic_spt_dpb_output_du_delay");
            }
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            if (dpb_output_du_delay_present_flag != 0)
            {
                size += stream.WriteUnsignedIntVariable(((H265Context)context).SeqParameterSetRbsp.VuiParameters.HrdParameters.DpbOutputDelayDuLengthMinus1 + 1, this.pic_spt_dpb_output_du_delay, "pic_spt_dpb_output_du_delay");
            }
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            for (i = 0; i <= num_info_sets_minus1; i++)
            {
                ...
                if (slice_reordering_enabled_flag[i] != 0)
                {
                    ...
                    for (j = 0; j <= num_slice_segments_minus1[i]; j++)
                    {
                        size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(((H265Context)context).PicSizeInCtbsY)), out this.output_slice_segment_address[i][j], "output_slice_segment_address");
                    }
                }
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            for (i = 0; i <= num_info_sets_minus1; i++)
            {
                ...
                if (slice_reordering_enabled_flag[i] != 0)
                {
                    ...
                    for (j = 0; j <= num_slice_segments_minus1[i]; j++)
                    {
                        size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(((H265Context)context).PicSizeInCtbsY)), this.output_slice_segment_address[i][j], "output_slice_segment_address");
                    }
                }
  ...
  vps_vui()  
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            for (i = 1; i <= Math.Min(62, ((H265Context)context).VideoParameterSetRbsp.VpsMaxLayersMinus1); i++)
            {
                ...
                if (splitting_flag == 0)
                {
                    ...
                    for (j = 0; j < NumScalabilityTypes; j++)
                    {
                        size += stream.ReadUnsignedIntVariable(size, (dimension_id_len_minus1[i] + 1), out this.dimension_id[i][j], "dimension_id");
            ...
            for (i = 0; i < num_add_layer_sets; i++)
            {
                ...
                {
                    size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(((H265Context)context).NumLayersInTreePartition[j] + 1)), out this.highest_layer_idx_plus1[i][j], "highest_layer_idx_plus1");
          ...
          i <= vps_num_profile_tier_level_minus1; i++)
            ...
            for (i = 1; i < NumOutputLayerSets; i++)
            {
                ...
                {
                    size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2((((H265Context)context).VideoParameterSetRbsp.VpsNumLayerSetsMinus1 + 1 + ((H265Context)context).VideoParameterSetRbsp.VpsExtension.NumAddLayerSets) - 1)), out this.layer_set_idx_for_ols_minus1[i], "layer_set_idx_for_ols_minus1");
                ...
                for (j = 0; j < ((H265Context)context).NumLayersInIdList[((H265Context)context).OlsIdxToLsIdx[i]]; j++)
                {
                    ...
                    {
                        size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(vps_num_profile_tier_level_minus1 + 1)), out this.profile_tier_level_idx[i][j], "profile_tier_level_idx");
                    }
                }
   ...
   && ((H265Context)context).NumDirectRefLayers[((H265Context)context).OlsHighestOutputLayerId[i]] > 0)
            ...
            if (rep_format_idx_present_flag != 0)
            {
                ...
                {
                    size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(vps_num_rep_formats_minus1 + 1)), out this.vps_rep_format_idx[i], "vps_rep_format_idx");
                }
            }
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            for (i = 1; i <= Math.Min(62, ((H265Context)context).VideoParameterSetRbsp.VpsMaxLayersMinus1); i++)
            {
                ...
                if (splitting_flag == 0)
                {
                    ...
                    for (j = 0; j < NumScalabilityTypes; j++)
                    {
                        size += stream.WriteUnsignedIntVariable((dimension_id_len_minus1[i] + 1), this.dimension_id[i][j], "dimension_id");
                        ((H265Context)context).OnDimensionId();
                    }
                }
            }
            ...
            for (i = 0; i < num_add_layer_sets; i++)
            {
                ...
                for (j = 1; j < ((H265Context)context).NumIndependentLayers; j++)
                {
                    size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(((H265Context)context).NumLayersInTreePartition[j] + 1)), this.highest_layer_idx_plus1[i][j], "highest_layer_idx_plus1");
                    ((H265Context)context).OnHighestLayerIdxPlus1(i);
                }
            }
          ...
          i <= vps_num_profile_tier_level_minus1; i++)
            ...
            for (i = 1; i < NumOutputLayerSets; i++)
            {
                ...
                if ((((H265Context)context).VideoParameterSetRbsp.VpsNumLayerSetsMinus1 + 1 + ((H265Context)context).VideoParameterSetRbsp.VpsExtension.NumAddLayerSets) > 2 && i >= (((H265Context)context).VideoParameterSetRbsp.VpsNumLayerSetsMinus1 + 1 + ((H265Context)context).VideoParameterSetRbsp.VpsExtension.NumAddLayerSets))
                {
                    size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2((((H265Context)context).VideoParameterSetRbsp.VpsNumLayerSetsMinus1 + 1 + ((H265Context)context).VideoParameterSetRbsp.VpsExtension.NumAddLayerSets) - 1)), this.layer_set_idx_for_ols_minus1[i], "layer_set_idx_for_ols_minus1");
                    ((H265Context)context).OnLayerSetIdxForOlsMinus1(i, NumOutputLayerSets);
                }
                ...
                for (j = 0; j < ((H265Context)context).NumLayersInIdList[((H265Context)context).OlsIdxToLsIdx[i]]; j++)
                {
                    ...
                    if (((H265Context)context).NecessaryLayerFlag[i][j] != 0 && vps_num_profile_tier_level_minus1 > 0)
                    {
                        size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(vps_num_profile_tier_level_minus1 + 1)), this.profile_tier_level_idx[i][j], "profile_tier_level_idx");
                    }
                }
   ...
   && ((H265Context)context).NumDirectRefLayers[((H265Context)context).OlsHighestOutputLayerId[i]] > 0)
            ...
            if (rep_format_idx_present_flag != 0)
            {
                ...
                for (i = (uint)(((H265Context)context).VideoParameterSetRbsp.VpsBaseLayerInternalFlag != 0 ? 1 : 0); i <= Math.Min(62, ((H265Context)context).VideoParameterSetRbsp.VpsMaxLayersMinus1); i++)
                {
                    size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(vps_num_rep_formats_minus1 + 1)), this.vps_rep_format_idx[i], "vps_rep_format_idx");
                }
            }
                        ...
                        for (t = 0; t <= ((H265Context)context).MaxSubLayersInLayerSetMinus1[((H265Context)context).OlsIdxToLsIdx[h]]; t++)
                        {
                            ...
                            for (j = 0; j <= num_bsp_schedules_minus1[h][i][t]; j++)
                            {
                                ...
                                for (k = 0; k <= num_partitions_in_scheme_minus1[h][i]; k++)
                                {
                                    ...
                                    {
                                        size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(((H265Context)context).VideoParameterSetRbsp.VpsNumHrdParameters + vps_num_add_hrd_params)), out this.bsp_hrd_idx[h][i][t][j][k], "bsp_hrd_idx");
                                    }
                        ...
                        for (t = 0; t <= ((H265Context)context).MaxSubLayersInLayerSetMinus1[((H265Context)context).OlsIdxToLsIdx[h]]; t++)
                        {
                            ...
                            for (j = 0; j <= num_bsp_schedules_minus1[h][i][t]; j++)
                            {
                                ...
                                for (k = 0; k <= num_partitions_in_scheme_minus1[h][i]; k++)
                                {
                                    ...
                                    if ((uint)((H265Context)context).VideoParameterSetRbsp.VpsNumHrdParameters + vps_num_add_hrd_params > 1)
                                    {
                                        size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(((H265Context)context).VideoParameterSetRbsp.VpsNumHrdParameters + vps_num_add_hrd_params)), this.bsp_hrd_idx[h][i][t][j][k], "bsp_hrd_idx");
                                    }
    ...
    */
    ...
    i <= sps_max_sub_layers_minus1; i++)
            ...
            if (long_term_ref_pics_present_flag != 0)
            {
                ...
                for (i = 0; i < num_long_term_ref_pics_sps; i++)
                {
                    size += stream.ReadUnsignedIntVariable(size, (((H265Context)context).SeqParameterSetRbsp.Log2MaxPicOrderCntLsbMinus4 + 4), out this.lt_ref_pic_poc_lsb_sps[i], "lt_ref_pic_poc_lsb_sps");
    ...
    i <= sps_max_sub_layers_minus1; i++)
            ...
            if (long_term_ref_pics_present_flag != 0)
            {
                ...
                for (i = 0; i < num_long_term_ref_pics_sps; i++)
                {
                    size += stream.WriteUnsignedIntVariable((((H265Context)context).SeqParameterSetRbsp.Log2MaxPicOrderCntLsbMinus4 + 4), this.lt_ref_pic_poc_lsb_sps[i], "lt_ref_pic_poc_lsb_sps");
    ...
    */
    public class DeltaDlt : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            uint k = 0;
            size += stream.ReadUnsignedIntVariable(size, ((H265Context)context).PicParameterSetRbsp.Pps3dExtension.PpsBitDepthForDepthLayersMinus8 + 8, out this.num_val_delta_dlt, "num_val_delta_dlt");
            ...
            if (num_val_delta_dlt > 0)
            {
                ...
                if (num_val_delta_dlt > 1)
                {
                    size += stream.ReadUnsignedIntVariable(size, ((H265Context)context).PicParameterSetRbsp.Pps3dExtension.PpsBitDepthForDepthLayersMinus8 + 8, out this.max_diff, "max_diff");
                }

                if (num_val_delta_dlt > 2 && max_diff > 0)
                {
                    size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(max_diff + 1)), out this.min_diff_minus1, "min_diff_minus1");
                }
                size += stream.ReadUnsignedIntVariable(size, ((H265Context)context).PicParameterSetRbsp.Pps3dExtension.PpsBitDepthForDepthLayersMinus8 + 8, out this.delta_dlt_val0, "delta_dlt_val0");
                ...
                if (max_diff > (min_diff_minus1 + 1))
                {
                    ...
                    for (k = 1; k < num_val_delta_dlt; k++)
                    {
                        size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(max_diff - min_diff_minus1 + 1)), out this.delta_val_diff_minus_min[k], "delta_val_diff_minus_min");
                    }
                }
            }
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            uint k = 0;
            size += stream.WriteUnsignedIntVariable(((H265Context)context).PicParameterSetRbsp.Pps3dExtension.PpsBitDepthForDepthLayersMinus8 + 8, this.num_val_delta_dlt, "num_val_delta_dlt");
            ...
            if (num_val_delta_dlt > 0)
            {
                ...
                if (num_val_delta_dlt > 1)
                {
                    size += stream.WriteUnsignedIntVariable(((H265Context)context).PicParameterSetRbsp.Pps3dExtension.PpsBitDepthForDepthLayersMinus8 + 8, this.max_diff, "max_diff");
                }

                if (num_val_delta_dlt > 2 && max_diff > 0)
                {
                    size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(max_diff + 1)), this.min_diff_minus1, "min_diff_minus1");
                }
                size += stream.WriteUnsignedIntVariable(((H265Context)context).PicParameterSetRbsp.Pps3dExtension.PpsBitDepthForDepthLayersMinus8 + 8, this.delta_dlt_val0, "delta_dlt_val0");
                ...
                if (max_diff > (min_diff_minus1 + 1))
                {
                    ...
                    for (k = 1; k < num_val_delta_dlt; k++)
                    {
                        size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(max_diff - min_diff_minus1 + 1)), this.delta_val_diff_minus_min[k], "delta_val_diff_minus_min");
                    }
                }
            }
    ...
    public class SliceSegmentHeader : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (first_slice_segment_in_pic_flag == 0)
            {
                ...
                size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(((H265Context)context).PicSizeInCtbsY)), out this.slice_segment_address, "slice_segment_address");
            }
            ...
            (((H265Context)context).NalHeader.NalUnitHeader.NalUnitType != H265NALTypes.IDR_W_RADL && ((H265Context)context).NalHeader.NalUnitHeader.NalUnitType != H265NALTypes.IDR_N_LP))
                ...
                if (((H265Context)context).NalHeader.NalUnitHeader.NalUnitType != H265NALTypes.IDR_W_RADL && ((H265Context)context).NalHeader.NalUnitHeader.NalUnitType != H265NALTypes.IDR_N_LP)
                {
                    ...
                    {
                        size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(((H265Context)context).SeqParameterSetRbsp.NumShortTermRefPicSets)), out this.short_term_ref_pic_set_idx, "short_term_ref_pic_set_idx");
                    ...
                    if (((H265Context)context).SeqParameterSetRbsp.LongTermRefPicsPresentFlag != 0)
                    {
                        ...
                        for (i = 0; i < num_long_term_sps + num_long_term_pics; i++)
                        {
                            ...
                            if (i < num_long_term_sps)
                            {
                                ...
                                {
                                    size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(((H265Context)context).SeqParameterSetRbsp.NumLongTermRefPicsSps)), out this.lt_idx_sps[i], "lt_idx_sps");
                                }
                            }
                            else
                            {
            ...
            ((H265Context)context).NumRefListLayers[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId] > 0)
                {
                    ...
                    if (inter_layer_pred_enabled_flag != 0 && ((H265Context)context).NumRefListLayers[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId] > 1)
                    {
                        ...
                        {
                            size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(((H265Context)context).NumDirectRefLayers[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId])), out this.num_inter_layer_ref_pics_minus1, "num_inter_layer_ref_pics_minus1");
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            if (first_slice_segment_in_pic_flag == 0)
            {
                ...
                size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(((H265Context)context).PicSizeInCtbsY)), this.slice_segment_address, "slice_segment_address");
            }
            ...
            (((H265Context)context).NalHeader.NalUnitHeader.NalUnitType != H265NALTypes.IDR_W_RADL && ((H265Context)context).NalHeader.NalUnitHeader.NalUnitType != H265NALTypes.IDR_N_LP))
                ...
                if (((H265Context)context).NalHeader.NalUnitHeader.NalUnitType != H265NALTypes.IDR_W_RADL && ((H265Context)context).NalHeader.NalUnitHeader.NalUnitType != H265NALTypes.IDR_N_LP)
                {
                    ...
                    {
                        size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(((H265Context)context).SeqParameterSetRbsp.NumShortTermRefPicSets)), this.short_term_ref_pic_set_idx, "short_term_ref_pic_set_idx");
                        ((H265Context)context).OnShortTermRefPicSetIdx();
                    }
                    ...
                    if (((H265Context)context).SeqParameterSetRbsp.LongTermRefPicsPresentFlag != 0)
                    {
                        ...
                        for (i = 0; i < num_long_term_sps + num_long_term_pics; i++)
                        {
                            ...
                            if (i < num_long_term_sps)
                            {
                                ...
                                if (((H265Context)context).SeqParameterSetRbsp.NumLongTermRefPicsSps > 1)
                                {
                                    size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(((H265Context)context).SeqParameterSetRbsp.NumLongTermRefPicsSps)), this.lt_idx_sps[i], "lt_idx_sps");
                                }
                            }
                            else
                            {
            ...
            ((H265Context)context).NumRefListLayers[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId] > 0)
                {
                    ...
                    if (inter_layer_pred_enabled_flag != 0 && ((H265Context)context).NumRefListLayers[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId] > 1)
                    {
                        ...
                        if (((H265Context)context).VideoParameterSetRbsp.VpsExtension.MaxOneActiveRefLayerFlag == 0)
                        {
                            size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(((H265Context)context).NumDirectRefLayers[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId])), this.num_inter_layer_ref_pics_minus1, "num_inter_layer_ref_pics_minus1");
                            ((H265Context)context).OnNumInterLayerRefPicsMinus1();
                        }
    ...
    public class RefPicListsModification : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (ref_pic_list_modification_flag_l0 != 0)
            {
                ...
                for (i = 0; i <= ((H265Context)context).SliceSegmentLayerRbsp.SliceSegmentHeader.NumRefIdxL0ActiveMinus1; i++)
                {
                    size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(((H265Context)context).NumPicTotalCurr)), out this.list_entry_l0[i], "list_entry_l0");
            ...
            if (H265FrameTypes.IsB(((H265Context)context).SliceSegmentLayerRbsp.SliceSegmentHeader.SliceType))
            {
                ...
                if (ref_pic_list_modification_flag_l1 != 0)
                {
                    ...
                    for (i = 0; i <= ((H265Context)context).SliceSegmentLayerRbsp.SliceSegmentHeader.NumRefIdxL1ActiveMinus1; i++)
                    {
                        size += stream.ReadUnsignedIntVariable(size, (uint)Math.Ceiling(Math.Log2(((H265Context)context).NumPicTotalCurr)), out this.list_entry_l1[i], "list_entry_l1");
                    }
                }
            }
        ...
        public ulong Write(IItuContext context, ItuStream stream)
        {
            ...
            if (ref_pic_list_modification_flag_l0 != 0)
            {
                ...
                for (i = 0; i <= ((H265Context)context).SliceSegmentLayerRbsp.SliceSegmentHeader.NumRefIdxL0ActiveMinus1; i++)
                {
                    size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(((H265Context)context).NumPicTotalCurr)), this.list_entry_l0[i], "list_entry_l0");
                    ((H265Context)context).OnListEntryL0();
                }
            }
            ...
            if (H265FrameTypes.IsB(((H265Context)context).SliceSegmentLayerRbsp.SliceSegmentHeader.SliceType))
            {
                ...
                if (ref_pic_list_modification_flag_l1 != 0)
                {
                    ...
                    for (i = 0; i <= ((H265Context)context).SliceSegmentLayerRbsp.SliceSegmentHeader.NumRefIdxL1ActiveMinus1; i++)
                    {
                        size += stream.WriteUnsignedIntVariable((uint)Math.Ceiling(Math.Log2(((H265Context)context).NumPicTotalCurr)), this.list_entry_l1[i], "list_entry_l1");
                    }
                }
            }
