  ...
  vps_vui()  
    ...
    */
    public class VpsExtension : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            for (i = ((H265Context)context).VideoParameterSetRbsp.VpsBaseLayerInternalFlag != 0 ? 2 : 1;
          i <= vps_num_profile_tier_level_minus1; i++)
            {
   ...
   && H265Helpers.GetNumDirectRefLayers(context)[H265Helpers.GetOlsHighestOutputLayerId(context)[i]] > 0)
            ...
            if (rep_format_idx_present_flag != 0)
            {
                ...
                for (i = ((H265Context)context).VideoParameterSetRbsp.VpsBaseLayerInternalFlag != 0 ? 1 : 0; i <= Math.Min(62, ((H265Context)context).VideoParameterSetRbsp.VpsMaxLayersMinus1); i++)
                {
            ...
            else
            {
                ...
                for (i = ((H265Context)context).VideoParameterSetRbsp.VpsBaseLayerInternalFlag != 0 ? 1 : 2; i <= Math.Min(62, ((H265Context)context).VideoParameterSetRbsp.VpsMaxLayersMinus1); i++)
                {

                    this.direct_dependency_type[i] = new uint[i];
                    for (j = ((H265Context)context).VideoParameterSetRbsp.VpsBaseLayerInternalFlag != 0 ? 0 : 1; j < i; j++)
                    {
    ...
    public class VpsVui : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            if (bit_rate_present_vps_flag != 0 || pic_rate_present_vps_flag != 0)
            {
                ...
                for (i = ((H265Context)context).VideoParameterSetRbsp.VpsBaseLayerInternalFlag != 0 ? 0 : 1; i < (((H265Context)context).VideoParameterSetAnnexfRbsp.VpsNumLayerSetsMinus1 + 1 + ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumAddLayerSets); i++)
                {
            ...
            if (video_signal_info_idx_present_flag != 0 && vps_num_video_signal_info_minus1 > 0)
            {
                ...
                for (i = ((H265Context)context).VideoParameterSetRbsp.VpsBaseLayerInternalFlag != 0 ? 0 : 1; i <= Math.Min(62, ((H265Context)context).VideoParameterSetRbsp.VpsMaxLayersMinus1); i++)
                {
            ...
            if (((H265Context)context).VideoParameterSetRbsp.VpsNumHrdParameters + vps_num_add_hrd_params > 0)
            {
                ...
                for (h = 1; h < ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.NumOutputLayerSets; h++)
                {
                    ...
                    for (i = 0; i < num_signalled_partitioning_schemes[h] + 1; i++)
                    {
                        ...
                        this.num_bsp_schedules_minus1[h][i] = new uint[H265Helpers.GetMaxSubLayersInLayerSetMinus1(context) + 1[H265Helpers.GetOlsIdxToLsIdx(context)[h]]];
                        this.bsp_hrd_idx[h][i] = new uint[H265Helpers.GetMaxSubLayersInLayerSetMinus1(context) + 1[H265Helpers.GetOlsIdxToLsIdx(context)[h]]][][];
                        this.bsp_sched_idx[h][i] = new uint[H265Helpers.GetMaxSubLayersInLayerSetMinus1(context) + 1[H265Helpers.GetOlsIdxToLsIdx(context)[h]]][][];
    ...
    */
    public class ColourMappingTable : IItuSerializable
    {
        ...
        public ulong Read(IItuContext context, ItuStream stream)
        {
            ...
            this.colour_mapping_octants = new ColourMappingOctants(0, 0, 0, 0, 1 << ((H265Context)context).PicParameterSetRbsp.PpsMultilayerExtension.ColourMappingTable.CmOctantDepth);
   ...
   (slice_sao_luma_flag != 0 || slice_sao_chroma_flag != 0 ||
    slice_deblocking_filter_disabled_flag == 0))
            ...
            if (((H265Context)context).PicParameterSetRbsp.SliceSegmentHeaderExtensionPresentFlag != 0)
            {
                ...
                if (((((H265Context)context).NalHeader.NalUnitHeader.NalUnitType == H265NALTypes.BLA_W_LP || ((H265Context)context).NalHeader.NalUnitHeader.NalUnitType == H265NALTypes.BLA_N_LP || ((H265Context)context).NalHeader.NalUnitHeader.NalUnitType == H265NALTypes.BLA_W_RADL || ((H265Context)context).NalHeader.NalUnitHeader.NalUnitType == H265NALTypes.CRA_NUT) && (((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.VpsPocLsbAlignedFlag == 0 || (((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.VpsPocLsbAlignedFlag != 0 && H265Helpers.GetNumDirectRefLayers(context)[((H265Context)context).NalHeader.NalUnitHeader.NuhLayerId] == 0))) == 0 && ((H265Context)context).VideoParameterSetAnnexfRbsp.VpsExtension.VpsPocLsbAlignedFlag != 0)
                {
