...
public class PseudoExpression : PseudoCode
{
    private string Expression { get; }

    public PseudoExpression(string expression)
    {
        this.Expression = expression;
    }
}

public class PseudoExpressionBlock : PseudoCode
{
    public ImmutableArray<PseudoCode> PseudoCodes { get; }

    public PseudoExpressionBlock(ImmutableArray<PseudoCode> pseudoCodes)
    {
...
partial class Program
{
    ...
    public static Parser<char, IEnumerable<PseudoCode>> Fields =>
    ...
    public static Parser<char, PseudoCode> CodeBlock => Try(LineComment(String("//")).Then(SkipWhitespaces)).Optional().Then(Block.Or(Field));
