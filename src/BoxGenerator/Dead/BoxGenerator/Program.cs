...
";
    ...
    private static string GetReadMethod(string type)
    {
        Dictionary<string, string> map = new Dictionary<string, string>
        {
            ...
            { "ItemInfoEntry[ entry_count ]", "stream.ReadClass(" },
            ...
            { "PartitionEntry[ entry_count ]", "stream.ReadClass(entry_count, " },
            ...
            { "SampleGroupDescriptionEntry (grouping_type)", "stream.ReadClass(" },
    ...
    private static string GetCalculateSizeMethod(string type)
    {
        Dictionary<string, string> map = new Dictionary<string, string>
        {
            ...
            { "ItemInfoEntry[ entry_count ]", "IsoStream.CalculateClassSize(value)" },
            ...
            { "VvcSubpicIDEntry", "IsoStream.CalculateClassSize(value)" },
            { "VvcSubpicOrderEntry", "IsoStream.CalculateClassSize(value)" },
            ...
            { "DownMixInstructions() []", "IsoStream.CalculateClassSize(value)" },
    ...
    private static string GetWriteMethod(string type)
    {
        Dictionary<string, string> map = new Dictionary<string, string>
        {
            ...
            { "ItemInfoEntry[ entry_count ]", "stream.WriteClass(entry_count, " },
            ...
            { "PartitionEntry[ entry_count ]", "stream.WriteClass(entry_count, " },
