...
";
    ...
    private static string GetCalculateSizeMethod(string type)
    {
        Dictionary<string, string> map = new Dictionary<string, string>
        {
            ...
            { "DRCCoefficientsBasic() []", "IsoStream.CalculateSize(value)" },
            { "DRCInstructionsBasic() []", "IsoStream.CalculateSize(value)" },
            { "DRCCoefficientsUniDRC() []", "IsoStream.CalculateSize(value)" },
            { "DRCInstructionsUniDRC() []", "IsoStream.CalculateSize(value)" },
