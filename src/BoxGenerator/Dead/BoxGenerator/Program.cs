...
";
    ...
    private static string GetReadMethod(string type)
    {
        Dictionary<string, string> map = new Dictionary<string, string>
        {
            ...
            { "ItemPropertyAssociationBox[]", "IsoReaderWriter.ReadBoxes(stream, " },
            ...
            { "ItemInfoEntry[ entry_count ]", "IsoReaderWriter.ReadClasses(stream, " },
            { "TypeCombinationBox[]", "IsoReaderWriter.ReadBoxes(stream, " },
            ...
            { "PartitionEntry[ entry_count ]", "IsoReaderWriter.ReadClasses(stream, entry_count, " },
            ...
            { "SingleItemTypeReferenceBox[]", "IsoReaderWriter.ReadBoxes(stream, " },
            { "SingleItemTypeReferenceBoxLarge", "IsoReaderWriter.ReadBox(stream, " },
            { "SingleItemTypeReferenceBoxLarge[]", "IsoReaderWriter.ReadBoxes(stream, " },
            ...
            { "Descriptor[0 .. 255]", "IsoReaderWriter.ReadClasses(stream, " },
            ...
            { "DownMixInstructions() []", "IsoReaderWriter.ReadClasses(stream, " },
            { "DRCCoefficientsBasic() []", "IsoReaderWriter.ReadClasses(stream, " },
            { "DRCInstructionsBasic() []", "IsoReaderWriter.ReadClasses(stream, " },
            { "DRCCoefficientsUniDRC() []", "IsoReaderWriter.ReadClasses(stream, " },
            { "DRCInstructionsUniDRC() []", "IsoReaderWriter.ReadClasses(stream, " },
            ...
            { "DependencyInfo[numReferences]", "IsoReaderWriter.ReadClasses(stream, numReferences, " },
