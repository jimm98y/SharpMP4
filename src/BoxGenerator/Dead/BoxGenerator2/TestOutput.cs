...
namespace BoxGenerator2
{
    ...
    public class hintpayloadID : Box
    {
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ...
            size += IsoReaderWriter.WriteInt8(stream, this.rtpmap_string[count]);
            return size;
        }
    }
    ...
    public class ColourInformationBox : Box
    {
        ...
        public byte full_range_flag { get; set; }
    ...
    public class ScrambleSchemeInfoBox : Box
    {
        ...
        {
            await base.ReadAsync(stream);
            this.scheme_type_box = IsoReaderWriter.ReadBox(stream);
            this.info = IsoReaderWriter.ReadBox(stream);
        }
    ...
    public class URIInitBox : FullBox
    {
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ulong size = 0;
            size += await base.WriteAsync(stream);
            size += IsoReaderWriter.WriteUInt8(stream, this.uri_initialization_data[]);
            return size;
        }
    }
    ...
    public class TrackSelectionBox : FullBox
    {
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ...
            size += IsoReaderWriter.WriteUInt32(stream, this.attribute_list[]);
            return size;
        }
    }
    ...
    public class rtptracksdphintinformation : Box
    {
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ulong size = 0;
            size += await base.WriteAsync(stream);
            size += IsoReaderWriter.WriteInt8(stream, this.sdptext[]);
            return size;
        }
    }
    ...
    public class LoudnessBox : Box
    {
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ...
            size += IsoReaderWriter.WriteInt32(stream, this.TrackLoudnessInfo[]);
            return size;
        }
    }
    ...
    public class ItemPropertyContainerBox : Box
    {
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ulong size = 0;
            size += await base.WriteAsync(stream);
            size += IsoReaderWriter.WriteBox(stream, this.properties[]);
    ...
    public class ItemPropertiesBox : Box
    {
        ...
        {
            await base.ReadAsync(stream);
            this.property_container = IsoReaderWriter.ReadBox(stream);
            this.association[] = IsoReaderWriter.ReadBox(stream);
        }
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ...
            size += IsoReaderWriter.WriteBox(stream, this.association[]);
            return size;
        }
    }
    ...
    public class BinaryXMLBox : FullBox
    {
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ulong size = 0;
            size += await base.WriteAsync(stream);
            size += IsoReaderWriter.WriteUInt8(stream, this.data[]);
            return size;
        }
    }
    ...
    public class CompleteTrackInfoBox : Box
    {
        ...
        {
            await base.ReadAsync(stream);
            this.original_format = IsoReaderWriter.ReadBox(stream);
        }
    ...
    public class CompactSampleToGroupBox : FullBox
    {
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ...
            for (int i = 1; i <= pattern_count; i++)
            {
                size += IsoReaderWriter.WriteBytes(stream, f(pattern_size_code), this.pattern_length[i]);
                size += IsoReaderWriter.WriteBytes(stream, f(count_size_code), this.sample_count[i]);
            }
            ...
            for (int j = 1; j <= pattern_count; j++)
            {
                ...
                for (int k = 1; k <= pattern_length[j]; k++)
                {
                    size += IsoReaderWriter.WriteBytes(stream, f(index_size_code), this.sample_group_description_index[j][k]);
                }
            }
            return size;
        }
    ...
    public class ExtendedTypeBox : Box
    {
        ...
        {
            await base.ReadAsync(stream);
            this.compatible_combinations[] = IsoReaderWriter.ReadBox(stream);
        }
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ulong size = 0;
            size += await base.WriteAsync(stream);
            size += IsoReaderWriter.WriteBox(stream, this.compatible_combinations[]);
            return size;
        }
    }
    ...
    public class PartitionEntry : Box
    {
        ...
        {
            await base.ReadAsync(stream);
            this.blocks_and_symbols = IsoReaderWriter.ReadBox(stream);
            this.FEC_symbol_locations = IsoReaderWriter.ReadBox(stream);
            this.File_symbol_locations = IsoReaderWriter.ReadBox(stream);
        }
    ...
    public class FDItemInformationBox : FullBox
    {
        ...
        public async override Task ReadAsync(Stream stream)
        {
            await base.ReadAsync(stream);
            this.entry_count = IsoReaderWriter.ReadUInt16(stream);
            this.partition_entries[entry_count] = IsoReaderWriter.ReadClass(stream);
            this.session_info = IsoReaderWriter.ReadBox(stream);
            this.group_id_to_name = IsoReaderWriter.ReadBox(stream);
        }
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ...
            size += await base.WriteAsync(stream);
            size += IsoReaderWriter.WriteUInt16(stream, this.entry_count);
            size += IsoReaderWriter.WriteClass(stream, this.partition_entries[entry_count]);
    ...
    public class MetaBox : FullBox
    {
        ...
        {
            await base.ReadAsync(stream);
            this.theHandler = IsoReaderWriter.ReadBox(stream);
            this.primary_resource = IsoReaderWriter.ReadBox(stream);
            this.file_locations = IsoReaderWriter.ReadBox(stream);
            this.item_locations = IsoReaderWriter.ReadBox(stream);
            this.protections = IsoReaderWriter.ReadBox(stream);
            this.item_infos = IsoReaderWriter.ReadBox(stream);
            this.IPMP_control = IsoReaderWriter.ReadBox(stream);
            this.item_refs = IsoReaderWriter.ReadBox(stream);
            this.item_data = IsoReaderWriter.ReadBox(stream);
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ...
            size += IsoReaderWriter.WriteBox(stream, this.other_boxes[]);
            return size;
        }
    }
    ...
    public class SampleAuxiliaryInformationOffsetsBox : FullBox
    {
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ...
            if (version == 0)
            {
                size += IsoReaderWriter.WriteUInt32(stream, this.offset[entry_count]);
            }

            else
            {
                size += IsoReaderWriter.WriteUInt64(stream, this.offset[entry_count]);
            }
            return size;
        }
    }
    ...
    public class SampleAuxiliaryInformationSizesBox : FullBox
    {
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ...
            if (default_sample_info_size == 0)
            {
                size += IsoReaderWriter.WriteUInt8(stream, this.sample_info_size[sample_count]);
            }
            return size;
        }
    }
    ...
    public class SchemeInformationBox : Box
    {
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ulong size = 0;
            size += await base.WriteAsync(stream);
            size += IsoReaderWriter.WriteBox(stream, this.scheme_specific_data[]);
            return size;
        }
    }
    ...
    public class TrackFragmentRandomAccessBox : FullBox
    {
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ...
            for (int i = 1; i <= number_of_entry; i++)
            {
                ...
                size += IsoReaderWriter.WriteBytes(stream, (length_size_of_traf_num + 1), this.traf_number);
                size += IsoReaderWriter.WriteBytes(stream, (length_size_of_trun_num + 1), this.trun_number);
                size += IsoReaderWriter.WriteBytes(stream, (length_size_of_sample_num + 1), this.sample_delta);
            }
            return size;
        }
    }
    ...
    public class TrackReferenceBox : Box
    {
        ...
        {
            await base.ReadAsync(stream);
            this.TrackReferenceTypeBox = IsoReaderWriter.ReadBoxes(stream);
        }
    ...
    public class TypeCombinationBox : Box
    {
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ulong size = 0;
            size += await base.WriteAsync(stream);
            size += IsoReaderWriter.WriteUInt32(stream, this.compatible_brands[]);
            return size;
        }
    }
    ...
    public class MetadataKeyTableBox : Box
    {
        ...
        {
            await base.ReadAsync(stream);
            this.MetadataKeyBox = IsoReaderWriter.ReadBoxes(stream);
        }
    ...
    public class MultiviewGroupBox : FullBox
    {
        ...
        public async override Task ReadAsync(Stream stream)
        {
            ...
            this.subset_stream_info = IsoReaderWriter.ReadBox(stream);
            this.relation_attributes = IsoReaderWriter.ReadBox(stream);
            this.subset_stream_bit_rate = IsoReaderWriter.ReadBox(stream);
            this.subset_stream_buffering = IsoReaderWriter.ReadBox(stream);
            this.multiview_scene_info = IsoReaderWriter.ReadBox(stream);
        }
    ...
    public class MVDDepthResolutionBox : Box
    {
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ...
            for (int i = 0; i < grid_pos_num_vies; i++)
            {
                ...
                size += IsoReaderWriter.WriteInt16(stream, this.grid_pos_x[grid_pos_view_id[i]]);
                size += IsoReaderWriter.WriteInt16(stream, this.grid_pos_y[grid_pos_view_id[i]]);
            }
            return size;
        }
    }
    ...
    public class MVCDConfigurationBox : Box
    {
        ...
        {
            await base.ReadAsync(stream);
            this.MVDConfig = IsoReaderWriter.ReadClass(stream);
            this.mvdDepthRes = IsoReaderWriter.ReadBox(stream);
        }
    ...
    public class ViewIdentifierBox : FullBox
    {
        ...
        public byte[] texture_in_stream { get; set; }
        public byte[] texture_in_track { get; set; }
        public byte[] depth_in_stream { get; set; }
    ...
    public class MVCConfigurationBox : Box
    {
        ...
        {
            await base.ReadAsync(stream);
            this.MVCConfig = IsoReaderWriter.ReadClass(stream);
        }
    ...
    public class AVCConfigurationBox : Box
    {
        ...
        {
            await base.ReadAsync(stream);
            this.AVCConfig = IsoReaderWriter.ReadClass(stream);
        }
    ...
    public class HEVCConfigurationBox : Box
    {
        ...
        {
            await base.ReadAsync(stream);
            this.HEVCConfig = IsoReaderWriter.ReadClass(stream);
        }
    ...
    public class LHEVCConfigurationBox : Box
    {
        ...
        {
            await base.ReadAsync(stream);
            this.LHEVCConfig = IsoReaderWriter.ReadClass(stream);
        }
    ...
    public class MPEG4ExtensionDescriptorsBox : Box
    {
        ...
        {
            await base.ReadAsync(stream);
            this.Descr[0..255] = IsoReaderWriter.ReadClass(stream);
        }
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ulong size = 0;
            size += await base.WriteAsync(stream);
            size += IsoReaderWriter.WriteClass(stream, this.Descr[0..255]);
            return size;
        }
    }
    ...
    public class SVCConfigurationBox : Box
    {
        ...
        {
            await base.ReadAsync(stream);
            this.SVCConfig = IsoReaderWriter.ReadClass(stream);
        }
    ...
    public class SVCPriorityAssignmentBox : Box
    {
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ...
            size += IsoReaderWriter.WriteString(stream, this.PriorityAssignmentURI[method_count]);
            return size;
        }
    }
    ...
    public class HEVCTileConfigurationBox : Box
    {
        ...
        {
            await base.ReadAsync(stream);
            this.HEVCTileTierLevelConfig = IsoReaderWriter.ReadClass(stream);
        }
    ...
    public class EVCConfigurationBox : Box
    {
        ...
        {
            await base.ReadAsync(stream);
            this.EVCConfig = IsoReaderWriter.ReadClass(stream);
        }
    ...
    public class VvcConfigurationBox : FullBox
    {
        ...
        {
            await base.ReadAsync(stream);
            this.VvcConfig = IsoReaderWriter.ReadClass(stream);
        }
    ...
    public class EVCSliceComponentTrackConfigurationBox : Box
    {
        ...
        {
            await base.ReadAsync(stream);
            this.config = IsoReaderWriter.ReadClass(stream);
        }
    ...
    public class WVTTSampleEntry : PlainTextSampleEntry
    {
        ...
        {
            await base.ReadAsync(stream);
            this.config = IsoReaderWriter.ReadBox(stream);
            this.label = IsoReaderWriter.ReadBox(stream);
    ...
    public class URIMetaSampleEntry : MetaDataSampleEntry
    {
        ...
        {
            await base.ReadAsync(stream);
            this.the_label = IsoReaderWriter.ReadBox(stream);
            this.init = IsoReaderWriter.ReadBox(stream);
        }
    ...
    public class ProtectedMPEG2TransportStreamSampleEntry : MPEG2TSSampleEntry
    {
        ...
        {
            await base.ReadAsync(stream);
            this.SchemeInformation = IsoReaderWriter.ReadBox(stream);
        }
    ...
    public class TrackReferenceTypeBox : Box
    {
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ulong size = 0;
            size += await base.WriteAsync(stream);
            size += IsoReaderWriter.WriteUInt32(stream, this.track_IDs[]);
            return size;
        }
    }
    ...
    public class HEVCLHVCSampleEntry : HEVCSampleEntry
    {
        ...
        {
            await base.ReadAsync(stream);
            this.lhvcconfig = IsoReaderWriter.ReadBox(stream);
        }
    ...
    public class AVCSVCSampleEntry : AVCSampleEntry
    {
        ...
        {
            await base.ReadAsync(stream);
            this.svcconfig = IsoReaderWriter.ReadBox(stream);
            this.scalability = IsoReaderWriter.ReadBox(stream);
            this.method = IsoReaderWriter.ReadBox(stream);
        }
    ...
    public class SVCMetadataSampleEntry : MetadataSampleEntry
    {
        ...
        public async override Task ReadAsync(Stream stream)
        {
            await base.ReadAsync(stream);
            this.config = IsoReaderWriter.ReadBox(stream);
            this.methods = IsoReaderWriter.ReadBox(stream);
            this.priorities = IsoReaderWriter.ReadBox(stream);
        }
    ...
    public class OperatingPointGroupBox : EntityToGroupBox
    {
        ...
        public async override Task ReadAsync(Stream stream)
        {
            ...
            {
                this.opeg_ptl[i] = IsoReaderWriter.ReadClass(stream);
            }
            this.reserved = IsoReaderWriter.ReadBits(stream, 6);
            ...
            for (int i = 0; i < num_olss; i++)
            {
                ...
                if (layer_info_present_flag)
                {
                    ...
                    for (int j = 0; j < layer_count; j++)
                    {
                        ...
                        size += IsoReaderWriter.WriteBit(stream, this.is_output_layer[i][j]);
                        size += IsoReaderWriter.WriteBit(stream, this.reserved);
                    }
                }
            }
    ...
    public class AVCSubSequenceEntry : VisualSampleGroupEntry
    {
        ...
        public async override Task ReadAsync(Stream stream)
        {
            ...
            this.dependency[numReferences] = IsoReaderWriter.ReadClass(stream);
        }
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ...
            size += IsoReaderWriter.WriteClass(stream, this.dependency[numReferences]);
            return size;
        }
    }
    ...
    public class LayerInfoGroupEntry : VisualSampleGroupEntry
    {
        ...
        public byte reserved { get; set; } = 0;
        public byte irap_gdr_pics_in_layer_only_flag { get; set; }
        public byte completeness_flag { get; set; }
        public byte layer_id { get; set; }
    ...
    public class OperatingPointsInformation : VisualSampleGroupEntry
    {
        ...
        {
            await base.ReadAsync(stream);
            this.oinf = IsoReaderWriter.ReadClass(stream);
        }
    ...
    public class RectangularRegionGroupEntry : VisualSampleGroupEntry
    {
        ...
        public byte full_picture { get; set; }
    ...
    public class AuxiliaryTypeProperty : ItemFullProperty
    {
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ...
            size += IsoReaderWriter.WriteUInt8(stream, this.aux_subtype[]);
            return size;
        }
    }
    ...
    public class JPEGConfigurationBox : Box
    {
        ...
        public async override Task<ulong> WriteAsync(Stream stream)
        {
            ulong size = 0;
            size += await base.WriteAsync(stream);
            size += IsoReaderWriter.WriteUInt8(stream, this.JPEGprefix[]);
            return size;
        }
    }
    ...
    public class OperatingPointsInformationProperty : ItemFullProperty
    {
        ...
        {
            await base.ReadAsync(stream);
            this.op_info = IsoReaderWriter.ReadClass(stream);
        }
    ...
    public class VvcSubpicIDProperty : ItemFullProperty
    {
        ...
        {
            await base.ReadAsync(stream);
            this.sid_info = IsoReaderWriter.ReadClass(stream);
        }
    ...
    public class VvcSubpicOrderProperty : ItemFullProperty
    {
        ...
        {
            await base.ReadAsync(stream);
            this.sor_info = IsoReaderWriter.ReadClass(stream);
        }
